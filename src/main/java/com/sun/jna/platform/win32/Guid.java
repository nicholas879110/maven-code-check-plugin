...
public interface Guid {
    public static class GUID extends Structure {
        ...
        public static class ByReference extends Guid.GUID implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
