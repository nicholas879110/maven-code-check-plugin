...
public interface WinUser extends StdCallLibrary, WinDef {
    HWND HWND_BROADCAST = new HWND(Pointer.createConstant(65535));
    int FLASHW_STOP = 0;
    ...
    public static class MOUSEINPUT extends Structure {
        ...
        public static class ByReference extends WinUser.MOUSEINPUT implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
    ...
    public static class KEYBDINPUT extends Structure {
        ...
        public static class ByReference extends WinUser.KEYBDINPUT implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
    ...
    public static class INPUT extends Structure {
        ...
        public static class ByReference extends WinUser.INPUT implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
    ...
    public static class HARDWAREINPUT extends Structure {
        ...
        public static class ByReference extends WinUser.HARDWAREINPUT implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
    ...
    public interface LowLevelKeyboardProc extends WinUser.HOOKPROC {
        LRESULT callback(int var1, WPARAM var2, WinUser.KBDLLHOOKSTRUCT var3);
    }
