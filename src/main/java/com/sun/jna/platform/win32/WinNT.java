...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
    ...
    int FILE_FLAG_WRITE_THROUGH = -2147483648;
    ...
    int SE_PRIVILEGE_USED_FOR_ACCESS = -2147483648;
    ...
    int PROTECTED_DACL_SECURITY_INFORMATION = -2147483648;
    ...
    HMODULE GetModuleHandle(String var1);

    void GetSystemTime(SYSTEMTIME var1);
    ...
    WinNT.HANDLE CreateFile(String var1, int var2, int var3, SECURITY_ATTRIBUTES var4, int var5, int var6, WinNT.HANDLE var7);

    boolean CopyFile(String var1, String var2, boolean var3);

    boolean MoveFile(String var1, String var2);

    boolean MoveFileEx(String var1, String var2, DWORD var3);

    boolean CreateDirectory(String var1, SECURITY_ATTRIBUTES var2);

    boolean ReadFile(WinNT.HANDLE var1, Pointer var2, int var3, IntByReference var4, OVERLAPPED var5);

    WinNT.HANDLE CreateIoCompletionPort(WinNT.HANDLE var1, WinNT.HANDLE var2, Pointer var3, int var4);

    boolean GetQueuedCompletionStatus(WinNT.HANDLE var1, IntByReference var2, ULONG_PTRByReference var3, PointerByReference var4, int var5);

    boolean PostQueuedCompletionStatus(WinNT.HANDLE var1, int var2, Pointer var3, OVERLAPPED var4);
    ...
    boolean ReadDirectoryChangesW(WinNT.HANDLE var1, WinNT.FILE_NOTIFY_INFORMATION var2, int var3, boolean var4, int var5, IntByReference var6, OVERLAPPED var7, WinNT.OVERLAPPED_COMPLETION_ROUTINE var8);

    int GetShortPathName(String var1, char[] var2, int var3);

    Pointer LocalAlloc(int var1, int var2);

    boolean WriteFile(WinNT.HANDLE var1, byte[] var2, int var3, IntByReference var4, OVERLAPPED var5);

    WinNT.HANDLE CreateEvent(SECURITY_ATTRIBUTES var1, boolean var2, boolean var3, String var4);

    boolean SetEvent(WinNT.HANDLE var1);

    boolean PulseEvent(WinNT.HANDLE var1);

    WinNT.HANDLE CreateFileMapping(WinNT.HANDLE var1, SECURITY_ATTRIBUTES var2, int var3, int var4, int var5, String var6);
    ...
    boolean CreateProcess(String var1, String var2, SECURITY_ATTRIBUTES var3, SECURITY_ATTRIBUTES var4, boolean var5, DWORD var6, Pointer var7, String var8, STARTUPINFO var9, com.sun.jna.platform.win32.WinBase.PROCESS_INFORMATION.ByReference var10);

    WinNT.HANDLE OpenProcess(int var1, boolean var2, int var3);

    DWORD GetTempPath(DWORD var1, char[] var2);
    ...
    void GetSystemInfo(SYSTEM_INFO var1);

    void GetNativeSystemInfo(SYSTEM_INFO var1);

    boolean IsWow64Process(WinNT.HANDLE var1, IntByReference var2);

    boolean GlobalMemoryStatusEx(MEMORYSTATUSEX var1);

    boolean GetFileTime(WinNT.HANDLE var1, com.sun.jna.platform.win32.WinBase.FILETIME.ByReference var2, com.sun.jna.platform.win32.WinBase.FILETIME.ByReference var3, com.sun.jna.platform.win32.WinBase.FILETIME.ByReference var4);

    int SetFileTime(WinNT.HANDLE var1, FILETIME var2, FILETIME var3, FILETIME var4);

    boolean SetFileAttributes(String var1, DWORD var2);

    DWORD GetLogicalDriveStrings(DWORD var1, char[] var2);
    ...
    boolean CreatePipe(WinNT.HANDLEByReference var1, WinNT.HANDLEByReference var2, SECURITY_ATTRIBUTES var3, int var4);
    ...
    WinNT.HANDLE CreateToolhelp32Snapshot(DWORD var1, DWORD var2);

    boolean Process32First(WinNT.HANDLE var1, com.sun.jna.platform.win32.Tlhelp32.PROCESSENTRY32.ByReference var2);

    boolean Process32Next(WinNT.HANDLE var1, com.sun.jna.platform.win32.Tlhelp32.PROCESSENTRY32.ByReference var2);

    public interface OVERLAPPED_COMPLETION_ROUTINE extends StdCallCallback {
        void callback(int var1, int var2, OVERLAPPED var3);
    }
    ...
    public static class SECURITY_DESCRIPTOR_RELATIVE extends Structure {
        ...
        public SECURITY_DESCRIPTOR_RELATIVE(byte[] data) {
            super(new Memory((long)data.length));
        ...
        public static class ByReference extends WinNT.SECURITY_DESCRIPTOR_RELATIVE implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
        }
    }
    ...
    public static class ACL extends Structure {
        ...
        public ACL(Pointer pointer) {
            ...
            for(int i = 0; i < this.AceCount; ++i) {
                ...
                this.ACEs[i] = (WinNT.ACCESS_ACEStructure)ace;
                offset += ((WinNT.ACCESS_ACEStructure)ace).AceSize;
            }
    ...
    public static class SECURITY_DESCRIPTOR extends Structure {
        ...
        public static class ByReference extends WinNT.SECURITY_DESCRIPTOR implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
        }
    }
    ...
    public static class LARGE_INTEGER extends Structure {
        ...
        public static class ByReference extends WinNT.LARGE_INTEGER implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
        }
    }
    ...
    public static class PSID extends Structure {
        ...
        public static class ByReference extends WinNT.PSID implements com.sun.jna.Structure.ByReference {
            public ByReference() {
            }
        }
    }
    ...
    public static class LUID_AND_ATTRIBUTES extends Structure {
        ...
        public LUID_AND_ATTRIBUTES(WinNT.LUID luid, DWORD attributes) {
            this.Luid = luid;
