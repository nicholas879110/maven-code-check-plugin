...
public abstract class NotificationsManager {
    ...
    public abstract void expire( final Notification notification);

    public abstract <T extends Notification> T[] getNotificationsOfType(Class<T> klass,  Project project);
