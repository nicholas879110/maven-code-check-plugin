...
import com.gome.maven.notification.impl.NotificationsManagerImpl;
...
public class EventLog {
    ...
    public static LogModel getLogModel( Project project) {
        return project != null ? getProjectComponent(project).myProjectModel : getApplicationComponent().myModel;
    }

    
    public static Trinity<Notification, String, Long> getStatusMessage( Project project) {
        return getLogModel(project).getStatusMessage();
    }

    public static LogEntry formatForLog( final Notification notification, String indent) {
    ...
    public static void toggleLog( final Project project,  final Notification notification) {
    ...
    public static class ProjectTracker extends AbstractProjectComponent {
        ...
        private void doPrintNotification( final Notification notification,  final EventLogConsole console) {
