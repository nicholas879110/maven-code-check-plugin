...
public class NotificationsManagerImpl extends NotificationsManager {
    ...
    @Override
    public void expire( final Notification notification) {
    ...
    @Override
    public <T extends Notification> T[] getNotificationsOfType(Class<T> klass,  final Project project) {
    ...
    private static void showNotification(final Notification notification,  final Project project) {
    ...
    public static Balloon createBalloon( final IdeFrame window, final Notification notification, final boolean showCallout, final boolean hideOnClickOutside) {
    ...
    private static class MyNotificationListener extends NotificationsAdapter {
        ...
        public MyNotificationListener( Project project) {
            myProject = project;
        }
