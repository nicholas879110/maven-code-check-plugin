...
package com.gome.maven.history.core.changes;

import com.gome.maven.history.core.Content;
...
public class ChangeSet {
    ...
    private <T> T accessChanges( Producer<T> func) {
        if (isLocked) {
    ...
    private void accessChanges( final Runnable func) {
