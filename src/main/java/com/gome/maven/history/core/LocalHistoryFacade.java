...
package com.gome.maven.history.core;

import com.gome.maven.history.ByteContent;
import com.gome.maven.history.core.changes.*;
import com.gome.maven.history.core.revisions.ChangeRevision;
import com.gome.maven.history.core.revisions.RecentChange;
import com.gome.maven.history.core.revisions.Revision;
...
public class LocalHistoryFacade {
    ...
    public void addListener( final Listener l,  Disposable parent) {
        myListeners.add(l);
