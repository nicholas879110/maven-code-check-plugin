 ...
 * Should be registered as "com.gome.maven.lang.importOptimizer" extension.
 * @author max
...
public interface ImportOptimizer {
     ...
     * processFile() is guaranteed to run with {@link com.gome.maven.openapi.application.Application#runReadAction(Runnable)} privileges and
     * the Runnable returned is guaranteed to run with {@link com.gome.maven.openapi.application.Application#runWriteAction(Runnable)} privileges.
     *
