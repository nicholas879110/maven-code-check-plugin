 ...
 */
package com.gome.maven.lang.java.lexer;
...
public class JavaLexer extends LexerBase {
    ...
    public JavaLexer( final LanguageLevel level) {
    ...
    private static final class HashTable {
        ...
        private static final Logger LOG = Logger.getInstance("com.gome.maven.Lexer.JavaLexer");
