...
import static com.gome.maven.lang.PsiBuilderUtil.*;
...
public class StatementParser {
    ...
    public StatementParser( final JavaParser javaParser) {
        myParser = javaParser;
    }
    ...
    private void parseStatements(final PsiBuilder builder,  final BraceMode braceMode) {
