...
import com.gome.maven.lang.PsiBuilderUtil;
import com.gome.maven.lang.WhitespacesBinders;
...
import static com.gome.maven.lang.PsiBuilderUtil.drop;
import static com.gome.maven.lang.PsiBuilderUtil.expect;
import static com.gome.maven.lang.PsiBuilderUtil.rollbackTo;
...
public class ExpressionParser {
    ...
    public ExpressionParser( final JavaParser javaParser) {
        myParser = javaParser;
    }
    ...
    private PsiBuilder.Marker parsePrimary(final PsiBuilder builder,  final BreakPoint breakPoint, final int breakOffset) {
    ...
    private PsiBuilder.Marker parseNew(PsiBuilder builder,  PsiBuilder.Marker start) {
    ...
    private PsiBuilder.Marker parseLambdaAfterParenth(final PsiBuilder builder,  final PsiBuilder.Marker typeList) {
    ...
    private PsiBuilder.Marker parseLambdaExpression(final PsiBuilder builder, final boolean typed,  final PsiBuilder.Marker typeList) {
