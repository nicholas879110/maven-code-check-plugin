...
public class JavadocParser {
    ...
    private static void parseDataItem( final PsiBuilder builder,  final String tagName, final boolean isInline) {
    ...
    private static void parseSeeTagValue( final PsiBuilder builder) {
        final IElementType tokenType = getTokenType(builder);
