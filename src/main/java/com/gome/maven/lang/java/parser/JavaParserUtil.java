...
import com.gome.maven.lang.impl.PsiBuilderAdapter;
...
public class JavaParserUtil {
    ...
    public static IElementType exprType( final PsiBuilder.Marker marker) {
    ...
    public static void error(final PsiBuilder builder, final String message,  final PsiBuilder.Marker before) {
        if (before == null) {
