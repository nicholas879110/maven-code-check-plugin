...
import static com.gome.maven.util.BitUtil.*;
...
public class ReferenceParser {
    ...
    public ReferenceParser( final JavaParser javaParser) {
        myParser = javaParser;
    }
    ...
    public PsiBuilder.Marker parseReferenceList(PsiBuilder builder, IElementType start,  IElementType type, IElementType delimiter) {
