...
public class WhitespacesBinders {
    ...
    public static WhitespacesAndCommentsBinder leadingCommentsBinder( Condition<IElementType> isCommentCondition) {
    ...
    public static WhitespacesAndCommentsBinder leadingCommentsBinder( final TokenSet commentTypes) {
    ...
    private static class LeadingCommentsBinder implements WhitespacesAndCommentsBinder {
        ...
        LeadingCommentsBinder( Condition<IElementType> isCommentCondition) {
