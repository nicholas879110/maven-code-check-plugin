 ...
 * and its register instance wrapped with {@link com.gome.maven.openapi.fileTypes.LanguageFileType} instance through
 * <code>FileTypeManager.getInstance().registerFileType</code>
 * There should be exactly one instance of each Language.
 * It is usually created when creating {@link com.gome.maven.openapi.fileTypes.LanguageFileType} and can be retrieved later
 * with {@link #findInstance(Class)}.
 * For the list of standard languages, see {@link com.gome.maven.lang.StdLanguages}.
 */
public abstract class Language extends UserDataHolderBase {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.lang.Language");
    ...
    protected Language( Language baseLanguage,   final String ID,   final String... mimeTypes) {
