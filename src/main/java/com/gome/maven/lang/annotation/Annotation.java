 ...
 * @see com.gome.maven.openapi.editor.markup.RangeHighlighter
 */
public final class Annotation implements Segment {
    ...
    public static class QuickFixInfo {
        ...
        public QuickFixInfo( IntentionAction fix,  TextRange range,  final HighlightDisplayKey key) {
            this.key = key;
            quickFix = fix;
            textRange = range;
        }
     ...
     */
    public Annotation(final int startOffset, final int endOffset,  HighlightSeverity severity, final String message, String tooltip) {
    ...
    public void registerFix( LocalQuickFix fix,  TextRange range,  HighlightDisplayKey key,
     ...
     */
    public void registerFix( IntentionAction fix,  TextRange range,  final HighlightDisplayKey key) {
        if (range == null) {
            range = new TextRange(myStartOffset, myEndOffset);
        }
        if (myQuickFixes == null) {
     ...
     */
    public <T extends IntentionAction & LocalQuickFix> void registerUniversalFix( T fix,  TextRange range,  final HighlightDisplayKey key) {
