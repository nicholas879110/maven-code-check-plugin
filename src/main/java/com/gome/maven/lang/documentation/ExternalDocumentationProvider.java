...
public interface ExternalDocumentationProvider {
     ...
     * If not implemented, update check is performed by calling {@link DocumentationProvider#getUrlFor(com.gome.maven.psi.PsiElement, com.gome.maven.psi.PsiElement)}.
     *
