...
package com.gome.maven.lang.cacheBuilder;
 ...
 * from {@link com.gome.maven.lang.findUsages.FindUsagesProvider#getWordsScanner()}.
 *
 * @author yole
 */
public abstract class CacheBuilderRegistry {
     ...
     */
    @Deprecated
    public abstract void registerCacheBuilder( FileType fileType, WordsScanner cacheBuilder);
