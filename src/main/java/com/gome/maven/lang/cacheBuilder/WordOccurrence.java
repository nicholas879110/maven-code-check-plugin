...
public class WordOccurrence {
    ...
    public WordOccurrence(final CharSequence text, int start, int end,  final Kind kind) {
        myKind = kind;
        myText = text;
        myStart = start;
        myEnd = end;
     ...
     * @param kind The type of text where the word was encountered (code, comments or literals).
     */
    public final void init(final CharSequence text, int start, int end,  final Kind kind) {
        myKind = kind;
        myText = text;
        myStart = start;
        myEnd = end;
