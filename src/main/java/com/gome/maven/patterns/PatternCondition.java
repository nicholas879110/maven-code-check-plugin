...
public abstract class PatternCondition<T> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.patterns.PatternCondition");
     private static final String PARAMETER_FIELD_PREFIX = "val$";
    private final String myDebugMethodName;

    public PatternCondition(  String debugMethodName) {
    ...
    public abstract boolean accepts( T t, final ProcessingContext context);
