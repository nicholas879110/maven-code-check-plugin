...
public abstract class TreeElementPattern<ParentType, T extends ParentType, Self extends TreeElementPattern<ParentType, T, Self>>
    ...
    protected TreeElementPattern( final InitialPatternCondition<T> condition) {
        super(condition);
    }
    ...
    protected abstract ParentType[] getChildren( final ParentType parentType);
    ...
    public Self withParent( final ElementPattern<? extends ParentType> pattern) {
        return withSuperParent(1, pattern);
    }

    public Self withChild( final ElementPattern<? extends ParentType> pattern) {
        return withChildren(StandardPatterns.<ParentType>collection().atLeastOne(pattern));
    }

    public Self withFirstChild( final ElementPattern<? extends ParentType> pattern) {
        return withChildren(StandardPatterns.<ParentType>collection().first(pattern));
    }

    public Self withLastChild( final ElementPattern<? extends ParentType> pattern) {
    ...
    public Self withSuperParent(final int level,  final Class<? extends ParentType> aClass) {
    ...
    public Self inside( final Class<? extends ParentType> pattern) {
        return inside(StandardPatterns.instanceOf(pattern));
    }

    public Self inside( final ElementPattern<? extends ParentType> pattern) {
    ...
    public Self inside(final boolean strict,  final ElementPattern<? extends ParentType> pattern,
                        final ElementPattern<? extends ParentType> stopAt) {
