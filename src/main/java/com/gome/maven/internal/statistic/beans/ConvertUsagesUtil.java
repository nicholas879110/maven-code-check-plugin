 ...
 */
package com.gome.maven.internal.statistic.beans;
...
/**
 * ATTENTION! DO NOT IMPORT  AND @Nullable ANNOTATIONS
...
public class ConvertUsagesUtil {
    ...
    public static String escapeDescriptorName( final String name) {
