...
public class RemotelyConfigurableStatisticsService implements StatisticsService {
    ...
    public RemotelyConfigurableStatisticsService( StatisticsConnectionService connectionService,
                                                  StatisticsDataSender sender,
                                                  StatisticsUploadAssistant assistant) {
    ...
    @Override
    public Notification createNotification( final String groupDisplayId,  NotificationListener listener) {
