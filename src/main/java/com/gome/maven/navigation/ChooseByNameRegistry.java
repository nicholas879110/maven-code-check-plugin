...
public class ChooseByNameRegistry {
     ...
     * @deprecated use {@link com.gome.maven.navigation.ChooseByNameContributor#CLASS_EP_NAME} extension point instead
     */
     ...
     * @param contributor the contributor instance.
     * @see #removeContributor(ChooseByNameContributor)
     * @deprecated use {@link com.gome.maven.navigation.ChooseByNameContributor#SYMBOL_EP_NAME} extension point instead
     */
