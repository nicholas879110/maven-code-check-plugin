 ...
 */
package com.gome.maven.errorreport.itn;

import com.gome.maven.diagnostic.DiagnosticBundle;
...
import com.gome.maven.util.net.ssl.CertificateUtil;
            ...
            try {
                ...
                if (certificates.length > 1) {
                    ...
                    if (certificate instanceof X509Certificate) {
                        ...
                        if (cn.endsWith(".jetbrains.com") || cn.endsWith(".gome.maven.net")) {
                            return true;
                        }
                    }
