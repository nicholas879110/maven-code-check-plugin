 ...
 * <p/>
 * Many {@link com.gome.maven.psi.PsiElement}s implement this interface (see {@link com.gome.maven.psi.NavigatablePsiElement}). To create an
 * instance which opens a file in editor and put caret to a specific location use {@link com.gome.maven.openapi.fileEditor.OpenFileDescriptor}.
 */
