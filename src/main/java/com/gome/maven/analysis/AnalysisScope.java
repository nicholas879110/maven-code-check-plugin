...
public class AnalysisScope {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.analysis.AnalysisScope");
...
//    @MagicConstant(intValues = {PROJECT, DIRECTORY, FILE, MODULE, INVALID, MODULES, CUSTOM, VIRTUAL_FILES, UNCOMMITTED_FILES})
    ...
    private static boolean processFile( final VirtualFile fileOrDir,
                                        final PsiElementVisitor visitor,
                                        final PsiManager psiManager,
                                       final boolean needReadAction) {
        final PsiFile file;
    ...
    protected boolean accept( final PsiDirectory dir,  final Processor<VirtualFile> processor) {
