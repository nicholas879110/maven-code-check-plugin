...
public class FileCopyPasteUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.dnd.FileCopyPasteUtil");
    ...
    public static DataFlavor createDataFlavor( final String mimeType,  final Class<?> klass) {
        return createDataFlavor(mimeType, klass, false);
    }

    public static DataFlavor createDataFlavor( final String mimeType,  final Class<?> klass, final boolean register) {
        try {
    ...
    public static DataFlavor createJvmDataFlavor( final Class<?> klass) {
    ...
    public static List<File> getFileList( final Transferable transferable) {
        try {
