...
import static com.gome.maven.ide.dnd.FileCopyPasteUtil.createDataFlavor;
...
public class LinuxDragAndDropSupport {
    ...
    public static List<File> getFiles( final Transferable transferable) throws IOException, UnsupportedFlavorException {
    ...
    private static List<File> getFiles( final String transferData) {
    ...
    public static String toUriList( final List<File> files) {
    ...
    public static boolean isMoveOperation( final Transferable transferable) {
