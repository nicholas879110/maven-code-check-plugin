 ...
 */
package com.gome.maven.ide.dnd;
...
import com.gome.maven.ui.MouseDragHelper;
import com.gome.maven.ui.awt.RelativeRectangle;
import com.gome.maven.util.ui.GeometryUtil;
...
public class DnDManagerImpl extends DnDManager implements Disposable {
    private static final Logger LOG = Logger.getInstance("com.gome.maven.ide.dnd.DnDManager");
    ...
    public void registerSource( final AdvancedDnDSource source) {
    ...
    private void cleanup( final DnDSource source,  final DnDTarget target,  final JComponent targetComponent) {
    ...
    private DnDEventImpl updateCurrentEvent(Component aComponentOverDragging, Point aPoint, int nativeAction,  DataFlavor[] flavors,  Transferable transferable) {
