...
public class IdeTooltipManager implements ApplicationComponent, AWTEventListener {
    ...
    public boolean hideCurrent( MouseEvent me,  AnAction action,  AnActionEvent event) {
        return hideCurrent(me, action, event, myCurrentTipUi != null && myCurrentTipUi.isAnimationEnabled());
    }

    public boolean hideCurrent( MouseEvent me,  AnAction action,  AnActionEvent event, final boolean animationEnabled) {
    ...
    public static JEditorPane initPane( String text, final HintHint hintHint,  final JLayeredPane layeredPane) {
        return initPane(new Html(text), hintHint, layeredPane);
    }

    public static JEditorPane initPane( Html html, final HintHint hintHint,  final JLayeredPane layeredPane) {
