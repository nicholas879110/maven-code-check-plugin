...
public class ErrorViewStructure extends AbstractTreeStructure {
    ...
    public boolean hasMessages( Set<ErrorTreeElementKind> kinds) {
        synchronized (myLock) {
    ...
    public void addNavigatableMessage( String groupName,
    ...
    private void addSimpleMessage( ErrorTreeElementKind kind, final String[] text, final Object data) {
