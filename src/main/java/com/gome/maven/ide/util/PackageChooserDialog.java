...
import com.gome.maven.openapi.fileChooser.ex.TextFieldAction;
...
import com.gome.maven.openapi.ui.PackageChooser;
...
public class PackageChooserDialog extends PackageChooser {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.util.PackageChooserDialog");
    ...
    public String getDimensionServiceKey(){
        return "#com.gome.maven.ide.util.PackageChooserDialog";
    }
