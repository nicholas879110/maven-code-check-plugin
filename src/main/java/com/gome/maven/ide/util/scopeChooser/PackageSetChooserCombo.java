...
import com.gome.maven.ui.components.editors.JBComboBoxTableCellEditorComponent;
...
public class PackageSetChooserCombo extends ComponentWithBrowseButton<JComponent> {
    ...
    public PackageSetChooserCombo(final Project project,  final String preselect, final boolean enableBrowseButton, final boolean useCombo) {
