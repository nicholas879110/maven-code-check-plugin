...
public class AbstractTreeUpdater implements Disposable, Activatable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.util.treeView.AbstractTreeUpdater");
    ...
    /**
     * @deprecated use {@link com.gome.maven.ide.util.treeView.AbstractTreeBuilder#queueUpdateFrom(Object, boolean)}
     */
