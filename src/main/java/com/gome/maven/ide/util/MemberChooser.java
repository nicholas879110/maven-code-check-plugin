...
import com.gome.maven.codeInsight.generation.*;
...
import com.gome.maven.openapi.ui.VerticalFlowLayout;
...
public class MemberChooser<T extends ClassMember> extends DialogWrapper implements TypeSafeDataProvider {
    ...
    public void resetElements(T[] elements, final  Comparator<T> sortComparator, final boolean restoreSelectedElements) {
    ...
    protected String getDimensionServiceKey() {
        return "#com.gome.maven.ide.util.MemberChooser";
    }
    ...
    protected abstract static class ElementNodeImpl extends DefaultMutableTreeNode implements ElementNode {
        ...
        public ElementNodeImpl( DefaultMutableTreeNode parent, MemberChooserObject delegate, Ref<Integer> order) {
            myOrder = order.get();
            order.set(myOrder + 1);
            myDelegate = delegate;
            if (parent != null) {
