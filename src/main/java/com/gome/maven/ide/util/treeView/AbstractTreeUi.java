...
import com.gome.maven.ide.UiActivity;
import com.gome.maven.ide.UiActivityMonitor;
...
import com.gome.maven.ui.LoadingNode;
import com.gome.maven.ui.treeStructure.AlwaysExpandedTree;
import com.gome.maven.ui.treeStructure.Tree;
import com.gome.maven.util.Alarm;
import com.gome.maven.util.ArrayUtil;
import com.gome.maven.util.Consumer;
import com.gome.maven.util.concurrency.WorkerThread;
import com.gome.maven.util.containers.ContainerUtil;
import com.gome.maven.util.containers.HashSet;
import com.gome.maven.util.enumeration.EnumerationCopy;
...
public class AbstractTreeUi {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.util.treeView.AbstractTreeBuilder");
    ...
    private void maybeSetBusyAndScheduleWaiterForReady(boolean forcedBusy,  Object element) {
    ...
    ActionCallback invokeLaterIfNeeded(boolean forceEdt,  final Runnable runnable) {
    ...
    void doExpandNodeChildren( final DefaultMutableTreeNode node) {
    ...
    private boolean update( final NodeDescriptor nodeDescriptor) {
        try {
    ...
    private ActionCallback updateNodeChildren( final DefaultMutableTreeNode node,
    ...
    private void doUpdateChildren( final DefaultMutableTreeNode node,
                                   final TreeUpdatePass pass,
                                   final LoadedChildren loadedChildren,
                                  boolean forcedNow,
                                  final boolean toSmartExpand,
                    ...
                    public void perform() {
                        ...
                        collectNodesToInsert(descriptor, elementToIndexMap, node, expanded, loadedChildren)
                                .doWhenDone(new Consumer<List<TreeNode>>() {
                                    @Override
                                    public void consume( final List<TreeNode> nodesToInsert) {
    ...
    private ActionCallback updateNodesToInsert( final List<TreeNode> nodesToInsert,
                                                TreeUpdatePass pass,
    ...
    private Boolean checkValue( Computable<Boolean> computable, boolean attempt) {
    ...
    private MutualMap<Object, Integer> loadElementsFromStructure(final NodeDescriptor descriptor,
                                                                  LoadedChildren preloadedChildren) {
    ...
    private static void processActions(DefaultMutableTreeNode node,
                                       Object element,
                                        ...
                                        final Map<Object, List<NodeAction>> secondaryNodeAction) {
    ...
    private ActionCallback queueToBackground( final Runnable bgBuildAction,  final Runnable edtPostRunnable) {
    ...
    private void unregisterWorkerTask( Runnable runnable,  Runnable finalizeRunnable) {
        boolean wasRemoved;
    ...
    private void insertNodesInto( final List<TreeNode> toInsert,  final DefaultMutableTreeNode parentNode) {
    ...
    private void sortChildren( DefaultMutableTreeNode node,  List<TreeNode> children, boolean updateStamp, boolean forceSort) {
        NodeDescriptor descriptor = getDescriptorFrom(node);
    ...
    public void select( final Object[] elements,  final Runnable onDone) {
        select(elements, onDone, false);
    }

    public void select( final Object[] elements,  final Runnable onDone, boolean addToSelection) {
        select(elements, onDone, addToSelection, false);
    }

    public void select( final Object[] elements,  final Runnable onDone, boolean addToSelection, boolean deferred) {
    ...
    private boolean checkDeferred(boolean isDeferred,  Runnable onDone) {
    ...
    public void select( Object element,  final Runnable onDone) {
        select(element, onDone, false);
    }

    public void select( Object element,  final Runnable onDone, boolean addToSelection) {
    ...
    public void scrollSelectionToVisible( final Runnable onDone, final boolean shouldBeCentered) {
    ...
    public void expandAllWithoutRecursion( final Runnable onDone) {
    ...
    public void expandAll( final Runnable onDone) {
        final JTree tree = getTree();
        if (tree.getRowCount() > 0) {
    ...
    public void expand(final Object element,  final Runnable onDone) {
    ...
    void expand( final Object[] element,  final Runnable onDone, boolean checkIfInStructure) {
    ...
    public void collapseChildren( final Object element,  final Runnable onDone) {
    ...
    private void runDone( Runnable done) {
        if (done == null) return;
    ...
    private void removeMapping( Object element, DefaultMutableTreeNode node,  Object elementToPutNodeActionsFor) {
        element = TreeAnchorizer.getService().createAnchor(element);
        final Object value = myElementToNodeMap.get(element);
        if (value != null) {
            if (value instanceof DefaultMutableTreeNode) {
    ...
    public boolean isInStructure( Object element) {
