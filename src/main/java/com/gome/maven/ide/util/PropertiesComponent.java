...
public abstract class PropertiesComponent {
     ...
     */
    public abstract void setValue( String name,  String value,  String defaultValue);
    ...
    public final int getOrInitInt( String name, int defaultValue) {
        try {
    ...
    public final long getOrInitLong( String name, long defaultValue) {
        try {
    ...
    public String getOrInit( String name, String defaultValue) {
        if (!isValueSet(name)) {
    ...
    public final boolean saveFields( Object object) {
        try {
    ...
    public final boolean loadFields( Object object) {
        try {
            for (Field field : object.getClass().getDeclaredFields()) {
                field.setAccessible(true);
