...
public class UpdaterTreeState {
    ...
    public boolean restore( DefaultMutableTreeNode actionNode) {
    ...
    public void addAdjustedSelection(final Object element, Condition isExpired,  Object adjustmentCause) {
