...
import com.gome.maven.openapi.projectRoots.impl.ProjectRootUtil;
...
import com.gome.maven.util.ActionRunner;
...
public class PackageUtil {
    private static final Logger LOG = Logger.getInstance("com.gome.maven.ide.util.PackageUtil");
