 ...
 * @see TreeFileChooserFactory#createFileChooser(String, com.gome.maven.psi.PsiFile, com.gome.maven.openapi.fileTypes.FileType, com.gome.maven.ide.util.TreeFileChooser.PsiFileFilter)
 * @see PsiFileFilter
 */
