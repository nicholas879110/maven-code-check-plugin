...
import com.gome.maven.psi.util.proximity.PsiProximityComparator;
...
public class DefaultChooseByNameItemProvider implements ChooseByNameItemProvider {
    ...
    @Override
    public boolean filterElements( final ChooseByNameBase base,
                                   final String pattern,
                                  boolean everywhere,
                                   final ProgressIndicator indicator,
                                   final Processor<Object> consumer) {
    ...
    private static boolean startMiddleMatchVariants( List<Object> qualifierMiddleMatched,
    ...
    protected void sortNamesList( String namePattern,  List<MatchResult> namesList) {
    ...
    private static String getNamePattern( ChooseByNameBase base, String pattern) {
    ...
    private static MatchResult matchQualifier( Object element,
                                               final ChooseByNameBase base,
                                               List<Pair<String, MinusculeMatcher>> patternsAndMatchers) {
    ...
    private static void processNamesByPattern( final ChooseByNameBase base,
                                               final String[] names,
                                               final String pattern,
                                              final ProgressIndicator indicator,
    ...
    private static MatchResult matches( ChooseByNameBase base,
                                        String pattern,
    ...
    private static class PathProximityComparator implements Comparator<Object> {
        ...
        private PathProximityComparator( final PsiElement context) {
