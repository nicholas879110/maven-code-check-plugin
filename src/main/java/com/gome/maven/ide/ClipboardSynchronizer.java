...
public class ClipboardSynchronizer implements ApplicationComponent {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.ClipboardSynchronizer");
...
//        }
    ...
    public void setContent( final Transferable content,  final ClipboardOwner owner) {
