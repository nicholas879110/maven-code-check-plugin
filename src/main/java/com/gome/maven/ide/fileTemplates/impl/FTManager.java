...
import com.gome.maven.ide.fileTemplates.FileTemplatesScheme;
 ...
 */
class FTManager {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.fileTemplates.impl.FTManager");
    ...
    FTManager(  String name,   String defaultTemplatesDirName) {
        this(name, defaultTemplatesDirName, false);
    }

    FTManager(  String name,   String defaultTemplatesDirName, boolean internal) {
        myName = name;
        myInternal = internal;
