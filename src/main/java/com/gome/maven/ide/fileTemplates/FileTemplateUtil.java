...
import com.gome.maven.ide.fileTemplates.impl.CustomFileTemplate;
...
import com.gome.maven.openapi.util.ClassLoaderUtil;
...
public class FileTemplateUtil{
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.fileTemplates.FileTemplateUtil");
    ...
    public static PsiElement createFromTemplate( final FileTemplate template,
                                                  final String fileName,
                                                 Properties props,
                                                 final PsiDirectory directory) throws Exception {
    ...
    public static Icon getIcon( FileTemplate fileTemplate) {
    ...
    public static FileTemplate createTemplate( String prefName,
                                               String extension,
                                               String content,
