...
public abstract class FileTemplateBase implements FileTemplate {
    ...
    public final String[] getUnsetAttributes( Properties properties, Project project) throws ParseException {
    ...
    @Override
    public boolean isTemplateOfType( final FileType fType) {
