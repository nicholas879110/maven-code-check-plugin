...
import com.gome.maven.ide.util.gotoByName.ChooseByNameFilter;
import com.gome.maven.ide.util.gotoByName.ChooseByNamePopup;
import com.gome.maven.ide.util.gotoByName.GotoFileConfiguration;
import com.gome.maven.ide.util.gotoByName.GotoFileModel;
