...
public class BookmarkManager extends AbstractProjectComponent implements PersistentStateComponent<Element> {
    ...
    public BookmarkManager(Project project, MessageBus bus, PsiDocumentManager documentManager, EditorColorsManager colorsManager) {
        ...
        documentManager.addListener(new PsiDocumentManager.Listener() {
            @Override
            public void documentCreated( final Document document, PsiFile psiFile) {
    ...
    public Bookmark findEditorBookmark( Document document, int line) {
        for (Bookmark bookmark : myBookmarks) {
    ...
    private class MyDocumentListener extends DocumentAdapter {
        ...
        private boolean isDuplicate(Bookmark bookmark,  List<Bookmark> toRemove) {
