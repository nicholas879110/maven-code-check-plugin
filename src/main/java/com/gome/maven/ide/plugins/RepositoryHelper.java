...
import com.gome.maven.util.io.RequestBuilder;
...
public class RepositoryHelper {
    ...
    public static List<IdeaPluginDescriptor> loadPlugins( ProgressIndicator indicator) throws IOException {
    ...
    public static List<IdeaPluginDescriptor> loadPlugins( String repositoryUrl,
    ...
    public static List<IdeaPluginDescriptor> loadPlugins( String repositoryUrl,
        ...
        return process(repositoryUrl, request.connect(new HttpRequests.RequestProcessor<List<IdeaPluginDescriptor>>() {
            @Override
            public List<IdeaPluginDescriptor> process( HttpRequests.Request request) throws IOException {
                if (indicator != null) {
