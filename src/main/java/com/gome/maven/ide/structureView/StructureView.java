 ...
 *
 * @see StructureViewBuilder#createStructureView(com.gome.maven.openapi.fileEditor.FileEditor, com.gome.maven.openapi.project.Project)
...
public interface StructureView extends Disposable {
     ...
     *
     * @see FileEditor#getUserData(com.gome.maven.openapi.util.Key)
     */
    void restoreState();
     ...
     *
     * @see FileEditor#putUserData(com.gome.maven.openapi.util.Key, Object)
     */
    void storeState();
