...
import com.gome.maven.ide.util.treeView.smartTree.TreeModel;
 ...
 *
 * @see com.gome.maven.ide.structureView.TreeBasedStructureViewBuilder#createStructureViewModel()
