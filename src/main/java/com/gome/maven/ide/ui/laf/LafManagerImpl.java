 ...
 */
package com.gome.maven.ide.ui.laf;
...
//import com.gome.maven.ui.mac.MacPopupMenuUI;
import com.gome.maven.ui.popup.OurHeavyWeightPopup;
...
public final class LafManagerImpl extends LafManager implements ApplicationComponent, PersistentStateComponent<Element> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.ui.LafManager");
     ...
     private static final String[] ourFileChooserTextKeys = {"FileChooser.viewMenuLabelText", "FileChooser.newFolderActionLabelText",
