...
public abstract class CustomizableActionGroupProvider {
    public static final ExtensionPointName<CustomizableActionGroupProvider> EP_NAME = ExtensionPointName.create("com.gome.maven.customizableActionGroupProvider");
    ...
    public interface CustomizableActionGroupRegistrar {
        void addCustomizableActionGroup( String groupId,  String groupTitle);
    }
}
