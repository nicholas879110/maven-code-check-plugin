...
import static com.gome.maven.util.ui.UIUtil.isValidFont;
...
public class UISettings extends SimpleModificationTracker implements PersistentStateComponent<UISettings> {
    ...
    /**
     * @deprecated use {@link UISettings#addUISettingsListener(com.gome.maven.ide.ui.UISettingsListener, Disposable disposable)} instead.
     */
    public void addUISettingsListener(UISettingsListener listener) {
        myDispatcher.addListener(listener);
    }

    public void addUISettingsListener(final UISettingsListener listener, Disposable parentDisposable) {
