 ...
 */
package com.gome.maven.ide.ui.laf.darcula;

import com.gome.maven.ide.ui.laf.DarculaMetalTheme;
import com.gome.maven.ide.ui.laf.IdeaLaf;
import com.gome.maven.ide.ui.laf.LafManagerImpl;
...
import com.gome.maven.util.containers.hash.HashMap;
...
//    e.printStackTrace();
    ...
    protected Object parseValue(String key,  String value) {
