...
import com.gome.maven.util.ui.JBInsets;
...
public class DarculaTextFieldUI extends BasicTextFieldUI {
    private static final Icon SEARCH_ICON = IconLoader.findIcon("/com/gome.maven/ide/ui/laf/darcula/icons/search.png", DarculaTextFieldUI.class, true);
    private static final Icon SEARCH_WITH_HISTORY_ICON = IconLoader.findIcon("/com/gome.maven/ide/ui/laf/darcula/icons/searchWithHistory.png", DarculaTextFieldUI.class, true);
    private static final Icon CLEAR_ICON = IconLoader.findIcon("/com/gome.maven/ide/ui/laf/darcula/icons/clear.png", DarculaTextFieldUI.class, true);
    ...
    protected void paintBackground(Graphics graphics) {
        ...
        if (isSearchField(c)) {
            ...
            if (searchIcon == null) {
                searchIcon = IconLoader.findIcon("/com/gome.maven/ide/ui/laf/icons/search.png", DarculaTextFieldUI.class, true);
            }
            ...
            if (hasText()) {
                ...
                if (clearIcon == null) {
                    clearIcon = IconLoader.findIcon("/com/gome.maven/ide/ui/laf/icons/clear.png", DarculaTextFieldUI.class, true);
                }
