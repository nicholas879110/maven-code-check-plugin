...
public class CustomizationUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.ui.customization.CustomizationUtil");
    ...
    public static MouseListener installPopupHandler(JComponent component,  final String groupId, final String place) {
