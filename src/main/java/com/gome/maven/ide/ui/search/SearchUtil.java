...
import com.gome.maven.application.options.SkipSelfSearchComponent;
...
import com.gome.maven.openapi.options.ex.GlassPanel;
...
public class SearchUtil {
    ...
    public static void processComponent(final JComponent component, final Set<OptionDescription> configurableOptions,  String path) {
    ...
    private static void processUILabel( final String title, final Set<OptionDescription> configurableOptions, String path) {
    ...
    public static String markup(  String textToMarkup,  String filter) {
