...
import com.gome.maven.ide.impl.dataRules.*;
...
public class DataManagerImpl extends DataManager {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ide.impl.DataManagerImpl");
    ...
    private Object getDataFromProvider( final DataProvider provider,  String dataId,  Set<String> alreadyComputedIds) {
