 ...
 */
package com.gome.maven.ide.impl.dataRules;
...
public interface GetDataRule {
    ExtensionPointName<KeyedLazyInstanceEP<GetDataRule>> EP_NAME = ExtensionPointName.create("com.gome.maven.getDataRule");
