...
import com.gome.maven.openapi.roots.ui.configuration.actions.ModuleDeleteProvider;
...
import com.gome.maven.ui.AutoScrollFromSourceHandler;
...
public class ProjectViewImpl extends ProjectView implements PersistentStateComponent<Element>, Disposable, QuickActionProvider, BusyObject  {
    ...
    // public for tests
    public synchronized void setupImpl( ToolWindow toolWindow, final boolean loadPaneExtensions) {
        ApplicationManager.getApplication().assertIsDispatchThread();
    ...
    @Override
    public ActionCallback changeViewCB( String viewId, String subId) {
    ...
    private class MyAutoScrollFromSourceHandler extends AutoScrollFromSourceHandler {
        ...
        private void scrollFromFile( PsiFile file,  Editor editor) {
        ...
        private class MySelectInContext implements SelectInContext {
            ...
            private MySelectInContext( PsiFile psiFile,  Editor editor) {
                myPsiFile = psiFile;
                myEditor = editor;
            }
    ...
    @Override
    public void setManualOrder( String paneId, final boolean enabled) {
