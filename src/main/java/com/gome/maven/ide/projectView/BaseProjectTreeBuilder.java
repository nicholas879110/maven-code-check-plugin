...
import com.gome.maven.ide.favoritesTreeView.FavoritesTreeNodeDescriptor;
...
public abstract class BaseProjectTreeBuilder extends AbstractTreeBuilder {
    ...
    private void expandChild( final List<AbstractTreeNode> kids,
                             int i,
                              final Condition<AbstractTreeNode> nonStopCondition,
                             final VirtualFile file,
                             final Object element,
