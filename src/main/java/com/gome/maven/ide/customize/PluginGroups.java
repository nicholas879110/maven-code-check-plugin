...
public class PluginGroups {
    ...
    initGroups(Map<String, Pair<Icon, List<String>>> tree, Map<String, String> featuredPlugins) {
        tree.put(CORE, Pair.create((Icon)null, Arrays.asList(
                "com.gome.maven.copyright",
                "com.gome.maven.java-i18n",
                "org.gome.maven.intelliLang",
                "com.gome.maven.properties",
                "Refactor-X",//?
                "Type Migration",
                "ZKM"
        )));
        tree.put("Java Frameworks", Pair.create(PlatformImplIcons.JavaFrameworks, Arrays.asList(
                "com.gome.maven.appengine",
                "org.gome.maven.grails",
                "com.gome.maven.gwt",
                "com.gome.maven.vaadin",
                "JBoss Seam:com.gome.maven.seam,com.gome.maven.seam.pages,com.gome.maven.seam.pageflow",
                "JBoss jBPM:JBPM",
                "Struts:StrutsAssistant,com.gome.maven.struts2",
                "com.gome.maven.hibernate",
                "Spring:com.gome.maven.spring.batch," +
                        "com.gome.maven.spring.data," +
                        "com.gome.maven.spring.integration," +
                        "com.gome.maven.spring.osgi," +
                        "com.gome.maven.spring.security," +
                        "com.gome.maven.spring," +
                        "com.gome.maven.spring.webflow," +
                        "com.gome.maven.spring.ws,com.gome.maven.aop",
                "J2EE:com.gome.maven.javaee.batch," +
                        "com.gome.maven.beanValidation," +
                        "com.gome.maven.cdi," +
                        "com.gome.maven.javaee," +
                        "com.gome.maven.jsf," +
                        "com.gome.maven.javaee.extensions," +
                        "com.jetbrains.restWebServices," +
                        "Java EE: Web Services (JAX-WS)," +
                        "com.gome.maven.javaee.webSocket," +
                        "com.gome.maven.jsp," +
                        "com.gome.maven.persistence",
                "com.gome.maven.freemarker",
                "com.gome.maven.tapestry",
                "com.gome.maven.velocity",
                "GuiceyIDEA",
                "com.gome.maven.aspectj",
                "Osmorc"
        )));
        ...
        tree.put("Web Development", Pair.create(PlatformImplIcons.WebDevelopment, Arrays.asList(
                ...
                "org.coffeescript",
                "com.gome.maven.flex",
                "com.gome.maven.plugins.html.instantEditing",
        ...
        tree.put("Other Tools", Pair.create(PlatformImplIcons.OtherTools, Arrays.asList(
                ...
                "Task Management:com.gome.maven.tasks,com.gome.maven.tasks.timeTracking",
                "org.jetbrains.plugins.terminal",
                "com.gome.maven.diagram",
        ...
        featuredPlugins.put("Scala", "Custom Languages:Plugin for Scala language support:org.gome.maven.scala");
        featuredPlugins.put("Live Edit Tool",
                "Web Development:Provides live edit HTML/CSS/JavaScript:com.gome.maven.plugins.html.instantEditing");
    ...
    private List<String> getNonOptionalDependencies(final String id) {
        ...
        if (descriptor != null) {
            for (PluginId pluginId : descriptor.getDependentPluginIds()) {
                if (pluginId.getIdString().equals("com.gome.maven")) continue;
