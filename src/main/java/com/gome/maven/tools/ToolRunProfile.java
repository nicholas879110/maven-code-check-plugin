...
import com.gome.maven.execution.configurations.CommandLineState;
import com.gome.maven.execution.configurations.GeneralCommandLine;
import com.gome.maven.execution.configurations.ModuleRunProfile;
import com.gome.maven.execution.configurations.RunProfileState;
import com.gome.maven.execution.filters.RegexpFilter;
...
import com.gome.maven.execution.process.*;
import com.gome.maven.execution.runners.ExecutionEnvironment;
import com.gome.maven.execution.runners.ProgramRunner;
import com.gome.maven.ide.macro.Macro;
import com.gome.maven.ide.macro.MacroManager;
...
public class ToolRunProfile implements ModuleRunProfile{
    ...
    @Override
    public RunProfileState getState( final Executor executor,  final ExecutionEnvironment env) {
