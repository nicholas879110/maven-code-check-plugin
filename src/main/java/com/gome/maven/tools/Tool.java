...
import com.gome.maven.execution.configurations.PathEnvironmentVariableUtil;
...
import com.gome.maven.execution.process.ProcessListener;
...
public class Tool implements SchemeElement {
    ...
    public void execute(AnActionEvent event, DataContext dataContext, long executionId,  final ProcessListener processListener) {
