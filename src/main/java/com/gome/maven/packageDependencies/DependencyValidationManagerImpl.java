...
public class DependencyValidationManagerImpl extends DependencyValidationManager {
    ...
    private void readRules(Element element) {
        ...
        for (Element rule1 : (List<Element>)element.getChildren(DENY_RULE_KEY)) {
    ...
    public NamedScope getScope( final String name) {
    ...
    private static void addScopesToList( final List<Pair<NamedScope, NamedScopesHolder>> scopeList,
