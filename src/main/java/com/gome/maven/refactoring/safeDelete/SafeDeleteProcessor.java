...
import com.gome.maven.refactoring.BaseRefactoringProcessor;
...
import com.gome.maven.refactoring.safeDelete.usageInfo.SafeDeleteCustomUsageInfo;
import com.gome.maven.refactoring.safeDelete.usageInfo.SafeDeleteReferenceSimpleDeleteUsageInfo;
import com.gome.maven.refactoring.safeDelete.usageInfo.SafeDeleteReferenceUsageInfo;
import com.gome.maven.refactoring.safeDelete.usageInfo.SafeDeleteUsageInfo;
import com.gome.maven.refactoring.util.NonCodeSearchDescriptionLocation;
...
public class SafeDeleteProcessor extends BaseRefactoringProcessor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.safeDelete.SafeDeleteProcessor");
    ...
    public static void addNonCodeUsages(final PsiElement element,
                                        List<UsageInfo> usages,
                                         final Condition<PsiElement> insideElements,
