...
import com.gome.maven.lang.java.JavaFindUsagesProvider;
...
public class MoveClassesOrPackagesUtil {
    private static final Logger LOG = Logger.getInstance(
            "#com.gome.maven.refactoring.move.moveClassesOrPackages.MoveClassesOrPackagesUtil");
    ...
    public static PsiDirectory chooseDestinationPackage(Project project, String packageName,  PsiDirectory baseDir) {
