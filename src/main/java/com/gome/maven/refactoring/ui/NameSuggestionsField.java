...
import com.gome.maven.codeInsight.editorActions.SelectWordUtil;
...
import com.gome.maven.ui.EditorComboBoxEditor;
import com.gome.maven.ui.EditorComboBoxRenderer;
import com.gome.maven.ui.EditorTextField;
import com.gome.maven.ui.StringComboboxEditor;
...
public class NameSuggestionsField extends JPanel {
    ...
    public NameSuggestionsField(final String[] suggestedNames, final Project project, final FileType fileType,  final Editor editor) {
