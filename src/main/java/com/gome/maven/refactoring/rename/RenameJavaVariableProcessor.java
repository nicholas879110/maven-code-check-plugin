...
import com.gome.maven.codeInsight.generation.GetterSetterPrototypeProvider;
...
import com.gome.maven.refactoring.util.ConflictsUtil;
...
public class RenameJavaVariableProcessor extends RenameJavaMemberProcessor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.rename.RenameJavaVariableProcessor");
