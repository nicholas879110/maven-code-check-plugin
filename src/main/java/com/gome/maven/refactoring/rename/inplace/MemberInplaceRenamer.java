...
import com.gome.maven.refactoring.rename.RenameProcessor;
import com.gome.maven.refactoring.rename.RenamePsiElementProcessor;
...
public class MemberInplaceRenamer extends VariableInplaceRenamer {
    ...
    public MemberInplaceRenamer( PsiNamedElement elementToRename, PsiElement substituted, Editor editor, String initialName, String oldName) {
