...
public class RefactoringChangeUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.util.ChangeUtil");
    ...
    public static PsiReferenceExpression qualifyReference( PsiReferenceExpression referenceExpression,
                                                           PsiMember member,
                                                           final PsiClass qualifyingClass) throws IncorrectOperationException {
    ...
    static <T extends PsiQualifiedExpression> T createQualifiedExpression( PsiManager manager,
                                                                          PsiClass qualifierClass,
                                                                           String qName) throws IncorrectOperationException {
