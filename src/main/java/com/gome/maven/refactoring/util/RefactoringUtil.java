...
public class RefactoringUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.util.RefactoringUtil");
    ...
    /**
     * @see com.gome.maven.psi.codeStyle.CodeStyleManager#suggestUniqueVariableName(String, com.gome.maven.psi.PsiElement, boolean)
    ...
    public static PsiElement expandExpressionLambdaToCodeBlock( PsiElement element) {
