 ...
 */
package com.gome.maven.refactoring.introduceField;

import com.gome.maven.codeInsight.AnnotationUtil;
import com.gome.maven.codeInsight.ChangeContextUtil;
import com.gome.maven.codeInsight.TestFrameworks;
import com.gome.maven.codeInsight.daemon.impl.quickfix.AnonymousTargetClassPreselectionUtil;
...
import com.gome.maven.ide.util.PsiClassListCellRenderer;
...
import com.gome.maven.refactoring.IntroduceHandlerBase;
...
import com.gome.maven.refactoring.introduceVariable.IntroduceVariableBase;
import com.gome.maven.refactoring.rename.RenameJavaVariableProcessor;
import com.gome.maven.refactoring.util.*;
import com.gome.maven.refactoring.util.occurrences.OccurrenceManager;
import com.gome.maven.util.IncorrectOperationException;
import com.gome.maven.util.VisibilityUtil;
import com.gome.maven.psi.util.FileTypeUtils;
...
public abstract class BaseExpressionToFieldHandler extends IntroduceHandlerBase {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.introduceField.BaseExpressionToFieldHandler");
    ...
    public static class ConvertToFieldRunnable implements Runnable {
        ...
        private static PsiField checkForwardRefs( final PsiExpression initializer, final PsiClass parentClass) {
