...
import com.gome.maven.refactoring.ui.TypeSelectorManager;
...
public abstract class IntroduceFieldCentralPanel {
    protected static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.introduceField.IntroduceFieldDialog");
    ...
    protected boolean setEnabledInitializationPlaces( final PsiElement initializer) {
