...
import com.gome.maven.refactoring.util.EnumConstantsUtil;
...
import static com.gome.maven.refactoring.introduceField.BaseExpressionToFieldHandler.InitializationPlace.IN_CONSTRUCTOR;
import static com.gome.maven.refactoring.introduceField.BaseExpressionToFieldHandler.InitializationPlace.IN_FIELD_DECLARATION;

public abstract class LocalToFieldHandler {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.introduceField.LocalToFieldHandler");
