...
import com.gome.maven.featureStatistics.ProductivityFeatureNames;
...
import com.gome.maven.psi.impl.PsiDiamondTypeUtil;
import com.gome.maven.psi.impl.source.jsp.jspJava.JspCodeBlock;
import com.gome.maven.psi.impl.source.jsp.jspJava.JspHolderMethod;
import com.gome.maven.psi.impl.source.tree.injected.InjectedLanguageUtil;
import com.gome.maven.psi.impl.source.tree.java.ReplaceExpressionUtil;
...
import com.gome.maven.refactoring.*;
...
import com.gome.maven.refactoring.introduceField.ElementToWorkOn;
...
import com.gome.maven.refactoring.util.FieldConflictsResolver;
...
import com.gome.maven.refactoring.util.occurrences.NotInSuperCallOccurrenceFilter;
...
public abstract class IntroduceVariableBase extends IntroduceHandlerBase {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.refactoring.introduceVariable.IntroduceVariableBase");
    ...
    public static SuggestedNameInfo getSuggestedName( PsiType type,
    ...
    public static PsiExpression getSelectedExpression(final Project project, PsiFile file, int startOffset, int endOffset) {
        ...
        try {
            ...
            final String fakeInitializer = "gome.mavenidearulezzz";
