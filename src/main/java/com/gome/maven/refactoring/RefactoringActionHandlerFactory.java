...
public abstract class RefactoringActionHandlerFactory {
     ...
     *
     * {@link RefactoringActionHandler#invoke(com.gome.maven.openapi.project.Project, com.gome.maven.psi.PsiElement[], com.gome.maven.openapi.actionSystem.DataContext)}
     * accepts a list of {@link com.gome.maven.psi.PsiElement}s to delete.
     * @return
     */
