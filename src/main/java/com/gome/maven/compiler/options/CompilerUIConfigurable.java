...
import com.gome.maven.compiler.CompilerConfigurationImpl;
import com.gome.maven.compiler.CompilerWorkspaceConfiguration;
import com.gome.maven.compiler.MalformedPatternException;
...
public class CompilerUIConfigurable implements SearchableConfigurable, Configurable.NoScroll {
    ...
    private void tweakControls( Project project) {
