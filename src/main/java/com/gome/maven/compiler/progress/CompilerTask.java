 ...
 * Time: 2:25:31 PM
 */
package com.gome.maven.compiler.progress;

import com.gome.maven.compiler.CompilerManagerImpl;
import com.gome.maven.compiler.impl.CompilerErrorTreeView;
...
public class CompilerTask extends Task.Backgroundable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.compiler.progress.CompilerProgressIndicator");
    ...
    @Deprecated
    public CompilerTask( Project project, String contentName, final boolean headlessMode, boolean forceAsync,
    ...
    public static final class IDObject {
        ...
        public IDObject( String displayName) {
