...
import com.gome.maven.compiler.impl.CompilerUtil;
import com.gome.maven.compiler.impl.javaCompiler.javac.JavacConfiguration;
import com.gome.maven.compiler.server.impl.BuildProcessClasspathManager;
import com.gome.maven.execution.ExecutionAdapter;
...
import com.gome.maven.ide.file.BatchFileChangeListener;
...
import com.gome.maven.openapi.compiler.CompilationStatusListener;
import com.gome.maven.openapi.compiler.CompileContext;
import com.gome.maven.openapi.compiler.CompilerTopics;
...
import com.gome.maven.openapi.projectRoots.impl.JavaAwareProjectJdkTableImpl;
...
import com.gome.maven.openapi.vfs.newvfs.impl.FileNameCache;
...
import com.gome.maven.util.concurrency.SequentialTaskExecutor;
...
public class BuildManager implements ApplicationComponent{
    ...
    private Project getContextProject( Window window) {
    ...
    private void notifySessionTerminationIfNeeded(UUID sessionId,  Throwable execFailure) {
    ...
    private static class NotifyingMessageHandler extends DelegatingMessageHandler {
        ...
        public NotifyingMessageHandler( Project project, BuilderMessageHandler delegateHandler, final boolean isAutomake) {
            myProject = project;
    ...
    private class ProjectWatcher extends ProjectManagerAdapter {
        ...
        public void projectOpened(final Project project) {
            ...
            conn.subscribe(ExecutionManager.EXECUTION_TOPIC, new ExecutionAdapter() {
                @Override
                public void processTerminated( RunProfile runProfile, ProcessHandler handler) {
                    scheduleAutoMake();
                }
            });
    ...
    private static final class DelegateFuture<T> implements TaskFuture<T> {
        ...
        public synchronized boolean setDelegate( TaskFuture<? extends T> delegate) {
            if (myDelegate == null) {
                try {
                    myDelegate = delegate;
