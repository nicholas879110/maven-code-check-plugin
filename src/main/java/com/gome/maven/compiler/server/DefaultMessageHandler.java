...
public abstract class DefaultMessageHandler implements BuilderMessageHandler {
    ...
    private boolean performRemovedConstantSearch( final PsiClass aClass, String fieldName, int fieldAccessFlags, final Set<String> affectedPaths) {
    ...
    private static boolean processIdentifiers(PsiSearchHelper helper,  final PsiElementProcessor<PsiIdentifier> processor,  final String identifier,  SearchScope searchScope, short searchContext) {
