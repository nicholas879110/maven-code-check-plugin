...
class BuildMessageDispatcher extends SimpleChannelInboundHandlerAdapter<CmdlineRemoteProto.Message> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.compiler.server.BuildMessageDispatcher");
    ...
    public void registerBuildMessageHandler( final RequestFuture<? extends BuilderMessageHandler> future,  CmdlineRemoteProto.Message.ControllerMessage params) {
    ...
    public boolean sendBuildParameters( final UUID preloadedSessionId,  CmdlineRemoteProto.Message.ControllerMessage params) {
