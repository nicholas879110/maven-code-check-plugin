...
public abstract class ProblemsView {
    ...
    public abstract void addMessage(int type,  String[] text,  String groupName,  Navigatable navigatable,  String exportTextPrefix,  String rendererTextPrefix,  UUID sessionId);

    public final void addMessage(CompilerMessage message,  UUID sessionId) {
