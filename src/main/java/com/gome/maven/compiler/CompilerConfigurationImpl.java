...
import com.gome.maven.compiler.impl.javaCompiler.eclipse.EclipseCompiler;
import com.gome.maven.compiler.impl.javaCompiler.javac.JavacCompiler;
...
import com.gome.maven.openapi.compiler.CompilerManager;
...
import com.gome.maven.openapi.project.ModuleAdapter;
...
import com.gome.maven.packaging.impl.artifacts.ArtifactBySourceFileFinder;
import com.gome.maven.util.ArrayUtil;
import com.gome.maven.util.messages.MessageBusConnection;
import com.gome.maven.util.xmlb.Accessor;
...
public class CompilerConfigurationImpl extends CompilerConfiguration implements PersistentStateComponent<Element>, ProjectComponent {
    ...
    public void setProjectBytecodeTarget( String level) {
    ...
    private void addWildcardResourcePattern( final String wildcardPattern) throws MalformedPatternException {
    ...
    private boolean isResourceFile(String name,  VirtualFile parent) {
    ...
    public void readExternal(Element parentNode)  {
        ...
        if (bytecodeTargetElement != null) {
            ...
            for (Element elem : (List<Element>)bytecodeTargetElement.getChildren(JpsJavaCompilerConfigurationSerializer.MODULE)) {
    ...
    private static class ExcludesConfigNotificationsWrapper<T extends ExcludesConfiguration> implements ExcludesConfiguration {
        ...
        public ExcludesConfigNotificationsWrapper( Project project,  T delegate) {
            myProject = project;
            myDelegate = delegate;
        }
