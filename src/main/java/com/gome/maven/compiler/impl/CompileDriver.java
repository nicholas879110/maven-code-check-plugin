...
import com.gome.maven.compiler.*;
import com.gome.maven.compiler.progress.CompilerTask;
import com.gome.maven.compiler.server.BuildManager;
import com.gome.maven.compiler.server.DefaultMessageHandler;
...
import com.gome.maven.openapi.compiler.ex.CompilerPathsEx;
import com.gome.maven.openapi.deployment.DeploymentUtil;
...
import com.gome.maven.openapi.roots.ui.configuration.CommonContentEntriesEditor;
...
import com.gome.maven.packaging.impl.compiler.ArtifactCompilerUtil;
import com.gome.maven.packaging.impl.compiler.ArtifactsCompiler;
...
public class CompileDriver {
    ...
    private TaskFuture compileInExternalProcess(final  CompileContextImpl compileContext, final boolean onlyCheckUpToDate)
            throws Exception {
  ...
  */
    ...
    private void showNotSpecifiedError( final String resourceId, List<String> modules, String editorNameToSelect) {
