...
public class CompileScopeUtil {
    ...
    public static void setBaseScopeForExternalBuild( CompileScope scope,  List<TargetTypeBuildScope> scopes) {
    ...
    public static List<TargetTypeBuildScope> getBaseScopeForExternalBuild( CompileScope scope) {
