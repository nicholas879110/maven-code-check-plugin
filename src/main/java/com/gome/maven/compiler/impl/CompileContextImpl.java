...
import com.gome.maven.compiler.CompilerMessageImpl;
import com.gome.maven.compiler.CompilerWorkspaceConfiguration;
import com.gome.maven.compiler.ProblemsView;
import com.gome.maven.compiler.progress.CompilerTask;
import com.gome.maven.execution.impl.ExecutionManagerImpl;
...
import com.gome.maven.openapi.compiler.ex.CompileContextEx;
...
public class CompileContextImpl extends UserDataHolderBase implements CompileContextEx {
    ...
    public boolean isInTestSourceContent( final VirtualFile fileOrDir) {
    ...
    public boolean isInSourceContent( final VirtualFile fileOrDir) {
