...
import com.gome.maven.spellchecker.engine.Transformation;
...
public final class CompressedDictionary implements Dictionary {
    ...
    private CompressedDictionary( Alphabet alphabet,  Encoder encoder,  String name) {
        this.alphabet = alphabet;
        this.encoder = encoder;
        this.name = name;
    }

    private void addToDictionary( byte[] word) {
    ...
    public static CompressedDictionary create( Loader loader,  final Transformation transform) {
    ...
    private static int compareArrays( byte[] array1, int start1, int length1,  byte[] array2) {
