...
import com.gome.maven.ui.components.JBTabbedPane;
...
import com.gome.maven.usages.rules.*;
...
import com.gome.maven.util.enumeration.EmptyEnumeration;
import com.gome.maven.util.messages.MessageBusConnection;
import com.gome.maven.util.ui.DialogUtil;
...
public class UsageViewImpl implements UsageView, UsageModelTracker.UsageModelTrackerListener {
    ...
    UsageViewImpl( final Project project,
    ...
    private void tabSelected( final UsageContextPanel.Provider provider) {
        myCurrentUsageContextProvider = provider;
        setupCentralPanel();
        updateOnSelectionChanged();
    }
    ...
    private static ConfigurableUsageTarget getConfigurableTarget( UsageTarget[] targets) {
    ...
    static KeyboardShortcut getShowUsagesWithSettingsShortcut( UsageTarget[] targets) {
            ...
            public void run( final ProgressIndicator indicator) {
                ...
                usageSearcher.generate(new Processor<Usage>() {
                    ...
                    public boolean process(final Usage usage) {
                        ...
                        boolean incrementCounter = !com.gome.maven.usages.UsageViewManager.isSelfUsage(usage, myTargets);
    ...
    private void updateImmediatelyNodesUpToRoot( List<TreeNode> nodes) {
        if (myProject.isDisposed()) return;
        TreeNode root = (TreeNode)myTree.getModel().getRoot();
    ...
    private void checkNodeValidity( TreeNode node,  TreePath path) {
    ...
    @Override
    public void addPerformOperationAction( Runnable processRunnable,
                                          String commandName,
