 ...
 */
package com.gome.maven.lifecycle;
...
public class PeriodicalTasksCloser implements ApplicationComponent {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.lifecycle.PeriodicalTasksCloser");
    ...
    public <T> T safeGetComponent( final Project project, final Class<T> componentClass) throws ProcessCanceledException {
        T component = null;
        try {
    ...
    public <T> T safeGetService( final Project project, final Class<T> componentClass) throws ProcessCanceledException {
        try {
