...
public abstract class GenericCompilerInstance<T extends BuildTarget, Item extends CompileItem<Key, SourceState, OutputState>, Key, SourceState, OutputState> {
    ...
    public abstract void processObsoleteTarget( String targetId,  List<GenericCompilerCacheState<Key, SourceState, OutputState>> obsoleteItems);


    
    public abstract List<Item> getItems( T target);

    public abstract void processItems( T target,  List<GenericCompilerProcessingItem<Item, SourceState, OutputState>> changedItems,  List<GenericCompilerCacheState<Key, SourceState, OutputState>> obsoleteItems,
