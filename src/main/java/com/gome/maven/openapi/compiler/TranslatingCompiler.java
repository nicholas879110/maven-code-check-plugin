...
public interface TranslatingCompiler extends Compiler {
     ...
     *         will not be included in the list of files passed to {@link #compile(CompileContext,Chunk<Module>,com.gome.maven.openapi.vfs.VirtualFile[], com.gome.maven.openapi.compiler.TranslatingCompiler.OutputSink)}.
     */
