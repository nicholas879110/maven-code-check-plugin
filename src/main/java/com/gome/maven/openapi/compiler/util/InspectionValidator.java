...
import com.gome.maven.codeInspection.InspectionToolProvider;
...
import com.gome.maven.openapi.compiler.CompilerMessageCategory;
...
public abstract class InspectionValidator {
    ...
    protected InspectionValidator( final String description,  final String progressIndicatorText, final Class<? extends LocalInspectionTool>... inspectionToolClasses) {
        myDescription = description;
        myProgressIndicatorText = progressIndicatorText;
        myInspectionToolClasses = inspectionToolClasses;
    }

    protected InspectionValidator( final String description,  final String progressIndicatorText, final InspectionToolProvider provider) {
        //noinspection unchecked
        this(description, progressIndicatorText, provider.getInspectionClasses());
    }

    protected InspectionValidator( final String description,  final String progressIndicatorText, final Class<? extends InspectionToolProvider> providerClass)
    ...
    public CompilerMessageCategory getCategoryByHighlightDisplayLevel( final HighlightDisplayLevel severity,  final VirtualFile virtualFile,  final CompileContext context) {
