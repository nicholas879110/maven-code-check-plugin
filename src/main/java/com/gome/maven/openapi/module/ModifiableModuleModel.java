...
public interface ModifiableModuleModel {
     ...
     */
     Module newModule( String filePath, final String moduleTypeId);
     ...
     * @return the module instance.
     */
     Module newModule( String filePath, final String moduleTypeId,  Map<String, String> options);
     ...
     */
     Module loadModule( String filePath) throws InvalidDataException, IOException, JDOMException, ModuleWithNameAlreadyExists;
