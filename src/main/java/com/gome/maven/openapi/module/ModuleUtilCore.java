...
public class ModuleUtilCore {
     ...
     */
    public static void collectModulesDependsOn( final Module module, final Set<Module> result) {
    ...
    public static boolean visitMeAndDependentModules( final Module module, final ModuleVisitor visitor) {
