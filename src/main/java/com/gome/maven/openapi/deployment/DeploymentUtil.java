 ...
 */
package com.gome.maven.openapi.deployment;
...
import com.gome.maven.util.descriptors.ConfigFile;
...
public abstract class DeploymentUtil {
    ...
    @Deprecated
    public abstract void copyFile( File fromFile,
                                   File toFile,
    ...
    /**
     * @deprecated use {@link com.gome.maven.openapi.util.io.FileUtil#getRelativePath}
     */
    
    public static String getRelativePath( String basePath,  final String filePath) {
