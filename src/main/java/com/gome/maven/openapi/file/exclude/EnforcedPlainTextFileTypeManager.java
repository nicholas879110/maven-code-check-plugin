...
public class EnforcedPlainTextFileTypeManager implements ProjectManagerListener {
    ...
    public void markAsPlainText( Project project, VirtualFile... files) {
        setPlainTextStatus(project, true, files);
    }

    public void resetOriginalFileType( Project project, VirtualFile... files) {
        setPlainTextStatus(project, false, files);
    }

    private void setPlainTextStatus( final Project project, final boolean isAdded, final VirtualFile... files) {
    ...
    private void ensureProjectFileSetAdded( Project project,
    ...
    private void addProjectPlainTextFiles( Project project) {
