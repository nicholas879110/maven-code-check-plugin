...
public class SegmentArrayWithData extends SegmentArray {
    ...
    private short[] insert( short[] array,  short[] insertArray, int startIndex, int insertLength) {
    ...
    private short[] remove( short[] array, int startIndex, int endIndex) {
    ...
    private static short[] reallocateArray( short[] array, int index) {
