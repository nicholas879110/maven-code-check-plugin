...
import com.gome.maven.openapi.editor.impl.event.EditorEventMulticasterImpl;
...
public class EditorFactoryImpl extends EditorFactory implements ApplicationComponent {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.editor.impl.EditorFactoryImpl");
    ...
    @Override
    public Editor createEditor( final Document document, final Project project,  final FileType fileType, final boolean isViewer) {
