...
public class SettingsImpl implements EditorSettings {
    ...
    public SettingsImpl( EditorEx editor,  Project project) {
        myEditor = editor;
    ...
    private static Language getDocumentLanguage( Project project,  Document document) {
        if (project != null) {
    ...
    private PsiFile getPsiFile( Project project) {
        if (myEditor != null) {
