...
import com.gome.maven.openapi.editor.actionSystem.ReadonlyFragmentModificationHandler;
...
import com.gome.maven.util.containers.IntArrayList;
import com.gome.maven.util.text.CharArrayUtil;
import com.gome.maven.util.text.ImmutableText;
...
public class DocumentImpl extends UserDataHolderBase implements DocumentEx {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.editor.impl.DocumentImpl");
     ...
     *
     * @deprecated should be replaced with {@link #stripTrailingSpaces(com.gome.maven.openapi.project.Project, boolean, boolean, int[])}
     * once multicaret logic will become unconditional (not controlled by configuration flag)
     */
    boolean stripTrailingSpaces( final Project project,
        ...
        try {
            ...
            for (int line = 0; line < lineSet.getLineCount(); line++) {
                ...
                if (!virtualSpaceEnabled && caretLine == line && caretMarker != null &&
                    ...
                    // which should have been caught by assertion in com.gome.maven.pom.core.impl.PomModelImpl.runTransaction
    ...
    @Override
    public void registerRangeMarker( RangeMarkerEx rangeMarker,
                                    int start,
                                    int end,
     ...
     * <ol>
     *   <li>
     *     All {@link #addDocumentListener(com.gome.maven.openapi.editor.event.DocumentListener) registered listeners} are notified
     *     {@link com.gome.maven.openapi.editor.event.DocumentListener#beforeDocumentChange(com.gome.maven.openapi.editor.event.DocumentEvent) before the change};
     *   </li>
     *   <li>The change is performed </li>
     *   <li>
     *     All {@link #addDocumentListener(com.gome.maven.openapi.editor.event.DocumentListener) registered listeners} are notified
     *     {@link com.gome.maven.openapi.editor.event.DocumentListener#documentChanged(com.gome.maven.openapi.editor.event.DocumentEvent) after the change};
     *   </li>
     * </ol>
     * </pre>
     * <p/>
    ...
    private void assertInsideCommand() {
        ...
        if (!commandProcessor.isUndoTransparentActionInProgress() &&
            ...
            throw new IncorrectOperationException("Must not change document outside command or undo-transparent action. See com.gome.maven.openapi.command.WriteCommandAction or com.gome.maven.openapi.command.CommandProcessor");
        }
    }
    ...
    @Override
    public String getText( final TextRange range) {
        return ApplicationManager.getApplication().runReadAction(new Computable<String>() {
            @Override
            public String compute() {
    ...
    private static class DocumentListenerDisposable implements Disposable {
        ...
        private DocumentListenerDisposable( DocumentListener listener,
    ...
    @Override
    public boolean processRangeMarkers( Processor<RangeMarker> processor) {
        return processRangeMarkersOverlappingWith(0, getTextLength(), processor);
    }

    @Override
    public boolean processRangeMarkersOverlappingWith(int start, int end,  Processor<RangeMarker> processor) {
