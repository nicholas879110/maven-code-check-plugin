...
import com.gome.maven.openapi.util.text.LineTokenizer;
...
public class EditorModificationUtil {
    ...
    public static void deleteSelectedTextForAllCarets( final Editor editor) {
    ...
    /**
     * @deprecated Use {@link com.gome.maven.openapi.editor.EditorCopyPasteHelper} methods instead.
     * (to remove in IDEA 15)
     */
    
    public static TextRange pasteTransferable(final Editor editor,  Producer<Transferable> producer) {
    ...
    public static void pasteTransferableAsBlock(Editor editor,  Producer<Transferable> producer) {
    ...
    public static Transferable getContentsToPasteToEditor( Producer<Transferable> producer) {
        if (producer == null) {
    ...
    public static void typeInStringAtCaretHonorMultipleCarets(final Editor editor,  final String str) {
        typeInStringAtCaretHonorMultipleCarets(editor, str, true, str.length());
    }

    public static void typeInStringAtCaretHonorMultipleCarets(final Editor editor,  final String str, final int caretShift) {
        typeInStringAtCaretHonorMultipleCarets(editor, str, true, caretShift);
    }

    public static void typeInStringAtCaretHonorMultipleCarets(final Editor editor,  final String str, final boolean toProcessOverwriteMode) {
     ...
     */
    public static void typeInStringAtCaretHonorMultipleCarets(final Editor editor,  final String str, final boolean toProcessOverwriteMode, final int caretShift)
            throws ReadOnlyFragmentModificationException
    {
        editor.getCaretModel().runForEachCaret(new CaretAction() {
            @Override
    ...
    public static void moveAllCaretsRelatively( Editor editor, final int caretShift) {
        editor.getCaretModel().runForEachCaret(new CaretAction() {
            @Override
            public void perform(Caret caret) {
    ...
    public static void moveCaretRelatively( Editor editor, final int caretShift) {
        CaretModel caretModel = editor.getCaretModel();
        caretModel.moveToOffset(caretModel.getOffset() + caretShift);
    }

    /**
     * This method is safe to run both in and out of {@link com.gome.maven.openapi.editor.CaretModel#runForEachCaret(CaretAction)} context.
    ...
    public static List<CaretState> calcBlockSelectionState( Editor editor,
                                                            LogicalPosition blockStart,  LogicalPosition blockEnd) {
