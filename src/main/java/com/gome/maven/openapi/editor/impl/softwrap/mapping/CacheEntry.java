...
class CacheEntry implements Comparable<CacheEntry>, Cloneable {
    ...
    CacheEntry(int visualLine,  Editor editor) {
        this.visualLine = visualLine;
        myEditor = editor;
    }

    public void setLineStartPosition( EditorPosition context) {
    ...
    public void setLineEndPosition( EditorPosition position) {
    ...
    public FoldingData getFoldingData( final FoldRegion region) {
