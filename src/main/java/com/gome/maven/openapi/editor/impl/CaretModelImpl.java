...
public class CaretModelImpl implements CaretModel, PrioritizedDocumentListener, Disposable {
    ...
    @Override
    public void runForEachCaret( final CaretAction action, final boolean reverseOrder) {
        EditorImpl.assertIsDispatchThread();
    ...
    private static boolean caretsOverlap( CaretImpl firstCaret,  CaretImpl secondCaret) {
    ...
    @Override
    public void setCaretsAndSelections( final List<CaretState> caretStates) {
        setCaretsAndSelections(caretStates, true);
    }

    @Override
    public void setCaretsAndSelections( final List<CaretState> caretStates, final boolean updateSystemSelection) {
        EditorImpl.assertIsDispatchThread();
    ...
    void fireCaretAdded( Caret caret) {
    ...
    void fireCaretRemoved( Caret caret) {
