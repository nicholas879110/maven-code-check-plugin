...
class OffsetToLogicalCalculationStrategy extends AbstractMappingStrategy<LogicalPosition> {
    ...
    OffsetToLogicalCalculationStrategy( EditorEx editor,  SoftWrapsStorage storage,  List<CacheEntry> cache)
    {
    ...
    @Override
    protected LogicalPosition buildIfExceeds( EditorPosition position,  FoldRegion foldRegion) {
