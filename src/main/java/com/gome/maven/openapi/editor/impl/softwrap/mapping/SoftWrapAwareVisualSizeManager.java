...
import com.gome.maven.openapi.editor.impl.VisualSizeChangeListener;
import com.gome.maven.openapi.editor.impl.softwrap.SoftWrapDrawingType;
import com.gome.maven.openapi.editor.impl.softwrap.SoftWrapPainter;
...
public class SoftWrapAwareVisualSizeManager extends SoftWrapAwareDocumentParsingListenerAdapter {
    ...
    public SoftWrapAwareVisualSizeManager( SoftWrapPainter painter) {
        myPainter = painter;
    }
