...
import com.gome.maven.codeInsight.hint.*;
...
import com.gome.maven.openapi.editor.markup.ErrorStripeRenderer;
import com.gome.maven.openapi.editor.markup.RangeHighlighter;
import com.gome.maven.openapi.fileEditor.impl.EditorWindowHolder;
...
import static com.gome.maven.openapi.editor.ex.util.EditorUtil.isRealFileEditor;
...
public class EditorMarkupModelImpl extends MarkupModelImpl implements EditorMarkupModel {
    ...
    @Override
    public void setErrorStripTooltipRendererProvider( final ErrorStripTooltipRendererProvider provider) {
    ...
    private class MyErrorPanel extends ButtonlessScrollBarUI implements MouseMotionListener, MouseListener, MouseWheelListener, UISettingsListener {
        ...
        private void repaint( final Graphics g, int gutterWidth,  ProperTextRange yrange) {
        ...
        private void drawMarkup( final Graphics g, int startOffset, int endOffset,  MarkupModelEx markup1,  MarkupModelEx markup2) {
        ...
        private void drawSpot( Graphics g, boolean thinErrorStripeMark, int yStart, int yEnd,  Color color) {
        ...
        private void setPopupHandler( PopupHandler handler) {
            if (myHandler != null) {
    ...
    @Override
    public void addErrorMarkerListener( final ErrorStripeListener listener,  Disposable parent) {
    ...
    private static class BasicTooltipRendererProvider implements ErrorStripTooltipRendererProvider {
        ...
        public TrafficTooltipRenderer createTrafficTooltipRenderer( final Runnable onHide,  Editor editor) {
            return new TrafficTooltipRenderer() {
                ...
                @Override
                public LightweightHint show( Editor editor,
                                             Point p,
