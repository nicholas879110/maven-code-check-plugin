...
public class IncrementalCacheUpdateEvent {
     ...
     */
    IncrementalCacheUpdateEvent( DocumentEvent event,  CachingSoftWrapDataMapper mapper) {
     ...
     */
    IncrementalCacheUpdateEvent( Document document, int startOffset, int endOffset,  CachingSoftWrapDataMapper mapper) {
     ...
     */
    IncrementalCacheUpdateEvent( Document document) {
        myStartOffset = 0;
    ...
    private IncrementalCacheUpdateEvent( Document document, int startOffset, int oldEndOffset, int newEndOffset,  CachingSoftWrapDataMapper mapper) {
    ...
    public void updateAfterDocumentChange( Document document) {
