...
public class ComplementaryFontsRegistry {
    ...
    private static class FontKey {
        ...
        public FontKey( String familyName, final int size, /*@JdkConstants.FontStyle */int style) {
    ...
    public static FontInfo getFontAbleToDisplay(char c, /*@JdkConstants.FontStyle*/ int style,  FontPreferences preferences) {
    ...
    public static FontInfo getFontAbleToDisplay(char c, int size, /*@JdkConstants.FontStyle*/ int style,  String defaultFontFamily) {
    ...
    private static FontInfo doGetFontAbleToDisplay(char c, int size, /*@JdkConstants.FontStyle*/ int style,  String defaultFontFamily) {
        synchronized (lock) {
