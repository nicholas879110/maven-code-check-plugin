...
public class FoldingModelImpl implements FoldingModelEx, PrioritizedDocumentListener, Dumpable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.editor.impl.EditorFoldingModelImpl");
    ...
    public FoldRegion getFirstRegion( FoldingGroup group, FoldRegion child) {
    ...
    @Override
    public void addListener( final FoldingListener listener,  Disposable parentDisposable) {
    ...
    private void notifyListenersOnFoldRegionStateChange( FoldRegion foldRegion) {
        for (FoldingListener listener : myListeners) {
