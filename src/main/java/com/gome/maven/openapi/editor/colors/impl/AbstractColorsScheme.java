 ...
 * @author Yura Cangea
 */
package com.gome.maven.openapi.editor.colors.impl;
...
import com.gome.maven.openapi.editor.colors.ex.DefaultColorSchemesManager;
import com.gome.maven.openapi.editor.markup.EffectType;
import com.gome.maven.openapi.editor.markup.TextAttributes;
import com.gome.maven.openapi.options.FontSize;
...
import static com.gome.maven.openapi.editor.colors.CodeInsightColors.*;
import static com.gome.maven.openapi.editor.colors.EditorColors.*;
import static com.gome.maven.openapi.util.Couple.of;
import static com.gome.maven.ui.ColorUtil.fromHex;
...
public abstract class AbstractColorsScheme implements EditorColorsScheme {
    ...
    public void readExternal(Element parentNode) {
        if (SCHEME_ELEMENT.equals(parentNode.getName())) {
            ...
            for (Element element : (List<Element>)parentNode.getChildren(SCHEME_ELEMENT)) {
                readScheme(element);
            }
        }
        initFonts();
    ...
    protected void readAttributes( Element childNode) {
        for (Element e : (List<Element>)childNode.getChildren(OPTION_ELEMENT)) {
    ...
    private void migrateErrorStripeColorFrom14( TextAttributesKey name,  TextAttributes attr) {
    ...
    private static void readFontSettings( Element element,  FontPreferences preferences) {
