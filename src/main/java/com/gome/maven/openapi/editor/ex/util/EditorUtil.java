 ...
 */
package com.gome.maven.openapi.editor.ex.util;
...
import com.gome.maven.openapi.editor.impl.FontInfo;
import com.gome.maven.openapi.editor.impl.IterationState;
import com.gome.maven.openapi.editor.textarea.TextComponentEditor;
...
public final class EditorUtil {
    ...
    public static int calcOffset( EditorEx editor,
                                  CharSequence text,
                                 int start,
                                 int end,
                                 int columnNumber,
     ...
     */
    public static int calcSoftWrapUnawareOffset( Editor editor,
                                                 CharSequence text,
                                                int start,
                                                int end,
                                                int columnNumber,
     ...
     */
    public static int textWidth( Editor editor,  CharSequence text, int start, int end, /*@JdkConstants.FontStyle*/ int fontType, int x) {
        int result = 0;
