...
public class MappingUtil {
    ...
    public static CacheEntry getCacheEntryForLogicalPosition( LogicalPosition position,  List<CacheEntry> cache) {
        int start = 0;
        int end = cache.size() - 1;
    ...
    private static CacheEntry assertEnd( LogicalPosition position,  CacheEntry entry) {
