...
import com.gome.maven.openapi.editor.impl.softwrap.*;
import com.gome.maven.openapi.editor.impl.softwrap.mapping.CachingSoftWrapDataMapper;
import com.gome.maven.openapi.editor.impl.softwrap.mapping.SoftWrapApplianceManager;
import com.gome.maven.openapi.editor.impl.softwrap.mapping.SoftWrapAwareDocumentParsingListenerAdapter;
import com.gome.maven.openapi.editor.impl.softwrap.mapping.SoftWrapAwareVisualSizeManager;
        ...
        PropertyChangeListener, Dumpable, Disposable
{
    ...
    public SoftWrapModelImpl( EditorEx editor) {
        myEditor = editor;
    ...
    @Override
    public LogicalPosition visualToLogicalPosition( VisualPosition visual) {
    ...
    public VisualPosition adjustVisualPosition( LogicalPosition logical,  VisualPosition defaultVisual) {
        if (myBulkUpdateInProgress || myUpdateInProgress || !prepareToMapping()) {
    ...
    public void setPlace( SoftWrapAppliancePlaces place) {
    ...
    public boolean addVisualSizeChangeListener( VisualSizeChangeListener listener) {
