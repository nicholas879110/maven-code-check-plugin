...
public final class IterationState {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.editor.impl.IterationState");
    ...
    public IterationState( EditorEx editor, int start, int end, boolean useCaretAndSelection) {
        this(editor, start, end, useCaretAndSelection, false);
    }

    public IterationState( EditorEx editor, int start, int end, boolean useCaretAndSelection, boolean useOnlyFullLineHighlighters) {
        this(editor, start, end, useCaretAndSelection, useCaretAndSelection, useOnlyFullLineHighlighters);
    }

    public IterationState( EditorEx editor, int start, int end, boolean useCaretAndSelection, boolean useVirtualSelection, boolean useOnlyFullLineHighlighters) {
    ...
    private class HighlighterSweep {
        ...
        private HighlighterSweep( MarkupModelEx markupModel, int start, int end, final boolean onlyFullLine) {
