...
import com.gome.maven.openapi.ui.TypingTarget;
import com.gome.maven.openapi.util.ActionCallback;
import com.gome.maven.ui.Grayer;
import com.gome.maven.ui.components.Magnificator;
...
public class EditorComponentImpl extends JComponent implements Scrollable, DataProvider, Queryable, TypingTarget {
    ...
    public Object getData(String dataId) {
        ...
        if (CommonDataKeys.EDITOR.is(dataId)) {
            // for 'big' editors return null to allow injected editors (see com.gome.maven.openapi.fileEditor.impl.text.TextEditorComponent.getData())
