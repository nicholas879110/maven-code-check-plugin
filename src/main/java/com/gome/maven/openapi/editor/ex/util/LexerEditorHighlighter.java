...
import com.gome.maven.openapi.editor.impl.EditorDocumentPriorities;
...
public class LexerEditorHighlighter implements EditorHighlighter, PrioritizedDocumentListener {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.editor.ex.util.LexerEditorHighlighter");
