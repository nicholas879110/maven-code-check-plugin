...
import com.gome.maven.openapi.editor.impl.EditorTextRepresentationHelper;
...
public interface SoftWrapModelEx extends SoftWrapModel {
    ...
    LogicalPosition visualToLogicalPosition( VisualPosition visual);
     ...
     */
    int logicalPositionToOffset( LogicalPosition logicalPosition);
    ...
    VisualPosition adjustVisualPosition( LogicalPosition logical,  VisualPosition defaultVisual);
