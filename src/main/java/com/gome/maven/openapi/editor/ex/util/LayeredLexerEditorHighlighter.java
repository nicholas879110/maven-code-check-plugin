...
import com.gome.maven.util.text.MergingCharSequence;
...
public class LayeredLexerEditorHighlighter extends LexerEditorHighlighter {
    ...
    private class MappingSegments extends SegmentArrayWithData {
        ...
        private <T> T[] insert( T[] array,  T[] insertArray, int startIndex, int insertLength) {
        ...
        private <T> T[] remove( T[] array, int startIndex, int endIndex) {
