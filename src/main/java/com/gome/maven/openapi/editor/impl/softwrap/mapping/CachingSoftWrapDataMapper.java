...
import com.gome.maven.openapi.editor.impl.softwrap.SoftWrapImpl;
...
public class CachingSoftWrapDataMapper implements SoftWrapAwareDocumentParsingListener, Dumpable {
    ...
    public LogicalPosition visualToLogical( VisualPosition visual) throws IllegalStateException {
        if (myCache.isEmpty()) {
     ...
     * @throws IllegalStateException  if it's not possible to perform a mapping
     */
    public int logicalPositionToOffset( LogicalPosition logical) throws IllegalStateException {
     ...
     * @throws IllegalStateException  if it's not possible to perform a mapping
     */
    public VisualPosition logicalToVisualPosition( LogicalPosition logical,  VisualPosition softWrapUnawareVisual)
    ...
    private <T> T calculate( MappingStrategy<T> strategy) throws IllegalStateException {
    ...
    @Override
    public void onCollapsedFoldRegion( FoldRegion foldRegion, int widthInColumns, int visualLine) {
     ...
     */
    private int advanceSoftWrapOffsets( IncrementalCacheUpdateEvent event) {
     ...
     */
    private void applyStateChange( IncrementalCacheUpdateEvent event, int softWrappedLinesDiff) {
    ...
    public void rawAdd(int visualLine,
                       ...
                       int endVisualColumn,
                        List<Pair<Integer, FoldRegion>> foldRegions,
                        List<Pair<Integer, Integer>> tabData)
    {
