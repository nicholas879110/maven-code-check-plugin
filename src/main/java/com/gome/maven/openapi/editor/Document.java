 ...
 * @see com.gome.maven.psi.PsiDocumentManager
 * @see com.gome.maven.openapi.fileEditor.FileDocumentManager
...
public interface Document extends UserDataHolder {
     ...
     * @see com.gome.maven.util.text.ImmutableCharSequence
     */
     ...
     * @see com.gome.maven.psi.PsiFile#getModificationStamp()
     * @see com.gome.maven.openapi.vfs.VirtualFile#getModificationStamp()
     */
     ...
     * @see com.gome.maven.openapi.editor.actionSystem.EditorActionManager#setReadonlyFragmentModificationHandler(com.gome.maven.openapi.editor.actionSystem.ReadonlyFragmentModificationHandler)
     */
