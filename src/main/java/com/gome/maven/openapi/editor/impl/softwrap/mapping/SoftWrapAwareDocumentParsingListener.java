...
interface SoftWrapAwareDocumentParsingListener {
     ...
     */
    void onVisualLineStart( EditorPosition position);
     ...
     */
    void onVisualLineEnd( EditorPosition position);
     ...
     */
    void onCollapsedFoldRegion( FoldRegion foldRegion, int collapsedFoldingWidthInColumns, int visualLine);
     ...
     */
    void onTabulation( EditorPosition position, int widthInColumns);
     ...
     */
    void beforeSoftWrapLineFeed( EditorPosition position);
     ...
     */
    void afterSoftWrapLineFeed( EditorPosition position);
