...
public class TextAttributes implements Cloneable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.editor.markup.TextAttributes");
...
//    @JdkConstants.FontStyle
    ...
    public boolean equals(Object obj) {
        ...
        // myAttrs are interned, see com.gome.maven.openapi.editor.markup.AttributesFlyweight.create()
