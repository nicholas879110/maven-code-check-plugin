...
public class BulkChangesMerger {
     ...
     */
    public void mergeInPlace( char[] data, int length,  List<? extends TextChangeImpl> changes)
    ...
    private static class Context {
        ...
        Context( List<? extends TextChangeImpl> changes,  char[] data, int inputLength, int outputLength) {
            myChanges = changes;
            myData = data;
