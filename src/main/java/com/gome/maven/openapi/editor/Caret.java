...
public interface Caret extends UserDataHolderEx, Disposable {
     ...
     */
    void setSelection(int startOffset,  VisualPosition endPosition, int endOffset);
     ...
     * @param endOffset       end selection offset
     */
    void setSelection( VisualPosition startPosition, int startOffset,  VisualPosition endPosition, int endOffset);
     ...
     * @param updateSystemSelection whether system selection should be updated (might not have any effect if current editor doesn't support such a feature)
     */
    void setSelection( VisualPosition startPosition, int startOffset,  VisualPosition endPosition, int endOffset, boolean updateSystemSelection);
