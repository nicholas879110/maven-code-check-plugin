...
public final class UpdateChecker {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.updateSettings.impl.UpdateChecker");
     ...
     */
    public static void updateAndShowResult( Project project,  UpdateSettings customSettings) {
    ...
    private static void doUpdateAndShowResult( final Project project,
    ...
    private static CheckForUpdateResult checkPlatformUpdate( UpdateSettings settings) {
        UpdatesInfo info;
        try {
            ...
            info = HttpRequests.request(updateUrl).forceHttps(settings.canUseSecureConnection()).connect(new HttpRequests.RequestProcessor<UpdatesInfo>() {
                @Override
                public UpdatesInfo process( HttpRequests.Request request) throws IOException {
                    try {
    ...
    private static boolean newChannelReady( UpdateChannel channelToPropose) {
        return channelToPropose != null && channelToPropose.getLatestBuild() != null;
    }

    private static void showUpdateResult( final Project project,
    ...
    private static void showNotification( Project project, String message, boolean error,  final Runnable runnable) {
    ...
    public static void addUpdateRequestParameter( String name,  String value) {
    ...
    public static boolean installPluginUpdates( Collection<PluginDownloader> downloaders,  ProgressIndicator indicator) {
