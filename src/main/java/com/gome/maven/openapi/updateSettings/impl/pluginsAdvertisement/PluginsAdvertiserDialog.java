...
import com.gome.maven.openapi.updateSettings.impl.DetectedPluginsPanel;
...
public class PluginsAdvertiserDialog extends DialogWrapper {
    ...
    PluginsAdvertiserDialog( Project project, PluginDownloader[] plugins, List<IdeaPluginDescriptor> allPlugins) {
        super(project);
        myProject = project;
