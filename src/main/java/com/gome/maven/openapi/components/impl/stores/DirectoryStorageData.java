...
import com.gome.maven.openapi.components.StateSplitterEx;
...
public class DirectoryStorageData extends StorageDataBase {
    ...
    public void loadFrom( VirtualFile dir,  TrackingPathMacroSubstitutor pathMacroSubstitutor) {
    ...
    public Object setState( String componentName,  String fileName,  Element newState) {
    ...
    void processComponent( String componentName,  TObjectObjectProcedure<String, Object> consumer) {
    ...
    public Element getCompositeStateAndArchive( String componentName, @SuppressWarnings("deprecation")  StateSplitter splitter) {
        StateMap fileToState = myStates.get(componentName);
    ...
    public Element stateToElement( String key,  Object state) {
