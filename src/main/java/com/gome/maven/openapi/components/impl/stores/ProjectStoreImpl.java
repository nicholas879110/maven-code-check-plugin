...
class ProjectStoreImpl extends BaseFileConfigurableStoreImpl implements IProjectStore {
    ...
    ProjectStoreImpl( ProjectImpl project,  PathMacroManager pathMacroManager) {
...
//                }
    ...
    @Override
    protected final List<Throwable> doSave( List<SaveSession> saveSessions,  List<Pair<SaveSession, VirtualFile>> readonlyFiles,  List<Throwable> errors) {
