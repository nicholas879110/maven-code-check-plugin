...
public class ComponentSerializationUtil {
    public static <S> Class<S> getStateClass( Class<? extends PersistentStateComponent> aClass) {
    ...
    public static <S> void loadComponentState( PersistentStateComponent<S> configuration, Element element) {
        if (element != null) {
