...
public final class StateMap {
    ...
    static Element stateToElement( String key,  Object state,  Map<String, Element> newLiveStates) {
        if (state instanceof Element) {
            return (Element) ((Element)state).clone();
        }
        else {
    ...
    public void forEachEntry( TObjectObjectProcedure<String, Object> consumer) {
