...
import com.gome.maven.ide.FrameStateManager;
...
import com.gome.maven.openapi.wm.ex.*;
import com.gome.maven.openapi.wm.impl.commands.*;
import com.gome.maven.ui.BalloonImpl;
import com.gome.maven.ui.ColorUtil;
import com.gome.maven.ui.awt.RelativePoint;
import com.gome.maven.ui.switcher.QuickAccessSettings;
import com.gome.maven.ui.switcher.SwitchManager;
...
public final class ToolWindowManagerImpl extends ToolWindowManagerEx implements ProjectComponent, JDOMExternalizable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.wm.impl.ToolWindowManagerImpl");
     ...
     */
    public void execute( List<FinalizableCommand> commandList) {
    ...
    @Override
    public ToolWindow registerToolWindow( String id,
                                          JComponent component,
                                          ToolWindowAnchor anchor,
                                          Disposable parentDisposable,
    ...
    private ToolWindow registerToolWindow( final String id,
                                           final JComponent component,
                                           final ToolWindowAnchor anchor,
                                          boolean canWorkInDumbMode) {
    ...
    @Override
    public ToolWindow registerToolWindow( final String id, final boolean canCloseContent,  final ToolWindowAnchor anchor) {
    ...
    private ToolWindow registerDisposable( final String id,  final Disposable parentDisposable,  ToolWindow window) {
    ...
    @Override
    public boolean canShowNotification( final String toolWindowId) {
    ...
    @Override
    public void notifyByBalloon( final String toolWindowId,  final MessageType type,  final String htmlBody) {
        notifyByBalloon(toolWindowId, type, htmlBody, null, null);
    }

    @Override
    public void notifyByBalloon( final String toolWindowId,
    ...
    /**
     * @see com.gome.maven.openapi.wm.impl.ToolWindowsPane#createAddDecoratorCmd
     */
    ...
    /**
     * @see com.gome.maven.openapi.wm.impl.ToolWindowsPane#createRemoveDecoratorCmd
     */
    ...
    /**
     * @see com.gome.maven.openapi.wm.impl.ToolWindowsPane#createAddButtonCmd
     */
    ...
    /**
     * @see com.gome.maven.openapi.wm.impl.ToolWindowsPane#createSetEditorComponentCmd
     */
    public void appendSetEditorComponentCmd( final JComponent component, final List<FinalizableCommand> commandsList) {
        final CommandProcessor commandProcessor = myWindowManager.getCommandProcessor();
    ...
    public void setDefaultState( final ToolWindowImpl toolWindow,
                                 final ToolWindowAnchor anchor,
                                 final ToolWindowType type,
                                 final Rectangle floatingBounds) {
