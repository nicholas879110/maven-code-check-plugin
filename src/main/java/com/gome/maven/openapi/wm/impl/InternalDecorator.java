...
import com.gome.maven.ide.actions.ResizeToolWindowAction;
import com.gome.maven.ide.actions.ToggleToolbarAction;
...
public final class InternalDecorator extends JPanel implements Queryable, DataProvider {
    ...
    InternalDecorator(final Project project,  WindowInfoImpl info, final ToolWindowImpl toolWindow) {
    ...
    private final class HideAction extends AnAction implements DumbAware {
         public static final String HIDE_ACTIVE_WINDOW_ACTION_ID = InternalDecorator.HIDE_ACTIVE_WINDOW_ACTION_ID;
