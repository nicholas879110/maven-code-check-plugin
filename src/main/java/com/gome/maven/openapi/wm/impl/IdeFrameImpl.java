...
import com.gome.maven.diagnostic.IdeMessagePanel;
...
public class IdeFrameImpl extends JFrame implements IdeFrameEx, DataProvider {
    ...
    public void setFileTitle( final String fileTitle,  File file) {
    ...
    private void installDefaultProjectStatusBarWidgets( final Project project) {
...
//todo [kirillk] a dummy implementation
    ...
    public static Component findNearestModalComponent( Component c) {
