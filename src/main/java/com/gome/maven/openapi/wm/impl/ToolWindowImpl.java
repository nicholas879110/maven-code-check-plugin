...
import com.gome.maven.ui.content.impl.ContentImpl;
...
public final class ToolWindowImpl implements ToolWindowEx {
    ...
    ToolWindowImpl(final ToolWindowManagerImpl toolWindowManager, final String id, boolean canCloseContent,  final JComponent component) {
    ...
    @Override
    public void activate( final Runnable runnable, final boolean autoFocusContents) {
        activate(runnable, autoFocusContents, true);
    }

    @Override
    public void activate( final Runnable runnable, boolean autoFocusContents, boolean forced) {
    ...
    @Override
    public void setSplitMode(final boolean isSideTool,  final Runnable runnable) {
        ApplicationManager.getApplication().assertIsDispatchThread();
    ...
    @Override
    public final void setStripeTitle( String stripeTitle) {
        ApplicationManager.getApplication().assertIsDispatchThread();
    ...
    @Override
    public void setDefaultState( final ToolWindowAnchor anchor,  final ToolWindowType type,  final Rectangle floatingBounds) {
