 ...
 * @author max
 */
package com.gome.maven.openapi.wm.impl.welcomeScreen;
...
public class WelcomeFrame extends JFrame implements IdeFrame {
    public static final ExtensionPointName<WelcomeFrameProvider> EP = ExtensionPointName.create("com.gome.maven.welcomeFrameProvider");
