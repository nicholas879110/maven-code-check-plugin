...
import com.gome.maven.openapi.wm.impl.WindowWatcher;
...
public final class RequestFocusInToolWindowCmd extends FinalizableCommand {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.wm.impl.commands.RequestFocusInToolWindowCmd");
