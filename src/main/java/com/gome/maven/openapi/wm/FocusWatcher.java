...
public class FocusWatcher implements ContainerListener,FocusListener{
    ...
    public final void deinstall(final Component component,  AWTEvent cause){
    ...
    public void setFocusedComponentImpl(Component component,  AWTEvent cause){
     ...
     * @param cause
     */
    protected void focusedComponentChanged(Component component,  final AWTEvent cause){}
