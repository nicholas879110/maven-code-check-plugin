...
import com.gome.maven.openapi.wm.impl.CommandProcessor;
...
public abstract class WindowManagerEx extends WindowManager {
    ...
    public abstract IdeFrame findFrameFor( Project project);
     ...
     */
    public abstract Rectangle getScreenBounds( final Project project);
