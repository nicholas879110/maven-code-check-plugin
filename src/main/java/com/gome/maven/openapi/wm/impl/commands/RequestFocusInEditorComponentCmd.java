...
public final class RequestFocusInEditorComponentCmd extends FinalizableCommand{
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.wm.impl.commands.RequestFocusInEditorComponentCmd");

    public RequestFocusInEditorComponentCmd( final EditorsSplitters splitters, IdeFocusManager
