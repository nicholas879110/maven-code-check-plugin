...
import com.gome.maven.ui.TabbedPaneWrapper;
import com.gome.maven.ui.awt.RelativePoint;
import com.gome.maven.ui.components.labels.LinkLabel;
import com.gome.maven.ui.components.labels.LinkListener;
...
public class InfoAndProgressPanel extends JPanel implements CustomStatusBarWidget {
    ...
    private static Component getAnchor( JRootPane pane) {
    ...
    public Couple<String> setText( final String text,  final String requestor) {
    ...
    private InlineProgressIndicator createInlineDelegate( TaskInfo info,  ProgressIndicatorEx original, final boolean compact) {
    ...
    private class MyInlineProgressIndicator extends InlineProgressIndicator {
        ...
        public MyInlineProgressIndicator(final boolean compact,  TaskInfo task,  ProgressIndicatorEx original) {
            super(compact, task);
            myOriginal = original;
