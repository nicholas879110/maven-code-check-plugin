...
import com.gome.maven.openapi.actionSystem.impl.*;
...
import com.gome.maven.ui.tabs.TabsUtil;
...
public abstract class ToolWindowHeader extends JPanel implements Disposable, UISettingsListener {
    ...
    public ToolWindowHeader(final ToolWindowImpl toolWindow,  WindowInfoImpl info,  final Producer<ActionGroup> gearProducer) {
    ...
    private class ActionButton extends Wrapper implements ActionListener, AltStateManager.AltListener {
        ...
        public ActionButton(AnAction action, AnAction alternativeAction,  Icon activeIcon, Icon inactiveIcon,
        ...
        public ActionButton(AnAction action,  Icon activeIcon, Icon inactiveIcon) {
    ...
    private abstract class HideSideAction extends AnAction implements DumbAware {
         public static final String HIDE_ACTIVE_SIDE_WINDOW_ACTION_ID = ToolWindowHeader.HIDE_ACTIVE_SIDE_WINDOW_ACTION_ID;
    ...
    private abstract class HideAction extends AnAction implements DumbAware {
         public static final String HIDE_ACTIVE_WINDOW_ACTION_ID = ToolWindowHeader.HIDE_ACTIVE_WINDOW_ACTION_ID;
