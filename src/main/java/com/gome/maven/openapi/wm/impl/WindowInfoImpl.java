...
public final class WindowInfoImpl implements Cloneable,JDOMExternalizable, WindowInfo {
     ...
     * @see com.gome.maven.openapi.wm.ToolWindowType#DOCKED
     * @see com.gome.maven.openapi.wm.ToolWindowType#FLOATING
     * @see com.gome.maven.openapi.wm.ToolWindowType#SLIDING
     */
    @Override
