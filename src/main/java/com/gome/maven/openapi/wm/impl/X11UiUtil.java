...
import static com.gome.maven.util.ArrayUtil.newLongArray;
import static com.gome.maven.util.containers.ContainerUtil.newHashSet;

public class X11UiUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.wm.impl.X11UiUtil");
