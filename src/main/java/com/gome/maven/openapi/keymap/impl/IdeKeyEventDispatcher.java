 ...
 */
package com.gome.maven.openapi.keymap.impl;
...
import com.gome.maven.openapi.keymap.impl.keyGestures.KeyboardGestureProcessor;
import com.gome.maven.openapi.keymap.impl.ui.ShortcutTextField;
...
import com.gome.maven.openapi.wm.impl.FloatingDecorator;
import com.gome.maven.openapi.wm.impl.IdeFrameImpl;
import com.gome.maven.openapi.wm.impl.IdeGlassPaneEx;
import com.gome.maven.ui.ColoredListCellRenderer;
import com.gome.maven.ui.ComponentWithMnemonics;
import com.gome.maven.ui.KeyStrokeAdapter;
import com.gome.maven.ui.SimpleTextAttributes;
import com.gome.maven.ui.components.JBOptionButton;
...
//import com.gome.maven.util.ui.MacUIUtil;
...
//                MacUIUtil.hideCursor();
    ...
    private static class SecondaryKeystrokePopup extends ListPopupImpl {
        private SecondaryKeystrokePopup( final KeyStroke firstKeystroke,  final List<Pair<AnAction, KeyStroke>> actions, final DataContext context) {
            super(buildStep(actions, context));
            registerActions(firstKeystroke, actions, context);
        }

        private void registerActions( final KeyStroke firstKeyStroke,  final List<Pair<AnAction, KeyStroke>> actions, final DataContext ctx) {
        ...
        private static void invokeAction( final AnAction action, final DataContext ctx) {
            ApplicationManager.getApplication().invokeLater(new Runnable() {
                @Override
                public void run() {
        ...
        private static ListPopupStep buildStep( final List<Pair<AnAction, KeyStroke>> actions, final DataContext ctx) {
