...
//    @JdkConstants.InputEventMask
    ...
    public static boolean isEmacsKeymap( Keymap keymap) {
    ...
    public static KeyStroke getKeyStroke( final ShortcutSet shortcutSet) {
    ...
    public static String createTooltipText( String name,  AnAction action) {
