...
import com.gome.maven.ide.actionMacro.ActionMacro;
...
import com.gome.maven.openapi.keymap.KeymapExtension;
...
public class ActionsTreeUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.keymap.impl.ui.ActionsTreeUtil");
    ...
    private static Condition<AnAction> wrapFilter( final Condition<AnAction> filter, final Keymap keymap, final ActionManager actionManager) {
