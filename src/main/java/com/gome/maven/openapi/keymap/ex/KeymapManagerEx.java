 ...
 */
package com.gome.maven.openapi.keymap.ex;
...
public abstract class KeymapManagerEx extends KeymapManager {
    ...
    public abstract void addWeakListener( KeymapManagerListener listener);

    public abstract void removeWeakListener( KeymapManagerListener listenerToRemove);
}
