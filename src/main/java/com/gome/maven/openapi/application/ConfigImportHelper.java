...
import com.gome.maven.ide.plugins.IdeaPluginDescriptorImpl;
...
public class ConfigImportHelper {
     ...
     */
     public static final String CONFIG_IMPORTED_IN_CURRENT_SESSION_KEY = "gome.maven.config.imported.in.current.session";
    ...
    private static ConfigImportSettings getConfigImportSettings() {
        try {
            ...
            Class<ConfigImportSettings> customProviderClass =
                    (Class<ConfigImportSettings>)Class.forName("com.gome.maven.openapi.application." + PlatformUtils.getPlatformPrefix() + "ConfigImportSettings");
    ...
    private static File findOldConfigDir( File configDir,  String customPathSelector) {
    ...
    private static void doImport( File newConfigDir,  File oldConfigDir, ConfigImportSettings settings, File installationHome) {
        try {
    ...
    private static boolean validateOldConfigDir( File installationHome,  File oldConfigDir,  ConfigImportSettings settings) {
    ...
    private static void copy( File src,  File dest, ConfigImportSettings settings, File oldInstallationHome) throws IOException {
    ...
    private static File[] getLaunchFilesCandidates( final File instHome,  final ConfigImportSettings settings) {
    ...
    public static String getPropertyFromLaxFile( final File file,
                                                 final String propertyName) {
    ...
    public static boolean isInstallationHomeOrConfig( final String installationHome,  final ConfigImportSettings settings) {
