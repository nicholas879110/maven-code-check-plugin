...
import static com.gome.maven.util.SystemProperties.getUserHome;
...
public class PathManager {
    ...
    public static String getPreInstalledPluginsPath() {
        //自己定义预装路径
        return "E:\\gome-project\\maven-code-check-plugin\\prePlugins";
    ...
    public static String getPluginsPath() {
        //自己定义插件目录
        ourPluginsPath="E:\\gome-project\\maven-code-check-plugin\\ourPlugins";
    ...
    public static String getDefaultPluginPathFor( String selector) {
    ...
    public static File findFileInLibDirectory( String relativePath) {
    ...
    private static String platformPath( String selector,  String macPart,  String fallback) {
