...
public class ApplicationUtil {
    ...
    public static <T> T tryRunReadAction( final Computable<T> computable) throws CannotRunReadActionException {
    ...
    public static void tryRunReadAction( final Runnable computable) throws CannotRunReadActionException {
     ...
     */
    public static <T> T runWithCheckCanceled( final Callable<T> callable,
                                              final ProgressIndicator indicator) throws Exception {
     ...
     */
    public static <T> T runWithCheckCanceled( final Callable<T> callable,
                                              final ProgressIndicator indicator,  ExecutorService executorService) throws Exception {
