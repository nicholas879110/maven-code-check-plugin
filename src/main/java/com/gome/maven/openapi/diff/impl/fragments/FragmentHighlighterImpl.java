 ...
 */
package com.gome.maven.openapi.diff.impl.fragments;

import com.gome.maven.openapi.diff.actions.MergeOperations;
import com.gome.maven.openapi.diff.impl.DiffUtil;
import com.gome.maven.openapi.diff.impl.highlighting.DiffMarkup;
...
public class FragmentHighlighterImpl implements FragmentHighlighter {
    ...
    private static void addSeparatingLine( LineFragment fragment,  DiffMarkup appender, int startLine, int endLine) {
        if (endLine <= 0) return;
