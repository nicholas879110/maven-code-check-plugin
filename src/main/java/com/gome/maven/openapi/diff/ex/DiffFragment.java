...
import com.gome.maven.openapi.diff.impl.string.DiffStringBuilder;
...
public class DiffFragment {
    ...
    public DiffFragment( DiffString text1,  DiffString text2) {
        myText1 = text1;
        myText2 = text2;
    ...
    public void appendText1( DiffString str) {
        if (str == null) return;
    ...
    public void appendText2( DiffString str) {
        if (str == null) return;
    ...
    public static DiffFragment unchanged( DiffString text1,  DiffString text2) {
