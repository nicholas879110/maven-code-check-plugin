...
public class DividerPolygon {
    ...
    public static ArrayList<DividerPolygon> createVisiblePolygons( EditingSides sides,
                                                                   FragmentSide left,
...
//    return new LinearTransformation(editor.getScrollingModel().getVerticalScrollOffset(), editor.getLineHeight());
    ...
    private static DividerPolygon createPolygon( Transformation[] transformations,
                                                 Trapezium trapezium,
                                                 Color color,
                                                 FragmentSide left,
