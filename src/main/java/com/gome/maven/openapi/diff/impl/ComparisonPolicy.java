...
import com.gome.maven.openapi.diff.impl.processing.DiffCorrection;
import com.gome.maven.openapi.diff.impl.processing.Formatting;
import com.gome.maven.openapi.diff.impl.processing.Word;
...
public abstract class ComparisonPolicy {
    ...
    public DiffFragment[] buildDiffFragmentsFromLines( DiffString[] lines1,  DiffString[] lines2)
    ...
    private static class IgnoreSpacePolicy extends ComparisonPolicy
        ...
        @Override
        public DiffFragment[] buildFragments( DiffString[] strings1,  DiffString[] strings2)
                throws FilesTooBigForDiffException {
    ...
    private static DiffString toNull( DiffString text1) {
        return text1 == null || text1.isEmpty() ? null : text1;
    }

    
    private static DiffString toNotNull( DiffString text) {
