...
import com.gome.maven.openapi.diff.impl.patch.PatchLine;
import com.gome.maven.openapi.util.Pair;
import com.gome.maven.openapi.util.TextRange;
import com.gome.maven.openapi.util.UnfairTextRange;
...
public class GenericPatchApplier {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.patch.apply.GenericPatchApplier");
    ...
    private static class BetterPoint {
        ...
        public void feed( final Point point) {
