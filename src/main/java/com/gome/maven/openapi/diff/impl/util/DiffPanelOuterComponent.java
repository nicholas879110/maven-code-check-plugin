...
import com.gome.maven.openapi.diff.DiffToolbar;
import com.gome.maven.openapi.diff.ex.DiffStatusBar;
import com.gome.maven.openapi.diff.impl.DiffToolbarComponent;
...
public class DiffPanelOuterComponent extends JPanel implements DataProvider {
    ...
    public DiffPanelOuterComponent(List<TextDiffType> diffTypes,  DiffRequest.ToolbarAddons toolbarAddons) {
    ...
    public void setToolbarActions( DiffRequest.ToolbarAddons toolbarAddons) {
        myDefaultActions = toolbarAddons;
    }
