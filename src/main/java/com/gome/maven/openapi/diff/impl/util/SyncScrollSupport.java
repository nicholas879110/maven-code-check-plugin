...
import com.gome.maven.openapi.diff.impl.EditingSides;
...
public class SyncScrollSupport implements Disposable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.util.SyncScrollSupport");
    ...
    private void addSlavesScroller( Editor editor,  ScrollingContext... contexts) {
    ...
    private class ScrollListener implements VisibleAreaListener, Disposable {
        ...
        public ScrollListener( ScrollingContext[] scrollContexts,  Editor editor) {
    ...
    private static void syncHorizontalScroll( ScrollingContext context,
    ...
    private static void syncVerticalScroll( ScrollingContext context,
                                            Rectangle newRectangle,
                                            Rectangle oldRectangle) {
    ...
    private static int getHeaderOffset( final Editor editor) {
        final JComponent header = editor.getHeaderComponent();
        return header == null ? 0 : header.getHeight();
    }

    private static void doScrollVertically( ScrollingModel model, int offset) {
    ...
    private static void doScrollHorizontally( ScrollingModel model, int offset) {
        model.disableAnimation();
        try {
    ...
    private static class ScrollingContext {
        ...
        public ScrollingContext( FragmentSide masterSide,  EditingSides sidesContainer,  FragmentSide masterDiffSide) {
