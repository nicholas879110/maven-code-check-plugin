...
public class TriggerAdditionOrDeletion {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.patch.formove.TriggerAdditionOrDeletion");
