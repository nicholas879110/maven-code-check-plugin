...
import com.gome.maven.openapi.diff.impl.patch.apply.ApplyFilePatchFactory;
...
//    @CalledInAwt
    ...
    private static class MovedFileData {
        ...
        private MovedFileData( final VirtualFile newParent,  final VirtualFile current,  final String newName) {
