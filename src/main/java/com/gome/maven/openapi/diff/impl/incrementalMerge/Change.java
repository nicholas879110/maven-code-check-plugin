...
import com.gome.maven.openapi.diff.impl.util.DocumentUtil;
 ...
 * A change has two {@link com.gome.maven.openapi.diff.impl.incrementalMerge.Change.SimpleChangeSide sides} (left and right), each of them representing the text which has been changed and the original text
...
public abstract class Change {
     ...
     */
    protected final void updateTargetRangeMarker( FragmentSide targetFragmentSide,  TextRange updatedTextRange) {
    ...
    private static TextRange modifyDocument( Project project,  RangeMarker original,  RangeMarker target) {
