...
import com.gome.maven.openapi.diff.impl.processing.DiffFragmentsProcessor;
...
public class TextPatchBuilder {
    ...
    private TextPatchBuilder(final String basePath, final boolean isReversePath, final boolean isCaseSensitive,
                              final Runnable cancelChecker, boolean includeBaseText) {
        myBasePath = basePath;
    ...
    private static void addLineToHunk( final PatchHunk hunk,  final DiffString line, final PatchLine.Type type) {
