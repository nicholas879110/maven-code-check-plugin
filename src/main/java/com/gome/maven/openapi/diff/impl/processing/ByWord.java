...
public class ByWord implements DiffPolicy {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.processing.ByWord");
    ...
    private static int countNotWhitespaces( Word[] words) {
        int counter = 0;
    ...
    private static int countEqual(Diff.Change change,  Word[] words1,  Word[] words2) {
        int counter = 0;
        int position1 = 0;
        int position2 = 0;
        while (change != null) {
    ...
    private static void processOneside( FragmentBuilder.Version version, int wordCount) {
        DiffString prefix = version.getCurrentWordPrefix();
        version.addOneSide(prefix, wordCount);
    }

    private static void processEquals(int changed1, int changed2,  FragmentBuilder result) throws FilesTooBigForDiffException {
    ...
    static Word[] buildWords( DiffString text,  ComparisonPolicy policy) {
    ...
    private static class FragmentBuilder {
        ...
        public FragmentBuilder( Word[] words1,  Word[] words2,  ComparisonPolicy comparisonPolicy,  DiffString text1,  DiffString text2) {
        ...
        private DiffFragment[] fragmentsByChar( DiffString text1,  DiffString text2) throws FilesTooBigForDiffException {
        ...
        private static DiffString cutLast( DiffString text, int length) {
        ...
        private void addOneSide( DiffString text,  FragmentSide side) {
        ...
        public static class Version {
            ...
            public Version( Word[] words,  DiffString text,  FragmentBuilder builder, boolean delete) {
                myWords = words;
                myText = text;
                myBuilder = builder;
            ...
            public void addOneSide( DiffString prefix, int wordCount) {
