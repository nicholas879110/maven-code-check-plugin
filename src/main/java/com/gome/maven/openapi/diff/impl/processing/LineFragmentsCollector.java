...
class LineFragmentsCollector {
    ...
    private LineFragment addFragment( TextDiffTypeEnum type,  DiffString text1,  DiffString text2) {
    ...
    static int getLength( DiffString text) {
        return text == null ? 0 : text.length();
    }

    private static int countLines( DiffString text) {
