...
import com.gome.maven.openapi.vcs.changes.RefreshablePanel;
import com.gome.maven.openapi.vcs.changes.ui.ChangeNodeDecorator;
...
public class SelectFilesToAddTextsToPatchPanel implements RefreshablePanel {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.patch.SelectFilesToAddTextsToPatchPanel");
    ...
    public SelectFilesToAddTextsToPatchPanel(final Project project, final List<Change> changes, final Collection<Change> selectedChanges,
                                              final Runnable inclusionListener) {
