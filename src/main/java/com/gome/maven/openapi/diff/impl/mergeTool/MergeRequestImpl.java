...
public class MergeRequestImpl extends MergeRequest {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.mergeTool.MergeRequestImpl");
    ...
    public MergeRequestImpl( String left,
                             ...
                             String right,
                             Project project,
                             final ActionButtonPresentation okButtonPresentation,
                             final ActionButtonPresentation cancelButtonPresentation) {
