...
public class Util {
    ...
    private static boolean isSpaceOnly( DiffString string) {
    ...
    private static DiffString[] splitByLines( DiffString string) {
    ...
    public static DiffString getText( DiffFragment[] fragments,  FragmentSide side) {
