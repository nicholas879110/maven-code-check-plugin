 ...
 */
package com.gome.maven.openapi.diff.impl.splitter;

import com.gome.maven.openapi.diagnostic.Logger;
import com.gome.maven.openapi.diff.impl.DiffUtil;
import com.gome.maven.openapi.diff.impl.fragments.LineBlock;
...
public class LineBlocks {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.splitter.LineBlocks");
    ...
    public static LineBlocks fromChanges( List<Change> changes) {
    ...
    private static class Diff {
        ...
        private Diff( Interval intervalForSide1,  Interval intervalForSide2,  TextDiffType type) {
