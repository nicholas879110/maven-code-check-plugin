...
class MergeBuilder {
    ...
    private void addConflict( TextRange left,  TextRange base,  TextRange right) {
        myResult.add(new MergeFragment(left, base, right));
    }

    private static boolean compare( int[] lengths,  int[] processed) {
    ...
    private class EqualPair {
        ...
        public EqualPair( TextRange base,  TextRange version,  FragmentSide side) {
