...
import com.gome.maven.openapi.diff.actions.ToggleAutoScrollAction;
import com.gome.maven.openapi.diff.ex.DiffPanelEx;
import com.gome.maven.openapi.diff.ex.DiffPanelOptions;
...
import com.gome.maven.openapi.diff.impl.highlighting.DiffPanelState;
...
import com.gome.maven.openapi.diff.impl.processing.HorizontalDiffSplitter;
import com.gome.maven.openapi.diff.impl.settings.DiffMergeEditorSetting;
import com.gome.maven.openapi.diff.impl.settings.DiffMergeSettings;
import com.gome.maven.openapi.diff.impl.settings.DiffMergeSettingsAction;
import com.gome.maven.openapi.diff.impl.settings.DiffToolSettings;
import com.gome.maven.openapi.diff.impl.splitter.DiffDividerPaint;
import com.gome.maven.openapi.diff.impl.splitter.LineBlocks;
import com.gome.maven.openapi.diff.impl.util.*;
import com.gome.maven.openapi.editor.Document;
import com.gome.maven.openapi.editor.Editor;
import com.gome.maven.openapi.editor.ScrollType;
import com.gome.maven.openapi.editor.ScrollingModel;
import com.gome.maven.openapi.editor.event.VisibleAreaEvent;
import com.gome.maven.openapi.editor.event.VisibleAreaListener;
...
import com.gome.maven.util.containers.CacheOneStepIterator;
...
public class DiffPanelImpl implements DiffPanelEx, ContentChangeListener, TwoSidesContainer {
    ...
    protected DiffPanelState createDiffPanelState( Disposable parentDisposable) {
    ...
    public void setLineNumberConvertors( TIntFunction old,  TIntFunction newConvertor) {
        if (getEditor1() != null) {
    ...
    private static String addReadOnly( String title,  Editor editor) {
    ...
    public void setHighlightMode( HighlightMode mode, boolean notifyManager) {
    ...
    static JComponent createComponentForTitle( String title,
                                               final LineSeparator sep1,
                                               final LineSeparator sep2,
                                              boolean left) {
    ...
    private static void initEditorSettings( Editor editor) {
        if (editor == null) {
            return;
        }
    ...
    private void setTitles( DiffRequest data) {
