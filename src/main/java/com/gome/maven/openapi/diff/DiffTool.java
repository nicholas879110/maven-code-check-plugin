...
public interface DiffTool {
     ...
     */
     ...
     DataKey SCROLL_TO_LINE = DataKey.create("scrollToLine");

    /**
     * Opens window to compare contents. Clients should call {@link #canShow(com.gome.maven.openapi.diff.DiffRequest)} first.
     */
