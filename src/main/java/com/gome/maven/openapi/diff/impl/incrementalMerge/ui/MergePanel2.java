...
import com.gome.maven.openapi.diff.actions.NextDiffAction;
import com.gome.maven.openapi.diff.actions.PreviousDiffAction;
import com.gome.maven.openapi.diff.actions.ToggleAutoScrollAction;
import com.gome.maven.openapi.diff.impl.*;
import com.gome.maven.openapi.diff.impl.highlighting.FragmentSide;
import com.gome.maven.openapi.diff.impl.incrementalMerge.ChangeCounter;
import com.gome.maven.openapi.diff.impl.incrementalMerge.ChangeList;
...
import com.gome.maven.openapi.diff.impl.settings.MergeToolSettings;
...
public class MergePanel2 implements DiffViewer {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.diff.impl.incrementalMerge.ui.MergePanel2");
    ...
    public void setHighlighterSettings( EditorColorsScheme settings) {
        for (EditorPlace place : getEditorPlaces()) {
            setHighlighterSettings(settings, place);
        }
    }

    private void setHighlighterSettings( EditorColorsScheme settings,  EditorPlace place) {
        if (settings == null) {
    ...
    private static class StatusUpdater implements ChangeCounter.Listener {
        ...
        private static String makeCounterWord(int number,  String word) {
            if (number == 0) {
