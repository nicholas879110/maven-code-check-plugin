...
import com.gome.maven.openapi.diff.impl.util.LabeledEditor;
import com.gome.maven.openapi.diff.impl.util.SyncScrollSupport;
...
import com.gome.maven.util.ui.ScrollUtil;
...
public class DiffSideView {
    ...
    public DiffSideView(DiffSidesContainer container,  Border editorBorder) {
