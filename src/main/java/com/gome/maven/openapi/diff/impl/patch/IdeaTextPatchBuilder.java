...
import com.gome.maven.openapi.vcs.VcsOutgoingChangesProvider;
...
public class IdeaTextPatchBuilder {
    ...
    private static AirContentRevision convertRevision( final ContentRevision cr, final VcsOutgoingChangesProvider provider) {
        if (cr == null) return null;
