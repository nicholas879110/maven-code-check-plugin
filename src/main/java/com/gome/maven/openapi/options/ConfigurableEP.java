...
public class ConfigurableEP<T extends UnnamedConfigurable> extends AbstractExtensionPointBean {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.options.ConfigurableEP");
     ...
     * {@link com.gome.maven.openapi.options.Configurable.Composite#getConfigurables()} will be called for such configurables.
     */
    @Attribute("dynamic")
    ...
    protected ConfigurableEP(PicoContainer picoContainer,  Project project) {
        myProject = project;
