...
public class OptionsEditorContext {
    ...
    ActionCallback fireSelected( final Configurable configurable,  OptionsEditorColleague requestor) {
    ...
    ActionCallback fireModifiedAdded( final Configurable configurable,  OptionsEditorColleague requestor) {
    ...
    ActionCallback fireModifiedRemoved( final Configurable configurable,  OptionsEditorColleague requestor) {
        if (!myModified.contains(configurable)) return new ActionCallback.Rejected();
