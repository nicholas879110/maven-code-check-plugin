 ...
 *
 * <p><p>
 * Use {@code com.gome.maven.projectConfigurable} and {@code com.gome.maven.applicationConfigurable} extensions to provide items for
...
public interface Configurable extends UnnamedConfigurable {
    ...
    ExtensionPointName<ConfigurableEP<Configurable>> APPLICATION_CONFIGURABLE = ExtensionPointName.create("com.gome.maven.applicationConfigurable");

    ExtensionPointName<ConfigurableEP<Configurable>> PROJECT_CONFIGURABLE = ExtensionPointName.create("com.gome.maven.projectConfigurable");
