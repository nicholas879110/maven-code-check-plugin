...
import com.gome.maven.ui.navigation.History;
...
public class OptionsEditor extends JPanel implements DataProvider, Place.Navigator, Disposable, AWTEventListener {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.options.newEditor.OptionsEditor");
    ...
    */
    ...
    @Override
    public ActionCallback navigateTo( final Place place, final boolean requestFocus) {
