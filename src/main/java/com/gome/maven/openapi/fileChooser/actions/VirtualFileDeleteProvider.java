 ...
 */
package com.gome.maven.openapi.fileChooser.actions;
...
public final class VirtualFileDeleteProvider implements DeleteProvider {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileChooser.actions.VirtualFileDeleteProvider");
