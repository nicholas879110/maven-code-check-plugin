...
import com.gome.maven.ide.SaveAndSyncHandlerImpl;
...
import com.gome.maven.openapi.fileChooser.impl.FileChooserFactoryImpl;
import com.gome.maven.openapi.fileChooser.impl.FileChooserUtil;
...
public class FileChooserDialogImpl extends DialogWrapper implements FileChooserDialog, PathChooserDialog, FileLookup {
    ...
    public FileChooserDialogImpl( final FileChooserDescriptor descriptor,  Project project) {
        super(project, true);
    ...
    public FileChooserDialogImpl( final FileChooserDescriptor descriptor,  Component parent) {
        this(descriptor, parent, null);
    }

    public FileChooserDialogImpl( final FileChooserDescriptor descriptor,  Component parent,  Project project) {
        super(parent, true);
        myChooserDescriptor = descriptor;
        myProject = project;
        setTitle(getChooserTitle(descriptor));
    ...
    public VirtualFile[] choose( final Project project,  final VirtualFile... toSelect) {
        init();
    ...
    @Override
    public void choose( VirtualFile toSelect,  Consumer<List<VirtualFile>> callback) {
        init();
    ...
    protected void storeSelection( VirtualFile file) {
