...
import com.gome.maven.openapi.fileChooser.FileTextField;
...
import com.gome.maven.ui.popup.list.GroupedItemsListRenderer;
...
public abstract class FileTextFieldImpl implements FileLookup, Disposable, FileTextField {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileChooser.ex.FileTextFieldImpl");
    ...
    public FileTextFieldImpl(final JTextField field, Finder finder, LookupFilter filter, Map<String, String> macroMap, final Disposable parent) {
        ...
        new LazyUiDisposable<FileTextFieldImpl>(parent, field, this) {
            protected void initialize( Disposable parent,  FileTextFieldImpl child,  Project project) {
    ...
    public final void setText(final String text, boolean now,  final Runnable onDone) {
