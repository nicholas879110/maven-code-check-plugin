...
import com.gome.maven.openapi.progress.impl.ProgressManagerImpl;
 ...
 * To add a task to the queue use {@link #run(com.gome.maven.openapi.progress.Task.Backgroundable)}
