...
import com.gome.maven.openapi.application.impl.ModalityStateEx;
...
import com.gome.maven.util.containers.DoubleArrayList;
...
public class AbstractProgressIndicatorBase extends UserDataHolderBase implements ProgressIndicatorStacked {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.progress.util.ProgressIndicatorBase");
    ...
    @Override
    public synchronized void initStateFrom( final ProgressIndicator indicator) {
