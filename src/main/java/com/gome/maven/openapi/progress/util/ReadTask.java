 ...
 *
 * @see com.gome.maven.openapi.progress.util.ProgressIndicatorUtils#scheduleWithWriteActionPriority(ReadTask)
 *
 */
public interface ReadTask {
     ...
     */
    void computeInReadAction( ProgressIndicator indicator);
     ...
     */
    void onCanceled( ProgressIndicator indicator);
