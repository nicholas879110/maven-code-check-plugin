...
public abstract class Task implements TaskInfo, Progressive {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.progress.Task");
    ...
    public Task( final Project project, final String title, final boolean canBeCancelled) {
        myProject = project;
        myTitle = title;
    ...
    public abstract static class Backgroundable extends Task implements PerformInBackgroundOption {
        ...
        public Backgroundable( final Project project,
                               final String title,
        ...
        public Backgroundable( final Project project, final String title) {
    ...
    public abstract static class Modal extends Task {
        public Modal( final Project project,  String title, boolean canBeCancelled) {
            super(project, title, canBeCancelled);
        }
    ...
    public abstract static class ConditionalModal extends Backgroundable {
        public ConditionalModal( final Project project,  final String title, final boolean canBeCancelled,
                                 final PerformInBackgroundOption backgroundOption) {
