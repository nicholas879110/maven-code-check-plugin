...
public class ActionToolbarImpl extends JPanel implements ActionToolbar {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.actionSystem.impl.ActionToolbarImpl");
...
//      }
    ...
    private void tweakActionComponentUI( Component actionComponent) {
