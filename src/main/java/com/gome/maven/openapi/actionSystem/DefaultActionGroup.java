 ...
 * @see Constraints
 *
 * @see com.gome.maven.openapi.actionSystem.ComputableActionGroup
 *
 * @see com.gome.maven.ide.actions.NonEmptyActionGroup
 * @see com.gome.maven.ide.actions.NonTrivialActionGroup
 * @see com.gome.maven.ide.actions.SmartPopupActionGroup
 *
 */
public class DefaultActionGroup extends ActionGroup {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.actionSystem.DefaultActionGroup");
    /**
    ...
    public DefaultActionGroup( String name,  List<? extends AnAction> actions) {
        this(name, false);
        addActions(actions);
    }
