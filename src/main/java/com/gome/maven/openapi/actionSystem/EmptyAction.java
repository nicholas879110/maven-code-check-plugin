...
public final class EmptyAction extends AnAction {
    ...
    public EmptyAction( String text,  String description,  Icon icon) {
        super(text, description, icon);
    }

    public static AnAction createEmptyAction( String name,  Icon icon, boolean alwaysEnabled) {
    ...
    public static void setupAction( AnAction action,  String id,  JComponent component) {
