...
final class ActionPopupMenuImpl implements ActionPopupMenu, ApplicationActivationListener {
    ...
    public ActionPopupMenuImpl(String place,  ActionGroup group, ActionManagerImpl actionManager,  PresentationFactory factory) {
    ...
    public void setDataContextProvider( Getter<DataContext> dataContextProvider) {
    ...
    private class MyMenu extends JBPopupMenu {
        ...
        public MyMenu(String place,  ActionGroup group,  PresentationFactory factory) {
            myPlace = place;
            myGroup = group;
