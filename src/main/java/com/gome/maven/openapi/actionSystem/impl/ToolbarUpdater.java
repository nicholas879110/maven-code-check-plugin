...
import com.gome.maven.openapi.actionSystem.TimerListener;
...
public abstract class ToolbarUpdater implements Activatable {
    ...
    public ToolbarUpdater( JComponent component) {
        this(ActionManagerEx.getInstanceEx(), KeymapManagerEx.getInstanceEx(), component);
    }

    public ToolbarUpdater( ActionManagerEx actionManager,  KeymapManagerEx keymapManager,  JComponent component) {
    ...
    private static class MyUpdateRunnable implements Runnable {
        ...
        public MyUpdateRunnable( ToolbarUpdater updater, boolean transparentOnly, boolean forced) {
