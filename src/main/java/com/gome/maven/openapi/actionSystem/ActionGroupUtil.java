...
public class ActionGroupUtil {
    ...
    private static boolean isGroupEmpty( ActionGroup actionGroup,
                                         AnActionEvent e,
    ...
    public static AnAction getSingleActiveAction( ActionGroup actionGroup,  AnActionEvent e) {
    ...
    private static List<AnAction> getEnabledChildren( ActionGroup actionGroup,
                                                      AnActionEvent e,
                                                      Map<AnAction, Presentation> action2presentation) {
    ...
    private static boolean isActionEnabledAndVisible( final AnActionEvent e,
                                                      final Map<AnAction, Presentation> action2presentation,
