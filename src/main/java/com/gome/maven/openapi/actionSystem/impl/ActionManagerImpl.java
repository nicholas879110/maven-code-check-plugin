...
import com.gome.maven.ide.ActivityTracker;
...
import com.gome.maven.openapi.keymap.ex.KeymapManagerEx;
...
public final class ActionManagerImpl extends ActionManagerEx implements ApplicationComponent {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.actionSystem.impl.ActionManagerImpl");
    ...
    private static ResourceBundle getActionsResourceBundle(ClassLoader loader, IdeaPluginDescriptor plugin) {
         final String resBundleName = plugin != null && !"com.gome.maven".equals(plugin.getPluginId().getIdString())
    ...
    private static void setIcon( final String iconPath,
                                 String className,
                                 ClassLoader loader,
    ...
    private static void setIconFromClass( final Class actionClass,
    ...
    private static void reportActionError(final PluginId pluginId,   String message) {
        if (pluginId == null) {
            LOG.error(message);
        }
        else {
    ...
    private static void reportActionWarning(final PluginId pluginId,   String message) {
        if (pluginId == null) {
            LOG.warn(message);
        }
        else {
    ...
    public ActionPopupMenu createActionPopupMenu(String place,  ActionGroup group,  PresentationFactory presentationFactory) {
    ...
    private void registerOrReplaceActionInner( Element element,  String id,  AnAction action,  PluginId pluginId) {
        synchronized (myLock) {
    ...
    public void registerAction( String actionId,  AnAction action,  PluginId pluginId,  String projectType) {
        synchronized (myLock) {
    ...
    //@Override
    //public AnAction replaceAction(String actionId,  AnAction newAction) {
    //  synchronized (myLock) {
    ...
    private AnAction replaceAction( String actionId,  AnAction newAction,  PluginId pluginId) {
    ...
    @Override
    public ActionCallback tryToExecute( final AnAction action,  final InputEvent inputEvent,  final Component contextComponent,  final String place,
                                       boolean now) {
