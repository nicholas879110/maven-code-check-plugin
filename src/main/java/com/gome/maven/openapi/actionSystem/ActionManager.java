...
public abstract class ActionManager implements ApplicationComponent {
     ...
     *  See {@link com.gome.maven.openapi.actionSystem.ActionPlaces}
     *
     ...
     *
     * @see com.gome.maven.openapi.actionSystem.IdeActions
     */
     ...
     * @since 5.1
     */
    public abstract JComponent createButtonToolbar(final String actionPlace,  ActionGroup messageActionGroup);
    ...
    public abstract ActionCallback tryToExecute( AnAction action,  InputEvent inputEvent,  Component contextComponent,
                                                 String place, boolean now);
