...
import com.gome.maven.openapi.Forceable;
...
import com.gome.maven.util.io.storage.*;
...
import static com.gome.maven.util.io.IOUtil.deleteAllFilesStartingWith;

@SuppressWarnings({"PointlessArithmeticExpression", "HardCodedStringLiteral"})
public class FSRecords implements Forceable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.vfs.persistent.FSRecords");
    ...
    public static DataOutputStream writeAttribute(final int fileId,  FileAttribute att) {
    ...
    private static class AttributeOutputStream extends DataOutputStream {
        ...
        private AttributeOutputStream(final int fileId,  FileAttribute attribute) {
            super(new BufferExposingByteArrayOutputStream());
            myFileId = fileId;
