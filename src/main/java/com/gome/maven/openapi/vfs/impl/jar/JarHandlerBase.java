...
import com.gome.maven.openapi.vfs.impl.ZipHandler;
...
public class JarHandlerBase {
    ...
    private static class MyZipHandler extends ZipHandler {
        public MyZipHandler( String path) {
            super(path);
        }
    ...
    /** @deprecated to be removed in IDEA 15 */
    public com.gome.maven.openapi.vfs.JarFile getJar() {
        try {
    ...
    static class MyJarFile implements com.gome.maven.openapi.vfs.JarFile {
        private static class MyJarEntry implements com.gome.maven.openapi.vfs.JarFile.JarEntry {
