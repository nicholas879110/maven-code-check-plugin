...
import com.gome.maven.openapi.vfs.newvfs.CachingVirtualFileSystem;
...
public class VirtualFileManagerImpl extends VirtualFileManagerEx {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vfs.impl.VirtualFileManagerImpl");

    private final KeyedExtensionCollector<VirtualFileSystem, String> myCollector =
            new KeyedExtensionCollector<VirtualFileSystem, String>("com.gome.maven.virtualFileSystem") {
    ...
    @Override
    public long asyncRefresh( Runnable postAction) {
        return doRefresh(true, postAction);
    }

    protected long doRefresh(boolean asynchronous,  Runnable postAction) {
        if (!asynchronous) {
    ...
    @Override
    public void addVirtualFileManagerListener( final VirtualFileManagerListener listener,  Disposable parentDisposable) {
