...
import com.gome.maven.util.IntSLRUCache;
import com.gome.maven.util.containers.IntObjectLinkedMap;
import com.gome.maven.util.io.IOUtil;
import com.gome.maven.util.io.PersistentStringEnumerator;
import com.gome.maven.util.text.ByteArrayCharSequence;
...
public class FileNameCache {
    ...
    private static CharSequence convertToBytesIfAsciiString( String name) {
    ...
    static char[] appendPathOnFileSystem(int nameId, VirtualFileSystemEntry parent, int accumulatedPathLength,  int[] positionRef) {
