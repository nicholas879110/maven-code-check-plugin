...
import com.gome.maven.openapi.util.io.FileTooBigException;
...
public abstract class VirtualFileSystemEntry extends NewVirtualFile {
    ...
    protected static int copyString( char[] chars, int pos,  CharSequence s) {
        int length = s.length();
    ...
    @Override
    public void rename(final Object requestor,   final String newName) throws IOException {
