...
public abstract class VirtualFile extends UserDataHolderBase implements ModificationTracker {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vfs.VirtualFile");
     ...
     * For <code>{@link com.gome.maven.openapi.vfs.LocalFileSystem}</code> it is an absolute file path with file separator characters
     ...
     *         it returns {@link com.gome.maven.openapi.fileTypes.FileTypes#UNKNOWN}
     */
    @SuppressWarnings("JavadocReference")
    ...
    public void setCharset(final Charset charset,  Runnable whenChanged) {
