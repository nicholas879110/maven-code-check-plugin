 ...
 *
 * @see com.gome.maven.openapi.vfs.VirtualFileListener
 */
public class VirtualFileEvent extends EventObject {
    ...
    public VirtualFileEvent( Object requestor,  VirtualFile file,  String fileName,  VirtualFile parent) {
        this(requestor, file, fileName, parent,0,0);
    }

    public VirtualFileEvent( Object requestor,
                             VirtualFile file,
                             VirtualFile parent,
    ...
    private VirtualFileEvent( Object requestor,
                              VirtualFile file,
                              String fileName,
                              VirtualFile parent,
                             long oldModificationStamp,
