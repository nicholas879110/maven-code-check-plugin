...
public final class LocalFileSystemImpl extends LocalFileSystemBase implements ApplicationComponent {
    ...
    public LocalFileSystemImpl( ManagingFS managingFS) {
    ...
    public Set<WatchRequest> addRootsToWatch( final Collection<String> rootPaths, final boolean watchRecursively) {
    ...
    @Override
    public void removeWatchedRoots( final Collection<WatchRequest> watchRequests) {
    ...
    @Override
    public Set<WatchRequest> replaceWatchedRoots( final Collection<WatchRequest> watchRequests,
                                                  final Collection<String> _recursiveRoots,
                                                  final Collection<String> _flatRoots) {
    ...
    private boolean doAddRootsToWatch( final Collection<String> recursiveRoots,
                                       final Collection<String> flatRoots,
                                       final Set<WatchRequest> results,
                                       final Set<VirtualFile> filesToSync) {
    ...
    private void syncFiles( final Set<VirtualFile> filesToSync) {
    ...
    private boolean doRemoveWatchedRoots( final Collection<WatchRequest> watchRequests) {
        boolean update = false;
