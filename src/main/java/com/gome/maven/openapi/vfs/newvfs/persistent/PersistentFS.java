...
import com.gome.maven.lang.annotations.MagicConstant;
...
public abstract class PersistentFS extends ManagingFS {
    ...
    public abstract boolean isSpecialFile( VirtualFile file);
    ...
    public abstract void processEvents( List<VFileEvent> events);

    
    public static NewVirtualFileSystem replaceWithNativeFS( final NewVirtualFileSystem fs) {
