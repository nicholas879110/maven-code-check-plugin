...
public class VirtualFilePointerManagerImpl extends VirtualFilePointerManager implements ApplicationComponent, ModificationTracker, BulkFileListener {
    ...
    VirtualFilePointerManagerImpl( VirtualFileManager virtualFileManager,
                                   MessageBus bus,
    ...
    private static VirtualFilePointer[] toPointers( List<FilePointerPartNode> pointers) {
    ...
    public synchronized VirtualFilePointer create( String url,  Disposable parent,  VirtualFilePointerListener listener) {
        return create(null, url, parent, listener);
    }

    @Override
    
    public synchronized VirtualFilePointer create( VirtualFile file,  Disposable parent,  VirtualFilePointerListener listener) {
    ...
    private IdentityVirtualFilePointer getOrCreateIdentity( String url, VirtualFile found) {
    ...
    private static String cleanupPath( String path, boolean isJar) {
        path = FileUtil.normalize(path);
        path = trimTrailingSeparators(path, isJar);
        return path;
    }

    private static String trimTrailingSeparators( String path, boolean isJar) {
    ...
    private VirtualFilePointerImpl getOrCreate( Disposable parentDisposable,
                                                VirtualFilePointerListener listener,
                                                String path,
    ...
    public synchronized VirtualFilePointer duplicate( VirtualFilePointer pointer,
                                                      Disposable parent,
                                                      VirtualFilePointerListener listener) {
    ...
    public synchronized VirtualFilePointerContainer createContainer( Disposable parent,  VirtualFilePointerListener listener) {
    ...
    void removeNode( FilePointerPartNode node, VirtualFilePointerListener listener) {
