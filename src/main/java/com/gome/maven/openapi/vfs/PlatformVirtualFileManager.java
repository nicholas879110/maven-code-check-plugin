...
import com.gome.maven.openapi.vfs.impl.VirtualFileManagerImpl;
...
public class PlatformVirtualFileManager extends VirtualFileManagerImpl {
    ...
    public PlatformVirtualFileManager( VirtualFileSystem[] fileSystems,  MessageBus bus,  ManagingFS managingFS) {
