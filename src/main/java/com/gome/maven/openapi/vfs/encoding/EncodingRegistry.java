...
public abstract class EncodingRegistry {
    ...
    public abstract Charset getEncoding( VirtualFile virtualFile, boolean useParentDefaults);

    @Deprecated // return true always
    public abstract boolean isUseUTFGuessing(VirtualFile virtualFile);

    public abstract void setEncoding(VirtualFile virtualFileOrDir, Charset charset);
    ...
    public static <E extends Throwable> VirtualFile doActionAndRestoreEncoding( VirtualFile fileBefore,
                                                                                ThrowableComputable<VirtualFile, E> action) throws E {
