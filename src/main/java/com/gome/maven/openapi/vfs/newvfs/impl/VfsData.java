...
import static com.gome.maven.openapi.vfs.newvfs.impl.VirtualFileSystemEntry.ALL_FLAGS_MASK;
import static com.gome.maven.util.ObjectUtils.assertNotNull;
 ...
 * kept on hard references in {@link com.gome.maven.openapi.vfs.newvfs.persistent.PersistentFS}
 *
 ...
 *
 * 5. The file with removed data is marked as "dead" (see {@link #ourDeadMarker}, any access to it will throw {@link com.gome.maven.openapi.vfs.InvalidVirtualFileAccessException}
...
public class VfsData {
    ...
    public static void initFile(int id, Segment segment, int nameId,  Object data) {
        assert id > 0;
        int offset = getOffset(id);
