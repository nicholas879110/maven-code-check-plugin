...
class FilePointerPartNode {
    ...
    FilePointerPartNode( String part, FilePointerPartNode parent, Pair<VirtualFile,String> fileAndUrl) {
        this.part = part;
        this.parent = parent;
    ...
    int position( VirtualFile parent,
    ...
    void getPointersUnder( VirtualFile parent,
                          boolean separator,
                           CharSequence childName,
    ...
    private static void addAllPointersUnder( FilePointerPartNode node,  List<FilePointerPartNode> out) {
    ...
    boolean getPointersUnder( String path, int start,  List<FilePointerPartNode> out) {
        checkConsistency();
    ...
    FilePointerPartNode findPointerOrCreate( String path, int start,  Pair<VirtualFile, String> fileAndUrl) {
        // invariant: upper nodes are matched
        int index = indexOfFirstDifferentChar(path, start);
    ...
    private int indexOfFirstDifferentChar( CharSequence path, int start) {
    ...
    private static int indexOfFirstDifferentChar( CharSequence s1, int start1,  String s2, int start2) {
