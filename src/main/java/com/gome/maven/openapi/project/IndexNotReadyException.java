 ...
 * <ul>
 * <li> If {@link com.gome.maven.openapi.actionSystem.AnAction#actionPerformed(com.gome.maven.openapi.actionSystem.AnActionEvent)} is in stack trace,
 ...
 * indexing is in progress. It can be done via a dialog (see {@link com.gome.maven.openapi.ui.Messages}) or a status bar balloon
 * (see {@link DumbService#showDumbModeNotification(String)}, {@link com.gome.maven.openapi.actionSystem.ex.ActionUtil#showDumbModeWarning(com.gome.maven.openapi.actionSystem.AnActionEvent...)}).
 *
