...
public abstract class DumbService {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.project.DumbService");
    ...
    public abstract JComponent wrapGently( JComponent dumbUnawareContent,  Disposable parentDisposable);
