...
public abstract class OrderEnumerationHandler {
    ...
    public static abstract class Factory {
        ...
        public abstract boolean isApplicable( Module module);

        public abstract OrderEnumerationHandler createHandler( Module module);
    }
    ...
    public AddDependencyType shouldAddDependency( OrderEntry orderEntry,
                                                  OrderEnumeratorSettings settings) {
    ...
    public boolean addCustomRootsForLibrary( OrderEntry forOrderEntry,
                                             OrderRootType type,
                                             Collection<String> urls) {
        return false;
    }

    public boolean addCustomModuleRoots( OrderRootType type,
