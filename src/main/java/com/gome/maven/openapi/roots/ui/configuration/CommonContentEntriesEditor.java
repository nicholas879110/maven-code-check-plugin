...
import com.gome.maven.openapi.fileChooser.ex.FileChooserKeys;
...
import com.gome.maven.openapi.roots.ui.componentsList.components.ScrollablePanel;
import com.gome.maven.openapi.roots.ui.componentsList.layout.VerticalStackLayout;
...
import com.gome.maven.ui.JBSplitter;
...
import com.gome.maven.ui.roots.ToolbarPanel;
...
public class CommonContentEntriesEditor extends ModuleElementsEditor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.roots.ui.configuration.ContentEntriesEditor");
