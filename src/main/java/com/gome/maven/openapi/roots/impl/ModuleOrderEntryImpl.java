...
import com.gome.maven.openapi.module.ModulePointer;
import com.gome.maven.openapi.module.ModulePointerManager;
...
public class ModuleOrderEntryImpl extends OrderEntryBaseImpl implements ModuleOrderEntry, WritableOrderEntry, ClonableOrderEntry {
     public static final String ENTRY_TYPE = JpsModuleRootModelSerializer.MODULE_TYPE;
     public static final String MODULE_NAME_ATTR = JpsModuleRootModelSerializer.MODULE_NAME_ATTRIBUTE;
