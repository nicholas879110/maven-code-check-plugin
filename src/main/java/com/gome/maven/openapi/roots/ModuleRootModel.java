...
public interface ModuleRootModel {
     ...
     * @see ProjectRootManager#setProjectSdk(com.gome.maven.openapi.projectRoots.Sdk)
     */
    ...
    List<VirtualFile> getSourceRoots( JpsModuleSourceRootType<?> rootType);
    ...
    List<VirtualFile> getSourceRoots( Set<? extends JpsModuleSourceRootType<?>> rootTypes);
