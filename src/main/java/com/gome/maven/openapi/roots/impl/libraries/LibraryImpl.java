...
import com.gome.maven.openapi.components.ComponentSerializationUtil;
...
import static com.gome.maven.openapi.vfs.VirtualFileVisitor.ONE_LEVEL_DEEP;
import static com.gome.maven.openapi.vfs.VirtualFileVisitor.SKIP_ROOT;
...
public class LibraryImpl extends TraceableDisposable implements LibraryEx.ModifiableModelEx, LibraryEx {
    ...
    LibraryImpl(String name,  final PersistentLibraryKind<?> kind, LibraryTable table, ModifiableRootModel rootModel) {
    ...
    // primary
    private LibraryImpl(LibraryTable table, ModifiableRootModel rootModel, LibraryImpl newSource, String name,  final PersistentLibraryKind<?> kind) {
        super(new Throwable());
    ...
    @Override
    public void addJarDirectory( final String url, final boolean recursive,  OrderRootType rootType) {
        checkDisposed();
        LOG.assertTrue(isWritable());
    ...
    @Override
    public void addJarDirectory( final VirtualFile file, final boolean recursive,  OrderRootType rootType) {
        checkDisposed();
        LOG.assertTrue(isWritable());
    ...
    @Override
    public boolean isJarDirectory( final String url,  final OrderRootType rootType) {
