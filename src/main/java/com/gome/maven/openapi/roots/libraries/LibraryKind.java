...
public class LibraryKind {
    ...
    /**
     * @param kindId must be unique among all {@link com.gome.maven.openapi.roots.libraries.LibraryType} and {@link com.gome.maven.openapi.roots.libraries.LibraryPresentationProvider} implementations
     */
