...
public interface ProjectFileIndex extends FileIndex {
    ...
    VirtualFile getContentRootForFile( VirtualFile file, final boolean honorExclusion);
    ...
    /**
     * @deprecated name of this method may be confusing. If you want to check if the file is excluded or ignored use {@link #isExcluded(com.gome.maven.openapi.vfs.VirtualFile)}.
     * If you want to check if the file is ignored use {@link com.gome.maven.openapi.fileTypes.FileTypeRegistry#isFileIgnored(com.gome.maven.openapi.vfs.VirtualFile)}.
     * If you want to check if the file or one of its parents is ignored use {@link #isUnderIgnored(com.gome.maven.openapi.vfs.VirtualFile)}.
     */
    @Deprecated
     ...
     * either excluded from the project or ignored by {@link com.gome.maven.openapi.fileTypes.FileTypeRegistry#isFileIgnored(com.gome.maven.openapi.vfs.VirtualFile)}).
     *
     * @param file the file to check.
     ...
     * by {@link com.gome.maven.openapi.fileTypes.FileTypeRegistry#isFileIgnored(com.gome.maven.openapi.vfs.VirtualFile)}).
     *
     * @param file the file to check.
