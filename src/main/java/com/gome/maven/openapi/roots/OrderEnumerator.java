 ...
 * and source roots.<p>
 * <p/>
 * Use {@link #orderEntries(com.gome.maven.openapi.module.Module)} or {@link ModuleRootModel#orderEntries()} to process dependencies of a module
 * and use {@link #orderEntries(com.gome.maven.openapi.project.Project)} to process dependencies of all modules in a project.<p>
 * <p/>
...
public abstract class OrderEnumerator {
     ...
     */
    public abstract OrderRootsEnumerator roots( NotNullFunction<OrderEntry, OrderRootType> rootTypeProvider);
