...
public class SourceRootPresentation {
    ...
    public static Icon getSourceRootIcon( SourceFolder sourceFolder) {
        return getSourceRootIcon(sourceFolder.getJpsElement().asTyped());
    }

    
    private static <P extends JpsElement> Icon getSourceRootIcon( JpsTypedModuleSourceRoot<P> root) {
