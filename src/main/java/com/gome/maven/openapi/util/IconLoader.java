...
import com.gome.maven.util.RetinaImage;
...
public final class IconLoader {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.util.IconLoader");
    ...
    private static Icon getReflectiveIcon( String path, ClassLoader classLoader) {
        try {
             String pckg = path.startsWith("AllIcons.") ? "com.gome.maven.icons." : "icons.";
