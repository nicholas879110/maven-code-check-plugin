...
public class Registry  {
    ...
    public static double doubleValue(String key) throws MissingResourceException {
        return get(key).asDouble();
    }

    
    public static String stringValue(String key) throws MissingResourceException {
        return get(key).asString();
    }

    public static Color getColor(String key, Color defaultValue) throws MissingResourceException {
    ...
    public void loadState( Element state) {
        ...
        for (Element eachEntry : (List<Element>)state.getChildren("entry")) {
