...
/**
 * @deprecated {@link com.gome.maven.util.xmlb.XmlSerializer} should be used instead
 * @author mike
 */
@SuppressWarnings({"HardCodedStringLiteral"})
public class DefaultJDOMExternalizer {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.util.DefaultJDOMExternalizer");
    ...
    public static void writeExternal( Object data,
                                      Element parentNode,
                                      JDOMFilter filter) throws WriteExternalException {
    ...
    public static Color toColor( String value) throws InvalidDataException {
        Color color;
        if (value == null) {
            color = null;
        }
