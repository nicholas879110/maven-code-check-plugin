...
public class DimensionService implements PersistentStateComponent<Element> {
    ...
    public synchronized Dimension getSize(  String key, Project project) {
    ...
    public synchronized void setSize(  String key, Dimension size, Project project) {
        key = realKey(key, project);
    ...
    private static String realKey(String key,  Project project) {
