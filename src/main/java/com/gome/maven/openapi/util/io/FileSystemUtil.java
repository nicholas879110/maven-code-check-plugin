...
import com.gome.maven.util.Patches;
...
import static com.gome.maven.util.BitUtil.isSet;
import static com.gome.maven.util.BitUtil.notSet;
...
public class FileSystemUtil {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.util.io.FileSystemUtil");

    private abstract static class Mediator {
        
        protected abstract FileAttributes getAttributes( String path) throws Exception;

        
        protected abstract String resolveSymLink( String path) throws Exception;

        protected boolean clonePermissions( String source,  String target, boolean onlyPermissionsToExecute) throws Exception { return false; }
    ...
    private static class Nio2MediatorImpl extends Mediator {
        ...
        @Override
        protected FileAttributes getAttributes( String path) throws Exception {
            try {
        ...
        @Override
        protected String resolveSymLink( final String path) throws Exception {
        ...
        @Override
        protected boolean clonePermissions( String source,  String target, boolean onlyPermissionsToExecute) throws Exception {
    ...
    private static class IdeaWin32MediatorImpl extends Mediator {
        ...
        @Override
        protected FileAttributes getAttributes( final String path) throws Exception {
