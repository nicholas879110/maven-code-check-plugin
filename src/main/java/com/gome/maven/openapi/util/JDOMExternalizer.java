...
public class JDOMExternalizer {
    ...
    public static String readString( Element root,  String name) {
        for (Element element :(List<Element>) root.getChildren("setting")) {
    ...
    public static void writeMap(Element root, Map<String, String> map,   String rootName,  String entryName) {
        Element mapRoot;
        ...
        for (String name : names) {
             final Element element = new Element(entryName);
            element.setAttribute("name", name);
    ...
    public static void readMap(Element root, Map<String, String> map,   String rootName,  String entryName) {
        Element mapRoot;
        if (StringUtil.isNotEmpty(rootName)) {
        ...
        for ( Element element : (List<Element>) mapRoot.getChildren(entryName)) {
     ...
     */
    public static void saveStringsList( final Element parent,
