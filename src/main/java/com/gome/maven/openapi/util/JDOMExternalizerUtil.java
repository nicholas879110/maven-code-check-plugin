...
public class JDOMExternalizerUtil {
    ...
    public static void addChildrenWithValueAttribute( Element parent,
                                                      String childTagName,
    ...
    public static void addChildren( Element parent,
                                    String childElementName,
                                    Collection<? extends JDOMExternalizable> children) throws WriteExternalException {
