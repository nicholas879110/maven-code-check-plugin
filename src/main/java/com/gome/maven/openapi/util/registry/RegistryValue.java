 ...
 */
package com.gome.maven.openapi.util.registry;
...
public class RegistryValue {
    ...
    boolean isChangedFromDefault( String newValue) {
        return !newValue.equals(getBundleValue(myKey, false));
    }

    private String get( String key, String defaultValue, boolean isValue) throws MissingResourceException {
        if (isValue) {
    ...
    private String _get( String key, String defaultValue, boolean mustExistInBundle) throws MissingResourceException {
    ...
    private static String getBundleValue( String key, boolean mustExist) throws MissingResourceException {
        try {
