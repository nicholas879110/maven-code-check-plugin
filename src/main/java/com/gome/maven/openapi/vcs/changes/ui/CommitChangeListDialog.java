...
import com.gome.maven.openapi.vcs.checkin.*;
import com.gome.maven.openapi.vcs.impl.CheckinHandlersManager;
import com.gome.maven.openapi.vcs.impl.VcsGlobalMessageManager;
import com.gome.maven.openapi.vcs.ui.CommitMessage;
...
import com.gome.maven.ui.SplitterWithSecondHideable;
import com.gome.maven.util.Alarm;
import com.gome.maven.util.Consumer;
import com.gome.maven.util.OnOffListener;
...
public class CommitChangeListDialog extends DialogWrapper implements CheckinProjectPanel, TypeSafeDataProvider {
    ...
    private CommitChangeListDialog(final Project project,
                                   ...
                                   final String comment,  CommitResultHandler customResultHandler) {
        super(project, true);
    ...
    private void doCommit( CommitResultHandler customResultHandler) {
