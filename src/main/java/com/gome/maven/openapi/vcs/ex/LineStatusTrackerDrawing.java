...
import com.gome.maven.openapi.diff.DiffColors;
...
import com.gome.maven.openapi.editor.markup.ActiveGutterRenderer;
import com.gome.maven.openapi.editor.markup.LineMarkerRenderer;
import com.gome.maven.openapi.editor.markup.TextAttributes;
import com.gome.maven.openapi.fileEditor.FileDocumentManager;
import com.gome.maven.openapi.vcs.actions.ShowNextChangeMarkerAction;
import com.gome.maven.openapi.vcs.actions.ShowPrevChangeMarkerAction;
import com.gome.maven.openapi.vfs.VirtualFile;
import com.gome.maven.ui.ColoredSideBorder;
import com.gome.maven.ui.HintHint;
import com.gome.maven.ui.HintListener;
...
public class LineStatusTrackerDrawing {
    ...
    private static int lineToY( Editor editor, int line) {
    ...
    private static void paintRect( Graphics g,  Color color,  Color borderColor, int x1, int y1, int x2, int y2) {
        if (color != null) {
            g.setColor(color);
    ...
    private static void paintTriangle( Graphics g,  Color color,  Color borderColor, int x1, int x2, int y) {
        int size = 4;
    ...
    public static void showActiveHint( Range range,
                                       final Editor editor,
                                       Point mousePosition,
    ...
    private static Color getDiffColor( Range.InnerRange range) {
    ...
    private static Color getDiffGutterColor( Range range) {
        final EditorColorsScheme globalScheme = EditorColorsManager.getInstance().getGlobalScheme();
        switch (range.getType()) {
            case Range.INSERTED:
                return globalScheme.getColor(EditorColors.ADDED_LINES_COLOR);
