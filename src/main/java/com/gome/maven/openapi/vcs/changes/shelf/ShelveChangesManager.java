...
import com.gome.maven.openapi.diff.impl.patch.formove.CustomBinaryPatchApplier;
...
import com.gome.maven.openapi.vcs.changes.patch.ApplyPatchDefaultExecutor;
import com.gome.maven.openapi.vcs.changes.patch.PatchFileType;
import com.gome.maven.openapi.vcs.changes.patch.PatchNameChecker;
import com.gome.maven.openapi.vcs.changes.ui.RollbackChangesDialog;
import com.gome.maven.openapi.vcs.changes.ui.RollbackWorker;
...
import com.gome.maven.vcsUtil.FilesProgress;
...
import static com.gome.maven.openapi.vcs.changes.shelf.CompoundShelfFileProcessor.SHELF_DIR_NAME;

public class ShelveChangesManager extends AbstractProjectComponent implements JDOMExternalizable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.shelf.ShelveChangesManager");
    ...
    public static File suggestPatchName(Project project, final String commitMessage, final File file, String extension) {
         String defaultPath = PathUtil.suggestFileName(commitMessage);
    ...
    public void unshelveChangeList(final ShelvedChangeList changeList,  final List<ShelvedChange> changes,
                                    final List<ShelvedBinaryFile> binaryFiles, final LocalChangeList targetChangeList) {
    ...
    private FilePath unshelveBinaryFile(final ShelvedBinaryFile file,  final VirtualFile patchTarget) throws IOException {
