 ...
 * {@link com.gome.maven.openapi.vcs.merge.MergeProvider} should initialize all three variables of the MergeData, because
...
public class MergeData {
    ...
    public byte[] CURRENT;
     ...
     public VcsRevisionNumber LAST_REVISION_NUMBER;
}
