...
public interface ChangeDiffRequestProvider {
    ExtensionPointName<ChangeDiffRequestProvider> EP_NAME =
            ExtensionPointName.create("com.gome.maven.openapi.vcs.changes.actions.diff.ChangeDiffRequestProvider");
    ...
    DiffRequest process( ChangeDiffRequestProducer presentable,
