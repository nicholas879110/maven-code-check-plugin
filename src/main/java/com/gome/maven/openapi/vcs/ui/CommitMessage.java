...
import com.gome.maven.spellchecker.ui.SpellCheckingEditorCustomization;
...
public class CommitMessage extends AbstractDataProviderPanel implements Disposable, CommitMessageI {
     ...
     * @param forceSpellCheckOn if false, {@link com.gome.maven.openapi.vcs.VcsConfiguration#CHECK_COMMIT_MESSAGE_SPELLING} will control
