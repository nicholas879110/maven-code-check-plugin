 ...
 * is passed to implementers of the {@link com.gome.maven.openapi.vcs.changes.ChangeProvider}
 * interface to the method {@link ChangeProvider#getChanges(VcsDirtyScope, ChangelistBuilder,com.gome.maven.openapi.progress.ProgressIndicator, ChangeListManagerGate)}.</p>
 * <p/>
...
public abstract class VcsDirtyScope {
     ...
     * @see #getDirtyFiles()
     * @see com.gome.maven.openapi.vcs.ProjectLevelVcsManager#getVcsRootFor(com.gome.maven.openapi.vcs.FilePath)
     */
