...
import com.gome.maven.openapi.vcs.changes.committed.CommittedChangeListRenderer;
...
public class ChangeListChooserPanel extends JPanel {
    ...
    public ChangeListChooserPanel(final Project project,  final NullableConsumer<String> okEnabledListener) {
