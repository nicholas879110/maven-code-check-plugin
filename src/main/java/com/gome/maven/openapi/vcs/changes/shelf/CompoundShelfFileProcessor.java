...
public class CompoundShelfFileProcessor {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.shelf.CompoundShelfFileProcessor");
    ...
    public CompoundShelfFileProcessor( StreamProvider serverStreamProvider, String shelfPath) {
