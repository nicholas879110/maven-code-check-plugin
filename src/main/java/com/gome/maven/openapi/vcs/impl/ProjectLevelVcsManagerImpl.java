...
import com.gome.maven.openapi.vcs.changes.VcsAnnotationLocalChangesListenerImpl;
import com.gome.maven.openapi.vcs.checkout.CompositeCheckoutListener;
import com.gome.maven.openapi.vcs.ex.ProjectLevelVcsManagerEx;
import com.gome.maven.openapi.vcs.history.VcsHistoryCache;
import com.gome.maven.openapi.vcs.impl.projectlevelman.*;
import com.gome.maven.openapi.vcs.roots.VcsRootScanner;
...
import com.gome.maven.openapi.vcs.update.UpdatedFilesListener;
...
import com.gome.maven.util.ui.EditorAdapter;
...
public class ProjectLevelVcsManagerImpl extends ProjectLevelVcsManagerEx implements ProjectComponent, JDOMExternalizable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.impl.ProjectLevelVcsManagerImpl");
    ...
    public VcsShowConfirmationOption getStandardConfirmation( VcsConfiguration.StandardConfirmation option,
                                                             AbstractVcs vcs) {
    ...
    public void readDirectoryMappings(final Element element) {
        ...
        for (Element child : (List<Element>)element.getChildren(ELEMENT_MAPPING)) {
