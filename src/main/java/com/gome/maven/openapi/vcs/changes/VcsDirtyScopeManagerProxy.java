...
class VcsDirtyScopeManagerProxy extends VcsDirtyScopeManager {
    ...
    public void filePathsDirty( final Collection<FilePath> filesDirty,  final Collection<FilePath> dirsRecursivelyDirty) {
        if (filesDirty != null) {
    ...
    public void filesDirty( final Collection<VirtualFile> filesDirty,  final Collection<VirtualFile> dirsRecursivelyDirty) {
        if (filesDirty != null) {
