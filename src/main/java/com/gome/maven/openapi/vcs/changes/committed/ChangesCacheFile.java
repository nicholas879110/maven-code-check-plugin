...
import com.gome.maven.openapi.vcs.diff.DiffProviderEx;
import com.gome.maven.openapi.vcs.history.VcsRevisionNumber;
import com.gome.maven.openapi.vcs.update.FileGroup;
...
import static com.gome.maven.openapi.vcs.changes.committed.IncomingChangeState.State.*;

/**
 * @author yole
 */
public class ChangesCacheFile {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.committed.ChangesCacheFile");
    ...
    public List<CommittedChangeList> writeChanges(final List<CommittedChangeList> changes,  final List<Boolean> present) throws IOException {
    ...
    private static class RefreshIncomingChangesOperation {
        ...
        private ProcessingResult processIncomingChange(final Change change,
                                                       final IncomingChangeListData changeListData,
                                                        final Collection<FilePath> incomingFiles) {
        ...
        private static boolean isParentReplacedOrFileMoved( FilePath file,  Change change,  FilePath beforeFile) {
        ...
        private static boolean isFileDeleted( FilePath file,  FilePath beforeFile) {
