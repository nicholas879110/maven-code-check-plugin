...
import com.gome.maven.util.PlusMinusModify;
...
public class ChangeListWorker implements ChangeListsWriteOperations {
    private final static Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.ChangeListWorker");
    ...
    public void onAfterWorkerSwitch( final ChangeListWorker previous) {
    ...
    public boolean findListByName( final String name) {
    ...
    public LocalChangeList addChangeList( final String name,  final String comment,  Object data) {
        return addChangeList(null, name, comment, false, data);
    }

    LocalChangeList addChangeList(String id,  final String name,  final String description, final boolean inUpdate,
                                   Object data) {
    ...
    public boolean addChangeToList( final String name, final Change change, final VcsKey vcsKey) {
    ...
    public LocalChangeList getListCopy( final VirtualFile file) {
        for (LocalChangeList list : myMap.values()) {
            for (Change change : list.getChanges()) {
    ...
    public void addSwitched(final VirtualFile file,  String branchName, final boolean recursive) {
    ...
    public String listNameIfOnlyOne(final  Change[] changes) {
