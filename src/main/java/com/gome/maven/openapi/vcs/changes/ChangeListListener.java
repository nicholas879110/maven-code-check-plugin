 ...
 * @author max
 *
 * @see com.gome.maven.openapi.vcs.changes.ChangeListManager#addChangeListListener(ChangeListListener)
 * @see com.gome.maven.openapi.vcs.changes.ChangeListManager#removeChangeListListener(ChangeListListener)
 */
