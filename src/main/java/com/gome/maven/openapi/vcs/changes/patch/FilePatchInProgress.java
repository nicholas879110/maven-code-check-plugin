...
import com.gome.maven.openapi.diff.impl.patch.formove.PathMerger;
...
import com.gome.maven.openapi.vcs.changes.SimpleContentRevision;
...
public class FilePatchInProgress implements Strippable {
    ...
    public void setAutoBases( final Collection<VirtualFile> autoBases) {
