...
import com.gome.maven.openapi.vcs.checkin.BaseCheckinHandlerFactory;
import com.gome.maven.openapi.vcs.checkin.VcsCheckinHandlerFactory;
...
public abstract class CheckinHandlersManager {
    ...
    public abstract List<VcsCheckinHandlerFactory> getMatchingVcsFactories( final List<AbstractVcs> keys);

    @SuppressWarnings("UnusedDeclaration")
    /** @deprecated use EP {@link com.gome.maven.openapi.vcs.checkin.CheckinHandlerFactory#EP_NAME} (to remove in IDEA 14) */
