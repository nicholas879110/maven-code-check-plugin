...
import com.gome.maven.openapi.vcs.changes.local.ChangeListCommand;
...
public class DelayedNotificator {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.DelayedNotificator");
