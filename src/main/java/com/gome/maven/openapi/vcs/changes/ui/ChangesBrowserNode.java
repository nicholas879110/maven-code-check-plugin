...
import com.gome.maven.openapi.vcs.changes.ChangeListOwner;
import com.gome.maven.openapi.vcs.changes.LocallyDeletedChange;
...
public class ChangesBrowserNode<T> extends DefaultMutableTreeNode {
    ...
    public static ChangesBrowserNode create(final Project project,  final LocallyDeletedChange change) {
