...
import com.gome.maven.openapi.options.CancelledConfigurationException;
...
public abstract class UpdateOrStatusOptionsDialog extends OptionsDialog {
    ...
    protected String getDimensionServiceKey() {
        return "com.gome.maven.openapi.vcs.update.UpdateOrStatusOptionsDialog" + getActionNameForDimensions();
    }
