...
import com.gome.maven.ide.actions.ContextHelpAction;
...
import com.gome.maven.openapi.vcs.changes.issueLinks.TreeLinkMouseListener;
...
public class CommittedChangesTreeBrowser extends JPanel implements TypeSafeDataProvider, Disposable, DecoratorManager {
    ...
    public void setItems( List<CommittedChangeList> items, final CommittedChangesBrowserUseCase useCase) {
    ...
    public ActionToolbar createGroupFilterToolbar(final Project project, final ActionGroup leadGroup,  final ActionGroup tailGroup,
