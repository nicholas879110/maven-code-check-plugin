...
import com.gome.maven.openapi.vcs.VcsEventsListenerManager;
...
public class VcsEventsListenerManagerImpl implements VcsEventsListenerManager, VcsEnvironmentsProxyCreator {
    ...
    private static class Wrapper<T> {
        ...
        private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.impl.VcsEventsListenerManagerImpl.Wrapper");
        ...
        public T createProxy(final VcsKey key,  final T environment) {
