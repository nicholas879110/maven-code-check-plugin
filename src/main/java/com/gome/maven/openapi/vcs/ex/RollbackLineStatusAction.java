...
public class RollbackLineStatusAction extends DumbAwareAction {
    ...
    protected static void rollback( LineStatusTracker tracker,  Editor editor,  Range range) {
    ...
    private static void doRollback( final LineStatusTracker tracker,  final Range range) {
    ...
    private static void doRollback( final LineStatusTracker tracker,  final BitSet lines) {
        execute(tracker, new Runnable() {
            @Override
            public void run() {
    ...
    private static void doRollback( final LineStatusTracker tracker) {
        execute(tracker, new Runnable() {
            @Override
            public void run() {
    ...
    private static void execute( final LineStatusTracker tracker,  final Runnable task) {
