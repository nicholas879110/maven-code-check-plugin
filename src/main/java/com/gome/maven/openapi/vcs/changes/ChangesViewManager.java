...
import com.gome.maven.openapi.vcs.changes.actions.IgnoredSettingsAction;
...
public class ChangesViewManager implements ChangesViewI, JDOMExternalizable, ProjectComponent {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.ChangesViewManager");
    ...
    private void setChangeDetailsPanel( final JComponent component) {
