 ...
 */
package com.gome.maven.openapi.vcs.impl.projectlevelman;
...
import com.gome.maven.openapi.vcs.impl.DefaultVcsRootPolicy;
...
public class NewMappings {
    ...
    public static Comparator<VcsDirectoryMapping> MAPPINGS_COMPARATOR = new Comparator<VcsDirectoryMapping>() {
        @Override
        public int compare( VcsDirectoryMapping o1,  VcsDirectoryMapping o2) {
            return o1.getDirectory().compareTo(o2.getDirectory());
        }
    };

    private final static Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.impl.projectlevelman.NewMappings");
