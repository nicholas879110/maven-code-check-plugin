...
class UpdatingChangeListBuilder implements ChangelistBuilder {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.UpdatingChangeListBuilder");
    ...
    public void processChangeInList(final Change change,  final ChangeList changeList, final VcsKey vcsKey) {
        checkIfDisposed();
