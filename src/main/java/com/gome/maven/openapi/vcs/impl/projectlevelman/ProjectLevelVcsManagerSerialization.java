...
import com.gome.maven.openapi.vcs.VcsShowConfirmationOptionImpl;
import com.gome.maven.openapi.vcs.VcsShowOptionsSettingImpl;
...
public class ProjectLevelVcsManagerSerialization {
    ...
    public ProjectLevelVcsManagerSerialization() {
        myReadValue = new com.gome.maven.util.containers.HashMap<String, VcsShowConfirmationOption.Value>();
    }
