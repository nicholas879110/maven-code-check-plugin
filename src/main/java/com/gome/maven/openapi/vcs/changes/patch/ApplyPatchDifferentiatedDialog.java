...
import com.gome.maven.openapi.diff.impl.patch.PatchReader;
import com.gome.maven.openapi.diff.impl.patch.PatchSyntaxException;
import com.gome.maven.openapi.diff.impl.patch.PatchVirtualFileReader;
...
import com.gome.maven.openapi.vcs.changes.actions.ShowDiffAction;
...
public class ApplyPatchDifferentiatedDialog extends DialogWrapper {
    ...
    public ApplyPatchDifferentiatedDialog(final Project project, final ApplyPatchExecutor callback, final List<ApplyPatchExecutor> executors,
                                           final ApplyPatchMode applyPatchMode,  final VirtualFile patchFile) {
        this(project, callback, executors, applyPatchMode, patchFile, null, null);
    }

    public ApplyPatchDifferentiatedDialog(final Project project, final ApplyPatchExecutor callback, final List<ApplyPatchExecutor> executors,
                                           final ApplyPatchMode applyPatchMode,  final List<TextFilePatch> patches,  final LocalChangeList defaultList) {
    ...
    private ApplyPatchDifferentiatedDialog(final Project project, final ApplyPatchExecutor callback, final List<ApplyPatchExecutor> executors,
                                            final ApplyPatchMode applyPatchMode,  final VirtualFile patchFile,  final List<TextFilePatch> patches,
                                            final LocalChangeList defaultList) {
        super(project, true);
        myCallback = callback;
    ...
    private class MapPopup extends BaseListPopupStep<VirtualFile> {
        ...
        private MapPopup(final  List<? extends VirtualFile> aValues, Runnable newBaseSelector) {
