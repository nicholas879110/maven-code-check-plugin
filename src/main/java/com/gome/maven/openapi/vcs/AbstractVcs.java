...
import com.gome.maven.openapi.diff.impl.patch.formove.FilePathComparator;
...
import com.gome.maven.openapi.vcs.annotate.VcsCacheableAnnotationProvider;
import com.gome.maven.openapi.vcs.changes.ChangeListEditHandler;
import com.gome.maven.openapi.vcs.changes.ChangeProvider;
import com.gome.maven.openapi.vcs.changes.CommitExecutor;
import com.gome.maven.openapi.vcs.changes.VcsModifiableDirtyScope;
import com.gome.maven.openapi.vcs.checkin.CheckinEnvironment;
import com.gome.maven.openapi.vcs.diff.DiffProvider;
import com.gome.maven.openapi.vcs.diff.RevisionSelector;
import com.gome.maven.openapi.vcs.history.VcsAnnotationCachedProxy;
import com.gome.maven.openapi.vcs.history.VcsHistoryProvider;
import com.gome.maven.openapi.vcs.history.VcsRevisionNumber;
import com.gome.maven.openapi.vcs.impl.IllegalStateProxy;
import com.gome.maven.openapi.vcs.merge.MergeProvider;
import com.gome.maven.openapi.vcs.rollback.RollbackEnvironment;
import com.gome.maven.openapi.vcs.update.UpdateEnvironment;
...
import com.gome.maven.util.ui.VcsSynchronousProgressWrapper;
...
public abstract class AbstractVcs<ComList extends CommittedChangeList> extends StartedActivated {
    ...
    public AbstractVcs( Project project, final String name) {
        super(project);
    ...
    // for tests only
    protected AbstractVcs( Project project, String name, VcsKey key) {
        super();
        myProject = project;
        myName = name;
        myKey = key;
...
//    @CalledInAwt
    ...
    public boolean allowsRemoteCalls( final VirtualFile file) {
        return true;
    }
     ...
     */
    public boolean revisionsSame( final VcsRevisionNumber number1,  final VcsRevisionNumber number2) {
