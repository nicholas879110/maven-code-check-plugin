...
import com.gome.maven.ui.SmartExpander;
...
public class ChangesListView extends Tree implements TypeSafeDataProvider, AdvancedDnDSource {
    ...
    private final CopyProvider myCopyProvider;
     ...
     private final ChangesBrowserNodeRenderer myNodeRenderer;
     private final ChangesBrowserNodeRenderer myShowFlattenNodeRenderer;
    ...
    private List<FilePath> getSelectedFilePaths( Object tag) {
