...
public interface EditChangelistSupport {
    ...
    ExtensionPointName<EditChangelistSupport> EP_NAME = ExtensionPointName.create("com.gome.maven.editChangelistSupport");

    void installSearch(EditorTextField name, EditorTextField comment);

    Consumer<LocalChangeList> addControls(JPanel bottomPanel,  LocalChangeList initial);
