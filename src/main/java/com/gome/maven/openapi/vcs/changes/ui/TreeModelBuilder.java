...
public class TreeModelBuilder {
    ...
    public DefaultTreeModel buildModelFromFiles( List<VirtualFile> files) {
    ...
    public DefaultTreeModel buildModel(final List<? extends ChangeList> changeLists,
                                       ...
                                       final MultiMap<String, VirtualFile> switchedFiles,
                                        Map<VirtualFile, String> switchedRoots,
  ...
  /*private void buildVirtualFiles(final Iterator<FilePath> iterator,  final Object tag) {
    ...
    private void buildVirtualFiles( List<VirtualFile> files,  final Object tag) {
        final ChangesBrowserNode baseNode = createNode(tag);
    ...
    private ChangesBrowserNode getParentNodeFor(final StaticFilePath nodePath,  ChangesGroupingPolicy policy, ChangesBrowserNode rootNode) {
        if (showFlatten) {
            return rootNode;
        }
