...
public class VcsHistoryCache {
    ...
    public <C extends Serializable, T extends VcsAbstractHistorySession> void put(final FilePath filePath,
                                                                                  ...
                                                                                  final VcsKey vcsKey,
                                                                                  final T session,
                                                                                   final VcsCacheableHistorySessionFactory<C, T> factory,
                                                                                  boolean isFull) {
        synchronized (myLock) {
    ...
    public void put( final FilePath filePath,  final VcsKey vcsKey,  final VcsRevisionNumber number,
    ...
    public VcsAnnotation get( final FilePath filePath,  final VcsKey vcsKey,  final VcsRevisionNumber number) {
        synchronized (myLock) {
