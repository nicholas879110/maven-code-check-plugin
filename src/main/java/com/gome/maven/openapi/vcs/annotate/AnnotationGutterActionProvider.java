 ...
 */
package com.gome.maven.openapi.vcs.annotate;
...
public interface AnnotationGutterActionProvider {
    ...
    ExtensionPointName<AnnotationGutterActionProvider> EP_NAME = ExtensionPointName.create("com.gome.maven.vcsAnnotationGutterActionProvider");
