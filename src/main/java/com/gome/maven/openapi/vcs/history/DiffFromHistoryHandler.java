...
public interface DiffFromHistoryHandler {
     ...
     * @param previousRevision the previous revision in the list displayed file history panel, may be {@link com.gome.maven.openapi.vcs.history.VcsFileRevision#NULL}.
     * @param revision         the revision selected in the file history panel.
     */
    void showDiffForOne( AnActionEvent e,
                         Project project,
                         FilePath filePath,
     ...
     */
    void showDiffForTwo( Project project,
                         FilePath filePath,
