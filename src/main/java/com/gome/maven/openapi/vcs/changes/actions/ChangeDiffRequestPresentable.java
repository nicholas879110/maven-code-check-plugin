...
import com.gome.maven.diff.FileAwareSimpleContent;
import com.gome.maven.openapi.actionSystem.AnAction;
import com.gome.maven.openapi.diagnostic.Logger;
import com.gome.maven.openapi.diff.DiffContent;
import com.gome.maven.openapi.diff.FileContent;
...
public class ChangeDiffRequestPresentable implements DiffRequestPresentable {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.actions.ChangeDiffRequestPresentable");
    ...
    private static boolean hasContents( final ContentRevision rev, final List<String> errSb) {
    ...
    private static boolean checkContentsAvailable( final ContentRevision bRev,  final ContentRevision aRev, final List<String> errSb) {
