...
public class ShowDiffAction extends AnAction implements DumbAware {
    ...
    public static void showDiffForChange(final Iterable<Change> changes, final Condition<Change> selectionChecker,
                                         final Project project,  ShowDiffUIContext context) {
        int newIndex = -1;
    ...
    public static void showDiffForChange(final Change[] changes, int index, final Project project,  ShowDiffUIContext context) {
    ...
    public static void showDiffImpl(final Project project,  List<DiffRequestPresentable> changeList, int index,
                                     final ShowDiffUIContext context) {
