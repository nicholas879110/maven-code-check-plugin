...
public class LocalChangeListImpl extends LocalChangeList {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.ChangeList");
    ...
    void setNameImpl( final String name) {
    ...
    Collection<Change> startProcessingChanges(final Project project,  final VcsDirtyScope scope) {
        createReadChangesCache();
    ...
    private static boolean isIgnoredRevision(final  ContentRevision revision, final  Project project) {
