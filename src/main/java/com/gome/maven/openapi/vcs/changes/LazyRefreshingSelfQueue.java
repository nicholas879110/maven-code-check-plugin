...
public class LazyRefreshingSelfQueue<T> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.LazyRefreshingSelfQueue");
    ...
    public void addRequest( final T t) {
        synchronized (myLock) {
    ...
    public void forceRemove( final T t) {
        synchronized (myLock) {
