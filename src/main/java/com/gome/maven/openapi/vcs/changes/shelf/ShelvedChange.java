...
import com.gome.maven.openapi.diff.impl.patch.ApplyPatchException;
...
public class ShelvedChange {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.shelf.ShelvedChange");
