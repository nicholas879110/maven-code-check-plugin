...
import com.gome.maven.vcsUtil.VcsRunnable;
...
public class DefaultPatchBaseVersionProvider {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.changes.patch.DefaultPatchBaseVersionProvider");
