...
public class MergeDialogCustomizer {
     ...
     */
    public  String getMergeWindowTitle(VirtualFile file) {
     ...
     */
    public  String getCenterPanelTitle(VirtualFile file) {
     ...
     * Don't mix with {@link #getMergeWindowTitle(com.gome.maven.openapi.vfs.VirtualFile)} which is the title of a 3-way merge dialog
