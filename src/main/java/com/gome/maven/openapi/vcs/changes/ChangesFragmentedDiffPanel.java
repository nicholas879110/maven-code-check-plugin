...
import com.gome.maven.openapi.diff.impl.DiffSideView;
import com.gome.maven.openapi.diff.impl.IgnoreSpaceEnum;
...
import com.gome.maven.openapi.diff.impl.highlighting.FragmentedDiffPanelState;
...
import com.gome.maven.openapi.editor.highlighter.FragmentedEditorHighlighter;
...
public class ChangesFragmentedDiffPanel implements Disposable {
    ...
    private static class PresentationState {
        ...
        private PresentationState( VcsConfiguration configuration, boolean currentHorizontal) {
  ...
  /*private class MyShowSettingsButton extends ActionButton implements DumbAware {
    ...
    MyShowSettingsButton(AnAction action, Presentation presentation, String place,  Dimension minimumSize) {
