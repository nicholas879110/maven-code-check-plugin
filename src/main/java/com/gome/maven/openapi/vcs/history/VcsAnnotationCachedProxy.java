...
import com.gome.maven.openapi.vcs.annotate.VcsAnnotation;
...
public class VcsAnnotationCachedProxy implements AnnotationProvider {
    ...
    private final static Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.history.VcsAnnotationCachedProxy");
    ...
    private VcsAbstractHistorySession getHistory(VcsRevisionNumber revision, FilePath filePath, VcsHistoryProvider historyProvider,
                                                  final VcsRevisionNumber firstRevision) throws VcsException {
    ...
    private VcsAbstractHistorySession limitedHistory(final FilePath filePath,  final VcsRevisionNumber firstNumber) throws VcsException {
