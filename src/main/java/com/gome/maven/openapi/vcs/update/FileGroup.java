...
public class FileGroup implements JDOMExternalizable {
    ...
    public void addError( final String path,  final String error) {
    ...
    public void add( String path,  String vcsName,  VcsRevisionNumber revision) {
        myFiles.add(new UpdatedFile(path, vcsName, revision == null ? "" : revision.asString()));
    }

    public void add( String path,  VcsKey vcsKey,  VcsRevisionNumber revision) {
    ...
    static class UpdatedFile {
        ...
        public UpdatedFile(final String path,  final VcsKey vcsKey, final String revision) {
            myPath = path;
            myVcsName = vcsKey.getName();
            myRevision = revision;
        }

        private UpdatedFile(final String path,  String vcsName, final String revision) {
            myPath = path;
            myVcsName = vcsName;
            myRevision = revision;
        }
