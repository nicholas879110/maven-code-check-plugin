...
import com.gome.maven.openapi.vcs.impl.UpToDateLineNumberProviderImpl;
import com.gome.maven.openapi.vcs.impl.VcsBackgroundableActions;
import com.gome.maven.openapi.vfs.VirtualFile;
import com.gome.maven.util.containers.SortedList;
...
public class AnnotateToggleAction extends ToggleAction implements DumbAware, AnnotationColors {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.actions.AnnotateToggleAction");
    ...
    private static boolean isAnnotated( Editor editor) {
    ...
    private static Couple<Map<VcsRevisionNumber, Color>> computeBgColors( FileAnnotation fileAnnotation) {
