...
import com.gome.maven.ide.actions.CloseTabToolbarAction;
import com.gome.maven.ide.errorTreeView.ErrorTreeElementKind;
import com.gome.maven.ide.errorTreeView.HotfixData;
import com.gome.maven.ide.errorTreeView.SimpleErrorData;
...
import com.gome.maven.openapi.vcs.actions.AnnotateToggleAction;
...
import com.gome.maven.openapi.vcs.changes.committed.*;
import com.gome.maven.openapi.vcs.changes.ui.*;
import com.gome.maven.openapi.vcs.history.*;
import com.gome.maven.openapi.vcs.merge.MergeDialogCustomizer;
import com.gome.maven.openapi.vcs.merge.MergeProvider;
import com.gome.maven.openapi.vcs.merge.MultipleFileMergeDialog;
...
import com.gome.maven.util.ui.ConfirmationDialog;
import com.gome.maven.util.ui.ErrorTreeView;
import com.gome.maven.util.ui.MessageCategory;
...
import static com.gome.maven.openapi.ui.Messages.getQuestionIcon;
import static com.gome.maven.util.ui.ConfirmationDialog.requestForConfirmation;
import static java.text.MessageFormat.format;

public class AbstractVcsHelperImpl extends AbstractVcsHelper {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.vcs.impl.AbstractVcsHelperImpl");
    ...
    @Override
    public boolean commitChanges( Collection<Change> changes,  LocalChangeList initialChangeList,
    ...
    private void showErrorsImpl(final boolean isEmpty, final Getter<VcsException> firstGetter,  final String tabDisplayName,
    ...
    @Override
    public void showErrors(final Map<HotfixData, List<VcsException>> exceptionGroups,  final String tabDisplayName) {
    ...
    private ChangesBrowserDialog createChangesBrowserDialog(CommittedChangesTableModel changelists,
                                                            ...
                                                            boolean showSearchAgain,
                                                             final Component parent, Consumer<ChangesBrowserDialog> initRunnable) {
    ...
    public void showWhatDiffersBrowser(final Component parent, final Collection<Change> changes,  final String title) {
    ...
    public List<VirtualFile> showMergeDialog(List<VirtualFile> files, MergeProvider provider,  MergeDialogCustomizer mergeDialogCustomizer) {
    ...
    private static class AsynchronousListsLoader extends Task.Backgroundable {
        ...
        private AsynchronousListsLoader( Project project, final CommittedChangesProvider provider,
