...
import com.gome.maven.ide.actions.CloseAction;
...
import com.gome.maven.openapi.ui.ThreeComponentsSplitter;
...
public class EditorWindow {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileEditor.impl.EditorWindow");
    ...
    public void setWaveColor(final int index,  final Color color) {
        if (myTabbedPane != null) {
    ...
    protected static class TComp extends JPanel implements DataProvider, EditorWindowHolder {
        ...
        TComp( EditorWindow window,  EditorWithProviderComposite editor) {
    ...
    public void setEditor( final EditorWithProviderComposite editor, final boolean selectEditor, final boolean focusEditor) {
        if (editor != null) {
    ...
    public EditorWindow split(final int orientation, boolean forceSplit,  VirtualFile virtualFile, boolean focusNew) {
        checkConsistency();
     ...
     */
    private void syncCaretIfPossible( FileEditor[] toSync) {
        if (toSync == null) {
            return;
        }
