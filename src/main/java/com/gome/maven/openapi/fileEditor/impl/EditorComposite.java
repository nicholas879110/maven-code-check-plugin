...
import com.gome.maven.openapi.util.NullUtils;
import com.gome.maven.openapi.util.Pair;
import com.gome.maven.openapi.vfs.VirtualFile;
import com.gome.maven.openapi.wm.FocusWatcher;
import com.gome.maven.ui.JBColor;
import com.gome.maven.ui.PrevNextActionsDescriptor;
...
public abstract class EditorComposite implements Disposable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileEditor.impl.EditorComposite");
     ...
     */
    EditorComposite( final VirtualFile file,
    ...
    private class MyComponent extends JPanel implements DataProvider{
        ...
        public MyComponent( JComponent realComponent,  JComponent focusComponent){
