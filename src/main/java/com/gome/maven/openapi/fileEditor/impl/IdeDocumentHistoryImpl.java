...
import com.gome.maven.openapi.command.impl.CommandMerger;
...
public class IdeDocumentHistoryImpl extends IdeDocumentHistory implements ProjectComponent, PersistentStateComponent<IdeDocumentHistoryImpl.RecentlyChangedFilesState> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileEditor.impl.IdeDocumentHistoryImpl");
    ...
    private static void clearPlaceList( List<PlaceInfo> list) {
        list.clear();
    }
    ...
    private static final class PlaceInfo {
        ...
        public PlaceInfo( VirtualFile file,  FileEditorState navigationState,  String editorTypeId,  EditorWindow window) {
