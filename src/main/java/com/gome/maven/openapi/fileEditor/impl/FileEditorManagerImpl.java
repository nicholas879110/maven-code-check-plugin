...
import com.gome.maven.openapi.project.PossiblyDumbAware;
...
import com.gome.maven.ui.docking.impl.DockManagerImpl;
...
import com.gome.maven.util.messages.impl.MessageListenerList;
...
public class FileEditorManagerImpl extends FileEditorManagerEx implements ProjectComponent, JDOMExternalizable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileEditor.impl.FileEditorManagerImpl");
...
/*    ApplicationManager.getApplication().assertIsDispatchThread(); */
    ...
    public boolean isProblem( final VirtualFile file) {
        return false;
    }
     ...
     */
    void updateFileName( final VirtualFile file) {
    ...
    @Override
    public void createSplitter(final int orientation,  final EditorWindow window) {
    ...
    */
    ...
    public void closeFile( final VirtualFile file,  final EditorWindow window, final boolean transferFocus) {
    ...
    public void closeFile( final VirtualFile file, final boolean moveFocus, final boolean closeAllCopies) {
        assertDispatchThread();
    ...
    private void closeFileImpl( final VirtualFile file, final boolean moveFocus, boolean closeAllCopies) {
        assertDispatchThread();
    ...
    public Pair<FileEditor[], FileEditorProvider[]> openFileWithProviders( final VirtualFile file,
                                                                          boolean focusEditor,
    ...
    Pair<FileEditor[], FileEditorProvider[]> openFileImpl4( final EditorWindow window,
                                                            final VirtualFile file,
                                                            final HistoryEntry entry,
...
// Restore myEditor state
    ...
    public List<FileEditor> openEditor( final OpenFileDescriptor descriptor, final boolean focusEditor) {
        assertDispatchThread();
    ...
    protected Editor getOpenedEditor( Editor editor, final boolean focusEditor) {
        return editor;
    }
    ...
    private EditorWithProviderComposite getCurrentEditorWithProviderComposite( final VirtualFile virtualFile) {
    ...
    private List<EditorWithProviderComposite> getEditorComposites( VirtualFile file) {
    ...
    @Override
    public void addTopComponent( final FileEditor editor,  final JComponent component) {
        final EditorComposite composite = getEditorComposite(editor);
        if (composite != null) {
    ...
    @Override
    public void removeTopComponent( final FileEditor editor,  final JComponent component) {
        final EditorComposite composite = getEditorComposite(editor);
        if (composite != null) {
    ...
    public List<JComponent> getBottomComponents( FileEditor editor) {
        final EditorComposite composite = getEditorComposite(editor);
        return composite != null ? composite.getBottomComponents(editor) : Collections.<JComponent>emptyList();
    }

    @Override
    public void addBottomComponent( final FileEditor editor,  final JComponent component) {
        final EditorComposite composite = getEditorComposite(editor);
        if (composite != null) {
    ...
    @Override
    public void removeBottomComponent( final FileEditor editor,  final JComponent component) {
        final EditorComposite composite = getEditorComposite(editor);
        if (composite != null) {
    ...
    @Override
    public void addFileEditorManagerListener( final FileEditorManagerListener listener,  final Disposable parentDisposable) {
...
//======================= Misc =====================
    ...
    private static Trinity<VirtualFile, FileEditor, FileEditorProvider> extract( EditorComposite composite) {
        final VirtualFile file;
        final FileEditor editor;
