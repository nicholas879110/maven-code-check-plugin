...
import com.gome.maven.openapi.vcs.readOnlyHandler.FileListRenderer;
import com.gome.maven.openapi.vfs.VirtualFile;
import com.gome.maven.ui.CollectionListModel;
...
public class NonProjectFileWritingAccessDialog extends DialogWrapper {
    ...
    protected NonProjectFileWritingAccessDialog( Project project,  List<VirtualFile> nonProjectFiles) {
        super(project);
