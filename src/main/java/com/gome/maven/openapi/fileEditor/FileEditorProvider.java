...
public interface FileEditorProvider {
    ExtensionPointName<FileEditorProvider> EP_FILE_EDITOR_PROVIDER = new ExtensionPointName<FileEditorProvider>("com.gome.maven.fileEditorProvider");
    Key<FileEditorProvider> KEY = Key.create("com.gome.maven.fileEditorProvider");
