...
import com.gome.maven.ui.components.JBLoadingPanel;
...
class TextEditorComponent extends JBLoadingPanel implements DataProvider {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.fileEditor.impl.text.TextEditorComponent");
