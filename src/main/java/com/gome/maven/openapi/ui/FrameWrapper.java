...
import com.gome.maven.openapi.actionSystem.CommonShortcuts;
...
import com.gome.maven.openapi.wm.impl.IdeMenuBar;
...
public class FrameWrapper implements Disposable, DataProvider {
    ...
    public FrameWrapper(Project project,   String dimensionServiceKey) {
        this(project, dimensionServiceKey, false);
    }

    public FrameWrapper(Project project,   String dimensionServiceKey, boolean isDialog) {
