...
public class GlassPaneDialogWrapperPeer extends DialogWrapperPeer implements FocusTrackbackProvider {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.ui.impl.GlassPaneDialogWrapperPeer");
    ...
    public GlassPaneDialogWrapperPeer(DialogWrapper wrapper,  Component parent, boolean canBeParent)
...
//      myProject = new WeakReference<Project>(project);
        ...
        private Point getLocationInCenter(Dimension size,  Point _default) {
