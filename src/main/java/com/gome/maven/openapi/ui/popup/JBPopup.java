...
public interface JBPopup extends Disposable, LightweightWindow {
     ...
     * @see com.gome.maven.openapi.ui.popup.JBPopupFactory#guessBestPopupLocation(com.gome.maven.openapi.actionSystem.DataContext)
     */
     ...
     * @see com.gome.maven.openapi.ui.popup.JBPopupFactory#guessBestPopupLocation(com.gome.maven.openapi.editor.Editor)
     */
     ...
     * @see com.gome.maven.openapi.ui.popup.ComponentPopupBuilder#setCancelCallback(com.gome.maven.openapi.util.Computable)
     */
    boolean canClose();
    ...
    void setFinalRunnable( Runnable runnable);
