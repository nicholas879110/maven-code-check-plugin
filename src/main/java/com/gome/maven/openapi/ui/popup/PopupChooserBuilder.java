...
import com.gome.maven.ui.components.JBViewport;
import com.gome.maven.ui.speedSearch.ListWithFilter;
import com.gome.maven.ui.treeStructure.treetable.TreeTable;
...
public class PopupChooserBuilder {
    ...
    public PopupChooserBuilder setTitle(  String title) {
        myTitle = title;
        return this;
    }

    
    public PopupChooserBuilder addAdditionalChooseKeystroke( KeyStroke keyStroke) {
        if (keyStroke != null) {
    ...
    public PopupChooserBuilder setItemChoosenCallback( Runnable runnable) {
        myItemChosenRunnable = runnable;
        return this;
    }

    
    public PopupChooserBuilder setSouthComponent( JComponent cmp) {
        mySouthComponent = cmp;
        return this;
    }

    
    public PopupChooserBuilder setCouldPin( Processor<JBPopup> callback){
        myCouldPin = callback;
        return this;
    }

    
    public PopupChooserBuilder setEastComponent( JComponent cmp) {
        myEastComponent = cmp;
        return this;
    }
    ...
    public PopupChooserBuilder setCommandButton( ActiveComponent commandButton) {
    ...
    public PopupChooserBuilder setFocusOwners( Component[] focusOwners) {
