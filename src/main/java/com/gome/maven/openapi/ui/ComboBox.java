...
public class ComboBox extends ComboBoxWithWidePopup implements AWTEventListener {
    ...
    public static void registerTableCellEditor( JComboBox comboBox,  TableCellEditor cellEditor) {
        comboBox.putClientProperty(TABLE_CELL_EDITOR_PROPERTY, cellEditor);
        comboBox.putClientProperty("JComboBox.isTableCellEditor", Boolean.TRUE);
    }

    public void registerTableCellEditor( TableCellEditor cellEditor) {
