...
import com.gome.maven.openapi.MnemonicHelper;
...
public abstract class DialogWrapper {
    ...
    protected DialogWrapper( Project project, boolean canBeParent,  IdeModalityType ideModalityType) {
    ...
    protected DialogWrapperPeer createPeer( Component parent, final boolean canBeParent) {
    ...
    protected DialogWrapperPeer createPeer( final Project project,
    ...
    private class ErrorPainter extends AbstractPainter {
        ...
        private void setValidationInfo( ValidationInfo info) {
            myInfo = info;
        }
    }
