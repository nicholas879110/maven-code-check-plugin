 ...
 */
package com.gome.maven.openapi.ui.impl;

import com.gome.maven.ide.DataManager;
import com.gome.maven.ide.IdeEventQueue;
import com.gome.maven.ide.impl.TypeSafeDataProviderAdapter;
...
import com.gome.maven.util.IJSwingUtilities;
...
public class DialogWrapperPeerImpl extends DialogWrapperPeer implements FocusTrackbackProvider {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.ui.DialogWrapper");
    ...
    public DialogWrapperPeerImpl( final DialogWrapper wrapper,final Window owner, final boolean canBeParent,
     ...
     */
    @Deprecated
    public DialogWrapperPeerImpl( DialogWrapper wrapper, final boolean canBeParent, final boolean applicationModalIfPossible) {
        this(wrapper, null, canBeParent, applicationModalIfPossible);
    }

    @Deprecated
    public DialogWrapperPeerImpl( DialogWrapper wrapper,final Window owner, final boolean canBeParent, final boolean applicationModalIfPossible) {
    ...
    private void createDialog( Window owner, boolean canBeParent,  DialogWrapper.IdeModalityType ideModalityType) {
        if (isHeadless()) {
    ...
    private static class MyDialog extends JDialog implements DialogWrapperDialog, DataProvider, FocusTrackback.Provider, Queryable, AbstractDialog {
        ...
        private void _setSizeForLocation(int width, int height,  Point initial) {
...
//                        }
        ...
        private void disposeFocusTrackbackIfNoChildWindowFocused( IdeFocusManager focusManager) {
