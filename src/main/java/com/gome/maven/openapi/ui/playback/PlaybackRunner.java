 ...
 */
package com.gome.maven.openapi.ui.playback;
...
import com.gome.maven.openapi.ui.playback.commands.*;
...
public class PlaybackRunner {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ui.debugger.extensions.PlaybackRunner");
    ...
    public interface StatusCallback {
        ...
        void message( PlaybackContext context, String text, Type type);
        ...
        abstract class Edt implements StatusCallback {
            ...
            public abstract void messageEdt( PlaybackContext context, String text, Type type);
        }
    }
}
