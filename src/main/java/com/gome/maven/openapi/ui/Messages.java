...
import com.gome.maven.ui.InsertPathAction;
...
//import com.gome.maven.ui.mac.foundation.MacUtil;
...
public class Messages {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.openapi.ui.Messages");
...
//        catch (Exception reportThis) {LOG.error(reportThis);}
     ...
     * @return number of button pressed: from 0 up to options.length-1 inclusive, or -1 for Cancel
     */
    public static int showIdeaMessageDialog( Project project,
                                            String message,
                                             String title,
                                             String[] options,
                                            int defaultOptionIndex,
...
//    @MagicConstant(intValues = {YES, NO})
     ...
     */
    @YesNoResult
    public static int showYesNoDialog( Project project, String message,   String title,  String yesText,  String noText,  Icon icon) {
//        try {
//            if (canShowMacSheetPanel()) {
//                return MacMessages.getInstance()
...
//        catch (Exception reportThis) {LOG.error(reportThis);}
     ...
     */
    @YesNoResult
    public static int showYesNoDialog(String message,  String title,  String yesText,  String noText,  Icon icon,
                                       DialogWrapper.DoNotAskOption doNotAskOption) {
//        try {
//            if (canShowMacSheetPanel()) {
...
//        catch (Exception reportThis) {LOG.error(reportThis);}
     ...
     */
    @OkCancelResult
    public static int showOkCancelDialog(String message,  String title,  String okText,  String cancelText, Icon icon,  DialogWrapper.DoNotAskOption doNotAskOption) {
//        try {
//            if (canShowMacSheetPanel()) {
...
//        catch (Exception reportThis) {LOG.error(reportThis);}
    ...
    public static int showCheckboxMessageDialog(String message, String title,  String[] options, String checkboxText, final boolean checked,
                                                final int defaultOptionIndex, final int focusedOptionIndex, Icon icon,
                                                 final PairFunction<Integer, JCheckBox, Integer> exitFunc) {
        if (isApplicationInUnitTestOrHeadless()) {
            return ourTestImplementation.show(message);
        }
        else {
...
//        catch (Exception reportThis) {LOG.error(reportThis);}
    ...
    public static String showPasswordDialog(Project project,  String message, String title,  Icon icon) {
...
//        catch (Exception reportThis) {LOG.error(reportThis);}
    ...
    public static void showTextAreaDialog(final JTextField textField, final String title,  final String dimensionServiceKey) {
    ...
    private static class MessageDialog extends DialogWrapper {
        ...
        public MessageDialog( Project project, String message, String title,  String[] options, int defaultOptionIndex,  Icon icon, boolean canBeParent) {
        ...
        public MessageDialog( Component parent, String message, String title,  String[] options, int defaultOptionIndex,  Icon icon, boolean canBeParent) {
        ...
        public MessageDialog(String message, String title,  String[] options, int defaultOptionIndex,  Icon icon, boolean canBeParent) {
            super(canBeParent);
...
//            }
    ...
    protected static class TwoStepConfirmationDialog extends MessageDialog {
        ...
        public TwoStepConfirmationDialog(String message, String title,  String[] options, String checkboxText, boolean checked, final int defaultOptionIndexed,
                                         final int focusedOptionIndex, Icon icon,  final PairFunction<Integer, JCheckBox, Integer> exitFunc) {
