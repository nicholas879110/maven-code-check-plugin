...
import com.gome.maven.util.containers.Enumerator;
 ...
 */
public class Diff {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.diff.Diff");

    
    public static Change buildChanges( CharSequence before,  CharSequence after) throws FilesTooBigForDiffException {
     ...
     */
    public static int translateLine( CharSequence before,  CharSequence after, int line) throws FilesTooBigForDiffException {
    ...
    public static int translateLine( Change change, int line, boolean approximate) {
        int result = line;
