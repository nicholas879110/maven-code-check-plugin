...
abstract class AbstractCollectionBinding extends Binding implements MultiNodeBinding, MainBinding {
    ...
    public AbstractCollectionBinding( Class elementType,  MutableAccessor accessor) {
        super(accessor);
    ...
    private Object serializeItem( Object value, Object context,  SerializationFilter filter) {
        if (value == null) {
    ...
    protected abstract String getCollectionTagName( Object target);
}
