...
import com.gome.maven.util.xmlb.annotations.*;
...
class BeanBinding extends Binding implements MainBinding {
    ...
    public BeanBinding( Class<?> beanClass,  MutableAccessor accessor) {
        super(accessor);
    ...
    public Element serializeInto( Object o,  Element element,  SerializationFilter filter) {
    ...
    boolean equalByFields( Object currentValue,  Object defaultValue,  SkipDefaultsSerializationFilter filter) {
        for (Binding binding : myBindings) {
            Accessor accessor = binding.getAccessor();
    ...
    public TObjectFloatHashMap<String> computeBindingWeights( LinkedHashSet<String> accessorNameTracker) {
    ...
    public void sortBindings( final TObjectFloatHashMap<String> weights) {
    ...
    public void deserializeInto( Object result,  Element element,  Set<String> accessorNameTracker) {
        nextAttribute:
    ...
    static List<MutableAccessor> getAccessors( Class<?> aClass) {
            ...
            for (Field field : currentClass.getDeclaredFields()) {
                ...
                if (!Modifier.isStatic(modifiers) &&
                        (field.getAnnotation(OptionTag.class) != null ||
                                ...
                                field.getAnnotation(com.gome.maven.util.xmlb.annotations.Attribute.class) != null ||
    ...
    private static Binding createBinding( MutableAccessor accessor) {
        ...
        com.gome.maven.util.xmlb.annotations.Attribute attribute = accessor.getAnnotation(com.gome.maven.util.xmlb.annotations.Attribute.class);
        if (attribute != null) {
