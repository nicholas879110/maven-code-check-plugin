...
public class FileContentUtil extends FileContentUtilCore {
     ...
     */
    public static void setFileText( Project project, final VirtualFile virtualFile, final String text) throws IOException {
        if (project == null) {
    ...
    public static void reparseFiles( final Project project,  final Collection<VirtualFile> files, final boolean includeOpenFiles) {
