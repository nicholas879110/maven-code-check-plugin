...
import com.gome.maven.psi.search.ProjectAndLibrariesScope;
import com.gome.maven.psi.search.ProjectScopeImpl;
...
public final class MapIndexStorage<Key, Value> implements IndexStorage<Key, Value>{
    ...
    public MapIndexStorage( File storageFile,
    ...
    private File getSavedProjectFileValueIds(int id,  GlobalSearchScope scope) {
