...
import com.gome.maven.openapi.vfs.newvfs.persistent.ContentHashesUtil;
...
class ContentHashesSupport {
    ...
    static int calcContentHashIdWithFileType( byte[] bytes,  Charset charset,  FileType fileType) throws IOException {
    ...
    static byte[] calcContentHashWithFileType( byte[] bytes,  Charset charset,  FileType fileType) throws IOException {
