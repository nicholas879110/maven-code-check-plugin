...
import com.gome.maven.ide.util.DelegatingProgressIndicator;
...
import com.gome.maven.openapi.editor.impl.EditorHighlighterCache;
...
import com.gome.maven.openapi.progress.impl.BackgroundableProcessIndicator;
...
import com.gome.maven.openapi.vfs.newvfs.persistent.FlushingDaemon;
...
import com.gome.maven.psi.impl.PsiTreeChangePreprocessor;
...
public class FileBasedIndexImpl extends FileBasedIndex {
     ...
     */
    private <K, V> boolean registerIndexer( final FileBasedIndexExtension<K, V> extension) throws IOException {
    ...
    private <K, V> void initIndexStorage( FileBasedIndexExtension<K, V> extension, int version,  File versionFile)
            throws IOException {
    ...
    private <K, V> UpdatableIndex<K, V, FileContent> createIndex( final ID<K, V> indexId,
                                                                  final FileBasedIndexExtension<K, V> extension,
                                                                  final MemoryIndexStorage<K, V> storage)
    ...
    public static <K> PersistentHashMap<Integer, Collection<K>> createIdToDataKeysIndex( FileBasedIndexExtension <K, ?> extension,
                                                                                         MemoryIndexStorage<K, ?> storage)
            throws IOException {
    ...
    public <K> Collection<K> getAllKeys( final ID<K, ?> indexId,  Project project) {
    ...
    @Override
    public <K> boolean processAllKeys( final ID<K, ?> indexId,  Processor<K> processor,  Project project) {
     ...
     */
    @Override
    public <K> void ensureUpToDate( final ID<K, ?> indexId,  Project project,  GlobalSearchScope filter) {
        ensureUpToDate(indexId, project, filter, null);
    }

    protected <K> void ensureUpToDate( final ID<K, ?> indexId,
                                       Project project,
    ...
    private static void handleDumbMode( Project project) {
    ...
    public <K, V> List<V> getValues( final ID<K, V> indexId,  K dataKey,  final GlobalSearchScope filter) {
    ...
    public <K, V> Collection<VirtualFile> getContainingFiles( final ID<K, V> indexId,
                                                              K dataKey,
    ...
    @Override
    public <K, V> boolean processValues( final ID<K, V> indexId,  final K dataKey,  final VirtualFile inFile,
                                         ValueProcessor<V> processor,  final GlobalSearchScope filter) {
    ...
    private <K, V, R> R processExceptions( final ID<K, V> indexId,
                                           final VirtualFile restrictToFile,
                                           final GlobalSearchScope filter,
    ...
    private <K, V> boolean processValuesImpl( final ID<K, V> indexId,  final K dataKey, final boolean ensureValueProcessedOnce,
                                              final VirtualFile restrictToFile,  final ValueProcessor<V> processor,
                                              final GlobalSearchScope scope,  final IdFilter idFilter) {
    ...
    public static final class ProjectIndexableFilesFilter extends IdFilter {
        ...
        private ProjectIndexableFilesFilter( TIntArrayList set, int modificationCount) {
    ...
    public ProjectIndexableFilesFilter projectIndexableFiles( Project project) {
        ...
        ProjectIndexableFilesFilter data = com.gome.maven.reference.SoftReference.dereference(reference);
        ...
        if (myCalcIndexableFilesLock.tryLock()) { // make best effort for calculating filter
            try {
                ...
                data = com.gome.maven.reference.SoftReference.dereference(reference);
    ...
    private <K, V> TIntHashSet collectFileIdsContainingAllKeys( final ID<K, V> indexId,
                                                                final Collection<K> dataKeys,
                                                                final GlobalSearchScope filter,
                                                                final Condition<V> valueChecker,
                                                                final ProjectIndexableFilesFilter projectFilesFilter) {
    ...
    private static boolean processVirtualFiles( TIntHashSet ids,
                                                final GlobalSearchScope filter,
                                                final Processor<VirtualFile> processor) {
        final PersistentFS fs = (PersistentFS)ManagingFS.getInstance();
    ...
    @Override
    public <K, V> boolean getFilesWithKey( final ID<K, V> indexId,
                                           final Set<K> dataKeys,
    ...
    private void indexUnsavedDocuments( ID<?, ?> indexId,
                                        Project project,
                                       GlobalSearchScope filter,
    ...
    private boolean indexUnsavedDocument( final Document document,  final ID<?, ?> requestedIndexId, final Project project,
                                          GlobalSearchScope filter,  VirtualFile restrictedFile) {
        ...
        if (currentDocStamp != previousDocStamp) {
            ...
            try {
                if (!isTooLarge(vFile, contentText.length()) &&
                    ...
                    FileContentImpl previousContent = com.gome.maven.reference.SoftReference.dereference(previousContentRef);
    ...
    void processRefreshedFile( Project project,  final com.gome.maven.ide.caches.FileContent fileContent) {
        myChangedFilesCollector.tryToEnsureAllInvalidateTasksCompleted();
    ...
    public void indexFileContent( Project project,  com.gome.maven.ide.caches.FileContent content) {
    ...
    private void doIndexFileContent( Project project,  com.gome.maven.ide.caches.FileContent content) {
        myChangedFilesCollector.tryToEnsureAllInvalidateTasksCompleted();
    ...
    private void updateSingleIndex( ID<?, ?> indexId,  final VirtualFile file,  FileContent currentFC)
    ...
    private final class ChangedFilesCollector extends VirtualFileAdapter implements BulkFileListener {
        ...
        private void invalidateIndices( final VirtualFile file, final boolean markForReindex) {
        ...
        private void forceUpdate( Project project,  GlobalSearchScope filter,  VirtualFile restrictedTo) {
            myChangedFilesCollector.tryToEnsureAllInvalidateTasksCompleted();
                    ...
                    for (VirtualFile file : getAllFilesToUpdate()) {
                        ...
                        if (filter == null || filter.accept(file) || Comparing.equal(file, restrictedTo)) {
                            try {
                                ...
                                processFileImpl(project, new com.gome.maven.ide.caches.FileContent(file));
                            }
                            catch (ProcessCanceledException e) {
        ...
        private void processFileImpl(Project project,  final com.gome.maven.ide.caches.FileContent fileContent) {
    ...
    private boolean clearUpToDateStateForPsiIndicesOfUnsavedDocuments( VirtualFile file) {
    ...
    public CollectingContentIterator createContentIterator( ProgressIndicator indicator) {
    ...
    private static void iterateRecursively( final VirtualFile root,
                                            final ContentIterator processor,
                                            final ProgressIndicator indicator,
                                            final Set<VirtualFile> visitedRoots,
