...
public class IndexingStamp {
    ...
    public static boolean versionDiffers( File versionFile, final int currentIndexVersion) {
        try {
    ...
    private static long getIndexCreationStamp( ID<?, ?> indexName) {
    ...
    private static class Timestamps {
        ...
        private Timestamps( DataInputStream stream) throws IOException {
            if (stream != null) {
                try {
    ...
    public static void update(int fileId,  ID<?, ?> indexName, final long indexCreationStamp) {
    ...
    public static void flushCache( Integer finishedFile) {
    ...
    public static void flushCache( VirtualFile finishedVirtualFile) {
