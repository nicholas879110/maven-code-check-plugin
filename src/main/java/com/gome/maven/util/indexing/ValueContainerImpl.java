...
import com.gome.maven.openapi.util.ThreadLocalCachedIntArray;
import com.gome.maven.util.SmartList;
import com.gome.maven.util.containers.EmptyIterator;
import com.gome.maven.util.indexing.containers.ChangeBufferingList;
import com.gome.maven.util.indexing.containers.IdSet;
...
class ValueContainerImpl<Value> extends UpdatableValueContainer<Value> implements Cloneable{
    ...
    private static  IntPredicate getPredicateOutOfFileSetObject( Object input) {
    ...
    private static  IntIterator getIntIteratorOutOfFileSetObject( Object input) {
