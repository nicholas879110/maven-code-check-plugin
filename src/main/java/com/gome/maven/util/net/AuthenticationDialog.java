...
public class AuthenticationDialog extends DialogWrapper {
    ...
    public AuthenticationDialog( Component component, String title, String description, final String login, final String password, final boolean rememberPassword) {
