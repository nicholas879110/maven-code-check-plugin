...
public class ConfirmingTrustManager extends ClientOnlyTrustManager {
    ...
    public static ConfirmingTrustManager createForStorage( String path,  String password) {
     ...
     *
     * @see com.gome.maven.util.net.ssl.CertificateListener
     */
    public static class MutableTrustManager extends ClientOnlyTrustManager {
        ...
        private MutableTrustManager( String path,  String password) {
            myPath = path;
            myPassword = password;
            // initialization step
            myWriteLock.lock();
