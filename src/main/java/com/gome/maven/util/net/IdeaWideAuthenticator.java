...
import com.gome.maven.util.proxy.NonStaticAuthenticator;

import java.net.Authenticator;
import java.net.PasswordAuthentication;

public class IdeaWideAuthenticator extends NonStaticAuthenticator {
    private final static Logger LOG = Logger.getInstance("#com.gome.maven.util.net.IdeaWideAuthenticator");
