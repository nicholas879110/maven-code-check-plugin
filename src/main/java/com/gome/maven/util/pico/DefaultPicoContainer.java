 ...
 */
package com.gome.maven.util.pico;

import com.gome.maven.openapi.extensions.AreaPicoContainer;
...
//        if (adapter==null){
//            System.out.println("can not find ComponentAdapter:"+componentKey);
//        }
