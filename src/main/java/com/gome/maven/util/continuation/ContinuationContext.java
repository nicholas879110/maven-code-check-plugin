...
public interface ContinuationContext extends ContinuationPause {
    ...
    void after( TaskDescriptor inQueue, TaskDescriptor... next);
    ...
    void removeNewTasksPatcher( final Consumer<TaskDescriptor> consumer);
    void addNewTasksPatcher( final Consumer<TaskDescriptor> consumer);
}
