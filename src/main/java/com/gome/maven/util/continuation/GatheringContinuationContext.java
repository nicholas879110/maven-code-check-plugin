...
public class GatheringContinuationContext implements ContinuationContext {
    ...
    @Override
    public void after( TaskDescriptor inQueue, TaskDescriptor... next) {
        int idx = -1;
    ...
    @Override
    public void addNewTasksPatcher( Consumer<TaskDescriptor> consumer) {
    }

    @Override
    public void removeNewTasksPatcher( Consumer<TaskDescriptor> consumer) {
    }
}
