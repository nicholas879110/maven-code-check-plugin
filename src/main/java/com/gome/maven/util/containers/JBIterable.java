...
public abstract class JBIterable<E> implements Iterable<E> {
    ...
    JBIterable( Iterable<E> iterable) {
        myIterable = iterable;
    }
    ...
    public static <E> JBIterable<E> generate( final E first,  final Function<? super E, ? extends E> generator) {
    ...
    public static <E> JBIterable<E> generate( final E first1,  final E first2,  final PairFunction<? super E, ? super E, ? extends E> generator) {
    ...
    public final <T> JBIterable<E> append( Iterable<T> other,  Function<? super T, ? extends Iterable<? extends E>> fun) {
    ...
    public final <T> JBIterable<T> transform( final Function<? super E, T> function) {
    ...
    public final <T, X extends Iterator<E>> JBIterable<T> intercept( final Function<X, ? extends Iterator<T>> function) {
