...
import com.gome.maven.util.Functions;
...
public abstract class JBIterator<E> implements Iterator<E> {
    ...
    public final <T> JBIterator<T> transform( Function<? super E, T> function) {
    ...
    public final JBIterator<E> skipWhile( final Condition<? super E> condition) {
        return addOp(new Op<Condition<? super E>>(condition) {
