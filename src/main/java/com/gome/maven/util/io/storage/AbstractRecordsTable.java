...
import com.gome.maven.util.io.RandomAccessDataFile;
...
public abstract class AbstractRecordsTable implements Disposable, Forceable {
    private static final Logger LOG = Logger.getInstance("com.gome.maven.util.io.storage.AbstractRecordsTable");
