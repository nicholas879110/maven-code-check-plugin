...
import com.gome.maven.util.io.PagePool;
import com.gome.maven.util.io.RecordDataOutput;
import com.gome.maven.util.io.UnsyncByteArrayInputStream;
...
public abstract class AbstractStorage implements Disposable, Forceable {
    protected static final Logger LOG = Logger.getInstance("#com.gome.maven.util.io.storage.Storage");
