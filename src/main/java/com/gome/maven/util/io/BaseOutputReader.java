...
public abstract class BaseOutputReader extends BaseDataReader {
    ...
    public BaseOutputReader( InputStream inputStream,  Charset charset,  SleepingPolicy sleepingPolicy) {
    ...
    public BaseOutputReader( Reader reader, SleepingPolicy sleepingPolicy) {
    ...
    private static Reader createInputStreamReader(final  InputStream streamToRead,  Charset charset) {
        if (charset == null) {
