...
public class MappedFileInputStream extends InputStream {
    ...
    public MappedFileInputStream( ResizeableMappedFile raf, final long pos, final long limit) {
        this.raf = raf;
        setup(pos, limit);
    }

    public MappedFileInputStream( ResizeableMappedFile raf, final long pos) throws IOException {
