...
public class ZipUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.io.ZipUtil");
    ...
    public static boolean addFileToZip( ZipOutputStream zos,
                                        ...
                                        FileContentProcessor contentProcessor) throws IOException {
    ...
    public static boolean addFileOrDirRecursively( ZipOutputStream jarOutputStream,
                                                   File jarFile,
                                                   File file,
                                                   String relativePath,
                                                   FileFilter fileFilter,
