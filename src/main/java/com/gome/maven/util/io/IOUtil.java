...
public class IOUtil {
    ...
    public static void writeUTF( DataOutput storage,  final String value) throws IOException {
    ...
    public static void writeUTFFast( byte[] buffer,  DataOutput storage,  final String value) throws IOException {
    ...
    public static <T> T openCleanOrResetBroken( ThrowableComputable<T, IOException> factoryComputable, final File file) throws IOException {
    ...
    public static <T> T openCleanOrResetBroken( ThrowableComputable<T, IOException> factoryComputable, Runnable cleanupCallback) throws IOException {
        for(int i = 0; i < 2; ++i) {
            try {
