...
import com.gome.maven.util.containers.ShareableKey;
...
public abstract class PersistentEnumeratorBase<Data> implements Forceable, Closeable {
    protected static final Logger LOG = Logger.getInstance("#com.gome.maven.util.io.PersistentEnumerator");
    ...
    public boolean processAllDataObject(final Processor<Data> processor,  final DataFilter filter) throws IOException {
    ...
    public Collection<Data> getAllDataObjects( final DataFilter filter) throws IOException {
