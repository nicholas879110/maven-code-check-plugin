...
public class PersistentEnumeratorDelegate<Data> implements Closeable, Forceable {
    ...
    public PersistentEnumeratorDelegate( final File file,
    ...
    public Collection<Data> getAllDataObjects( final PersistentEnumeratorBase.DataFilter filter) throws IOException {
