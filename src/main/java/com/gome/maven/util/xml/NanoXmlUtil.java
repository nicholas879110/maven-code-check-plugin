...
public class NanoXmlUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.xml.NanoXmlUtil");
    ...
    public static void parse(final Reader reader, final IXMLBuilder builder,  final IXMLValidator validator) {
        try {
    ...
    public static void parse(final IXMLReader r, final IXMLBuilder builder,  final IXMLValidator validator) {
        try {
