...
import com.gome.maven.util.xml.reflect.*;
...
public class DomUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.xml.DomUtil");
    ...
    public static <T> T getContextElement( final Editor editor, Class<T> clazz) {
        final DomElement element = getContextElement(editor);
        return getParentOfType(element, clazz, false);
    }

    
    public static DomElement getContextElement( final Editor editor) {
    ...
    public static DomElement getDomElement( final PsiElement element) {
    ...
    public static <T extends DomElement> T findDomElement( final PsiElement element, final Class<T> beanClass) {
        return findDomElement(element, beanClass, true);
    }

    
    public static <T extends DomElement> T findDomElement( final PsiElement element, final Class<T> beanClass, boolean strict) {
        if (element == null) return null;
