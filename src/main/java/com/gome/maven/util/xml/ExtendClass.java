...
/**
 * Annotates DOM methods that return either {@link com.gome.maven.psi.PsiClass} or
 * {@link com.gome.maven.util.xml.GenericDomValue}<{@link com.gome.maven.psi.PsiClass}>.
 ...
 *
 * @see com.gome.maven.util.xml.ClassTemplate
