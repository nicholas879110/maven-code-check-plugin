...
import com.gome.maven.ui.UserActivityWatcher;
...
import com.gome.maven.util.xml.Required;
...
public abstract class DomUIFactory {
    ...
    public final static ExtensionPointName<Consumer<DomUIFactory>> EXTENSION_POINT_NAME = ExtensionPointName.create("com.gome.maven.dom.uiControlsProvider");
