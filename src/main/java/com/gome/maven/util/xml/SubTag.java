 ...
 * The getters may be annotated with {@link com.gome.maven.util.xml.Convert} annotation, if it returns {@link GenericDomValue} inheritor.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.METHOD})
public @interface SubTag {
    /**
     * @return child XML tag name if it can't be inferred from the getter name (see {@link com.gome.maven.util.xml.NameStrategy})
     */
    ...
    /**
     * @return for methods returning {@link com.gome.maven.util.xml.GenericDomValue}<{@link Boolean}>, defines, whether the Boolean.TRUE should
