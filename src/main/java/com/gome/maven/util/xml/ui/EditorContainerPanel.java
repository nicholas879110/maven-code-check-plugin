...
/**
 * Base component to be associated with (bound to) DOM controls (see {@link com.gome.maven.util.xml.ui.DomUIControl})
 * that have {@link com.gome.maven.openapi.editor.Editor}
 * as their part. This includes simple text, PSI class, PSI type editing, etc. The controls themselves
 * can be created in {@link com.gome.maven.util.xml.ui.DomUIFactory}.
 *
