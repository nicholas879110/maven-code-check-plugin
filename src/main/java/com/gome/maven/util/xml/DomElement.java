...
public interface DomElement extends AnnotatedElement, UserDataHolder {
     ...
     *
     * @return {@link com.gome.maven.psi.xml.XmlFile}, {@link com.gome.maven.psi.xml.XmlTag} or {@link com.gome.maven.psi.xml.XmlAttribute}
     */
    ...
    /**
     * @return stable element (see {@link DomManager#createStableValue(com.gome.maven.openapi.util.Factory)}}),
     ...
     * case is when one creates something inside {@link com.gome.maven.openapi.command.WriteCommandAction} and
