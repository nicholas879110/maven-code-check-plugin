...
/**
 * Basic DOM inspection (see {@link com.gome.maven.util.xml.highlighting.BasicDomElementsInspection})
...
public abstract class DomCustomAnnotationChecker<T extends Annotation> {
    public static final ExtensionPointName<DomCustomAnnotationChecker> EP_NAME = ExtensionPointName.create("com.gome.maven.dom.customAnnotationChecker");
