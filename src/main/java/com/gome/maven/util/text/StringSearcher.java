...
public class StringSearcher {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.text.StringSearcher");
    ...
    public int scan( CharSequence text,  char[] textArray, int _start, int _end) {
        if (_start > _end) {
