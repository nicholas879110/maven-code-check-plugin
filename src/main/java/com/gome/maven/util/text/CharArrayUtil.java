...
public class CharArrayUtil {
     ...
     */
    public static int shiftForward( CharSequence buffer, final int startOffset, final int endOffset,  String chars) {
    ...
    private static boolean isSuitable( String chars, final char c) {
     ...
     */
    public static int indexOf( CharSequence buffer,  CharSequence pattern, int fromIndex, final int toIndex) {
