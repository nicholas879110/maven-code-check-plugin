...
public class QueueProcessor<T> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.concurrency.QueueProcessor");
     ...
     * Constructs a QueueProcessor, which will autostart as soon as the first element is added to it.
     */
    public QueueProcessor( Consumer<T> processor,  Condition<?> deathCondition) {
        this(processor, deathCondition, true);
    }

    public QueueProcessor( Consumer<T> processor,  Condition<?> deathCondition, boolean autostart) {
    ...
    public QueueProcessor( PairConsumer<T, Runnable> processor,
                          boolean autostart,
