 ...
 */
package com.gome.maven.util.ui.tree;
...
public final class TreeUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.ui.tree.TreeUtil");
    ...
    public static int indexedBinarySearch( TreeNode parent,  TreeNode key, Comparator comparator) {
        int low = 0;
    ...
    public static Comparator<TreePath> getDisplayOrderComparator( final JTree tree) {
