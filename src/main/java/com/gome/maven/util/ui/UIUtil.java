...
import com.gome.maven.openapi.ui.GraphicsConfig;
...
import com.gome.maven.util.containers.JBIterable;
import com.gome.maven.util.containers.JBTreeTraverser;
...
public class UIUtil {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.util.ui.UIUtil");
    ...
    public static int getStringY( final String string,  final Rectangle bounds,  final Graphics2D g) {
    ...
    public static void drawLine(Graphics2D g, int x1, int y1, int x2, int y2,  Color bgColor,  Color fgColor) {
    ...
    public static int getCheckBoxTextHorizontalOffset( JCheckBox cb) {
    ...
    /**
     * @deprecated use com.gome.maven.util.ui.UIUtil#getTextFieldBackground()
     */
    ...
    /**
     * @deprecated use com.gome.maven.util.ui.UIUtil#getInactiveTextColor()
     */
    ...
    /**
     * @deprecated use com.gome.maven.util.ui.UIUtil#getPanelBackground() instead
     */
     ...
     */
    public static void paintWithXorOnRetina( Dimension size,
                                             Graphics g,
    ...
    public static boolean isFocusAncestor( final JComponent component) {
    ...
    public static Component findParentByCondition( Component c, Condition<Component> condition) {
...
//    @Language("HTML")
    ...
    public static String getCssFontDeclaration(final Font font,  Color fgColor,  Color linkColor,  String liImg) {
        URL resource = liImg != null ? SystemInfo.class.getResource(liImg) : null;

         String fontFamilyAndSize = "font-family:'" + font.getFamily() + "'; font-size:" + font.getSize() + "pt;";
//         @Language("HTML")
    ...
    public static StyleSheet loadStyleSheet( URL url) {
    ...
    public static HTMLEditorKit getHTMLEditorKit() {
        Font font = getLabelFont();
         String family = !SystemInfo.isWindows && font != null ? font.getFamily() : "Tahoma";
     ...
     * @see #invokeAndWaitIfNeeded(ThrowableRunnable)
     */
    public static void invokeAndWaitIfNeeded( final ThrowableRunnable runnable) throws Throwable {
        if (SwingUtilities.isEventDispatchThread()) {
            runnable.run();
        }
        else {
    ...
    public static boolean isFocusProxy( Component c) {
     ...
     */
    public static boolean isDescendingFrom( Component child,  Component parent) {
    ...
    public static JBIterable<Component> getParents( Component c) {
    ...
    public static JBTreeTraverser<Component> uiTraverser( Component component) {
    ...
    private static final Function<Component, Iterable<Component>> COMPONENT_CHILDREN = new Function<Component, Iterable<Component>>() {
        ...
        @Override
        public JBIterable<Component> fun( Component c) {
    ...
    public static void scrollListToVisibleIfNeeded( final JList list) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
    ...
    public static class TextPainter {
         ...
         */
        public void draw( final Graphics g, final PairFunction<Integer, Integer, Couple<Integer>> _position) {
    ...
    public static boolean isMeaninglessFocusOwner( Component c) {
    ...
    public static Timer createNamedTimer(  final String name, int delay,  ActionListener listener) {
    ...
    public static void addUndoRedoActions( final JTextComponent textComponent) {
    ...
    public static String upArrow( String defaultValue) {
     ...
     */
    public static boolean hasScrollPane( Component component) {
