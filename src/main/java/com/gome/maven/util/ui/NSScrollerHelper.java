...
//import static com.gome.maven.ui.mac.foundation.Foundation.invoke;
...
//        return Style.Legacy;
    ...
    public static void addScrollbarStyleListener( ScrollbarStyleListener listener) {
        ourStyleListeners.add(ScrollbarStyleListener.class, listener);
    }

    public static void removeScrollbarStyleListener( ScrollbarStyleListener listener) {
