...
import com.gome.maven.profile.codeInspection.ui.ScopeOrderComparator;
import com.gome.maven.profile.codeInspection.ui.ScopesChooser;
...
public class ScopesAndSeveritiesTable extends JBTable {
    ...
    public abstract static class TableSettings {
        ...
        protected abstract void onScopeChosen(final  ScopeToolState scopeToolState);
