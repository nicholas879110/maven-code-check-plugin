...
import com.gome.maven.codeInspection.ex.ToolsImpl;
import com.gome.maven.ide.IdeTooltip;
...
import com.gome.maven.profile.codeInspection.ui.InspectionsAggregationUtil;
...
import com.gome.maven.profile.codeInspection.ui.table.ThreeStateCheckBoxRenderer;
import com.gome.maven.ui.DoubleClickListener;
import com.gome.maven.ui.treeStructure.treetable.TreeTable;
import com.gome.maven.ui.treeStructure.treetable.TreeTableModel;
import com.gome.maven.ui.treeStructure.treetable.TreeTableTree;
...
public class InspectionsConfigTreeTable extends TreeTable {
    ...
    private static class MultiColoredHighlightSeverityIconSink {
        ...
        public void put( final ScopeToolState defaultState,  final List<ScopeToolState> nonDefault) {
            putOne(defaultState);
