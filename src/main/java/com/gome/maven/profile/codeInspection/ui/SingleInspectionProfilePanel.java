...
import com.gome.maven.ide.CommonActionsManager;
import com.gome.maven.ide.DefaultTreeExpander;
import com.gome.maven.ide.TreeExpander;
...
import com.gome.maven.profile.codeInspection.ui.filter.InspectionFilterAction;
import com.gome.maven.profile.codeInspection.ui.filter.InspectionsFilter;
import com.gome.maven.profile.codeInspection.ui.inspectionsTree.InspectionConfigTreeNode;
import com.gome.maven.profile.codeInspection.ui.inspectionsTree.InspectionsConfigTreeComparator;
import com.gome.maven.profile.codeInspection.ui.inspectionsTree.InspectionsConfigTreeRenderer;
import com.gome.maven.profile.codeInspection.ui.inspectionsTree.InspectionsConfigTreeTable;
import com.gome.maven.profile.codeInspection.ui.table.ScopesAndSeveritiesTable;
...
import com.gome.maven.util.config.StorageAccessors;
...
public class SingleInspectionProfilePanel extends JPanel {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInspection.ex.InspectionToolsPanel");
    ...
    public SingleInspectionProfilePanel( InspectionProjectProfileManager projectProfileManager,
            ...
            if (scopesNames.isEmpty()) {
                ...
                final JTable scopesAndScopesAndSeveritiesTable =
                        new ScopesAndSeveritiesTable(new ScopesAndSeveritiesTable.TableSettings(nodes, mySelectedProfile, project) {
                            @Override
                            protected void onScopeChosen( final ScopeToolState state) {
