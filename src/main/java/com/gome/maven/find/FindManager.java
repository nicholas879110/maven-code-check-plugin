...
public abstract class FindManager {
     ...
     */
    public abstract void showFindDialog( FindModel model,  Runnable okHandler);
     ...
     * @return the exit code of the dialog, as defined by the {@link com.gome.maven.find.FindManager.PromptResult}
     * interface.
     */
    @PromptResultValue
     ...
     */
    public abstract String getStringToReplace( String foundString,  FindModel model) throws MalformedReplacementStringException;
     ...
     * @see com.gome.maven.lang.findUsages.FindUsagesProvider#canFindUsagesFor(com.gome.maven.psi.PsiElement)
     */
