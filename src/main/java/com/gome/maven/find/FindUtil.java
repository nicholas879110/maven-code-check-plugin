...
import com.gome.maven.find.replaceInProject.ReplaceInProjectManager;
...
import com.gome.maven.openapi.editor.actions.IncrementalFindAction;
...
public class FindUtil {
    ...
    static VirtualFile getVirtualFile( Editor myEditor) {
    ...
    public static List<Usage> findAll( Project project,  Editor editor,  FindModel findModel) {
        final Document document = editor.getDocument();
    ...
    public static void findAllAndShow( Project project,  Editor editor,  FindModel findModel) {
    ...
    public static void searchBack(Project project, FileEditor fileEditor,  DataContext dataContext) {
    ...
    public static void searchBack(final Project project, final Editor editor,  DataContext context) {
        FindManager findManager = FindManager.getInstance(project);
    ...
    public static boolean searchAgain(Project project, FileEditor fileEditor,  DataContext context) {
    ...
    public static boolean searchAgain(final Project project, final Editor editor,  DataContext context) {
        FindManager findManager = FindManager.getInstance(project);
        if (!findManager.findWasPerformed() && !findManager.selectNextOccurrenceWasPerformed()) {
            new IncrementalFindAction().getHandler().execute(editor, context);
            return false;
     ...
     */
    public static void selectSearchResultsInEditor( Editor editor,
