...
import com.gome.maven.find.UsagesPreviewPanelProvider;
import com.gome.maven.find.findUsages.*;
import com.gome.maven.find.impl.FindManagerImpl;
import com.gome.maven.icons.AllIcons;
import com.gome.maven.ide.DataManager;
import com.gome.maven.ide.util.gotoByName.ModelDiff;
...
import com.gome.maven.usages.impl.*;
import com.gome.maven.usages.rules.UsageFilteringRuleProvider;
...
public class ShowUsagesAction extends AnAction implements PopupAction {
    ...
    private void showElementUsages(final Editor editor,
        ...
        Runnable itemChosenCallback = prepareTable(table, editor, popupPosition, handler, maxUsages, options, isPreviewMode);
         ...
         final JBPopup popup = isPreviewMode ? null : createUsagePopup(usages, visibleNodes, handler, editor, popupPosition,
    ...
    private static UsageNode createStringNode( final Object string) {
    ...
    private JComponent createHintComponent( String text,
                                            final FindUsagesHandler handler,
                                            final RelativePoint popupPosition,
                                           final Editor editor,
    ...
    private InplaceButton createSettingsButton( final FindUsagesHandler handler,
                                                final RelativePoint popupPosition,
                                               final Editor editor,
                                               final int maxUsages,
                                                final Runnable cancelAction) {
    ...
    private void showDialogAndFindUsages( FindUsagesHandler handler,
    ...
    private JBPopup createUsagePopup( final List<Usage> usages,
                                     ...
                                     final int maxUsages,
                                      ...
                                      final FindUsagesOptions options,
                                      final JTable table,
                                      final Runnable itemChoseCallback,
                                      final UsageViewPresentation presentation,
                                      final AsyncProcessIcon processIcon) {
    ...
    private ActiveComponent createPinButton( final FindUsagesHandler handler,
                                             final UsageViewImpl usageView,
                                             final FindUsagesOptions options,
                                             final JBPopup[] popup,
    ...
    private static String getFullTitle( List<Usage> usages,
                                        String title,
    ...
    private static String suggestSecondInvocation( FindUsagesOptions options,  FindUsagesHandler handler,  String text) {
    ...
    private static MyModel setTableModel( JTable table,
                                          UsageViewImpl usageView,
                                          final List<UsageNode> data,
    ...
    private static List<UsageNode> collectData( List<Usage> usages,
                                                Collection<UsageNode> visibleNodes,
                                                UsageViewImpl usageView,
                                                UsageViewPresentation presentation) {
         List<UsageNode> data = new ArrayList<UsageNode>();
    ...
    private void rebuildTable( final UsageViewImpl usageView,
    ...
    private void setSizeAndDimensions( JTable table,
                                       JBPopup popup,
                                       RelativePoint popupPosition,
                                       List<UsageNode> data) {
    ...
    private void navigateAndHint( Usage usage,
                                  final String hint,
                                  final FindUsagesHandler handler,
                                  final RelativePoint popupPosition,
                                 final int maxUsages,
    ...
    private void showHint( final Editor editor,
                           String hint,
                           FindUsagesHandler handler,
                           final RelativePoint popupPosition,
                          int maxUsages,
    ...
    private void hint( final Editor editor,
                       final String hint,
                       final FindUsagesHandler handler,
                       final RelativePoint popupPosition,
                      final int maxUsages,
    ...
    private static class MySpeedSearch extends SpeedSearchBase<JTable> {
        public MySpeedSearch( MyTable table) {
            super(table);
        }
