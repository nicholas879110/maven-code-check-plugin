...
import com.gome.maven.codeInsight.highlighting.HighlightManagerImpl;
...
import com.gome.maven.find.impl.livePreview.SearchResults;
...
import com.gome.maven.openapi.fileTypes.impl.AbstractFileType;
...
import com.gome.maven.ui.ReplacePromptDialog;
import com.gome.maven.usages.ChunkExtractor;
...
import com.gome.maven.util.containers.Predicate;
...
public class FindManagerImpl extends FindManager {
    ...
    @PromptResultValue
    public int showPromptDialogImpl( final FindModel model, String title,  final MalformedReplacementStringException exception) {
    ...
    @Override
    public void showFindDialog( final FindModel model,  final Runnable okHandler) {
    ...
    @Override
    public FindResult findString( CharSequence text, int offset,  FindModel model,  VirtualFile file) {
    ...
    private FindResult findStringLoop(CharSequence text, int offset, FindModel model, VirtualFile file,  Predicate<FindResult> filter) {
    ...
    private class FindExceptCommentsOrLiteralsData implements Predicate<FindResult> {
        ...
        @Override
        public boolean apply( FindResult input) {
    ...
    private FindResult doFindString( CharSequence text,
                                     char[] textArray,
                                    int offset,
                                     FindModel findmodel,
                                     VirtualFile file) {
    ...
    private FindResult findInCommentsAndLiterals( CharSequence text,
                                                 char[] textArray,
                                                 int offset,
                                                  FindModel model,
    ...
    @Override
    public String getStringToReplace( String foundString,  FindModel model) throws MalformedReplacementStringException {
    ...
    private static String getStringToReplaceByRegexp( final FindModel model,  CharSequence text, int startOffset) throws MalformedReplacementStringException {
        Matcher matcher = compileRegexAndFindFirst(model, text, startOffset);
        return getStringToReplaceByRegexp(model, matcher);
    }

    private static String getStringToReplaceByRegexp( final FindModel model, Matcher matcher) throws MalformedReplacementStringException{
    ...
    private static void expandFoldRegionsIfNecessary( Editor editor, final int startOffset, int endOffset) {
