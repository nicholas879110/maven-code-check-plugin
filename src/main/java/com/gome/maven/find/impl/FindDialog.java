...
import com.gome.maven.usages.impl.UsagePreviewPanel;
...
public class FindDialog extends DialogWrapper {
    ...
    public static String getPresentableName( FindModel.SearchContext searchContext) {
    ...
    private void setDirectories( List<String> strings, String directoryName) {
