...
import com.gome.maven.openapi.ui.popup.ComponentPopupBuilder;
import com.gome.maven.openapi.ui.popup.JBPopup;
import com.gome.maven.openapi.ui.popup.JBPopupFactory;
import com.gome.maven.openapi.ui.popup.util.MinimizeButton;
...
public class RegExHelpPopup extends JPanel {
    ...
    public static LinkLabel createRegExLink( String title,  final Component owner,  final Logger logger) {
