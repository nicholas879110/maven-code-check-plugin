...
public abstract class FacetDetector<T, C extends FacetConfiguration> {
     ...
     * @param id unique id
     */
    protected FacetDetector(  final String id) {
        myId = id;
    }
     ...
     * @param source {@link com.gome.maven.openapi.vfs.VirtualFile} or {@link com.gome.maven.psi.PsiFile} instance
     ...
     */
    public void beforeFacetAdded( Facet facet, final FacetModel facetModel,  ModifiableRootModel modifiableRootModel) {
    }
     ...
     * @param facet facet
     */
    public void afterFacetAdded( Facet facet) {
    }
