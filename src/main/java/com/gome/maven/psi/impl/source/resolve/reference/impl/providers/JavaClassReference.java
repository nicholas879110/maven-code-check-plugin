...
import com.gome.maven.codeInsight.completion.JavaClassNameCompletionContributor;
import com.gome.maven.codeInsight.completion.JavaLookupElementBuilder;
...
import com.gome.maven.codeInsight.daemon.quickFix.CreateClassOrPackageFix;
...
import com.gome.maven.codeInspection.LocalQuickFixProvider;
...
import com.gome.maven.psi.impl.source.resolve.reference.impl.GenericReference;
import com.gome.maven.psi.infos.CandidateInfo;
import com.gome.maven.psi.infos.ClassCandidateInfo;
...
import com.gome.maven.psi.search.searches.ClassInheritorsSearch;
...
public class JavaClassReference extends GenericReference implements PsiJavaReference, LocalQuickFixProvider {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.resolve.reference.impl.providers.JavaClassReference");
    ...
    private LookupElement[] processPackage( PsiPackage aPackage) {
    ...
    public void processSubclassVariants( PsiPackage context,  String[] extendClasses, Consumer<LookupElement> result) {
    ...
    private static LookupElementBuilder createSubclassLookupValue( final PsiClass clazz,  String qname) {
