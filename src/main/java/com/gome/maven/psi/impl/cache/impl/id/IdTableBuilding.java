...
import com.gome.maven.lang.cacheBuilder.*;
...
import com.gome.maven.util.indexing.IdDataConsumer;
...
public class IdTableBuilding {
    ...
    public interface ScanWordProcessor {
        void run(CharSequence chars,  char[] charsArray, int start, int end);
    }
    ...
    private static class WordsScannerFileTypeIdIndexerAdapter extends FileTypeIdIndexer {
        ...
        public WordsScannerFileTypeIdIndexerAdapter( final WordsScanner scanner) {
            myScanner = scanner;
        }
