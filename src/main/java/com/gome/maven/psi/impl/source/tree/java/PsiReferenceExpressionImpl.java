...
import com.gome.maven.psi.impl.source.resolve.*;
...
public class PsiReferenceExpressionImpl extends PsiReferenceExpressionBase implements PsiReferenceExpression, SourceJavaCodeReference {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.java.PsiReferenceExpressionImpl");
    ...
    public static final class OurGenericsResolver implements ResolveCache.PolyVariantContextResolver<PsiJavaReference> {
        ...
        private static List<ResolveResult[]> resolveAllQualifiers( PsiReferenceExpressionImpl expression,  final PsiFile containingFile) {
