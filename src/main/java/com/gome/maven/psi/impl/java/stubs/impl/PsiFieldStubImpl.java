...
public class PsiFieldStubImpl extends StubBase<PsiField> implements PsiFieldStub {
    ...
    public PsiFieldStubImpl(StubElement parent, String name,  TypeInfo type,  String initializer, byte flags) {
        this(parent, StringRef.fromString(name), type, StringRef.fromString(initializer), flags);
    }

    public PsiFieldStubImpl(StubElement parent, StringRef name,  TypeInfo type,  StringRef initializer, byte flags) {
