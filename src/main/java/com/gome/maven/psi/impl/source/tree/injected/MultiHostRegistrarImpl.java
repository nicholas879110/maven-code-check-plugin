...
import com.gome.maven.injected.editor.VirtualFileWindowImpl;
...
import com.gome.maven.psi.impl.DocumentCommitProcessor;
...
import com.gome.maven.psi.injection.ReferenceInjector;
...
public class MultiHostRegistrarImpl implements MultiHostRegistrar, ModificationTracker {
    ...
    MultiHostRegistrarImpl( Project project,
                            PsiFile hostPsiFile,
    ...
    public MultiHostRegistrar addPlace(  String prefix,
                                         String suffix,
    ...
    private static DocumentEx createDocument( LightVirtualFile virtualFile) {
    ...
    private static boolean cacheEverything( Place place,
    ...
    private static void patchLeaves( ASTNode parsedNode,
    ...
    // under com.gome.maven.psi.PsiLock.LOCK
