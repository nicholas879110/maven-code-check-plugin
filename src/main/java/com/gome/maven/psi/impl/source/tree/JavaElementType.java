...
import com.gome.maven.psi.impl.source.*;
...
public interface JavaElementType {
    class JavaCompositeElementType extends IJavaElementType implements ICompositeElementType {
        ...
        private JavaCompositeElementType( final String debugName, final Class<? extends ASTNode> nodeClass) {
            this(debugName, nodeClass, false);
        }

        private JavaCompositeElementType( final String debugName, final Class<? extends ASTNode> nodeClass, final boolean leftBound) {
