...
import com.gome.maven.psi.impl.light.LightTypeParameter;
...
public class PsiSubstitutorImpl implements PsiSubstitutor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.PsiSubstitutorImpl");
    ...
    private class SubstitutionVisitor extends SubstitutionVisitorBase {
        ...
        private PsiType substituteTypeParameter( PsiTypeParameter typeParameter) {
    ...
    private PsiType addBounds(PsiType substituted,  PsiTypeParameter typeParameter) {
    ...
    private void putAllInternal( PsiClass parentClass, PsiType[] mappings) {
