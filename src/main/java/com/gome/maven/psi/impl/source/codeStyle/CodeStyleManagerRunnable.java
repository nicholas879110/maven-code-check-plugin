...
import com.gome.maven.formatting.CoreFormatterUtil;
import com.gome.maven.formatting.FormattingMode;
import com.gome.maven.formatting.FormattingModel;
...
abstract class CodeStyleManagerRunnable<T> {
    ...
    public T perform(PsiFile file, int offset,  TextRange range, T defaultValue) {
    ...
    private static boolean isInsidePlainComment(int offset,  PsiElement element) {
