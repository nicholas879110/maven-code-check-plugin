...
import com.gome.maven.psi.impl.java.stubs.PsiMethodStub;
import com.gome.maven.psi.impl.source.tree.ChildRole;
import com.gome.maven.psi.impl.source.tree.CompositeElement;
import com.gome.maven.psi.impl.source.tree.JavaSharedImplUtil;
...
public class PsiMethodImpl extends JavaStubPsiElement<PsiMethodStub> implements PsiMethod, Queryable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.PsiMethodImpl");
