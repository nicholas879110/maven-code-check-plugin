...
public class PsiToDocumentSynchronizer extends PsiTreeChangeAdapter {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.PsiToDocumentSynchronizer");
    ...
    private void checkPsiModificationAllowed( final PsiTreeChangeEvent event) {
    ...
    boolean isInsideAtomicChange( PsiFile file) {
        return file.getUserData(PSI_DOCUMENT_ATOMIC_ACTION) == Boolean.TRUE;
    }

    public void performAtomically( PsiFile file,  Runnable runnable) {
