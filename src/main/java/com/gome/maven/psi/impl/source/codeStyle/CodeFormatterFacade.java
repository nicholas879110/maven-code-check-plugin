...
import com.gome.maven.lang.LanguageFormatting;
...
import com.gome.maven.psi.formatter.DocumentBasedFormattingModel;
...
public class CodeFormatterFacade {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.codeStyle.CodeFormatterFacade");
     ...
     */
    public ASTNode processRange( ASTNode element,  RangeMarker rangeMarker) {
        return doProcessRange(element, rangeMarker.getStartOffset(), rangeMarker.getEndOffset(), rangeMarker);
    }

    private ASTNode doProcessRange(final ASTNode element, final int startOffset, final int endOffset,  RangeMarker rangeMarker) {
...
//      return SourceTreeToPsiMap.psiElementToTree(pointer.getElement());
    ...
    private TextRange preprocess( final ASTNode node,  TextRange range) {
    ...
    private TextRange preprocessEnabledRanges( final ASTNode node,  TextRange range) {
    ...
    /**
     * Inspects all lines of the given document and wraps all of them that exceed {@link CodeStyleSettings#getRightMargin(com.gome.maven.lang.Language)}
     * right margin}.
     * <p/>
     ...
     * <ol>
     *   <li>
     *      Check if the line exceeds {@link CodeStyleSettings#getRightMargin(com.gome.maven.lang.Language)}  right margin}. Go to the next line in the case of
     *      negative answer;
     *   </li>
     ...
     */
    private void wrapLongLinesIfNecessary( final PsiFile file,  final Document document, final int startOffset,
                                          final int endOffset)
    {
    ...
    public void doWrapLongLinesIfNecessary( final Editor editor,  final Project project,  Document document,
     ...
     */
    private static void emulateEnter( final Editor editor,  Project project, int[] shifts) {
     ...
     */
    private int calculatePreferredWrapPosition( Editor editor,
                                                CharSequence text,
                                               int tabSize,
                                               int spaceSize,
                                               int startLineOffset,
    ...
    private int wrapPositionForTabbedTextWithOptimization( CharSequence text,
                                                          int tabSize,
                                                          int startLineOffset,
                                                          int endLineOffset,
                                                          int targetRangeEndOffset)
    ...
    private int wrapPositionForTabbedTextWithoutOptimization( Editor editor,
                                                              CharSequence text,
                                                             int spaceSize,
                                                             int startLineOffset,
                                                             int endLineOffset,
    ...
    private static DataContext prepareContext( Component component,  final Project project) {
