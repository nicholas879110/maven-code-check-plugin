...
public class FileReferenceUtil {
     ...
     * @see FileReference
     * @see com.gome.maven.psi.impl.source.resolve.reference.impl.providers.FileReferenceSet
     */
    
    public static PsiFile findFile( PsiElement element) {
     ...
     * @see com.gome.maven.psi.impl.source.resolve.reference.impl.providers.FileReference
     * @see com.gome.maven.psi.PsiElement#getReferences()
     */
