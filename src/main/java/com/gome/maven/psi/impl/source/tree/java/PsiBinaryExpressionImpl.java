...
public class PsiBinaryExpressionImpl extends ExpressionPsiElement implements PsiBinaryExpression {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.java.PsiBinaryExpressionImpl");

    /** used via reflection in {@link com.gome.maven.psi.impl.source.tree.JavaElementType.JavaCompositeElementType#JavaCompositeElementType(java.lang.String, java.lang.Class)} */
