 ...
 */
package com.gome.maven.psi.impl.source.resolve.graphInference;
...
import com.gome.maven.psi.impl.source.resolve.graphInference.constraints.*;
...
public class InferenceSession {
    ...
    private static PsiType getParameterType(PsiParameter[] parameters, int i,  PsiSubstitutor substitutor, boolean varargs) {
    ...
    public PsiSubstitutor infer( PsiParameter[] parameters,
                                 PsiExpression[] args,
                                 PsiElement parent) {
    ...
    public boolean isProperType( PsiType type) {
        return collectDependencies(type, null);
    }

    public boolean collectDependencies( PsiType type,
                                        final Set<InferenceVariable> dependencies) {
