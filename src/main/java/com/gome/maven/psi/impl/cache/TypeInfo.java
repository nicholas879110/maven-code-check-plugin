...
import com.gome.maven.psi.CommonClassNames;
...
public class TypeInfo {
    ...
    public TypeInfo(String text, byte arrayCount, boolean ellipsis,  PsiAnnotationStub[] annotationStubs) {
        this(StringRef.fromString(text == null ? null : internFrequentType(text)), arrayCount, ellipsis, annotationStubs);
    }

    private TypeInfo(StringRef text, byte arrayCount, boolean isEllipsis,  PsiAnnotationStub[] annotationStubs) {
        this.text = text;
    ...
    public TypeInfo applyAnnotations( StubBase<?> owner) {
