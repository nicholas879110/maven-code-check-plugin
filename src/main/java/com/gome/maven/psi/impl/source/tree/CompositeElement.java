...
import com.gome.maven.extapi.psi.ASTDelegatePsiElement;
...
public class CompositeElement extends TreeElement {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.CompositeElement");
  ...
  */
    ...
    public <T extends PsiElement> T[] getChildrenAsPsiElements( IElementType type, ArrayFactory<T> constructor) {
        ApplicationManager.getApplication().assertReadAccessAllowed();
    ...
    @Override
    public void addChild( ASTNode child,  final ASTNode anchorBefore) {
    ...
    @Override
    public void addLeaf( final IElementType leafType, final CharSequence leafText, final ASTNode anchorBefore) {
