...
public class CodeEditUtil {
    ...
    private static void markToReformatBeforeOrInsertWhitespace(final ASTNode left,  final ASTNode right) {
     ...
     */
    public static void setNodeReformatStrategy( NotNullFunction<ASTNode, Boolean> strategy) {
