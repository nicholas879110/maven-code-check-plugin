...
import com.gome.maven.lexer.DtdLexer;
import com.gome.maven.lexer._DtdLexer;
...
import com.gome.maven.psi.xml.XmlEntityDecl;

/**
 * @author Mike
 */
public class DtdParsing extends XmlParsing implements XmlElementType {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.parsing.xml.XmlParser");
