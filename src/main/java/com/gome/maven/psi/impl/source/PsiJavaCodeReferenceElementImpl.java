...
import com.gome.maven.codeInsight.javadoc.JavaDocUtil;
...
import com.gome.maven.psi.impl.source.resolve.VariableResolverProcessor;
...
public class PsiJavaCodeReferenceElementImpl extends CompositePsiElement implements PsiJavaCodeReferenceElement, SourceJavaCodeReference {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.PsiJavaCodeReferenceElementImpl");
    ...
    public int getKind( PsiFile containingFile) {
    ...
    public String getCanonicalText(boolean annotated,  PsiAnnotation[] annotations,  PsiFile containingFile) {
