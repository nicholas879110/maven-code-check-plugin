...
import com.gome.maven.lang.impl.PsiBuilderImpl;
...
import com.gome.maven.psi.stubs.ObjectStubSerializer;
import com.gome.maven.psi.stubs.Stub;
...
public class DebugUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.DebugUtil");
    ...
    public static String psiTreeToString( final PsiElement element, final boolean skipWhitespaces) {
    ...
    public static String treeToString( final ASTNode root, final boolean skipWhitespaces) {
    ...
    public static String nodeTreeToString( final ASTNode root, final boolean skipWhitespaces) {
        final LengthBuilder ruler = new LengthBuilder();
    ...
    public static void treeToBuffer( final Appendable buffer,
                                     final ASTNode root,
                                    final int indent,
    ...
    public static String lightTreeToString( final FlyweightCapableTreeStructure<LighterASTNode> tree,
                                           final boolean skipWhitespaces) {
        final LengthBuilder ruler = new LengthBuilder();
    ...
    public static void lightTreeToBuffer( final FlyweightCapableTreeStructure<LighterASTNode> tree,
    ...
    public static void doCheckTreeStructure( ASTNode anyElement) {
    ...
    public static String psiToString( PsiElement element, final boolean skipWhitespaces) {
        return psiToString(element, skipWhitespaces, false);
    }

    public static String psiToString( final PsiElement root, final boolean skipWhiteSpaces, final boolean showRanges) {
        return psiToString(root, skipWhiteSpaces, showRanges, null);
    }

    public static String psiToString( final PsiElement root, final boolean skipWhiteSpaces, final boolean showRanges, PairConsumer<PsiElement, Consumer<PsiElement>> extra) {
        final LengthBuilder ruler = new LengthBuilder();
    ...
    public static void psiToBuffer( final Appendable buffer,
                                    final PsiElement root,
                                   int indent,
     ...
     * identifying this transaction, and so will {@link com.gome.maven.psi.PsiInvalidElementAccessException} thrown when accessing such invalid
     ...
     */
    public static void startPsiModification( String trace) {
    ...
    private static Object calcInvalidationTrace( ASTNode treeElement) {
        if (!PsiInvalidElementAccessException.isTrackingInvalidation()) {
            return null;
        }
