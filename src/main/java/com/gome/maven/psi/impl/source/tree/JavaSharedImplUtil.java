...
public class JavaSharedImplUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.JavaSharedImplUtil");
    ...
    public static PsiType getType( PsiTypeElement typeElement,  PsiElement anchor,  PsiAnnotation stopAt) {
