 ...
 * @author max
 */
package com.gome.maven.psi.impl.java.stubs.index;

import com.gome.maven.openapi.project.Project;
import com.gome.maven.psi.PsiMember;
import com.gome.maven.psi.impl.search.JavaSourceFilterScope;
import com.gome.maven.psi.search.GlobalSearchScope;
import com.gome.maven.psi.stubs.StringStubIndexExtension;
import com.gome.maven.psi.stubs.StubIndex;
...
public class JavaStaticMemberTypeIndex extends StringStubIndexExtension<PsiMember> {
    ...
    public Collection<PsiMember> getStaticMembers( final String shortTypeText, final Project project,  final GlobalSearchScope scope) {
