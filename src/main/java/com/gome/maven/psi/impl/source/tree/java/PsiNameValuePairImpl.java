...
import com.gome.maven.psi.impl.java.stubs.PsiNameValuePairStub;
...
public class PsiNameValuePairImpl extends JavaStubPsiElement<PsiNameValuePairStub> implements PsiNameValuePair {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.java.PsiNameValuePairImpl");
