...
import com.gome.maven.psi.impl.source.resolve.reference.impl.CachingReference;
import com.gome.maven.psi.impl.source.resolve.reference.impl.PsiMultiReference;
import com.gome.maven.psi.search.PsiFileSystemItemProcessor;
import com.gome.maven.refactoring.rename.BindablePsiReference;
...
public class FileReference implements PsiFileReference, FileReferenceOwner, PsiPolyVariantReference,
    ...
    public static FileReference findFileReference( final PsiReference original) {
    ...
    protected void innerResolveInContext( final String text,
    ...
    public PsiFileSystemItem innerSingleResolve(final boolean caseSensitive,  PsiFile containingFile) {
    ...
    public PsiElement bindToElement( final PsiElement element, final boolean absolute) throws IncorrectOperationException {
