...
public class DummyHolder extends PsiFileImpl {
    ...
    public DummyHolder( PsiManager manager,  TreeElement contentElement,  PsiElement context,  CharTable table,  Boolean validity, Language language) {
    ...
    public DummyHolder( PsiManager manager, final CharTable table, final Language language) {
        this(manager, null, null, table, null, language);
    }

    public DummyHolder( PsiManager manager, final Language language, final PsiElement context) {
