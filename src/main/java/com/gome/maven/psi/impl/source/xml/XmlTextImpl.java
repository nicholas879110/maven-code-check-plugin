...
import com.gome.maven.pom.xml.events.XmlChange;
import com.gome.maven.pom.xml.impl.XmlAspectChangeSetImpl;
import com.gome.maven.pom.xml.impl.events.XmlTagChildAddImpl;
import com.gome.maven.pom.xml.impl.events.XmlTextChangedImpl;
...
import com.gome.maven.psi.impl.source.tree.injected.XmlTextLiteralEscaper;
import com.gome.maven.psi.impl.source.xml.behavior.DefaultXmlPsiPolicy;
...
public class XmlTextImpl extends XmlElementImpl implements XmlText, PsiLanguageInjectionHost {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.xml.XmlTextImpl");
