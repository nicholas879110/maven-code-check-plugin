...
public class NullFileReferenceHelper extends FileReferenceHelper {
    ...
    public Collection<PsiFileSystemItem> getRoots( final Module module) {
    ...
    public Collection<PsiFileSystemItem> getContexts(final Project project,  final VirtualFile file) {
    ...
    @Override
    public boolean isMine(final Project project,  final VirtualFile file) {
