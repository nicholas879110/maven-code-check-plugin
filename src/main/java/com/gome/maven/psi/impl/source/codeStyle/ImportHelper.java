...
import com.gome.maven.codeInsight.ImportFilter;
...
import com.gome.maven.psi.codeStyle.PackageEntry;
import com.gome.maven.psi.codeStyle.PackageEntryTable;
import com.gome.maven.psi.impl.source.PsiJavaCodeReferenceElementImpl;
import com.gome.maven.psi.impl.source.SourceTreeToPsiMap;
import com.gome.maven.psi.impl.source.jsp.jspJava.JspxImportStatement;
import com.gome.maven.psi.impl.source.resolve.ResolveClassUtil;
...
import com.gome.maven.psi.impl.source.tree.JavaJspElementType;
import com.gome.maven.psi.jsp.JspFile;
import com.gome.maven.psi.jsp.JspSpiUtil;
...
public class ImportHelper{
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.codeStyle.ImportHelper");
    ...
    private static Set<String> findSingleImports( final PsiJavaFile file,
                                                  ...
                                                  final Set<String> onDemandImports
    ) {
    ...
    private static Collection<Pair<String,Boolean>> collectNamesToImport( PsiJavaFile file, List<PsiElement> comments){
    ...
    private static void collectNamesToImport( final Set<Pair<String, Boolean>> names,
    ...
    private static void addNamesToImport( Set<Pair<String, Boolean>> names,
                                          List<PsiElement> comments,
                                          PsiElement scope,
    ...
    private static void addUnresolvedImportNames( final Set<Pair<String, Boolean>> namesToImport,  PsiJavaFile file) {
        ...
        final Map<String, Pair<String, Boolean>> unresolvedNames = new THashMap<String, Pair<String, Boolean>>();
         Set<Pair<String, Boolean>> unresolvedOnDemand = new THashSet<Pair<String, Boolean>>();
