...
import com.gome.maven.psi.impl.java.stubs.JavaParameterElementType;
...
public class ParameterElement extends CompositeElement {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.java.ParameterElement");
