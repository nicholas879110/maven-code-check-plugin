...
public class FileReferenceHelperRegistrar {
     ...
     */
    @Deprecated
    public static <T extends PsiFileSystemItem> FileReferenceHelper getHelper( final T psiFileSystemItem) {
    ...
    public static <T extends PsiFileSystemItem> List<FileReferenceHelper> getHelpers( final T psiFileSystemItem) {
        final VirtualFile file = psiFileSystemItem.getVirtualFile();
        if (file == null) return null;
        final Project project = psiFileSystemItem.getProject();
    ...
    public static boolean areElementsEquivalent( final PsiFileSystemItem element1,  final PsiFileSystemItem element2) {
