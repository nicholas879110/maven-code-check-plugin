...
import com.gome.maven.psi.impl.source.resolve.reference.impl.PsiPolyVariantCachingReference;
...
public class PsiNewExpressionImpl extends ExpressionPsiElement implements PsiNewExpression {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.tree.java.PsiNewExpressionImpl");
    ...
    private PsiType doGetType( PsiAnnotation stopAt) {
        PsiType type = null;
