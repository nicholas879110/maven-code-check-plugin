...
import com.gome.maven.openapi.roots.ProjectRootModificationTracker;
import com.gome.maven.openapi.util.Key;
import com.gome.maven.openapi.util.Pair;
import com.gome.maven.psi.*;
import com.gome.maven.psi.impl.source.HierarchicalMethodSignatureImpl;
...
public class PsiSuperMethodImplUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.PsiSuperMethodImplUtil");
    ...
    private static boolean isReturnTypeIsMoreSpecificThan( HierarchicalMethodSignature thisSig,  HierarchicalMethodSignature thatSig) {
    ...
    public static boolean processDirectSuperMethodsSmart( PsiMethod method,  Processor<PsiMethod> superMethodProcessor) {
