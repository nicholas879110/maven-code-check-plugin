...
import com.gome.maven.openapi.progress.util.StandardProgressIndicatorBase;
...
public class DocumentCommitThread extends DocumentCommitProcessor implements Runnable, Disposable {
    ...
    private void disable( Object reason) {
    ...
    private void enable( Object reason) {
        myEnabled = true;
        wakeUpQueue();
    ...
    private void cancel(  Object reason) {
        startNewTask(null, reason);
    }

    @Override
    public void commitAsynchronously( final Project project,  final Document document,   Object reason) {
        queueCommit(project, document, reason);
    }

    public void queueCommit( final Project project,  final Document document,   Object reason) {
...
//    System.err.println(s);
    ...
    private void markRemovedCurrentTask( CommitTask newTask) {
    ...
    private void markRemovedFromDocsToCommit( final CommitTask newTask) {
    ...
    @Override
    public void commitSynchronously( Document document,  Project project) {
        assert !isDisposed;
    ...
    private Runnable commitUnderProgress( final CommitTask task, final boolean synchronously) {
    ...
    private Processor<Document> handleCommitWithoutPsi( final PsiDocumentManagerBase documentManager,
                                                        Document document,
                                                        final CommitTask task,
