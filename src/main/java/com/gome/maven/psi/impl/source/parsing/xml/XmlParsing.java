 ...
 */
package com.gome.maven.psi.impl.source.parsing.xml;

import com.gome.maven.codeInsight.daemon.XmlErrorMessages;
import com.gome.maven.lang.PsiBuilder;
import com.gome.maven.psi.tree.CustomParsingType;
...
import static com.gome.maven.psi.xml.XmlElementType.*;
...
public class XmlParsing {
    ...
    private PsiBuilder.Marker startText( PsiBuilder.Marker xmlText) {
        if (xmlText == null) {
            xmlText = mark();
            assert xmlText != null;
        }
    ...
    private static PsiBuilder.Marker terminateText( PsiBuilder.Marker xmlText) {
        if (xmlText != null) {
