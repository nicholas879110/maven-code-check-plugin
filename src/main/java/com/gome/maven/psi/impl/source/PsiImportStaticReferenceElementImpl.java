...
import com.gome.maven.psi.impl.source.resolve.StaticImportResolveProcessor;
...
public class PsiImportStaticReferenceElementImpl extends CompositePsiElement implements PsiImportStaticReferenceElement {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.impl.source.PsiImportStaticReferenceElementImpl");
