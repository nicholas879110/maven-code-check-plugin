...
public abstract class PsiDocumentManager {
     ...
     * @see #commitDocument(com.gome.maven.openapi.editor.Document)
     */
     ...
     */
    public abstract void reparseFiles( final Collection<VirtualFile> files, final boolean includeOpenFiles);
