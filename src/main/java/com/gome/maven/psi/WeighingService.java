...
public class WeighingService {
    ...
    public static <T,Loc> WeighingComparable<T,Loc> weigh(final Key<? extends Weigher<T,Loc>> key, final T element,  final Loc location) {
        return weigh(key, new Computable.PredefinedValueComputable<T>(element), location);
    }

    
    public static <T,Loc> WeighingComparable<T,Loc> weigh(final Key<? extends Weigher<T,Loc>> key, final Computable<T> element,  final Loc location) {
