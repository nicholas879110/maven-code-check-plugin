 ...
 *
 * @see com.gome.maven.openapi.actionSystem.LangDataKeys#PSI_FILE
 * @see com.gome.maven.psi.PsiElement#getContainingFile()
 * @see PsiManager#findFile(com.gome.maven.openapi.vfs.VirtualFile)
 * @see PsiDocumentManager#getPsiFile(com.gome.maven.openapi.editor.Document)
 */
