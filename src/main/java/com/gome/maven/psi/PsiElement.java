...
public interface PsiElement extends UserDataHolder, Iconable {
     ...
     * and not yet committed ({@link com.gome.maven.psi.PsiDocumentManager#commitDocument(com.gome.maven.openapi.editor.Document)}).
     * (In this case an attempt to change PSI will result in an exception).
     *
     * Any access to invalid elements results in {@link com.gome.maven.psi.PsiInvalidElementAccessException}.
     *
     ...
     * @see com.gome.maven.psi.util.PsiUtilCore#ensureValid(PsiElement)
     */
     ...
     * @see com.gome.maven.psi.search.searches.ReferencesSearch
     */
     ...
     * <p/>
     * Actually, it's preferable to call {@link com.gome.maven.psi.PsiReferenceService#getReferences} instead
     * as it allows adding references by plugins when the element implements {@link com.gome.maven.psi.ContributedReferenceHost}.
     *
     * @return the array of references, or an empty array if the element has no associated
     *         references.
     * @see com.gome.maven.psi.PsiReferenceService#getReferences
     * @see com.gome.maven.psi.search.searches.ReferencesSearch
     */
     ...
     * @see #putCopyableUserData(com.gome.maven.openapi.util.Key, Object)
     */
     ...
     * @see #getCopyableUserData(com.gome.maven.openapi.util.Key)
     */
