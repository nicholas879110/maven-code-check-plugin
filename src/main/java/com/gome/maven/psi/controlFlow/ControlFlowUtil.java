...
public class ControlFlowUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.controlFlow.ControlFlowUtil");
    ...
    private static boolean checkReferenceExpressionScope(final PsiReferenceExpression ref,  PsiElement targetClassMember) {
    ...
    private static class CopyOnWriteList {
        ...
        public static CopyOnWriteList add( CopyOnWriteList list,  VariableInfo value) {
    ...
    private static class InitializedTwiceClientVisitor extends InstructionClientVisitor<Collection<VariableInfo>> {
        ...
        private static PsiElement getLatestWriteVarExpression( CopyOnWriteList writeVars,  PsiVariable variable) {
