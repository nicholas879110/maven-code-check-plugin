...
public class ClassFileDecompilers {
    ...
    public abstract static class Light implements Decompiler {
        ...
        public abstract CharSequence getText( VirtualFile file) throws CannotDecompileException;
    }
    ...
    public abstract static class Full implements Decompiler {
         ...
         * {@link FileViewProvider#getPsi(com.gome.maven.lang.Language)}.</p>
         */
    ...
    public static ExtensionPointName<Decompiler> EP_NAME = ExtensionPointName.create("com.gome.maven.psi.classFileDecompiler");
