...
import static com.gome.maven.psi.codeStyle.arrangement.std.StdArrangementTokens.Section.END_SECTION;
import static com.gome.maven.psi.codeStyle.arrangement.std.StdArrangementTokens.Section.START_SECTION;
...
public class ArrangementSectionRule implements Cloneable {
    ...
    private ArrangementSectionRule( String start,  String end,  List<StdArrangementMatchRule> rules) {
    ...
    public static ArrangementSectionRule create( String start,  String end,  StdArrangementMatchRule... rules) {
        return create(start, end, rules.length == 0 ? ContainerUtil.<StdArrangementMatchRule>emptyList() : ContainerUtil.newArrayList(rules));
    }

    public static ArrangementSectionRule create( String start,  String end,  List<StdArrangementMatchRule> rules) {
    ...
    private static StdArrangementMatchRule createSectionRule( String comment,  ArrangementSettingsToken token) {
