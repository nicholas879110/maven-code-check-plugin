...
import com.gome.maven.psi.codeStyle.arrangement.std.StdArrangementTokenType;
...
public class StdArrangementMatchRule extends ArrangementMatchRule implements Cloneable, Comparable<StdArrangementMatchRule> {
    ...
    private static String getEntryType( Map<ArrangementSettingsToken, Object> tokens) {
