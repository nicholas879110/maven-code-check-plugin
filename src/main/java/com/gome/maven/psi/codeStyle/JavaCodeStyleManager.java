...
public abstract class JavaCodeStyleManager {
    ...
    public abstract PsiElement shortenClassReferences( PsiElement element, /*@MagicConstant(flags = {DO_NOT_ADD_IMPORTS, UNCOMPLETE_CODE})*/ int flags) throws IncorrectOperationException;
     ...
     * @throws com.gome.maven.util.IncorrectOperationException if the file to shorten references in is read-only.
     */
    ...
    public SuggestedNameInfo suggestUniqueVariableName( SuggestedNameInfo baseNameInfo,
                                                       PsiElement place,
                                                       boolean lookForward) {
