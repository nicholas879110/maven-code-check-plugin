...
import com.gome.maven.util.containers.ClassMap;
...
//----------------- WRAPPING ---------------------------
    ...
    public void setFormatterOffPattern( Pattern formatterOffPattern) {
    ...
    public void setFormatterOnPattern( Pattern formatterOnPattern) {
    ...
    public IndentOptions getIndentOptionsByFile( PsiFile file) {
        return getIndentOptionsByFile(file, null);
    }

    
    public IndentOptions getIndentOptionsByFile( PsiFile file,  TextRange formatRange) {
    ...
    public IndentOptions getIndentOptionsByFile( PsiFile file,  TextRange formatRange, boolean ignoreDocOptions,
                                                 Processor<FileIndentOptionsProvider> providerProcessor) {
    ...
    private static boolean isFileFullyCoveredByRange( PsiFile file,  TextRange formatRange) {
        return
                formatRange != null &&
                        file.getTextRange().equals(formatRange);
    }

    private static void logIndentOptions( PsiFile file,
    ...
    private static class TempFileType implements FileType {
        ...
        private TempFileType( final String extension) {
     ...
     */
    public void setRightMargin( Language language, int rightMargin) {
        if (language != null) {
            CommonCodeStyleSettings langSettings = getCommonSettings(language);
            if (langSettings != null) {
