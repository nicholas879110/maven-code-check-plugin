...
public interface Rearranger<E extends ArrangementEntry> {
    ...
    LanguageExtension<Rearranger<?>> EXTENSION = new LanguageExtension<Rearranger<?>>("com.gome.maven.lang.rearranger");
    ...
    Pair<E, List<E>> parseWithNew( PsiElement root,
                                   Document document,
     ...
     */
    int getBlankLines( CodeStyleSettings settings,  E parent,  E previous,  E target);


    /**
     * @return serializer to save {@link com.gome.maven.psi.codeStyle.arrangement.ArrangementSettings arrangement settings}.
     * Serializer is expected to be lazy and don't save
     * {@link com.gome.maven.psi.codeStyle.arrangement.std.ArrangementStandardSettingsAware.getDefaultSettings() default settings}.
     * <p/>
     * @see com.gome.maven.psi.codeStyle.arrangement.DefaultArrangementSettingsSerializer
     */
