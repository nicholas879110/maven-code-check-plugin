...
public class MinusculeMatcher implements Matcher {
     ...
     * and try to {@link #matchFragment(String, int, int, com.gome.maven.psi.codeStyle.MinusculeMatcher.MatchingState)} for it.
     */
     ...
     * and invokes {@link #matchFragment(String, int, int, com.gome.maven.psi.codeStyle.MinusculeMatcher.MatchingState)} at those candidate positions
     */
