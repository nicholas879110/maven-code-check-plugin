...
import static com.gome.maven.psi.codeStyle.arrangement.std.StdArrangementTokens.EntryType.*;
...
public class StdArrangementTokens {
    ...
    private static NotNullLazyValue<Set<ArrangementSettingsToken>> collectFields( final Class<?> clazz) {
    ...
    private static StdArrangementSettingsToken compositeToken( String id,
                                                               StdArrangementTokenType type,
                                                               ArrangementSettingsToken... alternativeTokens)
    {
    ...
    private static StdArrangementSettingsToken token( String id,  /*@PropertyKey(resourceBundle = ApplicationBundle.BUNDLE)*/ String key,
                                                      StdArrangementTokenType type) {
