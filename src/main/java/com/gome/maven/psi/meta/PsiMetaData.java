 ...
 */
package com.gome.maven.psi.meta;
 ...
 * @author peter
 *
 * @see MetaDataRegistrar#registerMetaData(com.gome.maven.psi.filters.ElementFilter, Class)
...
public interface PsiMetaData {
     ...
     * @see com.gome.maven.psi.util.CachedValue
     */
