 ...
 * Generally returned from {@link PsiElement#getReferences()} and {@link com.gome.maven.psi.PsiReferenceService#getReferences},
 * but may be contributed to some elements by third party plugins via {@link com.gome.maven.psi.PsiReferenceContributor}
 *
 * @see PsiPolyVariantReference
 * @see PsiElement#getReference()
 * @see PsiElement#getReferences()
 * @see com.gome.maven.psi.PsiReferenceService#getReferences(PsiElement, com.gome.maven.psi.PsiReferenceService.Hints)
 * @see com.gome.maven.psi.PsiReferenceBase
 * @see com.gome.maven.psi.PsiReferenceContributor
