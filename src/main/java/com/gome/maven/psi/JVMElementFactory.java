...
public interface JVMElementFactory {
    ...
    PsiMethod createMethod(  String name, PsiType returnType, PsiElement context) throws IncorrectOperationException;
    ...
    PsiParameter createParameter(  String name, PsiType type, PsiElement context) throws IncorrectOperationException;
    ...
    PsiMethod createMethodFromText(String text,  PsiElement context);

    
    PsiAnnotation createAnnotationFromText(  String annotationText,  PsiElement context) throws IncorrectOperationException;

    
    PsiElement createExpressionFromText(  String text,  PsiElement context) throws IncorrectOperationException;
     ...
     * @throws com.gome.maven.util.IncorrectOperationException if <code>name</code> is not a valid Java identifier.
     */
    ...
    */
    ...
    /**
     * The same as {@link #createTypeByFQClassName(String, com.gome.maven.psi.search.GlobalSearchScope)}
     * with {@link com.gome.maven.psi.search.GlobalSearchScope#allScope(com.gome.maven.openapi.project.Project)}.
     *
