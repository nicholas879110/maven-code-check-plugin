 ...
 *
 * @see com.gome.maven.psi.JavaPsiFacade#getElementFactory()
 */
public interface PsiElementFactory extends PsiJavaParserFacade, JVMElementFactory {
     ...
     * with {@link GlobalSearchScope#allScope(com.gome.maven.openapi.project.Project)}.
     *
     ...
     * parameter in {@link com.gome.maven.lang.PsiParser#parse(com.gome.maven.psi.tree.IElementType, com.gome.maven.lang.PsiBuilder)}.
    ...
    PsiElement createDummyHolder( String text,  IElementType type,  PsiElement context);
    ...
    PsiCatchSection createCatchSection( PsiType exceptionType,  String exceptionName,  PsiElement context) throws IncorrectOperationException;
