...
import com.gome.maven.psi.impl.smartPointers.SelfElementInfo;
...
public abstract class PsiAnchor {
    ...
    private static class TreeRangeReference extends PsiAnchor {
        ...
        private TreeRangeReference( PsiFile file,
                                   int startOffset,
                                   int endOffset,
                                    Class aClass,
                                    Language language,
    ...
    public static PsiElement restoreFromStubIndex(PsiFileWithStubSupport fileImpl,
                                                  int index,
                                                   IStubElementType elementType, boolean throwIfNull) {
        if (fileImpl == null) {
    ...
    public static class StubIndexReference extends PsiAnchor {
        ...
        public StubIndexReference( final PsiFile file, final int index,  Language language, IStubElementType elementType) {
            myLanguage = language;
