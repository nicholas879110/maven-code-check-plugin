 ...
 */
package com.gome.maven.psi.filters.types;

import com.gome.maven.psi.*;
import com.gome.maven.psi.filters.ElementFilter;
import com.gome.maven.psi.filters.FilterUtil;
...
public class AssignableFromFilter implements ElementFilter{
    ...
    private static boolean isReturnTypeInferrable(PsiMethod method, PsiElement place, PsiType expectedType,  PsiSubstitutor substitutor) {
