...
public class PsiElementResolveResult implements ResolveResult{
    ...
    public PsiElementResolveResult( final PsiElement element, final boolean validResult) {
        myElement = element;
    ...
    public static ResolveResult[] createResults( Collection<? extends PsiElement> elements) {
