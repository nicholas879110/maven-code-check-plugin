...
public class JavaMethodsConflictResolver implements PsiConflictResolver{
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.scope.conflictResolvers.JavaMethodsConflictResolver");
    ...
    public JavaMethodsConflictResolver( PsiElement argumentsList,
    ...
    protected void checkSameSignatures( List<CandidateInfo> conflicts, FactoryMap<MethodCandidateInfo, PsiSubstitutor> map) {
    ...
    public static boolean checkParametersNumber( List<CandidateInfo> conflicts,
    ...
    private static boolean isBoxingHappened(PsiType argType, PsiType parameterType,  LanguageLevel languageLevel) {
    ...
    public void checkPrimitiveVarargs( List<CandidateInfo> conflicts,
                                      final int argumentsCount) {
