...
import com.gome.maven.psi.scope.conflictResolvers.DuplicateConflictResolver;
import com.gome.maven.psi.util.ImportsUtil;
...
public class MethodCandidatesProcessor extends MethodsProcessor{
    ...
    public void addMethod( PsiMethod method, final PsiSubstitutor substitutor, final boolean staticProblem) {
    ...
    protected MethodCandidateInfo createCandidateInfo( PsiMethod method,  PsiSubstitutor substitutor,
