 ...
 */
package com.gome.maven.psi.scope.util;
...
import com.gome.maven.psi.scope.processor.MethodsProcessor;
...
public class PsiScopesUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.scope.util.PsiScopesUtil");
    ...
    public static void setupAndRunProcessor( MethodsProcessor processor,
