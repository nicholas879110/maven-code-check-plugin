...
public class TypeConversionUtil {
    ...
    private static boolean isUnboxable( PsiPrimitiveType left,  PsiClassType right) {
    ...
    public static boolean typesAgree(final  PsiType typeLeft,
                                     final  PsiType typeRight,
    ...
    public static boolean containsWildcards( PsiType leftBound) {
     ...
     * @see InheritanceUtil#isInheritorOrSelf(com.gome.maven.psi.PsiClass, com.gome.maven.psi.PsiClass, boolean)
     */
    ...
    private static PsiSubstitutor checkReferenceList( PsiClassType[] types,
                                                      PsiSubstitutor candidateSubstitutor,
                                                      PsiClass base,
                                                      Set<PsiClass> set,
                                                      PsiManager manager) {
