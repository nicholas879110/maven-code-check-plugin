 ...
 *
 *   <li/> Make a {@link com.gome.maven.psi.util.CachedValue} instance dependent on a specific PSI modification tracker.
 *   To achieve that, one should can one of the constants in this interface as {@link com.gome.maven.psi.util.CachedValueProvider.Result}
 *   dependencies.
 ...
 *   See {@link com.gome.maven.psi.util.PsiModificationTracker.Listener}
 *
 * </ol>
 */
public interface PsiModificationTracker extends ModificationTracker {
    ...
    /**
     * Provides a way to get the instance of {@link com.gome.maven.psi.util.PsiModificationTracker} corresponding to a given project.
     * @see #getInstance(com.gome.maven.openapi.project.Project)
     */
    class SERVICE {
        private SERVICE() {
        }
        ...
        /**
         * @param project
         * @return The instance of {@link com.gome.maven.psi.util.PsiModificationTracker} corresponding to the given project.
         */
    ...
    /**
     * This key can be passed as a dependency in a {@link com.gome.maven.psi.util.CachedValueProvider}.
     * The corresponding {@link com.gome.maven.psi.util.CachedValue} will then be flushed on every physical PSI change.
    ...
    /**
     * This key can be passed as a dependency in a {@link com.gome.maven.psi.util.CachedValueProvider}.
     * The corresponding {@link com.gome.maven.psi.util.CachedValue} will then be flushed on every physical PSI change that doesn't happen inside a Java code block.
    ...
    /**
     * This key can be passed as a dependency in a {@link com.gome.maven.psi.util.CachedValueProvider}.
     * The corresponding {@link com.gome.maven.psi.util.CachedValue} will then be flushed on every physical PSI change that can affect Java structure and resolve.
     ...
     * @see com.gome.maven.util.messages.MessageBus
     */
