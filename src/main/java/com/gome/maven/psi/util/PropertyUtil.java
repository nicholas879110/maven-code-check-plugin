...
import com.gome.maven.util.containers.*;
...
public class PropertyUtil {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.util.PropertyUtil");
    ...
    public static Map<String, PsiMethod> getAllProperties( final PsiClass psiClass,
    ...
    /**
     * Consider using {@link com.gome.maven.codeInsight.generation.GenerateMembersUtil#generateGetterPrototype(com.gome.maven.psi.PsiField)} or
     * {@link com.gome.maven.codeInsight.generation.GenerateMembersUtil#generateSimpleGetterPrototype(com.gome.maven.psi.PsiField)}
    ...
    /**
     * Consider using {@link com.gome.maven.codeInsight.generation.GenerateMembersUtil#generateSetterPrototype(com.gome.maven.psi.PsiField)}
     * or {@link com.gome.maven.codeInsight.generation.GenerateMembersUtil#generateSimpleSetterPrototype(com.gome.maven.psi.PsiField)}
     * to add @Override annotation
     */
    ...
    private static PsiMethod findPropertyMethod( PsiClass aClass,
                                                 String prefix,
                                                 String propertyName,
                                                 PsiField field1) {
