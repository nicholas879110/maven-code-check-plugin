...
public class MethodSignatureUtil {
    ...
    private static boolean checkSignaturesEqualInner( MethodSignature subSignature,
    ...
    public static PsiMethod findMethodInSuperClassBySignatureInDerived( final PsiClass aClass,
