 ...
 */
package com.gome.maven.psi.util.proximity;
...
public class KnownElementWeigher extends ProximityWeigher {
    ...
    @Override
    public Comparable weigh( final PsiElement element,  final ProximityLocation location) {
    ...
    private static Comparable getJdkClassProximity( PsiClass element) {
