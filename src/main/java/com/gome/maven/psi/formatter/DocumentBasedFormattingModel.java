...
public class DocumentBasedFormattingModel implements FormattingModelEx {
    ...
    public DocumentBasedFormattingModel( final FormattingModel originalModel,
                                         final Document document,
                                        final Project project,
                                        final CodeStyleSettings settings,
                                        final FileType fileType,
    ...
    public TextRange replaceWhiteSpace(TextRange textRange, ASTNode nodeAfter, String whiteSpace) {
        ...
        // com.gome.maven.formatting.WhiteSpace and during building formatter model = blocks in e.g. com.gome.maven.psi.formatter.xml.XmlTagBlock
