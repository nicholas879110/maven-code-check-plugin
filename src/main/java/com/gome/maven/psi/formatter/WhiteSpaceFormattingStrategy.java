...
public interface WhiteSpaceFormattingStrategy {
    ...
    CharSequence adjustWhiteSpaceIfNecessary( CharSequence whiteSpaceText,  CharSequence text, int startOffset,
                                             int endOffset, CodeStyleSettings codeStyleSettings, ASTNode nodeAfter);


    /**
     * PSI-based version of {@link #adjustWhiteSpaceIfNecessary(CharSequence, CharSequence, int, int, com.gome.maven.psi.codeStyle.CodeStyleSettings, com.gome.maven.lang.ASTNode)}.
     * <p/>
     ...
     * @return                  symbols to use for replacing <code>[startOffset; endOffset)</code> sub-sequence of the given text
     */
    CharSequence adjustWhiteSpaceIfNecessary( CharSequence whiteSpaceText,  PsiElement startElement, int startOffset,
     ...
     *                           current method call
     */
    boolean addWhitespace( ASTNode treePrev,  LeafElement whiteSpaceElement);
}
