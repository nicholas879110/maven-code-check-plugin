...
import com.gome.maven.openapi.vcs.checkin.ReformatBeforeCheckinHandler;
...
public class FormatterUtil {
    ...
    private static ASTNode getNextOrPrevious( ASTNode node, boolean isNext,  IElementType... typesToIgnore) {
    ...
    public static ASTNode getPreviousNonWhitespaceLeaf( ASTNode node) {
        if (node == null) return null;
    ...
    public static ASTNode getPreviousNonWhitespaceSibling( ASTNode node) {
    ...
    public static ASTNode getNextNonWhitespaceSibling( ASTNode node) {
    ...
    public static boolean isPrecededBy( ASTNode node, TokenSet expectedTypes) {
     ...
     */
    public static void replaceInnerWhiteSpace( final String newWhiteSpaceText,
                                               final ASTNode holder,
                                               final TextRange whiteSpaceRange)
    {
    ...
    private static ASTNode getWsCandidate( ASTNode node) {
        if (node == null) return null;
        ASTNode treePrev = node.getTreePrev();
        if (treePrev != null) {
