...
import com.gome.maven.psi.impl.PsiToDocumentSynchronizer;
...
public class FormattingDocumentModelImpl implements FormattingDocumentModel {
    ...
    @Override
    public CharSequence adjustWhiteSpaceIfNecessary( CharSequence whiteSpaceText, int startOffset, int endOffset,
