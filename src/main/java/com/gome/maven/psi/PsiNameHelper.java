...
import static com.gome.maven.util.ObjectUtils.notNull;
...
public abstract class PsiNameHelper {
    ...
    public static String getPresentableText( String refName,  PsiAnnotation[] annotations,  PsiType[] types) {
    ...
    public static void appendTypeArgs( StringBuilder sb,  PsiType[] types, boolean canonical, boolean annotated) {
    ...
    public static boolean appendAnnotations( StringBuilder sb,  PsiAnnotation[] annotations, boolean canonical) {
        return appendAnnotations(sb, Arrays.asList(annotations), canonical);
    }

    public static boolean appendAnnotations( StringBuilder sb,  List<PsiAnnotation> annotations, boolean canonical) {
