...
import com.gome.maven.lang.injection.*;
 ...
 * <ul>
 * <li>Implement {@link com.gome.maven.psi.LanguageInjector} to describe exact place where injection should occur.</li>
 * <li>Register injection in {@link com.gome.maven.psi.LanguageInjector#EXTENSION_POINT_NAME} extension point.</li>
 * </ul>
...
public interface PsiLanguageInjectionHost extends PsiElement {
     ...
     * in accordance with the host language syntax. The implementation may delegate to {@link com.gome.maven.psi.ElementManipulators#handleContentChange(PsiElement, String)}
     * if {@link com.gome.maven.psi.ElementManipulator} implementation is registered for this element class
