...
import com.gome.maven.psi.scope.processor.MethodCandidatesProcessor;
...
public class PsiDiamondTypeImpl extends PsiDiamondType {
    ...
    private static PsiMethod generateStaticFactory( PsiMethod constructor,
    ...
    private static PsiSubstitutor inferTypeParametersForStaticFactory( PsiMethod staticFactoryMethod,
