...
public class IReparseableElementType extends ILazyParseableElementType {
    ...
    /**
     * The same as {@link this#isParsable(CharSequence, com.gome.maven.lang.Language, com.gome.maven.openapi.project.Project)}
     * but with parent ASTNode of the old node.
     *
     * Override this method only if you really understand what are doing.
     * In other cases override {@link this#isParsable(CharSequence, com.gome.maven.lang.Language, com.gome.maven.openapi.project.Project)}
     *
     ...
     * @return true if the content is valid, false if not
     */
    public boolean isParsable( ASTNode parent, CharSequence buffer, Language fileLanguage, final Project project) {
