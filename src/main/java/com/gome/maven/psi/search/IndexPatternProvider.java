 ...
 * @author yole
 * @since 5.1
 * @see com.gome.maven.psi.search.searches.IndexPatternSearch
 */
public interface IndexPatternProvider {
    ExtensionPointName<IndexPatternProvider> EP_NAME = ExtensionPointName.create("com.gome.maven.indexPatternProvider");
