...
import com.gome.maven.psi.util.MethodSignatureUtil;
...
public class SuperMethodsSearch extends ExtensibleQueryFactory<MethodSignatureBackedByPsiMethod, SuperMethodsSearch.SearchParameters> {
    public static final ExtensionPointName<QueryExecutor> EP_NAME = ExtensionPointName.create("com.gome.maven.superMethodsSearch");
    ...
    public static Query<MethodSignatureBackedByPsiMethod> search( PsiMethod derivedMethod,
