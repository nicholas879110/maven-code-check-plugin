...
public class LocalSearchScope extends SearchScope {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.psi.search.LocalSearchScope");
    ...
    public LocalSearchScope( PsiElement[] scope,  final String displayName, final boolean ignoreInjectedPsi) {
