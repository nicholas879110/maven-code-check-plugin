...
import com.gome.maven.psi.util.PsiElementFilter;
...
/**
 * @see com.gome.maven.psi.util.PsiTreeUtil#processElements(com.gome.maven.psi.PsiElement, PsiElementProcessor)
 */
