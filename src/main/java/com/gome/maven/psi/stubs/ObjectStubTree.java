...
public class ObjectStubTree<T extends Stub> {
    ...
    public ObjectStubTree( final ObjectStubBase root, final boolean withBackReference) {
        myRoot = root;
    ...
    protected static void enumerateStubs( Stub root,  List<Stub> result, int idOffset) {
    ...
    private static class StubIndexSink implements IndexSink, TObjectProcedure<Map<Object, int[]>>,TObjectObjectProcedure<Object,int[]> {
        ...
        @Override
        public void occurrence( final StubIndexKey indexKey,  final Object value) {
