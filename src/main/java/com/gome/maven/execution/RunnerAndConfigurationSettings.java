 ...
 *
 * @author anna
 * @see RunManager#createRunConfiguration(String, com.gome.maven.execution.configurations.ConfigurationFactory)
 */
public interface RunnerAndConfigurationSettings {
     ...
     * @see RunManager#makeStable(com.gome.maven.execution.configurations.RunConfiguration)
     */
     ...
     * configuration.
     */
    void checkSettings( Executor executor) throws RuntimeConfigurationException;
