...
package com.gome.maven.execution.junit;
...
/**
 * @deprecated please use {@link com.gome.maven.execution.actions.RunConfigurationProducer} instead
 */
public abstract class RuntimeConfigurationProducer implements Comparable, Cloneable {
    public static final ExtensionPointName<RuntimeConfigurationProducer> RUNTIME_CONFIGURATION_PRODUCER = ExtensionPointName.create("com.gome.maven.configurationProducer");
    ...
    protected RunnerAndConfigurationSettings findExistingByElement(final Location location,
                                                                    final List<RunnerAndConfigurationSettings> existingConfigurations,
