...
import com.gome.maven.execution.DefaultExecutionResult;
...
import com.gome.maven.ide.HelpIdProvider;
...
public class RunContentDescriptor implements Disposable {
    ...
    public RunContentDescriptor( ExecutionConsole executionConsole,
