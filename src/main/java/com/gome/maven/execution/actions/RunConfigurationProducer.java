 ...
 * run configurations that can be created from context should extend the {@link com.gome.maven.execution.configurations.LocatableConfigurationBase} class.
 *
 * @since 13
 * @author yole
 */
public abstract class RunConfigurationProducer<T extends RunConfiguration> {
    public static final ExtensionPointName<RunConfigurationProducer> EP_NAME = ExtensionPointName.create("com.gome.maven.runConfigurationProducer");
    ...
    protected RunnerAndConfigurationSettings cloneTemplateConfiguration( final ConfigurationContext context) {
