...
public class LogFileOptions implements JDOMExternalizable {
    ...
    public LogFileOptions(String name, String path,  final Charset charset, boolean enabled, boolean skipContent, final boolean showAll) {
        myName = name;
        myPathPattern = path;
        myEnabled = enabled;
    ...
    public static boolean areEqual( LogFileOptions options1,  LogFileOptions options2) {
