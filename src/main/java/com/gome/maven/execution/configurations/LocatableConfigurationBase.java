...
/**
 * Common base class that should be used for configurations that can be created from context by a {@link com.gome.maven.execution.actions.RunConfigurationProducer}}.
