 ...
 *
 * @see com.gome.maven.execution.RunManager
...
public interface RunConfiguration extends RunProfile, JDOMExternalizable, Cloneable {
     ...
     * returned from this method may also implement {@link com.gome.maven.execution.impl.CheckableRunConfigurationEditor}. The returned object
     * can also implement {@link com.gome.maven.openapi.options.SettingsEditorGroup} if the settings it provides need to be displayed in
     * multiple tabs.
     *
