...
import com.gome.maven.diagnostic.logging.LogConsole;
import com.gome.maven.execution.ExecutionTarget;
...
public abstract class RunConfigurationBase extends UserDataHolderBase implements RunConfiguration, TargetAwareRunProfile {
    ...
    protected RunConfigurationBase(final Project project,  ConfigurationFactory factory, final String name) {
        myProject = project;
        myFactory = factory;
        myName = name;
    ...
    public void checkRunnerSettings( ProgramRunner runner,
                                     RunnerSettings runnerSettings,
                                     ConfigurationPerRunnerSettings configurationPerRunnerSettings) throws RuntimeConfigurationException {
    }
