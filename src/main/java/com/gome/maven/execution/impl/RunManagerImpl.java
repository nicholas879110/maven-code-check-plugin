...
import com.gome.maven.openapi.updateSettings.impl.pluginsAdvertisement.UnknownFeaturesCollector;
...
public class RunManagerImpl extends RunManagerEx implements PersistentStateComponent<Element>, NamedComponent, Disposable {
    ...
    @Override
    public void setSelectedConfiguration( RunnerAndConfigurationSettings settings) {
        setSelectedConfigurationId(settings == null ? null : settings.getUniqueID());
        fireRunConfigurationSelected();
    }

    private void setSelectedConfigurationId( String id) {
    ...
    public static boolean canRunConfiguration( ExecutionEnvironment environment) {
    ...
    private String findExistingConfigurationId( RunnerAndConfigurationSettings settings) {
        if (settings != null) {
    ...
    private List<BeforeRunTask> readStepsBeforeRun( Element child,  RunnerAndConfigurationSettings settings) {
        ...
        if (child != null) {
            for (Element methodElement : (List<Element>)child.getChildren(OPTION)) {
    ...
    @Override
    public Icon getConfigurationIcon( final RunnerAndConfigurationSettings settings) {
    ...
    public RunnerAndConfigurationSettings findConfigurationByName( String name) {
    ...
    @Override
    public final void setBeforeRunTasks(final RunConfiguration runConfiguration,  List<BeforeRunTask> tasks, boolean addEnabledTemplateTasksIfAbsent) {
