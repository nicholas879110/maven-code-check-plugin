...
import com.gome.maven.codeInspection.InspectionsReportConverter;
...
public class XSLTReportConverter implements InspectionsReportConverter {
    ...
    public XSLTReportConverter( final String xsltSchemePath) {
    ...
    @Override
    public void convert( final String rawDataDirectoryPath,
                         final String outputPath,
                         final Map<String, Tools> tools,
                         final List<File> inspectionsResults) throws InspectionsReportConverter.ConversionException {
