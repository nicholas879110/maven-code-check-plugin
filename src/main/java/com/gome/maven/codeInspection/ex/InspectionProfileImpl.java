...
public class InspectionProfileImpl extends ProfileEx implements ModifiableModel, InspectionProfile, ExternalizableScheme {
    ...
    private static InspectionToolWrapper copyToolSettings( InspectionToolWrapper toolWrapper)
    ...
    public void readExternal( Element element) throws InvalidDataException {
        ...
        for (Element toolElement : (List<Element>)element.getChildren(INSPECTION_TOOL_TAG)) {
            // make clone to avoid retaining memory via o.parent pointers
            toolElement = (Element) toolElement.clone();
    ...
    @Override
    public InspectionProfileEntry getUnwrappedTool( String shortName,  PsiElement element) {
    ...
    public void initInspectionTools( Project project) {
    ...
    public void setErrorLevel( List<HighlightDisplayKey> keys,  HighlightDisplayLevel level, String scopeName, Project project) {
