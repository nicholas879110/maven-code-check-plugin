...
public class GlobalInspectionContextBase extends UserDataHolderBase implements GlobalInspectionContext {
    ...
    public boolean isToCheckMember( RefElement owner,  InspectionProfileEntry tool) {
    ...
    public void performInspectionsWithProgress( final AnalysisScope scope, final boolean runGlobalToolsOnly, final boolean isOfflineInspections) {
    ...
    public void initializeTools( List<Tools> outGlobalTools,
    ...
    private static void classifyTool( List<Tools> outGlobalTools,
                                      List<Tools> outLocalTools,
                                      List<Tools> outGlobalSimpleTools,
                                      Tools currentTools,
    ...
    public void codeCleanup( Project project,
                             AnalysisScope scope,
    ...
    public static void cleanupElements( final Project project,  final Runnable runnable,  PsiElement... scope) {
