...
public class InspectionToolRegistrar {
    ...
    private static void registerTools( Collection<InspectionToolProvider> providers,
                                       List<Factory<InspectionToolWrapper>> factories) {
    ...
    private static String checkTool( final InspectionToolWrapper toolWrapper) {
