 ...
 */
package com.gome.maven.codeInspection.java15api;
...
public class Java15APIUsageInspectionBase extends BaseJavaBatchLocalInspectionTool {
    ...
    private static boolean isForbiddenSignature( String signature,  LanguageLevel languageLevel,  Set<String> forbiddenApi) {
    ...
    /**
     * please leave public for {@link #com.gome.maven.codeInspection.JavaAPIUsagesInspectionTest#testCollectSinceApiUsages}
     */
