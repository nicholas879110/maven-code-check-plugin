...
import com.gome.maven.codeInspection.ui.actions.SuppressActionWrapper;
...
class Browser extends JPanel {
    ...
    private String generateHTML(final RefEntity refEntity,  final InspectionToolWrapper toolWrapper) {
                    ...
                    if (!activeSuppressActions.isEmpty()) {
                        ...
                        for (AnAction suppressAction : activeSuppressActions) {
                            ...
                            HTMLComposer.appendAfterHeaderIndention(buf);
                             final String href = "<a HREF=\"file://bred.txt#suppress:" + idx + "\">" + suppressAction.getTemplatePresentation().getText() + "</a>";
                            buf.append(href);
                            idx++;
                        }
                    }
