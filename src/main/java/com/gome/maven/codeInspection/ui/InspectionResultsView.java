...
import com.gome.maven.codeInspection.ui.actions.ExportHTMLAction;
import com.gome.maven.codeInspection.ui.actions.InspectionsOptionsToolbarAction;
import com.gome.maven.codeInspection.ui.actions.InvokeQuickFixAction;
...
public class InspectionResultsView extends JPanel implements Disposable, OccurenceNavigator, DataProvider {
    ...
    public InspectionNode addTool( final InspectionToolWrapper toolWrapper, HighlightDisplayLevel errorLevel, boolean groupedBySeverity) {
        String groupName =
