...
import com.gome.maven.ui.OptionGroup;
...
public class ExportToHTMLDialog extends DialogWrapper{
    ...
    protected JComponent createNorthPanel() {
        ...
        optionGroup.add(com.gome.maven.codeEditor.printing.ExportToHTMLDialog.assignLabel(myTargetDirectoryField, myProject));
