...
public abstract class GlobalInspectionTool extends InspectionProfileEntry {
     ...
     * graph nodes, through calls to {@link RefEntity#putUserData(com.gome.maven.openapi.util.Key, Object)}.
     *
     ...
     * {@link #runInspection(com.gome.maven.analysis.AnalysisScope, InspectionManager, GlobalInspectionContext, ProblemDescriptionsProcessor)})
     * ProgressIndicator should progress with {@link com.gome.maven.codeInspection.GlobalInspectionContext#incrementJobDoneAmount(com.gome.maven.codeInspection.ex.JobDescriptor, String)}
     */
