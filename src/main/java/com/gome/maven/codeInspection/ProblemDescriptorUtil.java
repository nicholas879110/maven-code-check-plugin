...
//    @MagicConstant(flags = {NONE, APPEND_LINE_NUMBER, TRIM_AT_END, TRIM_AT_TREE_END})
    ...
    public static String renderDescriptionMessage( CommonProblemDescriptor descriptor, PsiElement element, boolean appendLineNumber) {
        return renderDescriptionMessage(descriptor, element, appendLineNumber ? APPEND_LINE_NUMBER : NONE);
    }

    public static String renderDescriptionMessage( CommonProblemDescriptor descriptor, PsiElement element, @FlagConstant int flags) {
    ...
    public static String renderDescriptionMessage( CommonProblemDescriptor descriptor, PsiElement element) {
        return renderDescriptionMessage(descriptor, element, false);
    }

    
    public static HighlightInfoType highlightTypeFromDescriptor( ProblemDescriptor problemDescriptor,
