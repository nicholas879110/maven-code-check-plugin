...
import com.gome.maven.psi.impl.JavaConstantExpressionEvaluator;
...
public class DfaExpressionFactory {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInspection.dataFlow.value.DfaExpressionFactory");
    ...
    private PsiVariable getArrayIndexVariable( PsiExpression indexExpression) {
