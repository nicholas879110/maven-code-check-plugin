...
public class DfaConstValue extends DfaValue {
    ...
    public static class Factory {
        ...
        public DfaConstValue createFromValue(Object value, final PsiType type,  PsiVariable constant) {
    ...
    private DfaConstValue(Object value, DfaValueFactory factory,  PsiVariable constant) {
        super(factory);
        myValue = value;
        myConstant = constant;
    }
