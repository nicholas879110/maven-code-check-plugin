...
import com.gome.maven.openapi.util.UnorderedPair;
...
public class DfaMemoryStateImpl implements DfaMemoryState {
    ...
    List<DfaValue> getEquivalentValues( DfaValue dfaValue) {
    ...
    private boolean canBeNaN( DfaValue dfaValue) {
    ...
    private boolean isEffectivelyNaN( DfaValue dfaValue) {
    ...
    private boolean applyRelation( final DfaValue dfaLeft,  final DfaValue dfaRight, boolean isNegated) {
