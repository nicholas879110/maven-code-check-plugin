...
import static com.gome.maven.codeInspection.dataFlow.MethodContract.ValueConstraint.*;
import static com.gome.maven.codeInspection.dataFlow.MethodContract.createConstraintArray;

/**
 * @author peter
 */
public class HardcodedContracts {
    public static List<MethodContract> getHardcodedContracts( PsiMethod method,  PsiMethodCallExpression call) {
    ...
    public static boolean hasHardcodedContracts( PsiElement element) {
