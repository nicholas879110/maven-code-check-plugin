...
public class ValuableDataFlowRunner extends DataFlowRunner {
    ...
    static class ValuableDfaVariableState extends DfaVariableState {
        ...
        private ValuableDfaVariableState(Set<DfaPsiType> instanceofValues,
                                         ...
                                         Nullness nullability, DfaValue value,  FList<PsiExpression> concatenation) {
        ...
        @Override
        public DfaVariableState withValue( final DfaValue value) {
        ...
        public ValuableDfaVariableState withExpression( final FList<PsiExpression> concatenation) {
