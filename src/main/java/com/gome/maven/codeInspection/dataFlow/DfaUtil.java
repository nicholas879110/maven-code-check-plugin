...
public class DfaUtil {
    ...
    public static Collection<PsiExpression> getCachedVariableValues( final PsiVariable variable,  final PsiElement context) {
    ...
    private static Map<PsiElement, ValuableInstructionVisitor.PlaceResult> getCachedPlaceResults( final PsiElement codeBlock) {
    ...
    public static Nullness checkNullness( final PsiVariable variable,  final PsiElement context) {
