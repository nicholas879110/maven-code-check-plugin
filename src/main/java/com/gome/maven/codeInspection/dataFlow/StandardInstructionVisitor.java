...
public class StandardInstructionVisitor extends InstructionVisitor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInspection.dataFlow.StandardInstructionVisitor");
    ...
    private DfaValue getMethodResultValue(MethodCallInstruction instruction,  DfaValue qualifierValue, DfaValueFactory factory) {
    ...
    public void skipConstantConditionReporting( PsiElement anchor) {
    ...
    public boolean silenceConstantCondition( PsiElement element) {
