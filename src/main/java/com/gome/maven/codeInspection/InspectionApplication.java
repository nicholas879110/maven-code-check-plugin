...
import com.gome.maven.conversion.ConversionListener;
import com.gome.maven.conversion.ConversionService;
import com.gome.maven.ide.impl.PatchProjectUtil;
...
import com.gome.maven.psi.search.GlobalSearchScopes;
import com.gome.maven.psi.search.GlobalSearchScopesCore;
...
public class InspectionApplication {
    ...
    private InspectionsReportConverter getReportConverter( final String outputFormat) {
    ...
    private static void describeInspections( String myOutputPath, final String name) throws IOException {
