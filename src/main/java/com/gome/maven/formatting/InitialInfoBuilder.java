...
import com.gome.maven.psi.formatter.ReadOnlyBlockInformationProvider;
...
class InitialInfoBuilder {
    ...
    private void doIteration( State state) {
    ...
    private static Throwable makeLanguageStackTrace( Throwable currentThrowable,  PsiFile file) {
    ...
    private class State {
        ...
        State( Block parentBlock,  CompositeBlockWrapper wrappedBlock,  WrapImpl parentBlockWrap,
         ...
         */
        public boolean childBlockProcessed( Block child,  AbstractBlockWrapper wrappedChild) {
