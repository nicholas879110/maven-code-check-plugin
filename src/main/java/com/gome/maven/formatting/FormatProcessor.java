...
import com.gome.maven.openapi.editor.TextChange;
import com.gome.maven.openapi.editor.ex.DocumentEx;
import com.gome.maven.openapi.editor.impl.BulkChangesMerger;
import com.gome.maven.openapi.editor.impl.TextChangeImpl;
...
class FormatProcessor {
     ...
     */
    private void doIterationsSynchronously( FormattingStateId state) {
    ...
    private boolean applyChangesAtRewriteMode( final List<LeafBlockWrapper> blocksToModify,
    ...
    private CommonCodeStyleSettings.IndentOptions getIndentOptionsToUse( AbstractBlockWrapper block,
                                                                         CommonCodeStyleSettings.IndentOptions fallbackIndentOptions)
    {
    ...
    private static ChildAttributesInfo getChildAttributesInfo( final Block block,
                                                              final int index,
    ...
    private static AbstractBlockWrapper getLastNestedCompositeBlockForSameRange( final AbstractBlockWrapper block) {
     ...
     */
    private static int calcShift( final IndentInside oldIndent,
                                  final IndentInside newIndent,
                                  final CommonCodeStyleSettings.IndentOptions options)
    {
    ...
    private static class CaretOffsetUpdater {
        ...
        private CaretOffsetUpdater( Document document) {
        ...
        private void update( List<? extends TextChange> changes) {
