...
public class CoreFormatterUtil {
    ...
    public static FormattingModel buildModel( FormattingModelBuilder builder,
                                              PsiElement element,
    ...
    public static AlignmentImpl getAlignment(final  AbstractBlockWrapper block) {
     ...
     */
    public static int getStartColumn( LeafBlockWrapper block) {
        if (block != null) {
            int result = 0;
            while (true) {
     ...
     */
    public static boolean allowBackwardAlignment( LeafBlockWrapper first,  LeafBlockWrapper second,
