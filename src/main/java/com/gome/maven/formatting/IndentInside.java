...
class IndentInside {
    ...
    static IndentInside getLastLineIndent( final CharSequence text) {
        CharSequence lastLine = getLastLine(text);
        return createIndentOn(lastLine);
    }

    
    static IndentInside createIndentOn( final CharSequence lastLine) {
    ...
    static CharSequence getLastLine( final CharSequence text) {
