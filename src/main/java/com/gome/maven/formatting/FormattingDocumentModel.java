 ...
 *
 * @see com.gome.maven.formatting.FormattingModel#getDocumentModel()
 */
...
public interface FormattingDocumentModel {
    ...
    CharSequence adjustWhiteSpaceIfNecessary( CharSequence whiteSpaceText, int startOffset, int endOffset,
