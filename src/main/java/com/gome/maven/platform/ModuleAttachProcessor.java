...
import com.gome.maven.openapi.roots.ModuleRootModificationUtil;
...
import com.gome.maven.openapi.vcs.VcsDirectoryMapping;
...
public class ModuleAttachProcessor extends ProjectAttachProcessor {
    ...
    private static void attachModule(Project project, VirtualFile imlFile,  ProjectOpenedCallback callback) {
        try {
    ...
    private static Module addPrimaryModuleDependency(Project project,  Module newModule) {
    ...
    public static String getMultiProjectDisplayName( Project project) {
