...
import com.gome.maven.openapi.vfs.ex.http.HttpFileSystem;
...
public class XmlResourceResolver implements XMLEntityResolver {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.xml.util.XmlResourceResolver");
