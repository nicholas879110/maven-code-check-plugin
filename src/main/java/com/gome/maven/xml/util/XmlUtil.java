...
import com.gome.maven.codeInsight.completion.CompletionUtilCore;
import com.gome.maven.codeInsight.daemon.Validator;
...
import com.gome.maven.javaee.UriUtil;
...
import com.gome.maven.patterns.StringPattern;
import com.gome.maven.patterns.XmlPatterns;
import com.gome.maven.psi.*;
import com.gome.maven.psi.codeStyle.CodeStyleManager;
import com.gome.maven.psi.filters.ElementFilter;
import com.gome.maven.psi.filters.XmlTagFilter;
import com.gome.maven.psi.filters.position.FilterPattern;
import com.gome.maven.psi.impl.source.html.HtmlDocumentImpl;
import com.gome.maven.psi.impl.source.tree.CompositeElement;
import com.gome.maven.psi.impl.source.tree.LeafElement;
import com.gome.maven.psi.impl.source.xml.XmlEntityCache;
import com.gome.maven.psi.impl.source.xml.XmlEntityRefImpl;
import com.gome.maven.psi.scope.processor.FilterElementProcessor;
...
import com.gome.maven.xml.*;
import com.gome.maven.xml.impl.schema.ComplexTypeDescriptor;
import com.gome.maven.xml.impl.schema.TypeDescriptor;
import com.gome.maven.xml.impl.schema.XmlElementDescriptorImpl;
import com.gome.maven.xml.impl.schema.XmlNSDescriptorImpl;
import com.gome.maven.xml.index.IndexedRelevantResource;
import com.gome.maven.xml.index.XmlNamespaceIndex;
import com.gome.maven.xml.index.XsdNamespaceBuilder;
...
public class XmlUtil {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.xml.util.XmlUtil");
    ...
    public static String getTargetSchemaNsFromTag( final XmlTag xmlTag) {
    ...
    public static String[][] getDefaultNamespaces(final XmlDocument document) {
        ...
        if (tag == null) return null;
         ...
         final XmlFileNSInfoProvider[] nsProviders = Extensions.getExtensions(XmlFileNSInfoProvider.EP_NAME);
        if (file != null) {
    ...
    public static XmlElementDescriptor findXmlDescriptorByType(final XmlTag xmlTag,  XmlTag context) {
