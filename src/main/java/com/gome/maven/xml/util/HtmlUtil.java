...
import com.gome.maven.codeInspection.htmlInspections.XmlEntitiesInspection;
...
import com.gome.maven.psi.impl.source.html.dtd.HtmlAttributeDescriptorImpl;
import com.gome.maven.psi.impl.source.parsing.xml.HtmlBuilderDriver;
import com.gome.maven.psi.impl.source.parsing.xml.XmlBuilder;
...
import com.gome.maven.xml.impl.schema.XmlAttributeDescriptorImpl;
import com.gome.maven.xml.impl.schema.XmlElementDescriptorImpl;
import com.gome.maven.xml.util.documentation.HtmlDescriptorsTable;
import com.gome.maven.xml.util.documentation.MimeTypeDictionary;
...
public class HtmlUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.xml.util.HtmlUtil");
    ...
    public static String getEntitiesString( PsiElement context,  String inspectionName) {
    ...
    public static Charset detectCharsetFromMetaTag( CharSequence content) {
        ...
        try {
            new HtmlBuilderDriver(content).build(new XmlBuilder() {
                ...
                @Override
                public void doctype( final CharSequence publicId,
                                     final CharSequence systemId,
