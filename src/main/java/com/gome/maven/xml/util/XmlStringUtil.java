...
import static com.gome.maven.xml.CommonXmlStrings.*;
/**
 * @author yole
 */
public class XmlStringUtil {
    ...
    public static String escapeString( String str, final boolean escapeWhiteSpace, final boolean convertNoBreakSpace) {
