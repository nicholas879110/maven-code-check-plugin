 ...
 */
package com.gome.maven.xml.actions;

import com.gome.maven.codeInsight.CodeInsightUtilBase;
import com.gome.maven.codeInsight.CodeInsightUtilCore;
import com.gome.maven.codeInsight.actions.SimpleCodeInsightAction;
import com.gome.maven.codeInsight.hint.HintManager;
import com.gome.maven.codeInsight.lookup.impl.LookupCellRenderer;
import com.gome.maven.codeInsight.template.TemplateBuilder;
import com.gome.maven.codeInsight.template.TemplateBuilderFactory;
import com.gome.maven.codeInsight.template.impl.MacroCallNode;
import com.gome.maven.codeInsight.template.macro.CompleteMacro;
import com.gome.maven.codeInsight.template.macro.CompleteSmartMacro;
...
import com.gome.maven.xml.XmlElementsGroup;
...
public class GenerateXmlTagAction extends SimpleCodeInsightAction {
    ...
    public static void generateTag( XmlTag newTag, Editor editor) {
        generateRaw(newTag);
