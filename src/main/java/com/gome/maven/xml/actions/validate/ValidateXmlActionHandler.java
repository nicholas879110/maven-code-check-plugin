 ...
 */
package com.gome.maven.xml.actions.validate;
...
import com.gome.maven.xml.util.XmlResourceResolver;
...
public class ValidateXmlActionHandler {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.xml.actions.validate.ValidateXmlAction");
