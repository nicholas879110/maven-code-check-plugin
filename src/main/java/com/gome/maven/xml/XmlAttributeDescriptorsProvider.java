...
public interface XmlAttributeDescriptorsProvider {
    ...
    ExtensionPointName<XmlAttributeDescriptorsProvider> EP_NAME = new ExtensionPointName<XmlAttributeDescriptorsProvider>("com.gome.maven.xml.attributeDescriptorsProvider");
