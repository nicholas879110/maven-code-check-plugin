...
import com.gome.maven.openapi.util.FieldCache;
import com.gome.maven.psi.PsiElement;
import com.gome.maven.psi.impl.source.resolve.reference.impl.providers.FileReferenceSet;
import com.gome.maven.psi.impl.source.resolve.reference.impl.providers.SchemaReferencesProvider;
...
public class ComplexTypeDescriptor extends TypeDescriptor {
    ...
    public XmlAttributeDescriptor[] getAttributes( XmlElement context) {
        return myAttributeDescriptorsCache.get(null, this, context);
    }

    // Read-only calculation
    private XmlAttributeDescriptor[] doCollectAttributes( final XmlElement context) {
    ...
    public CanContainAttributeType canContainAttribute(String namespace,  String qName) {
        if (qName == null) {
