...
import com.gome.maven.xml.XmlNSDescriptorEx;
import com.gome.maven.xml.impl.ExternalDocumentValidator;
...
public class XmlNSDescriptorImpl implements XmlNSDescriptorEx,Validator<XmlDocument>, DumbAware, XmlNSTypeDescriptorProvider {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.xml.impl.schema.XmlNSDescriptorImpl");
    ...
    private static void collectDependencies( XmlTag myTag,  XmlFile myFile,  Set<PsiFile> visited) {
