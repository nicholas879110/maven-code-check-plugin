...
import com.gome.maven.openapi.diagnostic.ErrorLogger;
...
public class DefaultIdeaErrorLogger implements ErrorLogger {
    ...
    public boolean canHandle(IdeaLoggingEvent event) {
        ...
        try {
            ...
            if (e.getMessage().contains("Could not initialize class com.gome.maven.diagnostic.IdeErrorsDialog")) {
    ...
    public void handle(IdeaLoggingEvent event) {
        ...
        try {
            ...
            if (message != null && message.contains("Could not initialize class com.gome.maven.diagnostic.MessagePool") ||
