...
public class LogMessageEx extends LogMessage {
     ...
     * @param notificationText text to show in the error balloon that is popped up automatically. Default is <code>com.gome.maven.diagnostic.IdeMessagePanel#INTERNAL_ERROR_NOTICE</code>
     * @param attachments      attachments that will be suggested to include to the report
     */
