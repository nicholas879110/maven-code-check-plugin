...
public class VMOptions {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.diagnostic.VMOptions");
     ...
     private static final String XMX_OPTION = "-" + XMX_OPTION_NAME;
     private static final String PERM_GEN_OPTION = "-" + PERM_GEN_OPTION_NAME + "=";
     private static final String CODE_CACHE_OPTION = "-" + CODE_CACHE_OPTION_NAME + "=";
     ...
     private static final Pattern CODE_CACHE_PATTERN = Pattern.compile(CODE_CACHE_OPTION + MEM_SIZE_EXPR);
