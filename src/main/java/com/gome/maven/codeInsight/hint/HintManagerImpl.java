...
public class HintManagerImpl extends HintManager implements Disposable {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.hint.HintManager");
     ...
     */
    public static Point getHintPosition( LightweightHint hint,
                                         Editor editor,
                                         LogicalPosition pos,
                                        @PositionFlags short constraint) {
    ...
    private static JComponent getExternalComponent( Editor editor) {
    ...
    public void showInformationHint( Editor editor,  JComponent component, boolean showByBalloon) {
    ...
    @Override
    public void showErrorHint( Editor editor,
                               String hintText,
                              int offset1,
                              int offset2,
                              short constraint,
    ...
    @Override
    public void showQuestionHint( Editor editor,  String hintText, int offset1, int offset2,  QuestionAction action) {
    ...
    private final class MyProjectManagerListener extends ProjectManagerAdapter {
        ...
        public void projectClosed(Project project) {
            ApplicationManager.getApplication().assertIsDispatchThread();
            // avoid leak through com.gome.maven.codeInsight.hint.TooltipController.myCurrentTooltip
