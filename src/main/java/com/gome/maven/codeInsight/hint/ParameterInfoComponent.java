...
import com.gome.maven.lang.parameterInfo.ParameterInfoHandler;
import com.gome.maven.lang.parameterInfo.ParameterInfoUIContextEx;
...
public class ParameterInfoComponent extends JPanel {
    ...
    public static ParameterInfoUIContextEx createContext(Object[] objects, Editor editor,  ParameterInfoHandler handler, int currentParameterIndex) {
        return createContext(objects, editor, handler, currentParameterIndex, null);
    }

    
    public static ParameterInfoUIContextEx createContext(Object[] objects, Editor editor,  ParameterInfoHandler handler, int currentParameterIndex,  PsiElement parameterOwner) {
    ...
    private class OneLineComponent extends JPanel {
        ...
        private String setup(String text,
                             boolean isDisabled,
                             boolean isStrikeout,
                             Color background,  TextRange range) {
            Map<TextRange, ParameterInfoUIContextEx.Flag> flagsMap = new TreeMap<TextRange, ParameterInfoUIContextEx.Flag>(TEXT_RANGE_COMPARATOR);
            if (range != null)
        ...
        private String setup( String text,  Map<TextRange, ParameterInfoUIContextEx.Flag> flagsMap,  Color background) {
        ...
        private String buildLabelText( final String text,  final Map<TextRange, ParameterInfoUIContextEx.Flag> flagsMap) {
        ...
        private String getTag( final String tagValue) {
            return "<" + tagValue + ">";
        }

        private String getClosingTag( final String tagValue) {
            return "</" + tagValue + ">";
        }
