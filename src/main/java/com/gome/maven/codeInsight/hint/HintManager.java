...
//    @MagicConstant(flags = {HIDE_BY_ESCAPE, HIDE_BY_ANY_KEY, HIDE_BY_LOOKUP_ITEM_CHANGE, HIDE_BY_TEXT_CHANGE, HIDE_BY_OTHER_HINT, HIDE_BY_SCROLLING, HIDE_IF_OUT_OF_EDITOR, UPDATE_BY_SCROLLING, HIDE_BY_MOUSEOVER})
    ...
    public abstract void showHint( JComponent component,  RelativePoint p, @HideFlags int flags, int timeout);

    public abstract void showErrorHint( Editor editor,  String text);
    public abstract void showErrorHint( Editor editor,  String text, @PositionFlags short position);

    public abstract void showInformationHint( Editor editor,  String text);

    public abstract void showInformationHint( Editor editor,  JComponent component);

    public abstract void showQuestionHint( Editor editor,  String hintText, int offset1, int offset2,  QuestionAction action);

    public abstract boolean hideHints(@HideFlags int mask, boolean onlyOne, boolean editorChanged);

    public abstract void showErrorHint( Editor editor,  String hintText, int offset1, int offset2, @PositionFlags short constraint, @HideFlags int flags, int timeout);
