 ...
 */
package com.gome.maven.codeInsight.runner;
...
public interface JavaMainMethodProvider {
    ...
    ExtensionPointName<JavaMainMethodProvider> EP_NAME = ExtensionPointName.create("com.gome.maven.javaMainMethodProvider");
