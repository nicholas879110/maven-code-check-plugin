...
import com.gome.maven.codeInsight.lookup.LookupValueWithUIHint;
...
public class LookupCellRenderer implements ListCellRenderer {
    ...
    private String trimLabelText( String text, int maxWidth, FontMetrics metrics) {
    ...
    public static Icon augmentIcon( Icon icon,  Icon standard) {
        if (icon == null) {
            return standard;
        }
