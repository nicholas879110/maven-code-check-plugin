...
import com.gome.maven.psi.ResolveResult;
...
/**
 * A typical way to create lookup element is to use {@link com.gome.maven.codeInsight.lookup.LookupElementBuilder}.
 ...
 *
 * @see com.gome.maven.codeInsight.completion.PrioritizedLookupElement
 * @author peter
 */
public abstract class LookupElement extends UserDataHolderBase {
    ...
    /**
     * use {@link #as(com.gome.maven.openapi.util.ClassConditionKey)} instead
     */
    @Deprecated
