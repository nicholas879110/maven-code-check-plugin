 ...
 * {@link #applyPolicy(LookupElement)} to decorate {@link com.gome.maven.codeInsight.lookup.LookupElement} with correct policy.
 *
 * Use this only in simple cases, use {@link com.gome.maven.codeInsight.completion.CompletionContributor#handleAutoCompletionPossibility(com.gome.maven.codeInsight.completion.AutoCompletionContext)}
 * for finer tuning.
 *
 * @author peter
 */
