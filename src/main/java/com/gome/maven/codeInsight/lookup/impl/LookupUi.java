...
import com.gome.maven.codeInsight.completion.CodeCompletionFeatures;
import com.gome.maven.codeInsight.completion.ShowHideIntentionIconLookupAction;
import com.gome.maven.codeInsight.hint.HintManagerImpl;
import com.gome.maven.codeInsight.lookup.LookupElement;
import com.gome.maven.codeInsight.lookup.LookupElementAction;
...
class LookupUi {
    ...
    private void updateHint( final LookupElement item) {
        myLookup.checkValid();
