...
import com.gome.maven.codeInsight.completion.JavaMethodCallElement;
...
public class LookupItemUtil{
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.lookup.LookupItemUtil");

    private LookupItemUtil() {
    }

    
    public static LookupElement addLookupItem(Collection<LookupElement> set,  Object object) {
        return addLookupItem(set, object, new CamelHumpMatcher(""));
    }

    
    public static LookupElement addLookupItem(Collection<LookupElement> set,  Object object, PrefixMatcher matcher) {
