...
import com.gome.maven.codeInsight.lookup.DefaultLookupItemRenderer;
...
import com.gome.maven.psi.impl.beanProperties.BeanPropertyElement;
...
public class JavaElementLookupRenderer implements ElementLookupRenderer {
    ...
    private static String getTypeText(LookupItem item,  PsiType returnType) {
        if (returnType == null) {
            return null;
        }
