...
public abstract class LookupElementDecorator<T extends LookupElement> extends LookupElement {
    ...
    public static <T extends LookupElement> LookupElementDecorator<T> withInsertHandler( T element,  final InsertHandler<? super LookupElementDecorator<T>> insertHandler) {
        return new InsertingDecorator<T>(element, insertHandler);
    }

    
    public static <T extends LookupElement> LookupElementDecorator<T> withRenderer( final T element,  final LookupElementRenderer<? super LookupElementDecorator<T>> visagiste) {
