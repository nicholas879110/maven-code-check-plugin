...
public class PsiTypeLookupItem extends LookupItem {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.lookup.PsiTypeLookupItem");
    ...
    private PsiTypeLookupItem(Object o,   String lookupString, boolean diamond, int bracketsCount, InsertHandler<PsiTypeLookupItem> fixer) {
