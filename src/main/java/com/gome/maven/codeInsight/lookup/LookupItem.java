...
import com.gome.maven.codeInsight.lookup.impl.ElementLookupRenderer;
...
public class LookupItem<T> extends MutableLookupElement<T> implements Comparable {
    ...
    public static TailType handleCompletionChar( final Editor editor,  final LookupElement lookupElement, final char completionChar) {
    ...
    @Override
    public LookupItem<T> setInsertHandler( final InsertHandler<? extends LookupElement> handler) {
    ...
    public LookupItem<T> setPresentableText( final String displayText) {
