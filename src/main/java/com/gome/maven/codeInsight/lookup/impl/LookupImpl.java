...
public class LookupImpl extends LightweightHint implements LookupEx, Disposable, WeighingContext {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.lookup.impl.LookupImpl");
    ...
    private static boolean containsDummyIdentifier( final String s) {
    ...
    public void finishLookup(char completionChar,  final LookupElement item) {
    ...
    private void fireCurrentItemChanged( LookupElement oldItem,  LookupElement currentItem) {
