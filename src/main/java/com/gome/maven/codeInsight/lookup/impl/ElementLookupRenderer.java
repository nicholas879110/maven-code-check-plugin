...
/**
 * @author yole
 * @deprecated use {@link com.gome.maven.codeInsight.lookup.LookupElement#renderElement(com.gome.maven.codeInsight.lookup.LookupElementPresentation)}
 */
@Deprecated
public interface ElementLookupRenderer<T> {
    ExtensionPointName<ElementLookupRenderer> EP_NAME = ExtensionPointName.create("com.gome.maven.elementLookupRenderer");
