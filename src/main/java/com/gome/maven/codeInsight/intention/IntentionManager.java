...
public abstract class IntentionManager  {
    public static final ExtensionPointName<IntentionActionBean> EP_INTENTION_ACTIONS = new ExtensionPointName<IntentionActionBean>("com.gome.maven.intentionAction");
    ...
    public abstract void registerIntentionAndMetaData( IntentionAction action,
                                                       String[] category,
                                                       String description,
                                                       String exampleFileExtension,
                                                       String[] exampleTextBefore,
                                                       String[] exampleTextAfter);
