...
import com.gome.maven.ide.plugins.PluginManagerUISettings;
...
public class IntentionDescriptionPanel {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.intention.impl.config.IntentionDescriptionPanel");
    ...
    private void setupPoweredByPanel(final IntentionActionMetaData actionMetaData) {
        ...
        JComponent owner;
        if (pluginId == null) {
             String label = XmlStringUtil.wrapInHtml("<b>" + ApplicationNamesInfo.getInstance().getFullProductName() + "</b>");
    ...
    private static void showUsages(final JPanel panel,
                                   ...
                                   final List<IntentionUsagePanel> usagePanels,
                                    final TextDescriptor[] exampleUsages) throws IOException {
