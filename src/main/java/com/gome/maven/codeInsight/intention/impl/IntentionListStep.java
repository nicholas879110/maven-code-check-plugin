...
import com.gome.maven.codeInspection.IntentionWrapper;
...
class IntentionListStep implements ListPopupStep<IntentionActionWithTextCaching>, SpeedSearchFilter<IntentionActionWithTextCaching> {
    ...
    private boolean wrapActionsTo( List<HighlightInfo.IntentionActionDescriptor> newDescriptors,
    ...
    IntentionActionWithTextCaching wrapAction( HighlightInfo.IntentionActionDescriptor descriptor,
                                               PsiElement element,
