...
public class AddSingleMemberStaticImportAction extends BaseElementAtCaretIntentionAction {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.intention.impl.AddSingleMemberStaticImportAction");
    ...
    public static ImportAvailability getStaticImportClass( PsiElement element) {
