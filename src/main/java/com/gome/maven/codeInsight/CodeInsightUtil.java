...
import com.gome.maven.codeInsight.completion.AllClassesGetter;
...
import com.gome.maven.util.FilteredQuery;
...
*/
    ...
    public static void sortIdenticalShortNameClasses(PsiClass[] classes,  PsiReference context) {
    ...
    public static Processor<PsiClass> createInheritorsProcessor(final PsiElement context, final PsiClassType baseType,
                                                                ...
                                                                final Consumer<PsiType> result,  final PsiClass baseClass, final PsiSubstitutor baseSubstitutor) {
