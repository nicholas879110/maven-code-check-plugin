...
public class JavaDocUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.javadoc.JavaDocUtil");
    ...
    public static boolean isInsidePackageInfo( PsiDocComment containingComment) {
