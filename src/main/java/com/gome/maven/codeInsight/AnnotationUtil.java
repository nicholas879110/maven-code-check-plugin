...
public class AnnotationUtil {
    ...
    public static PsiAnnotation findAnnotation( PsiModifierListOwner listOwner,  Collection<String> annotationNames) {
    ...
    public static PsiAnnotation[] findAnnotations( PsiModifierListOwner modifierListOwner,  Collection<String> annotationNames) {
    ...
    public static PsiAnnotation findAnnotationInHierarchy( final PsiModifierListOwner listOwner,  Set<String> annotationNames) {
    ...
    private static void collectSuperParameters(LinkedHashSet<PsiModifierListOwner> result,  PsiParameter parameter) {
    ...
    private static boolean isAnnotated( PsiModifierListOwner listOwner,
    ...
    public static String getStringAttributeValue( PsiAnnotation anno,  final String attributeName) {
    ...
    public static Boolean getBooleanAttributeValue( PsiAnnotation anno,  final String attributeName) {
        PsiAnnotationMemberValue attrValue = anno.findAttributeValue(attributeName);
        Object constValue = JavaPsiFacade.getInstance(anno.getProject()).getConstantEvaluationHelper().computeConstantExpression(attrValue);
