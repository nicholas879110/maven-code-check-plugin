...
import com.gome.maven.psi.impl.source.PsiExtensibleClass;
...
public class PsiMethodWithOverridingPercentMember extends PsiMethodMember {
    ...
    public static PsiMethodWithOverridingPercentMember[] calculateOverridingPercents( final Collection<CandidateInfo> candidateInfos) {
    ...
    private static boolean maybeSuper( final PsiMethod superMethod,  final PsiMethod method) {
    ...
    private static String getTypeShortName( final PsiType type) {
