...
public class PsiElementMemberChooserObject extends MemberChooserObjectBase {
    ...
    public PsiElementMemberChooserObject( final PsiElement psiElement, final String text) {
        super(text);
        myPsiElement = psiElement;
    }

    public PsiElementMemberChooserObject( PsiElement psiElement, final String text,  final Icon icon) {
        super(text, icon);
        myPsiElement = psiElement;
    }
