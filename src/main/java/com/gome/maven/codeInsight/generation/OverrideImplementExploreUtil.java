...
import com.gome.maven.codeInsight.MemberImplementorExplorer;
...
public class OverrideImplementExploreUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.generation.OverrideImplementExploreUtil");
