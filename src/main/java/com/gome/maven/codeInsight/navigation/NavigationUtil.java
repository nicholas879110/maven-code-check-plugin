...
import com.gome.maven.ide.util.DefaultPsiElementCellRenderer;
import com.gome.maven.ide.util.EditSourceUtil;
import com.gome.maven.ide.util.PsiElementListCellRenderer;
import com.gome.maven.navigation.GotoRelatedItem;
import com.gome.maven.navigation.GotoRelatedProvider;
...
import com.gome.maven.openapi.fileEditor.impl.EditorHistoryManager;
...
import com.gome.maven.ui.popup.list.PopupListElementRenderer;
...
public final class NavigationUtil {
    ...
    public static JBPopup getPsiElementPopup( PsiElement[] elements,
                                              final PsiElementListCellRenderer<PsiElement> renderer,
                                             final String title) {
    ...
    public static <T extends PsiElement> JBPopup getPsiElementPopup( T[] elements,
    ...
    public static List<GotoRelatedItem> collectRelatedItems( PsiElement contextElement,  DataContext dataContext) {
