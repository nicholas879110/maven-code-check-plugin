...
import com.gome.maven.usages.UsageTargetUtil;
...
public class HighlightUsagesHandler extends HighlightHandlerBase {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.highlighting.HighlightUsagesHandler");

    public static void invoke( final Project project,  final Editor editor, final PsiFile file) {
    ...
    public static class DoHighlightRunnable implements Runnable {
        ...
        public DoHighlightRunnable( List<PsiReference> refs,  Project project,  PsiElement target, Editor editor,
    ...
    public static void highlightReferences( Project project,
                                            PsiElement element,
    ...
    private static void doHighlightRefs(HighlightManager highlightManager,  Editor editor,  List<PsiReference> refs,
