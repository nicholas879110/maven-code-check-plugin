...
import com.gome.maven.psi.impl.source.resolve.CompletionParameterTypeInferencePolicy;
...
import com.gome.maven.psi.search.searches.DeepestSuperMethodsSearch;
...
public class ExpectedTypesProvider {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.ExpectedTypesProvider");
    ...
    public static ExpectedTypeInfo createInfo(  PsiType type, @ExpectedTypeInfo.Type int kind, PsiType defaultType,  TailType tailType) {
    ...
    private static ExpectedTypeInfoImpl createInfoImpl( PsiType type, @ExpectedTypeInfo.Type int kind, PsiType defaultType,  TailType tailType) {
    ...
    public static void processAllSuperTypes( PsiType type,  PsiTypeVisitor<PsiType> visitor,  Project project,  Set<PsiType> set) {
    ...
    private static class MyParentVisitor extends JavaElementVisitor {
        ...
        private static ExpectedTypeInfo getEqualsType( PsiExpression anotherExpr) {
            PsiType anotherType = anotherExpr != null ? anotherExpr.getType() : null;
            if (anotherType == null) {
                return null;
            }
        ...
        private static TailType getMethodArgumentTailType( final PsiExpression argument,
                                                          final int index,
                                                           final PsiMethod method,
                                                           final PsiSubstitutor substitutor,
        ...
        protected static PsiType checkMethod( PsiMethod method,   final String className,  final NullableFunction<PsiClass,PsiType> function) {
        ...
        private static NullableComputable<String> getPropertyName( final PsiVariable variable) {
