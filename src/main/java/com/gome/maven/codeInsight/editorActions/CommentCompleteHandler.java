...
import com.gome.maven.lang.CodeDocumentationAwareCommenter;
...
public interface CommentCompleteHandler {
    ExtensionPointName<CommentCompleteHandler> EP_NAME = ExtensionPointName.create("com.gome.maven.commentCompleteHandler");
