...
import com.gome.maven.codeInsight.editorActions.enter.EnterHandlerDelegate;
import com.gome.maven.ide.DataManager;
import com.gome.maven.lang.*;
import com.gome.maven.lang.documentation.CodeDocumentationProvider;
...
public class EnterHandler extends BaseEnterHandler {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.editorActions.EnterHandler");
