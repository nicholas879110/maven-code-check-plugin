...
import com.gome.maven.psi.search.searches.AnnotatedMembersSearch;
...
public class FunctionalInterfaceSuggester {
    public static final String[] FUNCTIONAL_INTERFACES = {
            ...
            //IDEA
            "com.gome.maven.util.Function",
            "com.gome.maven.util.Consumer",
            "com.gome.maven.openapi.util.Computable",
            "com.gome.maven.openapi.util.Condition",
            "com.gome.maven.util.Processor",
            "com.gome.maven.util.Producer",
    ...
    public static Collection<? extends PsiType> suggestFunctionalInterfaces(final  PsiFunctionalExpression expression) {
    ...
    public static Collection<? extends PsiType> suggestFunctionalInterfaces(final  PsiMethod method) {
    ...
    private static <T extends PsiElement> Collection<? extends PsiType> suggestFunctionalInterfaces(final  T element, final NullableFunction<PsiClass, PsiType> acceptanceChecker) {
    ...
    private static PsiType composeAcceptableType( PsiClass interface2Consider,
