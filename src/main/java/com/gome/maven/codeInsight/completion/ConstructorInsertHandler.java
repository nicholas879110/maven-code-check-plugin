...
import com.gome.maven.codeInsight.generation.OverrideImplementExploreUtil;
...
public class ConstructorInsertHandler implements InsertHandler<LookupElementDecorator<LookupElement>> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.completion.ConstructorInsertHandler");
