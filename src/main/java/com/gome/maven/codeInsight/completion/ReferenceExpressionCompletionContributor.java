...
import com.gome.maven.codeInsight.lookup.ExpressionLookupItem;
...
import com.gome.maven.patterns.PsiMethodPattern;
...
import com.gome.maven.psi.filters.*;
import com.gome.maven.psi.filters.element.ModifierFilter;
import com.gome.maven.psi.filters.types.AssignableFromFilter;
...
import static com.gome.maven.patterns.PsiJavaPatterns.psiMethod;

/**
 * @author peter
 */
public class ReferenceExpressionCompletionContributor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.completion.ReferenceExpressionCompletionContributor");
    ...
    private static void addArrayMemberAccessors(final PsiElement element, final String prefix, final PsiType itemType,
        ...
        if (itemType instanceof PsiArrayType && expectedType.isAssignableFrom(((PsiArrayType)itemType).getComponentType())) {
            ...
            final LookupItem item = new ExpressionLookupItem(conversion);
             ...
             final String presentable = prefix + "[...]";
    ...
    private static void addArraysAsListConversions(final PsiElement element, final String prefix, final PsiType itemType, final Consumer<LookupElement> result,
        ...
        final LookupItem item = new ExpressionLookupItem(conversion);
         ...
         final String presentable = "Arrays.asList(" + qualifierText + prefix + ")";
        ...
        item.setInsertHandler(new InsertHandler<LookupElement>() {
            ...
            public void handleInsert(InsertionContext context, LookupElement item) {
                ...
                final String callSpace = getSpace(CodeStyleSettingsManager.getSettings(project).SPACE_WITHIN_METHOD_CALL_PARENTHESES);
                 final String newText = "java.util.Arrays.asList(" + callSpace + qualifierText + prefix + callSpace + ")";
    ...
    private static void addToArrayConversions(final PsiElement element, final Object object, final String prefix, final PsiType itemType,
                                              final Consumer<LookupElement> result,  final PsiElement qualifier,
                                              final PsiType expectedType) {
    ...
    private static String getQualifierText( final PsiElement qualifier) {
    ...
    public static PsiReferenceExpression createMockReference(final PsiElement place,  PsiType qualifierType, LookupElement qualifierItem) {
    ...
    private static void addToArrayConversion(final PsiElement element, final String prefix,  final String expressionString,  String presentableString, final Consumer<LookupElement> result, PsiElement qualifier) {
    ...
    private static boolean isEmptyArrayInitializer( PsiElement element) {
