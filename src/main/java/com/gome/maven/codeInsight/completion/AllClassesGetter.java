...
import com.gome.maven.psi.impl.search.AllClassesSearchExecutor;
...
public class AllClassesGetter {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.completion.AllClassesGetter");
    ...
    public static boolean isAcceptableInContext( final PsiElement context,
    ...
    public static JavaPsiClassReferenceElement createLookupItem( final PsiClass psiClass,
