...
import com.gome.maven.codeInsight.daemon.impl.quickfix.ImportClassFix;
...
import com.gome.maven.patterns.PatternCondition;
import com.gome.maven.patterns.PsiJavaElementPattern;
import com.gome.maven.patterns.PsiNameValuePairPattern;
...
import com.gome.maven.psi.filters.classes.AssignableFromContextFilter;
...
import com.gome.maven.psi.impl.source.PsiLabelReference;
...
public class JavaCompletionContributor extends CompletionContributor {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.completion.JavaCompletionContributor");
    ...
    @Override
    public String advertise( final CompletionParameters parameters) {
    ...
    @Override
    public void beforeCompletion( final CompletionInitializationContext context) {
    ...
    private static void autoImportReference( PsiFile file,  Editor editor,  PsiJavaCodeReferenceElement element) {
    ...
    private static PsiJavaCodeReferenceElement extractReference( PsiElement expression) {
