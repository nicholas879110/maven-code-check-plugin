...
import static com.gome.maven.patterns.StandardPatterns.character;
...
public class CompletionData {
    ...
    /**
     * @deprecated
     * @see com.gome.maven.codeInsight.completion.CompletionContributor
     */
    protected void registerVariant(CompletionVariant variant){
        myCompletionVariants.add(variant);
    }

    public void completeReference(final PsiReference reference, final Set<LookupElement> set,  final PsiElement position, final PsiFile file,
                                  final int offset){
    ...
    public static String findPrefixDefault(final PsiElement insertedElement, final int offset,  final ElementPattern trimStart) {
    ...
    public static LookupElement objectToLookupItem(final  Object object) {
    ...
    protected void addLookupItem(Set<LookupElement> set, TailType tailType,  Object completion, final PsiFile file,
