 ...
 * {@link com.gome.maven.psi.PsiElement}s, or better {@link LookupElement}s.<p>
 *
 ...
 * WITHOUT read action, so you'll have to manually invoke {@link com.gome.maven.openapi.application.Application#runReadAction(Runnable)} each time
 ...
 * A: When completion is invoked, the file being edited is first copied (the original file can be accessed from {@link com.gome.maven.psi.PsiFile#getOriginalFile()}
 ...
 * Most often this string is an identifier (see {@link com.gome.maven.codeInsight.completion.CompletionInitializationContext#DUMMY_IDENTIFIER}).
 ...
 * the caret position.
 * In {@link CompletionContributor} you will be given a {@link com.gome.maven.codeInsight.completion.CompletionResultSet}
 ...
 * {@link com.gome.maven.codeInsight.completion.CompletionResultSet#withPrefixMatcher(PrefixMatcher)} and feed your lookup elements to the latter.
 ...
 * by putting new offset to {@link CompletionInitializationContext#getOffsetMap()} as {@link com.gome.maven.codeInsight.completion.CompletionInitializationContext#IDENTIFIER_END_OFFSET}.<p>
 *
 ...
 * {@link com.gome.maven.codeInsight.completion.CompletionResultSet#runRemainingContributors(CompletionParameters, com.gome.maven.util.Consumer)}.
 * The consumer you provide should pass all the lookup elements to the {@link com.gome.maven.codeInsight.completion.CompletionResultSet}
 ...
 * {@link CompletionService#getVariantsFromContributors(CompletionParameters, CompletionContributor, com.gome.maven.util.Consumer)},
...
public abstract class CompletionContributor {
    ...
    public final void extend( CompletionType type,
                              final ElementPattern<? extends PsiElement> place, CompletionProvider<CompletionParameters> provider) {
     ...
     * The default implementation looks for {@link com.gome.maven.codeInsight.completion.CompletionProvider}s you could register by
     ...
     * ensure you call {@link com.gome.maven.openapi.progress.ProgressManager#checkCanceled()} often enough so that the completion process
    ...
    /**
     * @deprecated use {@link com.gome.maven.codeInsight.completion.CompletionResultSet#addLookupAdvertisement(String)}
    ...
    public String handleEmptyLookup( CompletionParameters parameters, final Editor editor) {
        return null;
    }
     ...
     * (see {@link com.gome.maven.codeInsight.completion.CompletionInitializationContext#setReplacementOffset(int)})
     * if it takes too much time to spend it in {@link #beforeCompletion(CompletionInitializationContext)},
     * e.g. doing {@link com.gome.maven.psi.PsiFile#findReferenceAt(int)}
     *
    ...
    protected static String getActionShortcut(  final String actionId) {
