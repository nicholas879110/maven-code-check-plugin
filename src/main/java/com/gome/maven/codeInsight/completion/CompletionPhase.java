...
public abstract class CompletionPhase implements Disposable {
    ...
    public static class CommittingDocuments extends CompletionPhase {
        ...
        public CommittingDocuments( CompletionProgressIndicator prevIndicator, Editor editor) {
            super(prevIndicator);
            myEditor = editor;
    ...
    public static abstract class ZombiePhase extends CompletionPhase {
        ...
        protected ZombiePhase( final LightweightHint hint, final CompletionProgressIndicator indicator) {
            super(indicator);
    ...
    public static class NoSuggestionsHint extends ZombiePhase {
        public NoSuggestionsHint( LightweightHint hint, CompletionProgressIndicator indicator) {
