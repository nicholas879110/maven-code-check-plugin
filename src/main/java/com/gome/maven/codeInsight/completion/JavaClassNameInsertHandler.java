...
import com.gome.maven.psi.codeStyle.JavaCodeStyleSettings;
import com.gome.maven.psi.filters.FilterPositionUtil;
import com.gome.maven.psi.impl.source.codeStyle.ImportHelper;
...
import static com.gome.maven.psi.codeStyle.JavaCodeStyleSettings.*;
...
class JavaClassNameInsertHandler implements InsertHandler<JavaPsiClassReferenceElement> {
    ...
    private static boolean shouldInsertFqnInJavadoc( JavaPsiClassReferenceElement item,
                                                     PsiFile file,
                                                     Project project)
    {
