...
import com.gome.maven.refactoring.introduceField.InplaceIntroduceFieldPopup;
...
import static com.gome.maven.patterns.PsiJavaPatterns.psiField;
import static com.gome.maven.patterns.StandardPatterns.or;
...
public class JavaMemberNameCompletionContributor extends CompletionContributor {
    ...
    private static void addLookupItems(Set<LookupElement> lookupElements,  final SuggestedNameInfo callback, PrefixMatcher matcher, Project project, String... strings) {
        outer:
