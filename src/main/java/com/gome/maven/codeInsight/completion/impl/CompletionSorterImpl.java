...
import com.gome.maven.codeInsight.completion.CompletionSorter;
...
public class CompletionSorterImpl extends CompletionSorter {
    ...
    @Override public CompletionSorterImpl weighBefore( final String beforeId, LookupElementWeigher... weighers) {
    ...
    @Override public CompletionSorterImpl weighAfter( final String afterId, LookupElementWeigher... weighers) {
        if (weighers.length == 0) return this;
    ...
    public CompletionSorterImpl withClassifier( String anchorId,
