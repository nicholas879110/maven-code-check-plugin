...
import com.gome.maven.codeInsight.editorActions.smartEnter.SmartEnterProcessor;
import com.gome.maven.codeInsight.editorActions.smartEnter.SmartEnterProcessors;
...
public class CodeCompletionHandlerBase {
    ...
    public final void invokeCompletion( final Project project,  final Editor editor, int time) {
        invokeCompletion(project, editor, time, false, false);
    }

    public final void invokeCompletion( final Project project,  final Editor editor, int time, boolean hasModifiers, boolean restarted) {
        clearCaretMarkers(editor);
        invokeCompletion(project, editor, time, hasModifiers, restarted, editor.getCaretModel().getPrimaryCaret());
    }

    public final void invokeCompletion( final Project project,  final Editor editor, int time, boolean hasModifiers, boolean restarted,  final Caret caret) {
    ...
    */
    ...
    protected void lookupItemSelected(final CompletionProgressIndicator indicator,  final LookupElement item, final char completionChar,
    ...
    private static boolean isCopyUpToDate(Document document,  PsiFile file) {
        if (!file.isValid()) {
            return false;
        }
