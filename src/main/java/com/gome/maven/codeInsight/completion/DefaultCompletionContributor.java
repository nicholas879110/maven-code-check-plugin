...
import com.gome.maven.codeInsight.documentation.actions.ShowQuickDocInfoAction;
import com.gome.maven.codeInsight.hint.actions.ShowImplementationsAction;
...
public class DefaultCompletionContributor extends CompletionContributor {
    ...
    static void addDefaultAdvertisements( final CompletionParameters parameters, LookupImpl lookup, boolean includePsiFeatures) {
