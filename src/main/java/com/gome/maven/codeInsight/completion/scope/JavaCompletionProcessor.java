 ...
 */
package com.gome.maven.codeInsight.completion.scope;

import com.gome.maven.codeInsight.CodeInsightSettings;
import com.gome.maven.codeInsight.completion.CompletionUtil;
import com.gome.maven.codeInsight.daemon.ImplicitUsageProvider;
import com.gome.maven.codeInspection.SuppressManager;
import com.gome.maven.codeInspection.accessStaticViaInstance.AccessStaticViaInstanceBase;
import com.gome.maven.openapi.util.Condition;
import com.gome.maven.openapi.util.Key;
import com.gome.maven.openapi.util.text.StringUtil;
import com.gome.maven.psi.*;
import com.gome.maven.psi.filters.ElementFilter;
import com.gome.maven.psi.impl.light.LightMethodBuilder;
...
public class JavaCompletionProcessor extends BaseScopeProcessor implements ElementClassHint {
    ...
    public JavaCompletionProcessor( PsiElement element, ElementFilter filter, Options options,  Condition<String> nameCondition) {
        myOptions = options;
        myElement = element;
    ...
    public boolean isAccessible( final PsiElement element) {
