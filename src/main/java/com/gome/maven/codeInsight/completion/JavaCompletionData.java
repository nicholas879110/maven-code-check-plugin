...
import com.gome.maven.codeInsight.TailTypes;
...
import com.gome.maven.psi.filters.classes.EnumOrAnnotationTypeFilter;
import com.gome.maven.psi.filters.classes.InterfaceFilter;
import com.gome.maven.psi.filters.getters.JavaMembersGetter;
import com.gome.maven.psi.filters.position.*;
import com.gome.maven.psi.impl.source.jsp.jspJava.JspClassLevelDeclarationStatement;
import com.gome.maven.psi.jsp.JspElementType;
...
public class JavaCompletionData extends JavaAwareCompletionData {
    private static final  String[] BLOCK_FINALIZERS = {"{", "}", ";", ":", "else"};
