...
import com.gome.maven.codeInsight.*;
import com.gome.maven.codeInsight.completion.impl.CamelHumpMatcher;
import com.gome.maven.codeInsight.completion.scope.CompletionElement;
import com.gome.maven.codeInsight.completion.scope.JavaCompletionProcessor;
import com.gome.maven.codeInsight.completion.util.ParenthesesInsertHandler;
...
import com.gome.maven.codeInspection.java15api.Java15APIUsageInspectionBase;
...
import com.gome.maven.psi.impl.light.LightVariableBuilder;
...
public class JavaCompletionUtil {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.completion.JavaCompletionUtil");
    ...
    public static boolean isInExcludedPackage( final PsiMember member, boolean allowInstanceInnerClasses) {
    ...
    private static PsiSubstitutor originalize( final PsiSubstitutor substitutor) {
    ...
    public static PsiType getQualifiedMemberReferenceType( PsiType qualifierType,  final PsiMember member) {
    ...
    private static LookupElement castQualifier( LookupElement item,
                                                final PsiTypeLookupItem castTypeItem,
                                                PsiType plainQualifier, JavaCompletionProcessor processor) {
    ...
    private static PsiType toRaw( PsiType type) {
        return type instanceof PsiClassType ? ((PsiClassType)type).rawType() : type;
    }

    
    public static LookupElement highlightIfNeeded( PsiType qualifierType,
                                                   LookupElement item,
                                                   Object object,
                                                   PsiElement place) {
    ...
    public static Set<String> getAllLookupStrings( PsiMember member) {
    ...
    public static boolean mayHaveSideEffects( final PsiElement element) {
