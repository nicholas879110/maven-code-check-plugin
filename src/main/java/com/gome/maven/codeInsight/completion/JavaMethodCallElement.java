...
import com.gome.maven.codeInsight.completion.util.MethodParenthesesHandler;
import com.gome.maven.codeInsight.lookup.*;
import com.gome.maven.codeInsight.lookup.impl.JavaElementLookupRenderer;
...
public class JavaMethodCallElement extends LookupItem<PsiMethod> implements TypedLookupItem, StaticallyImportable {
    ...
    public void setInferenceSubstitutor( final PsiSubstitutor substitutor, PsiElement place) {
