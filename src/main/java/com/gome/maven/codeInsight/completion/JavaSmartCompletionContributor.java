...
import com.gome.maven.psi.filters.ElementExtractorFilter;
import com.gome.maven.psi.filters.ElementFilter;
import com.gome.maven.psi.filters.GeneratorFilter;
import com.gome.maven.psi.filters.OrFilter;
import com.gome.maven.psi.filters.getters.*;
import com.gome.maven.psi.filters.types.AssignableFromFilter;
import com.gome.maven.psi.filters.types.AssignableGroupFilter;
import com.gome.maven.psi.filters.types.AssignableToFilter;
...
import static com.gome.maven.patterns.StandardPatterns.*;
...
public class JavaSmartCompletionContributor extends CompletionContributor {
    ...
    public JavaSmartCompletionContributor() {
        ...
        extend(CompletionType.SMART, or(
            ...
            @Override
            public void addCompletions( final CompletionParameters parameters, final ProcessingContext context,  final CompletionResultSet result) {
                final PsiElement element = parameters.getPosition();
