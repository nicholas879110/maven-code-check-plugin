...
import com.gome.maven.codeInsight.CharTailType;
...
class TypeArgumentCompletionProvider extends CompletionProvider<CompletionParameters> {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.completion.TypeArgumentCompletionProvider");
    private final boolean mySmart;
     private final InheritorsHolder myInheritors;

    TypeArgumentCompletionProvider(boolean smart,  InheritorsHolder inheritors) {
        mySmart = smart;
        myInheritors = inheritors;
    }

    @Override
    protected void addCompletions( final CompletionParameters parameters, final ProcessingContext processingContext,  final CompletionResultSet resultSet) {
    ...
    public static class TypeArgsLookupElement extends LookupElement {
        ...
        public void registerSingleClass( InheritorsHolder inheritors) {
