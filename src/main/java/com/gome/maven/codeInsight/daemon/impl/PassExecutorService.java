...
class PassExecutorService implements Disposable {
    ...
    private TextEditorHighlightingPass convertToTextHighlightingPass( final HighlightingPass pass,
    ...
    private FileEditor getPreferredFileEditor(Document document,  Collection<FileEditor> fileEditors) {
    ...
    private ScheduledPass createScheduledPass( FileEditor fileEditor,
    ...
    private ScheduledPass findOrCreatePredecessorPass( FileEditor fileEditor,
                                                       Map<Pair<FileEditor, Integer>, ScheduledPass> toBeSubmitted,
                                                       List<TextEditorHighlightingPass> textEditorHighlightingPasses,
                                                       List<ScheduledPass> freePasses,
                                                       List<ScheduledPass> dependentPasses,
    ...
    private static TextEditorHighlightingPass findPassById(final int id,  List<TextEditorHighlightingPass> textEditorHighlightingPasses) {
    ...
    private class ScheduledPass implements Runnable {
        ...
        private ScheduledPass( FileEditor fileEditor,
                               TextEditorHighlightingPass pass,
    ...
    private void applyInformationToEditorsLater( final FileEditor fileEditor,
    ...
    private static void sortById( List<TextEditorHighlightingPass> result) {
