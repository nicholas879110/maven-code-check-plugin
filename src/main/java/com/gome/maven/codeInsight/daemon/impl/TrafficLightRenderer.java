...
import com.gome.maven.openapi.editor.impl.EditorMarkupModelImpl;
...
public class TrafficLightRenderer implements ErrorStripeRenderer, Disposable {
    ...
    static void setOrRefreshErrorStripeRenderer( EditorMarkupModel editorMarkupModel,
                                                 Project project,
                                                 Document document,
                                                PsiFile file) {
    ...
    boolean updatePanel( DaemonCodeAnalyzerStatus status, Project project) {
