...
import com.gome.maven.codeInsight.completion.proc.VariablesProcessor;
import com.gome.maven.codeInsight.daemon.QuickFixBundle;
import com.gome.maven.codeInsight.generation.OverrideImplementUtil;
import com.gome.maven.codeInsight.generation.PsiGenerationInfo;
import com.gome.maven.codeInsight.intention.impl.CreateClassDialog;
...
import com.gome.maven.psi.util.ProximityLocation;
...
public class CreateFromUsageUtils {
    private static final Logger LOG = Logger.getInstance(
            "#com.gome.maven.codeInsight.daemon.impl.quickfix.CreateFromUsageUtils");
    ...
    private static boolean hasCorrectModifiers( final PsiMember member, final boolean staticAccess) {
        if (member == null) {
            return false;
        }
