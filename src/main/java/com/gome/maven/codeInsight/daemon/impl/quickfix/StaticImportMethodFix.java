...
import com.gome.maven.codeInsight.daemon.impl.actions.AddImportAction;
import com.gome.maven.codeInsight.intention.IntentionAction;
import com.gome.maven.codeInsight.intention.impl.AddSingleMemberStaticImportAction;
import com.gome.maven.ide.util.MethodCellRenderer;
...
public class StaticImportMethodFix implements IntentionAction {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.daemon.impl.quickfix.StaticImportMethodFix");
