...
import com.gome.maven.codeInsight.intention.AbstractIntentionAction;
...
import com.gome.maven.codeInsight.intention.impl.ShowIntentionActionsHandler;
...
import com.gome.maven.codeInspection.actions.CleanupAllIntention;
...
import com.gome.maven.psi.IntentionFilterOwner;
...
public class ShowIntentionsPass extends TextEditorHighlightingPass {
    ...
    public static List<HighlightInfo.IntentionActionDescriptor> getAvailableActions( final Editor editor,  final PsiFile file, final int passId) {
    ...
    public static class IntentionsInfo {
        ...
        public void filterActions( IntentionFilterOwner.IntentionActionsFilter actionsFilter) {
    ...
    ShowIntentionsPass( Project project,  Editor editor, int passId) {
    ...
    public static void getActionsToShow( final Editor hostEditor,
