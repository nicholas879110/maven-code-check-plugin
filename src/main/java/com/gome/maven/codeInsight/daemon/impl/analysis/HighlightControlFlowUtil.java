...
public class HighlightControlFlowUtil {
    ...
    private static boolean inInnerClass( PsiElement psiElement,  PsiClass containingClass,  PsiFile containingFile) {
    ...
    public static Collection<ControlFlowUtil.VariableInfo> getFinalVariableProblemsInBlock( Map<PsiElement,Collection<ControlFlowUtil.VariableInfo>> finalVarProblems,
    ...
    private static boolean canWriteToFinal( PsiVariable variable,
    ...
    private static boolean isSameField( PsiMember enclosingCtrOrInitializer,
                                        PsiField field,
                                        PsiReferenceExpression reference,
                                        PsiFile containingFile) {
