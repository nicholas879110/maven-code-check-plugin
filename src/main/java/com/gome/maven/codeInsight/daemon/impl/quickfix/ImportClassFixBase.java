...
import com.gome.maven.packageDependencies.DependencyRule;
...
public abstract class ImportClassFixBase<T extends PsiElement, R extends PsiReference> implements HintAction, HighPriorityAction {
    ...
    public Result doFix( final Editor editor, boolean allowPopup, final boolean allowCaretNearRef) {
