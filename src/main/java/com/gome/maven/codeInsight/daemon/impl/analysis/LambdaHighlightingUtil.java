...
public class LambdaHighlightingUtil {
    ...
    public static String checkInterfaceFunctional( PsiClass psiClass) {
        return checkInterfaceFunctional(psiClass, "Target type of a lambda conversion must be an interface");
    }

    
    public static String checkInterfaceFunctional( PsiClass psiClass, String interfaceNonFunctionalMessage) {
