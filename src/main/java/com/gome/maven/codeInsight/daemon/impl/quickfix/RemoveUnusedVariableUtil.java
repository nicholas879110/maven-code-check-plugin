...
public class RemoveUnusedVariableUtil {
    ...
    static void deleteReferences(PsiVariable variable, List<PsiElement> references,  RemoveMode mode) throws IncorrectOperationException {
     ...
     */
    static Boolean processUsage(PsiElement element, PsiVariable variable, List<PsiElement> sideEffects,  RemoveMode deleteMode)
            throws IncorrectOperationException {
