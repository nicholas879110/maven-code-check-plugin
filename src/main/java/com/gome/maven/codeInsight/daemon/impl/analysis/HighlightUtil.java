...
import com.gome.maven.codeInsight.daemon.impl.quickfix.*;
import com.gome.maven.codeInsight.highlighting.HighlightUsagesDescriptionLocation;
import com.gome.maven.codeInsight.intention.IntentionAction;
import com.gome.maven.codeInsight.intention.QuickFixFactory;
import com.gome.maven.codeInsight.intention.impl.PriorityActionWrapper;
import com.gome.maven.codeInsight.quickfix.ChangeVariableTypeQuickFixProvider;
import com.gome.maven.codeInsight.quickfix.UnresolvedReferenceQuickFixProvider;
import com.gome.maven.codeInspection.LocalQuickFixOnPsiElementAsIntentionAdapter;
...
import com.gome.maven.psi.impl.source.tree.java.PsiReferenceExpressionImpl;
import com.gome.maven.psi.javadoc.PsiDocComment;
import com.gome.maven.psi.scope.processor.VariablesNotProcessor;
...
import com.gome.maven.util.containers.hash.HashSet;
import com.gome.maven.util.ui.UIUtil;
import com.gome.maven.xml.util.XmlStringUtil;
import gnu.trove.THashMap;
//import org.jetbrains.lang.annotations.Language;
...
public class HighlightUtil extends HighlightUtilBase {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.daemon.impl.analysis.HighlightUtil");
    ...
    static HighlightInfo checkIntersectionInTypeCast( PsiTypeCastExpression expression,  LanguageLevel languageLevel) {
    ...
    static HighlightInfo checkAssignmentOperatorApplicable( PsiAssignmentExpression assignment, PsiFile containingFile) {
    ...
    private static void registerChangeVariableTypeFixes( PsiExpression expression,
                                                         PsiType type,
                                                         PsiExpression lExpr,
                                                         HighlightInfo highlightInfo) {
    ...
    static HighlightInfo checkAssignability( PsiType lType,
                                             PsiType rType,
    ...
    static HighlightInfo checkUnderscore( PsiIdentifier identifier,
    ...
    static String formatField( PsiField field) {
    ...
    static HighlightInfo checkUnhandledExceptions( final PsiElement element,  TextRange textRange) {
    ...
    static HighlightInfo checkUnhandledCloserExceptions( final PsiResourceVariable resource) {
    ...
    static String getIncompatibleModifier(String modifier,  PsiModifierList modifierList) {
        PsiElement parent = modifierList.getParent();
        if (parent == null || PsiUtilCore.hasErrorElementChild(parent)) return null;
    ...
    static HighlightInfo checkNotAllowedModifier( PsiKeyword keyword,  PsiModifierList modifierList) {
    ...
    public static HighlightInfo checkLiteralExpressionParsingError( PsiLiteralExpression expression, LanguageLevel level, PsiFile file) {
    ...
    static HighlightInfo checkMustBeBoolean( PsiExpression expr, PsiType type) {
    ...
    static List<HighlightInfo> checkExceptionThrownInTry( final PsiParameter parameter,  final Set<PsiClassType> thrownTypes) {
    ...
    private static List<HighlightInfo> checkMultiCatchParameter( final PsiParameter parameter,
                                                                 final Collection<PsiClassType> thrownTypes) {
    ...
    static Collection<HighlightInfo> checkWithImprovedCatchAnalysis( PsiParameter parameter,
    ...
    static HighlightInfo checkSwitchSelectorType( PsiSwitchStatement statement,  LanguageLevel level) {
    ...
    static HighlightInfo checkUnaryOperatorApplicable( PsiJavaToken token,  PsiExpression expression) {
    ...
    static HighlightInfo checkThisOrSuperExpressionInIllegalContext( PsiExpression expr,
    ...
    static HighlightInfo checkUnqualifiedSuperInDefaultMethod( LanguageLevel languageLevel,
    ...
    static String buildProblemWithAccessDescription( final PsiElement reference,  final JavaResolveResult result) {
        return buildProblemWithAccessDescription(reference, result, result.getElement());
    }

    
    private static String buildProblemWithAccessDescription( final PsiElement reference,
    ...
    static HighlightInfo checkValidArrayAccessExpression( PsiArrayAccessExpression arrayAccessExpression) {
    ...
    static HighlightInfo checkCatchParameterIsThrowable( final PsiParameter parameter) {
    ...
    static HighlightInfo checkTryResourceIsAutoCloseable( final PsiResourceVariable resource) {
    ...
    static HighlightInfo checkExpressionRequired( PsiReferenceExpression expression,
    ...
    static HighlightInfo checkArrayInitializerApplicable( PsiArrayInitializerExpression expression) {
    /*
    ...
    */
    ...
    static HighlightInfo checkCaseStatement( PsiSwitchLabelStatement statement) {
    ...
    static HighlightInfo checkIllegalForwardReferenceToField( PsiReferenceExpression expression,  PsiField referencedField) {
    ...
    public static Boolean isIllegalForwardReferenceToField( PsiReferenceExpression expression,  PsiField referencedField, boolean acceptQualified) {
    ...
    static HighlightInfo checkIllegalType( PsiTypeElement typeElement) {
    ...
    static HighlightInfo checkIllegalVoidType( PsiKeyword type) {
    ...
    static HighlightInfo checkMemberReferencedBeforeConstructorCalled( PsiElement expression,
                                                                      PsiElement resolved,
                                                                       PsiFile containingFile) {
    ...
    private static HighlightInfo createMemberReferencedError( final String resolvedName,  TextRange textRange) {
    ...
    static HighlightInfo checkImplicitThisReferenceBeforeSuper( PsiClass aClass,  JavaSdkVersion javaSdkVersion) {
    ...
    static HighlightInfo checkLabelWithoutStatement( PsiLabeledStatement statement) {
    ...
    static HighlightInfo checkLabelAlreadyInUse( PsiLabeledStatement statement) {
    ...
    static HighlightInfo checkUnclosedComment( PsiComment comment) {
    ...
    static HighlightInfo checkTernaryOperatorConditionIsBoolean( PsiExpression expression, PsiType type) {
    ...
    static HighlightInfo checkStatementPrependedWithCaseInsideSwitch( PsiStatement statement) {
    ...
    static HighlightInfo checkAssertOperatorTypes( PsiExpression expression,  PsiType type) {
        if (type == null) return null;
    ...
    static HighlightInfo checkSynchronizedExpressionType( PsiExpression expression,
                                                          PsiType type,
                                                          PsiFile containingFile) {
        if (type == null) return null;
    ...
    static HighlightInfo checkConditionalExpressionBranchTypesMatch( final PsiExpression expression, PsiType type) {
        PsiElement parent = expression.getParent();
    ...
    static HighlightInfo checkSingleImportClassConflict( PsiImportStatement statement,
    ...
    static HighlightInfo checkMustBeThrowable( PsiType type,  PsiElement context, boolean addCastIntention) {
        if (type == null) return null;
    ...
    static HighlightInfo checkLabelDefined( PsiIdentifier labelIdentifier,  PsiStatement exitedStatement) {
    ...
    static HighlightInfo checkReference( final PsiJavaCodeReferenceElement ref,
                                         final JavaResolveResult result,
                                         PsiFile containingFile,
                                         LanguageLevel languageLevel) {
    ...
    static HighlightInfo checkPackageAndClassConflict( PsiJavaCodeReferenceElement ref,  PsiFile containingFile) {
    ...
    static HighlightInfo checkElementInReferenceList( PsiJavaCodeReferenceElement ref,
    ...
    static HighlightInfo checkClassReferenceAfterQualifier( final PsiReferenceExpression expression, final PsiElement resolved) {
    ...
    static void registerChangeVariableTypeFixes( PsiVariable parameter,
                                                PsiType itemType,
                                                 PsiExpression expr,
                                                 HighlightInfo highlightInfo) {
    ...
    static HighlightInfo checkForStatement( PsiForStatement statement) {
    ...
    public enum Feature {
        ...
        Feature( LanguageLevel level,  /*@PropertyKey(resourceBundle = JavaErrorMessages.BUNDLE) */final String key) {
            this.level = level;
            this.key = key;
        }
    }
    ...
    static HighlightInfo checkFeature( PsiElement element,
                                       Feature feature,
                                       LanguageLevel level,
                                       PsiFile file) {
