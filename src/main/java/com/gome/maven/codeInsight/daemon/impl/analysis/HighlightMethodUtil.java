...
public class HighlightMethodUtil {
    ...
    static HighlightInfo checkMethodCall( PsiMethodCallExpression methodCall,
    ...
    private static String buildOneLineMismatchDescription( PsiExpressionList list,
                                                           MethodCandidateInfo candidateInfo,
                                                           Ref<PsiElement> elementToHighlight) {
    ...
    static HighlightInfo checkAmbiguousMethodCallIdentifier( PsiReferenceExpression referenceToMethod,
    ...
    static HighlightInfo checkAmbiguousMethodCallArguments( PsiReferenceExpression referenceToMethod,
                                                            JavaResolveResult[] resolveResults,
                                                            PsiExpressionList list,
                                                           final PsiElement element,
                                                            JavaResolveResult resolveResult,
...
//    @Language("HTML")
    ...
    static HighlightInfo checkMethodCanHaveBody( PsiMethod method,  LanguageLevel languageLevel) {
        PsiClass aClass = method.getContainingClass();
    ...
    static HighlightInfo checkConstructorCallMustBeFirstStatement( PsiMethodCallExpression methodCall) {
    ...
    static HighlightInfo checkSuperAbstractMethodDirectCall( PsiMethodCallExpression methodCallExpression) {
     ...
     */
    static HighlightInfo checkStaticMethodOverride( PsiMethod method, PsiFile containingFile) {
    ...
    private static HighlightInfo checkStaticMethodOverride(PsiClass aClass, PsiMethod method, boolean isMethodStatic, PsiClass superClass, PsiMethod superMethod, PsiFile containingFile) {
    ...
    static HighlightInfo checkOverrideEquivalentInheritedMethods(PsiClass aClass, PsiFile containingFile,  LanguageLevel languageLevel) {
        String description = null;
    ...
    static void checkNewExpression( PsiNewExpression expression,
                                   PsiType type,
    ...
    private static HighlightInfo buildAccessProblem( PsiJavaCodeReferenceElement classReference, JavaResolveResult result, PsiMember elementToFix) {
    ...
    private static void registerChangeParameterClassFix( PsiCall methodCall,
                                                         PsiExpressionList list,
                                                        HighlightInfo highlightInfo) {
    ...
    public static void registerChangeMethodSignatureFromUsageIntentions( JavaResolveResult[] candidates,
                                                                         PsiExpressionList list,
                                                                         HighlightInfo highlightInfo,
                                                                        TextRange fixRange) {
    ...
    private static void registerChangeMethodSignatureFromUsageIntention( PsiExpression[] expressions,
                                                                         HighlightInfo highlightInfo,
                                                                        TextRange fixRange,
