...
import com.gome.maven.openapi.editor.ElementColorProvider;
...
public class JavaColorProvider implements ElementColorProvider {
    ...
    public static Color getJavaColorFromExpression( PsiElement element) {
    ...
    @Override
    public void setColorTo( PsiElement element,  Color color) {
