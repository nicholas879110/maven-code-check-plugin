...
import com.gome.maven.application.options.editor.AutoImportOptionsConfigurable;
import com.gome.maven.application.options.editor.JavaAutoImportOptions;
...
import com.gome.maven.codeInsight.actions.OptimizeImportsProcessor;
...
public class AddImportAction implements QuestionAction {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.daemon.impl.actions.AddImportAction");
