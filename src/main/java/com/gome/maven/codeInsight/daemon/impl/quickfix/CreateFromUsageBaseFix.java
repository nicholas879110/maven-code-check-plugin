...
import com.gome.maven.codeInsight.template.TemplateEditingListener;
...
public abstract class CreateFromUsageBaseFix extends BaseIntentionAction {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.daemon.impl.quickfix.CreateFromUsageBaseFix");
    ...
    protected static void startTemplate ( Editor editor, final Template template,  final Project project) {
        startTemplate(editor, template, project, null);
    }

    protected static void startTemplate( final Editor editor,
