...
public abstract class AbstractLayoutCodeProcessor {
    ...
    protected AbstractLayoutCodeProcessor( AbstractLayoutCodeProcessor previous,
                                           String commandName,
                                           String progressText)
    {
    ...
    protected abstract FutureTask<Boolean> prepareTask( PsiFile file, boolean processChangedTextOnly) throws IncorrectOperationException;
    ...
    private Runnable createIterativeFileProcessor( final FileTreeIterator fileIterator) {
        return new Runnable() {
            @Override
            public void run() {
    ...
    private void runProcessFiles( final FileTreeIterator fileIterator) {
        final Runnable[] resultRunnable = new Runnable[1];
    ...
    private class ReformatFilesTask implements SequentialTask {
        ...
        private void updateIndicatorText( String upperLabel,  String downLabel) {
        ...
        private String getPresentablePath( PsiFile file) {
        ...
        public void setCompositeTask( SequentialModalProgressTask compositeTask) {
    ...
    protected static List<TextRange> getSelectedRanges( SelectionModel selectionModel) {
    ...
    protected void handleFileTooBigException(Logger logger, FilesTooBigForDiffException e,  PsiFile file) {
