...
import com.gome.maven.formatting.FormattingProgressTask;
...
public class ReformatCodeProcessor extends AbstractLayoutCodeProcessor {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.codeInsight.actions.ReformatCodeProcessor");
    ...
    protected FutureTask<Boolean> prepareTask( final PsiFile file, final boolean processChangedTextOnly)
    ...
    private static class CaretVisualPositionKeeper {
        ...
        private CaretVisualPositionKeeper( Document document) {
