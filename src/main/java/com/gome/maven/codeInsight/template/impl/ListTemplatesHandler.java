...
import com.gome.maven.codeInsight.completion.PlainPrefixMatcher;
...
public class ListTemplatesHandler implements CodeInsightActionHandler {
    ...
    public static Map<TemplateImpl, String> filterTemplatesByPrefix( Collection<TemplateImpl> templates,  Editor editor,
    ...
    public static MultiMap<String, CustomLiveTemplateLookupElement> getCustomTemplatesLookupItems( Editor editor,
                                                                                                   PsiFile file,
                                                                                                  int offset) {
    ...
    private static void showLookup(LookupImpl lookup,  Map<TemplateImpl, String> template2Argument) {
    ...
    private static void showLookup(LookupImpl lookup,  PsiFile file) {
        Editor editor = lookup.getEditor();
        Project project = editor.getProject();
    ...
    private static class MyLookupAdapter extends LookupAdapter {
        ...
        public MyLookupAdapter(Project project, Editor editor,  PsiFile file) {
            myProject = project;
            myEditor = editor;
