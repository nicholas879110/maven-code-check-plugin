...
import com.gome.maven.codeInsight.template.EverywhereContextType;
...
public class TemplateContext {
    ...
    Map<TemplateContextType, Boolean> getDifference( TemplateContext defaultContext) {
    ...
    void setDefaultContext( TemplateContext defContext) {
    ...
    void writeTemplateContext(Element element,  TemplateContext defaultContext) throws WriteExternalException {
