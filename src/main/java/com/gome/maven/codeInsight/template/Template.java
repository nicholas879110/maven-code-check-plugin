...
import com.gome.maven.codeInsight.template.impl.Variable;
...
public abstract class Template {
    ...
    public abstract void addTextSegment( String text);
    public abstract void addVariableSegment(  String name);

    public Variable addVariable(  String name,  Expression defaultValueExpression, boolean isAlwaysStopAt) {
    ...
    public boolean getValue( Property key) {
        Boolean result = myProperties.get(key);
        return result == null ? getDefaultValue(key) : result;
    }

    public void setValue( Property key, boolean value) {
        myProperties.put(key, value);
    }

    public static boolean getDefaultValue( Property key) {
