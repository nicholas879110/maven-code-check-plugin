...
import com.gome.maven.codeInsight.completion.JavaCompletionData;
import com.gome.maven.codeInsight.daemon.DaemonCodeAnalyzer;
import com.gome.maven.ide.highlighter.JavaFileHighlighter;
...
public abstract class JavaCodeContextType extends TemplateContextType {
    ...
    protected JavaCodeContextType(  String id,
