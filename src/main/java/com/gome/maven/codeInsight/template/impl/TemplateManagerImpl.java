...
public class TemplateManagerImpl extends TemplateManager implements Disposable {
    ...
    private static void disposeState( TemplateState state) {
    ...
    public Runnable prepareTemplate(final Editor editor, char shortcutChar,  final PairProcessor<String, String> processor) {
    ...
    public static boolean isApplicable( CustomLiveTemplate customLiveTemplate,
                                        Editor editor,
                                        PsiFile file) {
    ...
    private static Set<TemplateContextType> getDirectlyApplicableContextTypes( PsiFile file, int offset) {
    ...
    public static List<CustomLiveTemplate> listApplicableCustomTemplates( Editor editor,  PsiFile file, boolean selectionOnly) {
