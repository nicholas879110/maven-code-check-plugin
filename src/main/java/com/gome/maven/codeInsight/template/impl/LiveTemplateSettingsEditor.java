...
public class LiveTemplateSettingsEditor extends JPanel {
    ...
    public LiveTemplateSettingsEditor(TemplateImpl template,
        ...
        myKeyField.getDocument().addDocumentListener(new com.gome.maven.ui.DocumentAdapter() {
            @Override
        ...
        myDescription.getDocument().addDocumentListener(new com.gome.maven.ui.DocumentAdapter() {
            @Override
            protected void textChanged(javax.swing.event.DocumentEvent e) {
