...
public class PathMacrosCollector extends PathMacroMap {
    public static final ExtensionPointName<PathMacroFilter> MACRO_FILTER_EXTENSION_POINT_NAME = ExtensionPointName.create("com.gome.maven.pathMacroFilter");
    ...
    public static Set<String> getMacroNames( final Element e) {
    ...
    public static Set<String> getMacroNames(Element root,  PathMacroFilter filter,  PathMacros pathMacros) {
