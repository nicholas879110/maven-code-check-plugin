...
import com.gome.maven.application.options.colors.highlighting.HighlightData;
import com.gome.maven.application.options.colors.highlighting.HighlightsExtractor;
...
import com.gome.maven.openapi.options.colors.ColorSettingsPage;
import com.gome.maven.openapi.options.colors.EditorHighlightingProvidingColorSettingsPage;
