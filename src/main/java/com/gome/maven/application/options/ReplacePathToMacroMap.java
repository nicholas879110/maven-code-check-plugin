 ...
 * @see com.gome.maven.openapi.components.PathMacroManager
 */
public class ReplacePathToMacroMap extends PathMacroMap {
    ...
    private String replacePathMacroRecursively( final String text,  final String path, boolean caseSensitive) {
