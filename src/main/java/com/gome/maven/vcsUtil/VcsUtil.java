...
import com.gome.maven.openapi.vcs.roots.VcsRootDetector;
...
public class VcsUtil {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.vcsUtil.VcsUtil");
    ...
    public static String getPathForProgressPresentation( final File file) {
    ...
    public static Collection<VcsDirectoryMapping> findRoots( VirtualFile rootDir,  Project project)
    ...
    public static List<VcsDirectoryMapping> addMapping( List<VcsDirectoryMapping> existingMappings,
                                                        String path,
                                                        String vcs) {
