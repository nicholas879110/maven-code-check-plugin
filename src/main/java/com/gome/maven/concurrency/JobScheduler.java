...
public abstract class JobScheduler {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.concurrency.JobScheduler");
            ...
            protected void afterExecute(Runnable r, Throwable t) {
                if (DO_TIMING) {
                    ...
                    if (elapsed > TASK_LIMIT && (unwrapped = info(r)) != null) {
                         String msg = TASK_LIMIT + " ms execution limit failed for: " + unwrapped + "; elapsed time was " + elapsed +"ms";
                        LOG.info(msg);
                    }
                }
            }
