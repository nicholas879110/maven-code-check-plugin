...
public class JobLauncherImpl extends JobLauncher {
    ...
    @Override
    public <T> boolean invokeConcurrentlyUnderProgress( final List<T> things,
                                                       ProgressIndicator progress,
                                                       boolean runInReadAction,
                                                       boolean failFastOnAcquireReadAction,
                                                        final Processor<? super T> thingProcessor) throws ProcessCanceledException {
    ...
    private static <T> Boolean processImmediatelyIfTooFew( final List<T> things,
    ...
    @Override
    public <T> AsyncFuture<Boolean> invokeConcurrentlyUnderProgressAsync( List<T> things,
                                                                         ProgressIndicator progress,
                                                                         boolean failFastOnAcquireReadAction,
    ...
    @Override
    public Job<Void> submitToJobThread( final Runnable action,  Consumer<Future> onDoneCallback) {
    ...
    private static class VoidForkJoinTask extends ForkJoinTask<Void> implements Job<Void> {
        ...
        private VoidForkJoinTask( Runnable action,  Consumer<Future> onDoneCallback) {
            myAction = action;
        ...
        @Override
        public void addTask( Runnable task, Void result) {
            throw new IncorrectOperationException();
        }
