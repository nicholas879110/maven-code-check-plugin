...
import com.gome.maven.openapi.editor.ex.EditReadOnlyListener;
import com.gome.maven.openapi.editor.ex.LineIterator;
...
import com.gome.maven.psi.impl.source.tree.injected.Place;
...
public class DocumentWindowImpl extends UserDataHolderBase implements Disposable, DocumentWindow, DocumentEx {
    ...
    public DocumentWindowImpl( DocumentEx delegate, boolean oneLine,  Place shreds) {
        myDelegate = delegate;
        myOneLine = oneLine;
        synchronized (myLock) {
            myShreds = shreds;
