 ...
 */
package com.gome.maven.ui.docking.impl;
...
import com.gome.maven.openapi.fileEditor.impl.*;
...
import com.gome.maven.ui.components.panels.VerticalBox;
import com.gome.maven.ui.docking.*;
...
public class DockManagerImpl extends DockManager implements PersistentStateComponent<Element> {
    ...
    private DockWindow createWindowFor( String id, DockContainer container) {
