...
public final class SpeedSearchUtil {
    ...
    public static void applySpeedSearchHighlighting( JComponent speedSearchEnabledComponent,
                                                     SimpleColoredComponent coloredComponent,
    ...
    public static void appendColoredFragmentForMatcher( String text,
