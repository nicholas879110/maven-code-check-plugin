...
public interface ElementFilter<T> {
    ...
    interface Active<T> extends ElementFilter<T> {
        ActionCallback fireUpdate( final T preferredSelection, final boolean adjustSelection, final boolean now);
    ...
    interface Listener<T> {
        ActionCallback update( final T preferredSelection, final boolean adjustSelection, final boolean now);
    }
