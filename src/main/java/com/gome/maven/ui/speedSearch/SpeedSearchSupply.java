 ...
 */
package com.gome.maven.ui.speedSearch;
...
public abstract class SpeedSearchSupply {
    ...
    public static SpeedSearchSupply getSupply( final JComponent component) {
        return getSupply(component, false);
    }

    
    public static SpeedSearchSupply getSupply( final JComponent component, boolean evenIfInactive) {
    ...
    public abstract Iterable<TextRange> matchingFragments( final String text);
