...
import com.gome.maven.ui.speedSearch.SpeedSearch;
...
import com.gome.maven.util.ui.ChildFocusWatcher;
...
public class AbstractPopup implements JBPopup {
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ui.popup.AbstractPopup");
    ...
    AbstractPopup init(Project project,
                       ...
                       boolean resizable,
                        String caption,
                        Computable<Boolean> callback,
                       boolean cancelOnClickOutside,
                        Set<JBPopupListener> listeners,
                       ...
                       boolean modalContext,
                        Component[] focusOwners,
                        String adText,
                       int adTextAlignment,
                       boolean headerAlwaysFocusable,
                        List<Pair<ActionListener, KeyStroke>> keyboardActions,
                       Component settingsButtons,
                        final Processor<JBPopup> pinCallback,
                       boolean mayBeParent,
                       boolean showShadow,
                       boolean showBorder,
                       boolean cancelOnWindowDeactivation,
                        BooleanFunction<KeyEvent> keyEventHandler)
    {
    ...
    public void setAdText( final String s) {
        setAdText(s, SwingConstants.LEFT);
    }

    @Override
    public void setAdText( final String s, int alignment) {
    ...
    @Override
    public final void closeOk( InputEvent e) {
        setOk(true);
        cancel(e);
    }
    ...
    public static boolean isFocused( Component[] components) {
