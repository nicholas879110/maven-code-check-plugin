...
import com.gome.maven.ui.PopupBorder;
...
import com.gome.maven.ui.popup.util.MnemonicsSearch;
import com.gome.maven.ui.speedSearch.ElementFilter;
...
public abstract class WizardPopup extends AbstractPopup implements ActionListener, ElementFilter {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ui.popup.WizardPopup");
    ...
    public final void registerAction( String aActionName, KeyStroke keyStroke, Action aAction) {
