...
public class CommonActionsPanel extends JPanel {
    ...
    CommonActionsPanel(ListenerFactory factory,  JComponent contextComponent, ActionToolbarPosition position,
                        AnActionButton[] additionalActions,  Comparator<AnActionButton> buttonComparator,
