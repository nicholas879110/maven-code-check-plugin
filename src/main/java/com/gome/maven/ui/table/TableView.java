 ...
 */
package com.gome.maven.ui.table;

import com.gome.maven.ui.BooleanTableCellRenderer;
...
import com.gome.maven.util.ui.TableViewModel;
...
public class TableView<Item> extends BaseTableView implements ItemsProvider, SelectionProvider {
    ...
    /**
     * use {@link #setModelAndUpdateColumns(com.gome.maven.util.ui.ListTableModel<Item>)} instead
     * @param model
     */
    @Deprecated
