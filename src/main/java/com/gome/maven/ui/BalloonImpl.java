...
import com.gome.maven.openapi.ui.impl.ShadowBorderPainter;
...
public class BalloonImpl implements Balloon, IdeTooltip.Ui {
    ...
    public void show(JLayeredPane pane,  Rectangle bounds) {
        if (bounds != null) {
    ...
    private void runAnimation(boolean forward, final JLayeredPane layeredPane,  final Runnable onDone) {
        if (myAnimator != null) {
