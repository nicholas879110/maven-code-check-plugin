...
public class CollectionListModel<T> extends AbstractListModel implements EditableModel {
    ...
    public CollectionListModel( final Collection<? extends T> items) {
        myItems = new ArrayList<T>(items);
    }

    public CollectionListModel( final List<? extends T> items) {
    ...
    public void add( final List<? extends T> elements) {
    ...
    public void setElementAt( final T element, final int index) {
    ...
    public void contentsChanged( final T element) {
        int i = myItems.indexOf(element);
    ...
    public void replaceAll( final List<? extends T> elements) {
        removeAll();
        add(elements);
    }
