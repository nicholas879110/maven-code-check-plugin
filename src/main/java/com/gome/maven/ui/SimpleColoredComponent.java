...
public class SimpleColoredComponent extends JComponent implements Accessible, ColoredTextContainer {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ui.SimpleColoredComponent");
     ...
     */
    public final void append( final String fragment,  final SimpleTextAttributes attributes, int padding, /*@JdkConstants.HorizontalAlignment*/ int align) {
        append(fragment, attributes, myMainTextLastIndex < 0);
     ...
     */
    public void append( final String fragment,  final SimpleTextAttributes attributes, boolean isMainText) {
        _append(fragment, attributes, isMainText);
        revalidateAndRepaint();
    }

    private synchronized void _append( final String fragment,  final SimpleTextAttributes attributes, boolean isMainText) {
    ...
    @Override
    public void append( final String fragment,  final SimpleTextAttributes attributes, Object tag) {
    ...
    private int computeTextWidth( Font font, final boolean mainTextOnly) {
        int result = 0;
    ...
    static void formatLink( StringBuilder builder,
                            String fragment,
