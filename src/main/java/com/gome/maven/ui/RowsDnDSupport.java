...
public class RowsDnDSupport {
    ...
    public static void install( final JTable table,  final EditableModel model) {
        table.setDragEnabled(true);
        installImpl(table, model);
    }

    public static void install( final JList list,  final EditableModel model) {
        list.setDragEnabled(true);
        installImpl(list, model);
    }

    public static void install( final JTree tree,  final EditableModel model) {
