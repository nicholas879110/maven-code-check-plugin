...
public class UserActivityWatcher extends ComponentTreeWatcher {
    ...
    private final com.gome.maven.openapi.editor.event.DocumentListener myIdeaDocumentListener = new com.gome.maven.openapi.editor.event.DocumentAdapter() {
        @Override
        public void documentChanged(final com.gome.maven.openapi.editor.event.DocumentEvent e) {
            fireUIChanged();
        }
    };
