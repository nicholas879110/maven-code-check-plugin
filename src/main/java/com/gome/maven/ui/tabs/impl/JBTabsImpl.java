 ...
 */
package com.gome.maven.ui.tabs.impl;
...
import com.gome.maven.openapi.ui.*;
...
import com.gome.maven.ui.switcher.SwitchTarget;
import com.gome.maven.ui.tabs.*;
import com.gome.maven.ui.tabs.impl.singleRow.ScrollableSingleRowLayout;
import com.gome.maven.ui.tabs.impl.singleRow.SingleRowLayout;
import com.gome.maven.ui.tabs.impl.singleRow.SingleRowPassInfo;
import com.gome.maven.ui.tabs.impl.table.TableLayout;
import com.gome.maven.ui.tabs.impl.table.TablePassInfo;
import com.gome.maven.util.Function;
import com.gome.maven.util.containers.ContainerUtil;
import com.gome.maven.util.containers.FluentIterable;
...
public class JBTabsImpl extends JComponent
    ...
    public void showMorePopup( final MouseEvent e) {
        final SingleRowPassInfo lastLayout = mySingleRowLayout.myLastSingRowLayout;
        if (lastLayout == null) {
            return;
        }
    ...
    public JBTabs setPopupGroup( final ActionGroup popupGroup,  String place, final boolean addNavigationGroup) {
    ...
    public JBTabs setPopupGroup( final Getter<ActionGroup> popupGroup,
                                 final String place,
...
//end hack
    ...
    public ActionCallback removeTab(final TabInfo info,  TabInfo forcedSelectionTransfer, boolean transferFocus) {
    ...
    @Override
    public int getIndexOf( final TabInfo tabInfo) {
    ...
    public JBTabsPresentation setActiveTabFillIn( final Color color) {
