...
import com.gome.maven.ui.tabs.JBTabsPosition;
...
public class JBEditorTabs extends JBTabsImpl {
    ...
    public JBEditorTabs( Project project,  ActionManager actionManager, IdeFocusManager focusManager,  Disposable parent) {
