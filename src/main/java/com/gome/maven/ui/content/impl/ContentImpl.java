...
import com.gome.maven.ui.content.AlertIcon;
...
public class ContentImpl extends UserDataHolderBase implements Content {
    ...
    @Override
    public void setActions(final ActionGroup actions, String place,  JComponent contextComponent) {
    ...
    @Override
    public void setAlertIcon( final AlertIcon icon) {
        myAlertIcon = icon;
    }
    ...
    @Override
    public void setSearchComponent( final JComponent comp) {
