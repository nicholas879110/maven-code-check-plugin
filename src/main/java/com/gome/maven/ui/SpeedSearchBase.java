...
import com.gome.maven.openapi.wm.ex.ToolWindowManagerListener;
...
public abstract class SpeedSearchBase<Comp extends JComponent> extends SpeedSearchSupply {
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ui.SpeedSearchBase");
    ...
    @Override
    public Iterable<TextRange> matchingFragments( String text) {
    ...
    protected class ViewIterator implements ListIterator<Object> {
        ...
        public ViewIterator( final SpeedSearchBase speedSearch, final int startIndex) {
