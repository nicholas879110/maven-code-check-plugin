...
public class ActionLink extends LinkLabel implements DataProvider {
    ...
    public ActionLink(String text,  AnAction action) {
        this(text, ICON, action);
    }

    public ActionLink(String text, Icon icon,  AnAction action) {
        this(text, icon, action, null);
    }

    public ActionLink(String text, Icon icon,  AnAction action,  final Runnable onDone) {
        super(text, icon);
