 ...
 */
package com.gome.maven.ui.components.labels;
...
import com.gome.maven.ui.UI;
import com.gome.maven.util.ui.JBRectangle;
...
public class LinkLabel<T> extends JLabel {
    ...
    public LinkLabel(String text,  Icon icon,  LinkListener<T> aListener) {
        this(text, icon, aListener, null, null);
    }

    public LinkLabel(String text,  Icon icon,  LinkListener<T> aListener,  T aLinkData) {
        this(text, icon, aListener, aLinkData, null);
    }

    public LinkLabel(String text,
                      Icon icon,
                      LinkListener<T> aListener,
                      T aLinkData,
                      String aVisitedLinksKey) {
    ...
    public void setListener(LinkListener<T> listener,  T linkData) {
