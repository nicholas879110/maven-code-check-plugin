...
public class JBScrollPane extends JScrollPane {
    ...
    private boolean relayoutScrollbars( JComponent container,  ScrollPaneLayout layout, boolean forceRelayout) {
    ...
    private boolean shouldExtendViewportUnderScrollbar( JScrollBar scrollbar) {
