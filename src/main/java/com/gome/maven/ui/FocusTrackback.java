...
public class FocusTrackback {
    ...
    public FocusTrackback( Object requestor, Component parent, boolean mustBeShown) {
        this(requestor, parent == null ? null : UIUtil.getWindow(parent), mustBeShown);
    }

    public FocusTrackback( Object requestor, Window parent, boolean mustBeShown) {
    ...
    public void registerFocusComponent( final Component focusedComponent) {
    ...
    public void registerFocusComponent( ComponentQuery query) {
    ...
    public static void release( final JFrame frame) {
    ...
    public static List<JBPopup> getChildPopups( final Component component) {
