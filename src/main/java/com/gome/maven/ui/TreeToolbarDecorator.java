...
import com.gome.maven.openapi.actionSystem.ActionToolbarPosition;
import com.gome.maven.openapi.util.SystemInfo;
import com.gome.maven.ui.treeStructure.SimpleNode;
import com.gome.maven.util.ui.EditableModel;
import com.gome.maven.util.ui.EditableTreeModel;
import com.gome.maven.util.ui.ElementProducer;
...
class TreeToolbarDecorator extends ToolbarDecorator {
    ...
    TreeToolbarDecorator(JTree tree,  final ElementProducer<?> producer) {
        myTree = tree;
        myProducer = producer;
