    ...
    public SearchTextField(boolean historyEnabled) {
        ...
        myTextField = new TextFieldWithProcessing() {
            ...
            public void setUI(TextUI ui) {
                if (SystemInfo.isMac) {
                    try {
                        Class<?> uiClass = Class.forName("com.gome.maven.ide.ui.laf.darcula.ui.DarculaTextFieldUI");
                        Method method = ReflectionUtil.getMethod(uiClass, "createUI", JComponent.class);
                        if (method != null) {
                            super.setUI((TextUI)method.invoke(uiClass, this));
                            Class<?> borderClass = Class.forName("com.gome.maven.ide.ui.laf.darcula.ui.DarculaTextBorder");
