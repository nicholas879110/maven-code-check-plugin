...
import com.gome.maven.ide.ui.laf.darcula.ui.DarculaEditorTextFieldBorder;
...
import com.gome.maven.openapi.wm.ex.AbstractDelegatingToRootTraversalPolicy;
...
public class EditorTextField extends NonOpaquePanel implements DocumentListener, TextComponent, DataProvider,
    ...
    private static final Logger LOG = Logger.getInstance("#com.gome.maven.ui.EditorTextField");
