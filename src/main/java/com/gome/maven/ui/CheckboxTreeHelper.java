...
class CheckboxTreeHelper {
    ...
    public void initTree( final Tree tree, JComponent mainComponent, CheckboxTreeBase.CheckboxTreeCellRendererBase cellRenderer) {
    ...
    public static <T> T[] getCheckedNodes(final Class<T> nodeType,  final Tree.NodeFilter<T> filter, final TreeModel model) {
