...
public interface AntCopyInstructionCreator {
    ...
    Tag createDirectoryContentCopyInstruction( String dirPath);

    
    Tag createFileCopyInstruction( String filePath, String outputFileName);
    ...
    Generator createExtractedDirectoryInstruction( String jarPath);
}
