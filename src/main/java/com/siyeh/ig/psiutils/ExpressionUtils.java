...
import com.gome.maven.psi.util.ConstantExpressionUtil;
...
public class ExpressionUtils {
    ...
    public static String getLiteralString( PsiExpression expression) {
    ...
    public static PsiLiteralExpression getLiteral( PsiExpression expression) {
    ...
    public static boolean isLiteral( PsiExpression expression) {
        return getLiteral(expression) != null;
    }

    public static boolean isEmptyStringLiteral( PsiExpression expression) {
        expression = ParenthesesUtils.stripParentheses(expression);
        if (!(expression instanceof PsiLiteralExpression)) {
            return false;
        }
    ...
    public static boolean isNegation( PsiExpression condition,
    ...
    public static boolean hasType( PsiExpression expression,   String typeName) {
        if (expression == null) {
            return false;
        }
    ...
    public static boolean hasStringType( PsiExpression expression) {
