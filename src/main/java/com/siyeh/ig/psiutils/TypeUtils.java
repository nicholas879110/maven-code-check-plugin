...
public class TypeUtils {
    ...
    public static boolean expressionHasTypeOrSubtype( PsiExpression expression,   String typeName) {
        return expressionHasTypeOrSubtype(expression, new String[] {typeName}) != null;
    }

    //getTypeIfOneOfOrSubtype
    public static String expressionHasTypeOrSubtype( PsiExpression expression,   String... typeNames) {
        if (expression == null) {
            return null;
        }
    ...
    public static boolean expressionHasTypeOrSubtype( PsiExpression expression,   Iterable<String> typeNames) {
        if (expression == null) {
            return false;
        }
        final PsiType type = expression.getType();
    ...
    public static boolean variableHasTypeOrSubtype( PsiVariable variable,   String... typeNames) {
        if (variable == null) {
            return false;
        }
    ...
    public static boolean hasFloatingPointType( PsiExpression expression) {
        if (expression == null) {
            return false;
        }
        final PsiType type = expression.getType();
