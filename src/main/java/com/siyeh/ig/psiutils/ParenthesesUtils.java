...
public class ParenthesesUtils {
    ...
    public static PsiExpression stripParentheses( PsiExpression expression) {
    ...
    private static void removeParensFromReferenceExpression( PsiReferenceExpression referenceExpression,
    ...
    private static void removeParensFromParenthesizedExpression( PsiParenthesizedExpression parenthesizedExpression,
                                                                boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromConditionalExpression( PsiConditionalExpression conditionalExpression,
                                                              boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromInstanceOfExpression( PsiInstanceOfExpression instanceofExpression,
                                                             boolean ignoreClarifyingParentheses) {
        final PsiExpression operand = instanceofExpression.getOperand();
        removeParentheses(operand, ignoreClarifyingParentheses);
    }

    private static void removeParensFromPolyadicExpression( PsiPolyadicExpression polyadicExpression,
                                                           boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromPostfixExpression( PsiPostfixExpression postfixExpression,
                                                          boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromArrayAccessExpression( PsiArrayAccessExpression arrayAccessExpression,
                                                              boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromTypeCastExpression( PsiTypeCastExpression typeCastExpression,
                                                           boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromArrayInitializerExpression( PsiArrayInitializerExpression arrayInitializerExpression,
                                                                   boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromAssignmentExpression( PsiAssignmentExpression assignment,
                                                             boolean ignoreClarifyingParentheses) {
    ...
    private static void removeParensFromMethodCallExpression( PsiMethodCallExpression methodCallExpression,
                                                             boolean ignoreClarifyingParentheses) {
