...
public class FastCgiRequest {
  ...
  public void writeFileHeaders( VirtualFile file,  Project project,  CharSequence canonicalRequestPath) {
  ...
  public final void addHeader( String key,  CharSequence value) {
    if (value == null) {
      return;
    }
