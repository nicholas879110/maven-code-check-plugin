...
public class FastCgiDecoder extends Decoder implements Decoder.FullMessageConsumer<Void> {
  ...
  public FastCgiDecoder( Consumer<String> errorOutputConsumer,  FastCgiService responseHandler) {
  ...
  @Override
  public Void contentReceived( ByteBuf buffer,  ChannelHandlerContext context, boolean isCumulateBuffer) {
    switch (type) {
