...
public final class NettyUtil {
  ...
  public static Channel connect( Bootstrap bootstrap,  InetSocketAddress remoteAddress,  AsyncPromise<?> promise) {
    return connect(bootstrap, remoteAddress, promise, DEFAULT_CONNECT_ATTEMPT_COUNT);
  }


  public static Channel connect( Bootstrap bootstrap,  InetSocketAddress remoteAddress,  AsyncPromise<?> promise, int maxAttemptCount) {
    return connect(bootstrap, remoteAddress, promise, maxAttemptCount, null);
  }


  public static Channel connect( Bootstrap bootstrap,  InetSocketAddress remoteAddress,  AsyncPromise<?> promise, int maxAttemptCount,  Condition<Void> stopCondition) {
    try {
  ...
  private static Channel doConnect( Bootstrap bootstrap,
                                   ...
                                   int maxAttemptCount,
                                    Condition<Void> stopCondition) throws Throwable {
    int attemptCount = 0;
