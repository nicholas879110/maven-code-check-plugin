...
public class SsiProcessor {
  ...
  public SsiProcessor(boolean allowExec) {
    commands.put("config", new SsiCommand() {
      @Override
      public long process( SsiProcessingState state,  String commandName,  List<String> paramNames,  String[] paramValues,  ByteBufUtf8Writer writer) {
   ...
   */
  public long process( SsiExternalResolver ssiExternalResolver,  String fileContents, long lastModifiedDate,  ByteBufUtf8Writer writer) {
  ...
  protected List<String> parseParamNames( StringBuilder command, int start) {
    int bIdx = start;
  ...
  protected String[] parseParamValues( StringBuilder command, int start, int count) {
    int valueIndex = 0;
    boolean inside = false;
  ...
  private String parseCommand( StringBuilder instruction) {
    int firstLetter = -1;
    int lastLetter = -1;
