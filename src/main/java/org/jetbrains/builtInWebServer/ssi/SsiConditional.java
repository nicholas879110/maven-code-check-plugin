...
public class SsiConditional implements SsiCommand {
  ...
  @Override
  public long process( SsiProcessingState ssiProcessingState,  String commandName,  List<String> paramNames,  String[] paramValues,  ByteBufUtf8Writer writer) {
   ...
   */
  private static boolean evaluateArguments( List<String> names,  String[] values,  SsiProcessingState ssiProcessingState) {
