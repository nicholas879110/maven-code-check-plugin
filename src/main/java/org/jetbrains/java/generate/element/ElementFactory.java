...
public class ElementFactory {
   ...
   *
   * @param field   the {@link com.gome.maven.psi.PsiField} to get the information from.
  ...
  public static MethodElement newMethodElement(PsiMethod method) {
    ...
    // http://www.gome.maven.net/forums/thread.jsp?nav=false&forum=18&thread=88676&start=0&msRange=15
    if (type == null) {
