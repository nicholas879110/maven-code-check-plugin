...
public class PsiAdapter {
     ...
     * @see #getTypeClassName(com.gome.maven.psi.PsiType) for the non qualified version.
     */
     ...
     * @see #getTypeQualifiedClassName(com.gome.maven.psi.PsiType) for the qualified version.
     */
     ...
     * @see #isGetterMethod(com.gome.maven.psi.PsiMethod) for the getter check
     */
