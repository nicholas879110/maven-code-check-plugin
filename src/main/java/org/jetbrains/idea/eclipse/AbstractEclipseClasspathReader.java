...
public abstract class AbstractEclipseClasspathReader<T> {
    ...
    public AbstractEclipseClasspathReader( String rootPath,  List<String> currentRoots,  Set<String> moduleNames) {
    ...
    protected static String getPresentableName( String path) {
        return getPresentableName(path, null);
    }

    
    protected static String getPresentableName( String path, Set<String> names) {
