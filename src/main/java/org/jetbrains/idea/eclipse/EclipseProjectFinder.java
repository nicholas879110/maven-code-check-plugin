...
public class EclipseProjectFinder implements EclipseXml {
    public static void findModuleRoots(final List<String> paths, final String rootPath,  Processor<String> progressUpdater) {
    ...
    public static LinkedResource findLinkedResource( String projectPath,  String relativePath) {
        String independentPath = FileUtil.toSystemIndependentName(relativePath);
         String resourceName = independentPath;
