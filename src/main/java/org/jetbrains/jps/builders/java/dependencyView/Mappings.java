...
public class Mappings {
  ...
  */
  ...
  private ClassRepr getReprByName(final  File source, final int qName) {
  ...
  private class Util {
    ...
    void collectSupersRecursively(final int className,  final TIntHashSet container) {
  ...
  void affectAll(final int className,  final File sourceFile, final Collection<File> affectedFiles, final Collection<File> alreadyCompiledFiles,  final DependentFilesFilter filter) {
  ...
  private boolean incrementalDecision(final int owner, final Proto member, final Collection<File> affectedFiles, final Collection<File> currentlyCompiled,  final DependentFilesFilter filter) {
  ...
  private class Differential {
    ...
    private Differential(final Mappings delta,
                         ...
                         final Collection<File> affectedFiles,
                          ...
                          final Callbacks.ConstantAffectionResolver constantSearch) {
      delta.myRemovedFiles = removed;
    ...
    private void processRemovedClases(final DiffState state,  File fileName) {
    ...
    private void calculateAffectedFiles(final DiffState state) {
      ...
      state.myDependants.forEach(new TIntProcedure() {
        ...
        private void processDependentFile(int depClass,  File depFile) {
  ...
  private void cleanupRemovedClass(final Mappings delta,  final ClassRepr cr, File sourceFile, final Set<UsageRepr.Usage> usages, final IntIntMultiMaplet dependenciesTrashBin) {
