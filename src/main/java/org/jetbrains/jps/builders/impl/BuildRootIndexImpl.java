...
public class BuildRootIndexImpl implements BuildRootIndex {
  ...
  @Override
  public <R extends BuildRootDescriptor> List<R> getRootDescriptors( File root,
  ...
  @Override
  public <R extends BuildRootDescriptor> List<R> getTargetRoots( BuildTarget<R> target, CompileContext context) {
    //noinspection unchecked
  ...
  @Override
  public <R extends BuildRootDescriptor> List<R> getTempTargetRoots( BuildTarget<R> target,  CompileContext context) {
  ...
  @Override
  public <R extends BuildRootDescriptor> void associateTempRoot( CompileContext context,  BuildTarget<R> target,  R root) {
  ...
  public <R extends BuildRootDescriptor> R findParentDescriptor( File file,  Collection<? extends BuildTargetType<? extends BuildTarget<R>>> types,
                                                                 CompileContext context) {
    File current = file;
    int depth = 0;
    while (current != null) {
  ...
  public <R extends BuildRootDescriptor> Collection<R> findAllParentDescriptors( File file,
                                                                                 Collection<? extends BuildTargetType<? extends BuildTarget<R>>> types,
                                                                                 CompileContext context) {
    File current = file;
    List<R> result = null;
  ...
  private <R extends BuildRootDescriptor> List<R> filterDescriptorsByFile( List<R> descriptors, File file, int parentsToCheck) {
  ...
  @Override
  public <R extends BuildRootDescriptor> Collection<R> findAllParentDescriptors( File file,  CompileContext context) {
    return findAllParentDescriptors(file, null, context);
  }

  @Override

  public Collection<? extends BuildRootDescriptor> clearTempRoots( CompileContext context) {
    try {
  ...
  public JavaSourceRootDescriptor findJavaRootDescriptor( CompileContext context, File file) {
    return findParentDescriptor(file, JavaModuleBuildTargetType.ALL_TYPES, context);
  }


  @Override
  public FileFilter getRootFilter( BuildRootDescriptor descriptor) {
  ...
  @Override
  public boolean isFileAccepted( File file,  BuildRootDescriptor descriptor) {
    return !myIgnoredFileIndex.isIgnored(file.getName()) && getRootFilter(descriptor).accept(file);
  }

  @Override
  public boolean isDirectoryAccepted( File dir,  BuildRootDescriptor descriptor) {
