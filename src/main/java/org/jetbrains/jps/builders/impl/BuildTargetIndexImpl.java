...
public class BuildTargetIndexImpl implements BuildTargetIndex {
  ...
  @Override
  public List<BuildTargetChunk> getSortedTargetChunks( CompileContext context) {
    initializeChunks(context);
    return myTargetChunks;
  }


  private synchronized void initializeChunks( CompileContext context) {
  ...
  @Override
  public boolean isDummy( BuildTarget<?> target) {
  ...
  @Override
  public Set<BuildTarget<?>> getDependenciesRecursively( BuildTarget<?> target,  CompileContext context) {
    initializeChunks(context);
  ...
  @Override
  public Collection<BuildTarget<?>> getDependencies( BuildTarget<?> target,  CompileContext context) {
    initializeChunks(context);
    return myDependencies.get(target);
  }


  public Collection<ModuleBasedTarget<?>> getModuleBasedTargets( JpsModule module,  ModuleTargetSelector selector) {
    return myRegistry.getModuleBasedTargets(module, selector);
  }


  public <T extends BuildTarget<?>> List<T> getAllTargets( BuildTargetType<T> type) {
