...
import com.gome.maven.util.ParameterizedRunnable;
...
public class JpsModelLoaderImpl implements JpsModelLoader {
  ...
  public JpsModelLoaderImpl(String projectPath, String globalOptionsPath,  ParameterizedRunnable<JpsModel> initializer) {
