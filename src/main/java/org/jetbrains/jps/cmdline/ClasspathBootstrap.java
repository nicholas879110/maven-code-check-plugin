...
import com.gome.maven.compiler.notNullVerification.NotNullVerifyingInstrumenter;
import com.gome.maven.openapi.application.PathManager;
import com.gome.maven.openapi.diagnostic.Logger;
import com.gome.maven.openapi.util.io.FileUtil;
import com.gome.maven.uiDesigner.compiler.AlienFormFileException;
...
public class ClasspathBootstrap {
  ...
  public static List<String> getBuildProcessApplicationClasspath(boolean isLauncherUsed) {
    ...
    try {
      final Class<?> cmdLineWrapper = Class.forName("com.gome.maven.rt.execution.CommandLineWrapper");
