...
final class BuildSession implements Runnable, CanceledStatus {
  ...
  BuildSession(UUID sessionId,
               ...
               CmdlineRemoteProto.Message.ControllerMessage.ParametersMessage params,
                CmdlineRemoteProto.Message.ControllerMessage.FSEvent delta,  PreloadedData preloaded) {
  ...
  private static void applyFSEvent(ProjectDescriptor pd,  CmdlineRemoteProto.Message.ControllerMessage.FSEvent event) throws IOException {
    if (event == null) {
      return;
    }
