...
public class JpsArtifactServiceImpl extends JpsArtifactService {
  ...
  @Override
  public <P extends JpsElement> JpsArtifact addArtifact( JpsProject project,
                                                         String name,
                                                         JpsCompositePackagingElement rootElement,
                                                         JpsArtifactType<P> type,
                                                         P properties) {
  ...
  @Override
  public <P extends JpsElement> JpsArtifact createArtifact( String name,  JpsCompositePackagingElement rootElement,
