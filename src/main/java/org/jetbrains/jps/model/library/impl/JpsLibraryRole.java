...
public class JpsLibraryRole extends JpsElementChildRoleBase<JpsLibrary> {
  ...
  @Override
  public void fireElementAdded( JpsEventDispatcher dispatcher,  JpsLibrary element) {
    dispatcher.getPublisher(JpsLibraryListener.class).libraryAdded(element);
  }

  @Override
  public void fireElementRemoved( JpsEventDispatcher dispatcher,  JpsLibrary element) {
