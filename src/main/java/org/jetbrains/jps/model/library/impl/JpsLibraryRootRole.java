...
public class JpsLibraryRootRole extends JpsElementChildRoleBase<JpsLibraryRoot> {
  ...
  public JpsLibraryRootRole( JpsOrderRootType rootType) {
    super("library root");
    myRootType = rootType;
  }

  @Override
  public void fireElementAdded( JpsEventDispatcher dispatcher,  JpsLibraryRoot element) {
    dispatcher.getPublisher(JpsLibraryRootListener.class).rootAdded(element);
  }

  @Override
  public void fireElementRemoved( JpsEventDispatcher dispatcher,  JpsLibraryRoot element) {
