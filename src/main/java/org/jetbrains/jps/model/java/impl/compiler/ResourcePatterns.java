...
public class ResourcePatterns {
  ...
  public boolean isResourceFile(File file,  final File srcRoot) {
  ...
  private static boolean matches(String name, String parentRelativePath,  File srcRoot, CompiledPattern pattern) {
  ...
  private static class CompiledPattern {
    ...
    CompiledPattern( Pattern fileName,  Pattern dir,  Pattern srcRoot) {
