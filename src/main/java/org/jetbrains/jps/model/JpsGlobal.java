...
public interface JpsGlobal extends JpsCompositeElement, JpsReferenceableElement<JpsGlobal> {
  ...
  JpsTypedLibrary<JpsSdk<P>> addSdk( String name,  String homePath,  String versionString,  SdkType type);

  <P extends JpsElement>
  JpsTypedLibrary<JpsSdk<P>> addSdk( String name,  String homePath,  String versionString,
