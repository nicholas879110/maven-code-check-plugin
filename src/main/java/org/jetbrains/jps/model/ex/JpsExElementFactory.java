...
public abstract class JpsExElementFactory {
  ...
  public abstract JpsElementContainerEx createContainer( JpsCompositeElementBase<?> parent);

  public abstract JpsElementContainerEx createContainerCopy( JpsElementContainerEx original,
                                                             JpsCompositeElementBase<?> parent);
