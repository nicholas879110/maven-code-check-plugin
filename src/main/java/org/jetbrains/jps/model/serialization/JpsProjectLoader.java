...
public class JpsProjectLoader extends JpsLoaderBase {
  ...
  private JpsModule loadModule( File file,  Element moduleRoot, List<String> paths,  JpsSdkType<?> projectSdkType) {
  ...
  private static JpsModulePropertiesSerializer<?> getModulePropertiesSerializer( String typeId) {
    for (JpsModelSerializerExtension extension : JpsModelSerializerExtension.getExtensions()) {
