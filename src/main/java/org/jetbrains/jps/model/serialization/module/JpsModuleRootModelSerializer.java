...
import static com.gome.maven.openapi.util.JDOMUtil.getChildren;
...
public class JpsModuleRootModelSerializer {
  ...
  private static <P extends JpsElement> JpsModuleSourceRoot createSourceRoot( String url,
                                                                              JpsModuleSourceRootPropertiesSerializer<P> serializer,
  ...
  private static JpsModuleSourceRootPropertiesSerializer<?> getSourceRootPropertiesSerializer( Element sourceElement) {
  ...
  public static <P extends JpsElement> void saveSourceRoot( Element contentElement,
                                                           final  String rootUrl,
                                                            JpsTypedModuleSourceRoot<P> root) {
