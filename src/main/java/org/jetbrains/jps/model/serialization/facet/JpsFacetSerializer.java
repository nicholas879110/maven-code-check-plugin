...
public class JpsFacetSerializer {
  ...
  public static void loadFacets(JpsModule module,  Element facetManagerElement) {
  ...
  public static void saveFacets(JpsModule module,  Element facetManagerElement) {
  ...
  private static void addFacets(JpsModule module, List<FacetState> facets,  final JpsElement parentFacet) {
  ...
  private static JpsFacetConfigurationSerializer<?> getModuleExtensionSerializer( String typeId) {
    for (JpsModelSerializerExtension extension : JpsModelSerializerExtension.getExtensions()) {
      for (JpsFacetConfigurationSerializer<?> serializer : extension.getFacetConfigurationSerializers()) {
