...
public abstract class JpsFacetConfigurationSerializer<E extends JpsElement> {
  ...
  public JpsFacetConfigurationSerializer(JpsElementChildRole<E> role, String facetTypeId, final  String facetName) {
    myRole = role;
  ...
  protected abstract E loadExtension( Element facetConfigurationElement, String name, JpsElement parent, JpsModule module);

  public boolean hasExtension(JpsModule module) {
    return module.getContainer().getChild(myRole) != null;
  }

  public void saveExtension(JpsModule module,  List<FacetState> states) {
