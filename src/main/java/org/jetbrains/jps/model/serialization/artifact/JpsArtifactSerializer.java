...
public class JpsArtifactSerializer {
  ...
  public static void loadArtifacts( JpsProject project,  Element componentElement) {
  ...
  public static void saveArtifact( JpsArtifact artifact, Element componentElement) {
  ...
  private static JpsPackagingElementSerializer<?> findElementSerializer( String typeId) {
  ...
  private static <E extends JpsPackagingElement> JpsPackagingElementSerializer<E> findElementSerializer( Class<E> elementClass) {
    for (JpsPackagingElementSerializer<?> serializer : STANDARD_SERIALIZERS) {
