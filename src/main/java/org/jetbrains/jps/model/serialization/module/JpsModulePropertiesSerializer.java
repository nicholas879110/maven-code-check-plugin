...
public abstract class JpsModulePropertiesSerializer<P extends JpsElement> extends JpsElementPropertiesSerializer<P, JpsModuleType<P>> {
  ...
  protected JpsModulePropertiesSerializer(JpsModuleType<P> type, String typeId,  String componentName) {
    super(type, typeId);
  ...
  public abstract P loadProperties( Element componentElement);

  public abstract void saveProperties( P properties,  Element componentElement);
}
