...
public class JpsJavaModelSerializerExtension extends JpsModelSerializerExtension {
  ...
  private static class JavaProjectExtensionSerializer extends JpsProjectExtensionSerializer {
    ...
    @Override
    public void loadExtension( JpsProject project,  Element componentTag) {
    ...
    @Override
    public void saveExtension( JpsProject project,  Element componentTag) {
  ...
  private static class JavaSourceRootPropertiesSerializer extends JpsModuleSourceRootPropertiesSerializer<JavaSourceRootProperties> {
    ...
    @Override
    public JavaSourceRootProperties loadProperties( Element sourceRootTag) {
    ...
    @Override
    public void saveProperties( JavaSourceRootProperties properties,  Element sourceRootTag) {
  ...
  private static class JavaResourceRootPropertiesSerializer extends JpsModuleSourceRootPropertiesSerializer<JavaResourceRootProperties> {
    ...
    @Override
    public JavaResourceRootProperties loadProperties( Element sourceRootTag) {
    ...
    @Override
    public void saveProperties( JavaResourceRootProperties properties,  Element sourceRootTag) {
