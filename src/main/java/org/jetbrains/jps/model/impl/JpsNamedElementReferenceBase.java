...
public abstract class JpsNamedElementReferenceBase<S extends JpsNamedElement, T extends JpsNamedElement, Self extends JpsNamedElementReferenceBase<S, T, Self>>
  ...
  protected JpsNamedElementReferenceBase( String elementName,  JpsElementReference<? extends JpsCompositeElement> parentReference) {
  ...
  protected abstract JpsElementCollection<? extends S> getCollection( JpsCompositeElement parent);
  ...
  @Override
  public JpsElementReference<T> asExternal( JpsModel model) {
