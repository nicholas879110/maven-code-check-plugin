...
public class JpsExElementFactoryImpl extends JpsExElementFactory {
  @Override
  public JpsElementContainerEx createContainer( JpsCompositeElementBase<?> parent) {
    return new JpsElementContainerImpl(parent);
  }

  @Override
  public JpsElementContainerEx createContainerCopy( JpsElementContainerEx original,
