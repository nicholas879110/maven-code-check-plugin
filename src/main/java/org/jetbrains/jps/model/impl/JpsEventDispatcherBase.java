...
public abstract class JpsEventDispatcherBase implements JpsEventDispatcher {
  ...
  @Override
  public <T extends JpsElement> void fireElementAdded( T element,  JpsElementChildRole<T> role) {
    role.fireElementAdded(this, element);
  }

  @Override
  public <T extends JpsElement> void fireElementRemoved( T element,  JpsElementChildRole<T> role) {
