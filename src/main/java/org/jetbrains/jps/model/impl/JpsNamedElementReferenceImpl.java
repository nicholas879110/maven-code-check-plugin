...
public abstract class JpsNamedElementReferenceImpl<T extends JpsNamedElement, Self extends JpsNamedElementReferenceImpl<T, Self>> extends JpsNamedElementReferenceBase<T, T, Self> {
  ...
  protected JpsNamedElementReferenceImpl( JpsElementCollectionRole<? extends T> role,  String elementName,
  ...
  protected JpsElementCollection<? extends T> getCollection( JpsCompositeElement parent) {
