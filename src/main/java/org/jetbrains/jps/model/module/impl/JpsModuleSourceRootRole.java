...
public class JpsModuleSourceRootRole extends JpsElementChildRoleBase<JpsModuleSourceRoot> {
  ...
  @Override
  public void fireElementAdded( JpsEventDispatcher dispatcher,  JpsModuleSourceRoot element) {
    dispatcher.getPublisher(JpsModuleSourceRootListener.class).sourceRootAdded(element);
  }

  @Override
  public void fireElementRemoved( JpsEventDispatcher dispatcher,  JpsModuleSourceRoot element) {
