...
public class JpsModuleRole extends JpsElementChildRoleBase<JpsModule> {
  ...
  @Override
  public void fireElementAdded( JpsEventDispatcher dispatcher,  JpsModule element) {
    dispatcher.getPublisher(JpsModuleListener.class).moduleAdded(element);
  }

  @Override
  public void fireElementRemoved( JpsEventDispatcher dispatcher,  JpsModule element) {
