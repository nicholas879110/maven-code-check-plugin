...
public class JpsDependenciesListImpl extends JpsCompositeElementBase<JpsDependenciesListImpl> implements JpsDependenciesList {
  ...
  public JpsModuleDependency addModuleDependency( JpsModule module) {
    return addModuleDependency(module.createReference());
  }


  @Override
  public JpsModuleDependency addModuleDependency( JpsModuleReference moduleReference) {
  ...
  public JpsLibraryDependency addLibraryDependency( JpsLibrary libraryElement) {
    return addLibraryDependency(libraryElement.createReference());
  }


  @Override
  public JpsLibraryDependency addLibraryDependency( JpsLibraryReference libraryReference) {
  ...
  @Override
  public void addSdkDependency( JpsSdkType<?> sdkType) {
