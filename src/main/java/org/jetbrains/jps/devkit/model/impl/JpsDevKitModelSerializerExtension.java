...
public class JpsDevKitModelSerializerExtension extends JpsModelSerializerExtension {
  ...
  private static class JpsIdeaSdkPropertiesSerializer extends JpsSdkPropertiesSerializer<JpsSimpleElement<JpsIdeaSdkProperties>> {
    ...
    @Override
    public JpsSimpleElement<JpsIdeaSdkProperties> loadProperties( Element propertiesElement) {
    ...
    @Override
    public void saveProperties( JpsSimpleElement<JpsIdeaSdkProperties> properties,  Element element) {
  ...
  private static class JpsPluginModulePropertiesSerializer extends JpsModulePropertiesSerializer<JpsSimpleElement<JpsPluginModuleProperties>> {
    ...
    @Override
    public JpsSimpleElement<JpsPluginModuleProperties> loadProperties( Element componentElement) {
    ...
    @Override
    public void saveProperties( JpsSimpleElement<JpsPluginModuleProperties> element,  Element componentElement) {
