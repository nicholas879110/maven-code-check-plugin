...
public class JavacMain {
  ...
  public static boolean compile(Collection<String> options,
                                ...
                                CanceledStatus canceledStatus,  JavaCompilingTool compilingTool) {
  ...
  private static Collection<String> prepareOptions(final Collection<String> options,  JavaCompilingTool compilingTool) {
  ...
  private static class ContextImpl implements JavacFileManager.Context {
    ...
    public ContextImpl( JavaCompiler compiler,
                        DiagnosticOutputConsumer outConsumer,
