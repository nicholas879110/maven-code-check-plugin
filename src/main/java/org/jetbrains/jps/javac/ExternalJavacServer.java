...
public class ExternalJavacServer {
  ...
  private static final class ChannelRegistrar extends ChannelInboundHandlerAdapter {
    ...
    public void add( Channel serverChannel) {
  ...
  private static class JavacProcessDescriptor {
    ...
    public JavacProcessDescriptor( UUID sessionId,  ExternalJavacMessageHandler handler,  JavacRemoteProto.Message.Request request) {
