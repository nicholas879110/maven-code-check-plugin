...
public class JpsGradleExtensionServiceImpl extends JpsGradleExtensionService {
  ...
  @Override
  public JpsGradleModuleExtension getExtension( JpsModule module) {
    return module.getContainer().getChild(JpsGradleModuleExtensionImpl.ROLE);
  }


  @Override
  public JpsGradleModuleExtension getOrCreateExtension( JpsModule module) {
  ...
  @Override
  public boolean hasGradleProjectConfiguration( BuildDataPaths paths) {
  ...
  public GradleProjectConfiguration getGradleProjectConfiguration( File dataStorageRoot) {
