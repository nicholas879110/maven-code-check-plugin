...
public class GradleResourcesTargetType extends ModuleBasedBuildTargetType<GradleResourcesTarget> {
  ...
  @Override
  public List<GradleResourcesTarget> computeAllTargets( JpsModel model) {
  ...
  @Override
  public BuildTargetLoader<GradleResourcesTarget> createLoader( JpsModel model) {
    ...
    return new BuildTargetLoader<GradleResourcesTarget>() {
      ...
      @Override
      public GradleResourcesTarget createTarget( String targetId) {
