...
public class GradleResourcesTarget extends ModuleBasedTarget<GradleResourceRootDescriptor> {
  ...
  GradleResourcesTarget(final GradleResourcesTargetType type,  JpsModule module) {
    super(type, module);
  }
  ...
  private Collection<ResourceRootConfiguration> getRootConfigurations( GradleModuleResourceConfiguration moduleConfig) {
  ...
  public static File getOutputDir( File moduleOutput, ResourceRootConfiguration config,  String outputDirectory) {
