...
public class MavenManifestGenerationBuildTaskProvider extends ArtifactBuildTaskProvider {
  ...
  @Override
  public List<? extends BuildTask> createArtifactBuildTasks( JpsArtifact artifact,
                                                             ArtifactBuildPhase buildPhase) {
  ...
  private static class MavenManifestGenerationBuildTask extends BuildTask {
    ...
    private static String getModuleName( String artifactName) {
