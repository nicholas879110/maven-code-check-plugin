...
public class MavenResourcesBuilder extends TargetBuilder<MavenResourceRootDescriptor, MavenResourcesTarget> {
  ...
  @Override
  public void build( final MavenResourcesTarget target,  final DirtyFilesHolder<MavenResourceRootDescriptor, MavenResourcesTarget> holder,  final BuildOutputConsumer outputConsumer,  final CompileContext context) throws ProjectBuildException, IOException {
