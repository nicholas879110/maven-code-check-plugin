...
public class MavenResourcesTarget extends ModuleBasedTarget<MavenResourceRootDescriptor> {
  ...
  MavenResourcesTarget(final MavenResourcesTargetType type,  JpsModule module) {
    super(type, module);
  }
  ...
  private Collection<ResourceRootConfiguration> getRootConfigurations( MavenModuleResourceConfiguration moduleConfig) {
