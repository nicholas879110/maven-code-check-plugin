...
public class FormsBindingManager extends FormsBuilder {
  ...
  private static File findSourceForClass(JavaSourceRootDescriptor rd, final  String boundClassName) throws IOException {
  ...
  private static Collection<File> findPossibleSourcesForClass(JavaSourceRootDescriptor rd, final  String boundClassName) throws IOException {
    if (boundClassName == null) {
      return Collections.emptyList();
    }
    String relPath = suggestRelativePath(rd, boundClassName);
  ...
  private static String suggestRelativePath( JavaSourceRootDescriptor rd,  String className) {
