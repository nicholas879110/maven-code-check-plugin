...
public class BuildFSState {
  ...
  public void registerDeleted(BuildTarget<?> target, final File file,  Timestamps tsStorage) throws IOException {
  ...
  public FilesDelta getEffectiveFilesDelta( CompileContext context, BuildTarget<?> target) {
   ...
   * @throws IOException
   */
  public final boolean markDirty( CompileContext context, File file, final BuildRootDescriptor rd,  Timestamps tsStorage) throws IOException {
    return markDirty(context, CompilationRound.NEXT, file, rd, tsStorage);
  }

  public boolean markDirty( CompileContext context, CompilationRound round, File file, final BuildRootDescriptor rd,  Timestamps tsStorage) throws IOException {
  ...
  public boolean markDirtyIfNotDeleted( CompileContext context, CompilationRound round, File file, final BuildRootDescriptor rd,  Timestamps tsStorage) throws IOException {
