...
public class FSOperations {
  ...
  /**
   * @deprecated use markDirty(CompileContext context, final CompilationRound round, final ModuleChunk chunk,  FileFilter filter)
   */
  public static void markDirty(CompileContext context, final ModuleChunk chunk,  FileFilter filter) throws IOException {
    markDirty(context, CompilationRound.NEXT, chunk, filter);
  }

  public static void markDirty(CompileContext context, final CompilationRound round, final ModuleChunk chunk,  FileFilter filter) throws IOException {
    final ProjectDescriptor pd = context.getProjectDescriptor();
  ...
  public static void markDirtyRecursively(CompileContext context, final CompilationRound round, ModuleChunk chunk,  FileFilter filter) throws IOException {
  ...
  private static void traverseRecursively(CompileContext context,
                                          ...
                                          final boolean forceDirty,
                                           Set<File> currentFiles,  FileFilter filter,  FSCache fsCache) throws IOException {
  ...
  public static void pruneEmptyDirs(CompileContext context,  final Set<File> dirsToDelete) {
