...
public class GreclipseJpsCompilerSettings extends JpsCompositeElementBase<GreclipseJpsCompilerSettings> {
  ...
  public GreclipseJpsCompilerSettings( GreclipseSettings settings) {
    mySettings = settings;
  }
  ...
  @Override
  public void applyChanges( GreclipseJpsCompilerSettings modified) {
    mySettings = modified.mySettings;
  }


  public static GreclipseSettings getSettings( JpsProject project) {
