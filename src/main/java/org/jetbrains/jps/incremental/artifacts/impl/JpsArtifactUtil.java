...
public class JpsArtifactUtil {
  public static boolean processPackagingElements( JpsPackagingElement element,
                                                  Processor<JpsPackagingElement> processor) {
    return processPackagingElements(element, processor, new HashSet<JpsPackagingElement>());
  }

  private static boolean processPackagingElements( JpsPackagingElement element,
                                                  Processor<JpsPackagingElement> processor,
