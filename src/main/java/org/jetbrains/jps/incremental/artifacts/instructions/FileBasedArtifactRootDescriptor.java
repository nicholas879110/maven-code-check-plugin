...
public class FileBasedArtifactRootDescriptor extends ArtifactRootDescriptor {
  ...
  public FileBasedArtifactRootDescriptor( File file,
                                          SourceFileFilter filter,
                                         int index,
                                         ArtifactBuildTarget target,
                                          DestinationInfo destinationInfo, FileCopyingHandler copyingHandler) {
  ...
  private static SourceFileFilter createCompositeFilter( final SourceFileFilter baseFilter,  final FileFilter filter) {
