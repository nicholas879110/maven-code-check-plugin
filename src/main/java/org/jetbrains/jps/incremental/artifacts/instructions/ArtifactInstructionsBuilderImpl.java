...
public class ArtifactInstructionsBuilderImpl implements ArtifactInstructionsBuilder {
  ...
  public ArtifactInstructionsBuilderImpl( ModuleExcludeIndex rootsIndex,
                                          IgnoredFileIndex ignoredFileIndex,
                                          ArtifactBuildTarget target,
                                          JpsModel model,  BuildDataPaths dataPaths) {
  ...
  public boolean addDestination( ArtifactRootDescriptor descriptor) {
  ...
  public boolean registerJarFile( JarInfo jarInfo,  String outputPath) {
  ...
  public FileBasedArtifactRootDescriptor createFileBasedRoot( File file,
                                                              SourceFileFilter filter,
                                                             final  DestinationInfo destinationInfo, FileCopyingHandler handler) {
    return new FileBasedArtifactRootDescriptor(file, filter, myRootIndex++, myBuildTarget, destinationInfo, handler);
  }


  @Override
  public FileCopyingHandler createCopyingHandler( File file,  JpsPackagingElement contextElement) {
  ...
  public JarBasedArtifactRootDescriptor createJarBasedRoot( File jarFile,
                                                            String pathInJar,
                                                            SourceFileFilter filter,
