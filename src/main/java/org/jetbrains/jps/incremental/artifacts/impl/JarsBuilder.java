...
public class JarsBuilder {
  private static final Logger LOG = Logger.getInstance("#com.gome.maven.compiler.impl.packagingCompiler.JarsBuilder");
      ...
      if (pair.getSecond() instanceof ArtifactRootDescriptor) {
        ...
        if (descriptor instanceof FileBasedArtifactRootDescriptor) {
          ...
          ((JarBasedArtifactRootDescriptor)descriptor).processEntries(new JarBasedArtifactRootDescriptor.EntryProcessor() {
            @Override
            public void process( InputStream inputStream,  String relativePath, ZipEntry entry) throws IOException {
  ...
  private void addFileToJar(final  JarOutputStream jarOutputStream, final  File jarFile,  File file,
                            SourceFileFilter filter,  String relativePath, String targetJarPath,
                            final  Set<String> writtenPaths, List<String> packedFilePaths, final int rootIndex) throws IOException {
  ...
  private void addFileOrDirRecursively( ZipOutputStream jarOutputStream,
                                        File file,
  ...
  private static void addDirectoryEntry(final ZipOutputStream output,  final String relativePath, Set<String> writtenPaths) throws IOException {
