...
import com.gome.maven.util.io.PersistentEnumeratorBase;
...
public class JavaBuilder extends ModuleLevelBuilder {
  ...
  public ExitCode doBuild( CompileContext context,
                           ModuleChunk chunk,
                           DirtyFilesHolder<JavaSourceRootDescriptor, ModuleBuildTarget> dirtyFilesHolder,
                           OutputConsumer outputConsumer, JavaCompilingTool compilingTool) throws ProjectBuildException, IOException {
    try {
  ...
  private ExitCode compile(final CompileContext context,
                           ...
                           OutputConsumer outputConsumer,  JavaCompilingTool compilingTool)
    throws Exception {
