...
public class CompileScopeImpl extends CompileScope {
  ...
  @Override
  public boolean isAffected( BuildTarget<?> target) {
  ...
  @Override
  public boolean isBuildForced( BuildTarget<?> target) {
  ...
  @Override
  public boolean isBuildForcedForAllTargets( BuildTargetType<?> targetType) {
    return myTypesToForceBuild.contains(targetType) && myTypes.contains(targetType) && myFiles.isEmpty();
  }

  @Override
  public boolean isBuildIncrementally( BuildTargetType<?> targetType) {
    return !myTypesToForceBuild.contains(targetType);
  }

  @Override
  public boolean isAffected(BuildTarget<?> target,  File file) {
