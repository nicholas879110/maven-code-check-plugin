...
public abstract class TargetBuilder<R extends BuildRootDescriptor, T extends BuildTarget<R>> extends Builder {
   ...
   */
  public abstract void build( T target,  DirtyFilesHolder<R, T> holder,  BuildOutputConsumer outputConsumer,
                              CompileContext context) throws ProjectBuildException, IOException;
