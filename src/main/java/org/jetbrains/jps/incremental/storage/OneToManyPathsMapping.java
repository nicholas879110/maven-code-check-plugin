...
public class OneToManyPathsMapping extends AbstractStateStorage<String, Collection<String>> {
  ...
  @Override
  public void update( String keyPath,  Collection<String> boundPaths) throws IOException {
    super.update(FileUtil.toSystemIndependentName(keyPath), normalizePaths(boundPaths));
  }

  public final void update( String keyPath,  String boundPath) throws IOException {
    super.update(FileUtil.toSystemIndependentName(keyPath), Collections.singleton(FileUtil.toSystemIndependentName(boundPath)));
  }

  public final void appendData( String keyPath,  String boundPath) throws IOException {
  ...
  @Override
  public void appendData( String keyPath,  Collection<String> boundPaths) throws IOException {
    super.appendData(FileUtil.toSystemIndependentName(keyPath), normalizePaths(boundPaths));
  }


  @Override
  public Collection<String> getState( String keyPath) throws IOException {
    return super.getState(FileUtil.toSystemIndependentName(keyPath));
  }

  @Override
  public void remove( String keyPath) throws IOException {
    super.remove(FileUtil.toSystemIndependentName(keyPath));
  }

  public final void removeData( String keyPath,  String boundPath) throws IOException {
